...
window.LEARN_TASKS_CTCE = {
  "vt-prs-s": {
    ...
    tasks: [
      ...
      {
        id: "vt-prs-s-13",
        stem: "Muhammad Ali ___ his opponents with speed and psychological tactics before every title fight.",
        options: ["outmanoeuvres", "is outmanoeuvring", "outmanoeuvred"],
        answer: "outmanoeuvres",
        explanation: "A characteristic habitual strategy uses Present Simple.",
        fullExplanation: "Present Simple describes characteristic or habitual behaviour. 'Is outmanoeuvring' would suggest this is happening at this very moment. 'Outmanoeuvred' is Past Simple and would imply the tactic belongs only to a finished past period.",
        source: "Murphy, EGU (4e), Unit 1",
        hint: "outmanoeuvre",
        flavor: "personalities"
      },
      {
        id: "vt-prs-s-14",
        stem: "The Great Wall of China ___ thousands of kilometres across northern China from east to west.",
        options: ["extends", "is extending", "extended"],
        answer: "extends",
        explanation: "Permanent geographical facts use Present Simple.",
        fullExplanation: "Present Simple expresses permanent physical facts. 'Is extending' would suggest the wall is actively growing at this moment. 'Extended' is Past Simple and would wrongly imply the wall no longer exists.",
        source: "Swan, PEU (4e), §482.1",
        hint: "extend",
        flavor: "history"
      },
      {
        id: "vt-prs-s-15",
        stem: "The head chef ___ the menu every Monday morning before ordering supplies for the week.",
        options: ["reviews", "is reviewing", "reviewed"],
        answer: "reviews",
        explanation: "A fixed weekly routine uses Present Simple.",
        fullExplanation: "Present Simple expresses scheduled routines. 'Every Monday morning' is a clear frequency marker. 'Is reviewing' would describe the action in progress right now. 'Reviewed' is Past Simple and would imply the routine has ended.",
        source: "Murphy, EGU (4e), Unit 1",
        hint: "review",
        flavor: "social"
      },
      {
        id: "vt-prs-s-16",
        stem: "The human heart ___ approximately seventy times per minute when a person is at rest.",
        options: ["beats", "is beating", "beat"],
        answer: "beats",
        explanation: "A biological constant expressed as a scientific fact uses Present Simple.",
        fullExplanation: "Universal scientific facts about the human body are expressed with Present Simple. 'Is beating' would describe what is happening at a specific moment. 'Beat' is Past Simple and would incorrectly suggest the heart no longer does this.",
        source: "Swan, PEU (4e), §482.1",
        hint: "beat",
        flavor: "science"
      },
      {
        id: "vt-prs-s-17",
        stem: "Agatha Christie ___ her plots so carefully that readers rarely guess the murderer before the final chapter.",
        options: ["constructs", "is constructing", "has constructed"],
        answer: "constructs",
        explanation: "A characteristic authorial method uses Present Simple.",
        fullExplanation: "Present Simple describes a consistent characteristic method. 'Is constructing' would imply she is writing a plot at this very moment. 'Has constructed' focuses on past experience rather than her habitual writing approach.",
        source: "Murphy, EGU (4e), Unit 1",
        hint: "construct",
        flavor: "personalities"
      },
      {
        id: "vt-prs-s-18",
        stem: "The Eiffel Tower ___ over three hundred metres tall, including its broadcasting antenna.",
        options: ["stands", "is standing", "has stood"],
        answer: "stands",
        explanation: "A permanent measurement fact uses Present Simple.",
        fullExplanation: "Present Simple states permanent facts such as height. 'Is standing' would imply a temporary position. 'Has stood' would emphasise duration rather than stating a simple factual measurement.",
        source: "Swan, PEU (4e), §482.1",
        hint: "stand",
        flavor: "history"
      },
      {
        id: "vt-prs-s-19",
        stem: "My aunt ___ her car every Sunday afternoon so it is ready for the working week.",
        options: ["washes", "is washing", "washed"],
        answer: "washes",
        explanation: "A fixed weekly personal habit uses Present Simple.",
        fullExplanation: "Present Simple expresses a personal routine marked by a frequency expression ('every Sunday'). 'Is washing' would describe the action happening at this moment. 'Washed' is Past Simple, implying the habit has stopped.",
        source: "Murphy, EGU (4e), Unit 1",
        hint: "wash",
        flavor: "social"
      },
      {
        id: "vt-prs-s-20",
        stem: "Water ___ its highest density at four degrees Celsius, just above its freezing point.",
        options: ["reaches", "is reaching", "reached"],
        answer: "reaches",
        explanation: "A physical scientific law expressed as a general truth uses Present Simple.",
        fullExplanation: "General laws of physics and chemistry take Present Simple. 'Is reaching' would suggest this is happening at a particular moment. 'Reached' is Past Simple and would wrongly imply the property no longer holds.",
        source: "Swan, PEU (4e), §482.1",
        hint: "reach",
        flavor: "science"
      },
      {
        id: "vt-prs-s-21",
        stem: "Nelson Mandela ___ reconciliation and forgiveness in every speech during his presidency.",
        options: ["emphasises", "is emphasising", "emphasised"],
        answer: "emphasises",
        explanation: "A consistent rhetorical characteristic uses Present Simple.",
        fullExplanation: "Present Simple describes a consistent characteristic associated with a person. 'Is emphasising' would mean the action is happening right now. 'Emphasised' is Past Simple and would limit the characteristic to a completed past period.",
        source: "Murphy, EGU (4e), Unit 1",
        hint: "emphasise",
        flavor: "personalities"
      },
      {
        id: "vt-prs-s-22",
        stem: "The Amazon River ___ more freshwater into the Atlantic Ocean than any other river on Earth.",
        options: ["discharges", "is discharging", "discharged"],
        answer: "discharges",
        explanation: "Permanent geographical and hydrological facts use Present Simple.",
        fullExplanation: "Present Simple expresses permanent natural facts. 'Is discharging' would describe a temporary or ongoing event at this moment. 'Discharged' is Past Simple and would wrongly suggest the river no longer flows into the Atlantic.",
        source: "Swan, PEU (4e), §482.1",
        hint: "discharge",
        flavor: "history"
      },
      {
        id: "vt-prs-s-23",
        stem: "Our neighbours ___ their garden gate whenever they leave so the children cannot wander out.",
        options: ["lock", "are locking", "locked"],
        answer: "lock",
        explanation: "A habitual precautionary action uses Present Simple.",
        fullExplanation: "Present Simple describes a regular habit. 'Are locking' would mean they are doing it at this very moment. 'Locked' is Past Simple and would imply the habit belongs to a finished period.",
        source: "Murphy, EGU (4e), Unit 1",
        hint: "lock",
        flavor: "social"
      },
      {
        id: "vt-prs-s-24",
        stem: "Plants ___ carbon dioxide from the atmosphere and release oxygen during the process of photosynthesis.",
        options: ["absorb", "are absorbing", "absorbed"],
        answer: "absorb",
        explanation: "A universal biological process stated as a general truth uses Present Simple.",
        fullExplanation: "Present Simple expresses scientific truths and universal natural processes. 'Are absorbing' would describe a process happening right now, not a general law. 'Absorbed' is Past Simple and would incorrectly imply the process has ended.",
        source: "Murphy, EGU (4e), Unit 1",
        hint: "absorb",
        flavor: "science"
      }
  ...
  "vt-prs-c": {
    ...
    tasks: [
      ...
      {
        id: "vt-prs-c-13",
        stem: "The gallery ___ a retrospective of Frida Kahlo's lesser-known sketches throughout this quarter.",
        options: ["is hosting", "hosts", "has hosted"],
        answer: "is hosting",
        explanation: "'Throughout this quarter' signals a temporary current activity — Present Continuous.",
        fullExplanation: "Present Continuous describes a temporary activity happening in an extended present period. 'Hosts' (Present Simple) would express a habitual or permanent feature of the gallery. 'Has hosted' (Present Perfect) focuses on the completed experience rather than the ongoing temporary exhibition.",
        source: "Murphy, EGU (4e), Unit 3",
        hint: "host",
        flavor: "personalities"
      },
      {
        id: "vt-prs-c-14",
        stem: "Conservationists ___ the ancient frescoes inside the catacombs of Rome during this restoration project.",
        options: ["are documenting", "document", "documented"],
        answer: "are documenting",
        explanation: "'During this restoration project' marks a temporary ongoing activity — Present Continuous.",
        fullExplanation: "Present Continuous expresses work currently in progress over a defined temporary period. 'Document' (Present Simple) would describe a habitual professional activity. 'Documented' is Past Simple, placing the work in a completed past time.",
        source: "Murphy, EGU (4e), Unit 3",
        hint: "document",
        flavor: "history"
      },
      {
        id: "vt-prs-c-15",
        stem: "My flatmate is always ___ the kitchen light on all night, which wastes a lot of electricity.",
        options: ["leaving", "leave", "left"],
        answer: "leaving",
        explanation: "'Is always leaving' — Present Continuous with 'always' for an irritating habit.",
        fullExplanation: "Present Continuous with 'always' expresses an irritating repeated behaviour. The -ing form must follow 'is always'. 'Leave' is the bare infinitive and cannot follow 'is'. 'Left' is the past participle and does not fit this grammatical slot.",
        source: "Murphy, EGU (4e), Unit 4",
        hint: "leave",
        flavor: "social"
      },
      {
        id: "vt-prs-c-16",
        stem: "Coral reefs in the Indian Ocean ___ due to increasingly warm sea temperatures this decade.",
        options: ["are bleaching", "bleach", "bleached"],
        answer: "are bleaching",
        explanation: "An ongoing environmental deterioration trend uses Present Continuous.",
        fullExplanation: "Present Continuous describes a developing or worsening situation over a current period. 'Bleach' (Present Simple) would state a habitual or general biological fact. 'Bleached' is Past Simple, wrongly implying the process has ended.",
        source: "Swan, PEU (4e), §482.4",
        hint: "bleach",
        flavor: "science"
      },
      {
        id: "vt-prs-c-17",
        stem: "Maya Angelou's foundation ___ a new literary prize for young African-American poets this academic year.",
        options: ["is launching", "launches", "has launched"],
        answer: "is launching",
        explanation: "'This academic year' signals a temporary current initiative — Present Continuous.",
        fullExplanation: "Present Continuous is used for activities happening during an extended current period. 'Launches' (Present Simple) would express a habitual or scheduled routine. 'Has launched' (Present Perfect) would focus on the completed fact rather than the ongoing nature of the initiative.",
        source: "Murphy, EGU (4e), Unit 3",
        hint: "launch",
        flavor: "personalities"
      },
      {
        id: "vt-prs-c-18",
        stem: "Archaeologists ___ new sections of the ancient trade route known as the Silk Road this summer.",
        options: ["are mapping", "map", "mapped"],
        answer: "are mapping",
        explanation: "'This summer' marks a temporary ongoing fieldwork activity — Present Continuous.",
        fullExplanation: "Present Continuous expresses work currently in progress over a defined temporary period. 'Map' (Present Simple) would describe a habitual or general professional activity. 'Mapped' is Past Simple, placing the work in a finished past time frame.",
        source: "Murphy, EGU (4e), Unit 3",
        hint: "map",
        flavor: "history"
      },
      {
        id: "vt-prs-c-19",
        stem: "The landlord is always ___ the rent at the last possible moment, which causes endless delays for tenants.",
        options: ["collecting", "collect", "collected"],
        answer: "collecting",
        explanation: "'Is always collecting' — Present Continuous with 'always' highlights an irritating pattern.",
        fullExplanation: "Present Continuous with 'always' signals a repeated behaviour that the speaker finds irritating. The -ing form must follow 'is always'. 'Collect' is the bare infinitive and cannot follow 'is'. 'Collected' is the past participle and is grammatically incorrect in this position.",
        source: "Murphy, EGU (4e), Unit 4",
        hint: "collect",
        flavor: "social"
      },
      {
        id: "vt-prs-c-20",
        stem: "The permafrost in Siberia ___ at an unprecedented pace, releasing methane trapped for millennia.",
        options: ["is thawing", "thaws", "thawed"],
        answer: "is thawing",
        explanation: "An accelerating current environmental change uses Present Continuous.",
        fullExplanation: "Present Continuous expresses a developing situation unfolding over a current period. 'Thaws' (Present Simple) would describe a regular seasonal cycle rather than an alarming ongoing trend. 'Thawed' is Past Simple, implying the process is over.",
        source: "Swan, PEU (4e), §482.4",
        hint: "thaw",
        flavor: "science"
      },
      {
        id: "vt-prs-c-21",
        stem: "Einstein's granddaughter ___ a series of lectures about his private correspondence at universities this term.",
        options: ["is delivering", "delivers", "has delivered"],
        answer: "is delivering",
        explanation: "'This term' signals a temporary current activity — Present Continuous.",
        fullExplanation: "Present Continuous is used for activities taking place in an extended present period ('this term'). 'Delivers' (Present Simple) would express a habitual professional practice. 'Has delivered' (Present Perfect) would focus on the completed activity rather than the ongoing nature of the lecture tour.",
        source: "Murphy, EGU (4e), Unit 3",
        hint: "deliver",
        flavor: "personalities"
      },
      {
        id: "vt-prs-c-22",
        stem: "Historians ___ the newly opened Ottoman imperial archives to understand the origins of World War One.",
        options: ["are examining", "examine", "examined"],
        answer: "are examining",
        explanation: "Research currently in progress uses Present Continuous.",
        fullExplanation: "Present Continuous describes scholarly work actively in progress at this time. 'Examine' (Present Simple) would describe a habitual or general professional activity. 'Examined' in Past Simple would place the research in a completed past moment.",
        source: "Murphy, EGU (4e), Unit 3",
        hint: "examine",
        flavor: "history"
      },
      {
        id: "vt-prs-c-23",
        stem: "Our upstairs neighbour is always ___ furniture around at midnight and keeping the whole building awake.",
        options: ["moving", "move", "moved"],
        answer: "moving",
        explanation: "'Is always moving' — Present Continuous with 'always' for an annoying repeated behaviour.",
        fullExplanation: "Present Continuous with 'always' highlights an irritating habitual action. The -ing form must follow 'is always'. 'Move' is the bare infinitive and cannot follow 'is'. 'Moved' is the past participle and is grammatically incorrect in this structural position.",
        source: "Murphy, EGU (4e), Unit 4",
        hint: "move",
        flavor: "social"
      },
      {
        id: "vt-prs-c-24",
        stem: "Researchers ___ a potential new antibiotic compound in clinical trials currently under way in Europe.",
        options: ["are evaluating", "evaluate", "evaluated"],
        answer: "are evaluating",
        explanation: "Trials currently in progress use Present Continuous.",
        fullExplanation: "Present Continuous describes scientific work happening right now. 'Evaluate' (Present Simple) would describe a habitual or general scientific activity. 'Evaluated' is Past Simple, implying the trials have already concluded.",
        source: "Murphy, EGU (4e), Unit 3",
        hint: "evaluate",
        flavor: "science"
      }
  ...
  "vt-pst-s": {
    ...
    tasks: [
      ...
      {
        id: "vt-pst-s-13",
        stem: "Frida Kahlo ___ her first self-portrait in 1926 while recovering from a serious bus accident.",
        options: ["painted", "was painting", "has painted"],
        answer: "painted",
        explanation: "A completed past act of creation with a specific year uses Past Simple.",
        fullExplanation: "Past Simple records a completed event at a definite past date ('1926'). 'Was painting' is Past Continuous and would imply the portrait was still unfinished. 'Has painted' is Present Perfect, which cannot be anchored to a closed past year.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "paint",
        flavor: "personalities"
      },
      {
        id: "vt-pst-s-14",
        stem: "The Magna Carta ___ in June 1215, limiting the power of the English king for the first time.",
        options: ["was signed", "has been signed", "was being signed"],
        answer: "was signed",
        explanation: "A completed historical event with a specific date uses Past Simple (passive).",
        fullExplanation: "Past Simple passive expresses a completed event at a definite past date ('June 1215'). 'Has been signed' is Present Perfect passive, incompatible with a closed historical time reference. 'Was being signed' is Past Continuous passive and would imply the signing was still in progress.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "sign",
        flavor: "history"
      },
      {
        id: "vt-pst-s-15",
        stem: "My sister ___ her driving test, celebrated with the family, and ordered a new car that same afternoon.",
        options: ["passed", "was passing", "has passed"],
        answer: "passed",
        explanation: "A sequence of completed past events uses Past Simple.",
        fullExplanation: "Past Simple expresses a chain of completed past actions (passed → celebrated → ordered). 'Was passing' is Past Continuous and would describe the test as still in progress. 'Has passed' is Present Perfect and does not fit a completed narrative sequence set in the past.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "pass",
        flavor: "social"
      },
      {
        id: "vt-pst-s-16",
        stem: "Galileo ___ that Jupiter has moons after observing the planet through his telescope in 1610.",
        options: ["proved", "has proved", "was proving"],
        answer: "proved",
        explanation: "A completed scientific discovery at a specific past date uses Past Simple.",
        fullExplanation: "Past Simple records a completed event at a known past date ('1610'). 'Has proved' is Present Perfect, which cannot combine with a closed past time reference. 'Was proving' is Past Continuous, implying the work was still ongoing rather than concluded.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "prove",
        flavor: "science"
      },
      {
        id: "vt-pst-s-17",
        stem: "Winston Churchill ___ the British wartime radio broadcast on the evening of the Dunkirk evacuation.",
        options: ["delivered", "has delivered", "was delivering"],
        answer: "delivered",
        explanation: "A completed past action at a specific past occasion uses Past Simple.",
        fullExplanation: "Past Simple expresses a single completed action at a definite past moment. 'Has delivered' is Present Perfect and would not match a specific historical occasion already in the past. 'Was delivering' is Past Continuous, emphasising the ongoing process rather than the completed speech.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "deliver",
        flavor: "personalities"
      },
      {
        id: "vt-pst-s-18",
        stem: "The Wright brothers ___ their first successful powered flight at Kitty Hawk in December 1903.",
        options: ["made", "have made", "were making"],
        answer: "made",
        explanation: "A completed historical milestone with a specific date uses Past Simple.",
        fullExplanation: "Past Simple is required for a completed event at a definite historical date ('December 1903'). 'Have made' is Present Perfect, incompatible with a closed past time reference. 'Were making' is Past Continuous, implying the flight was still in progress rather than a completed event.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "make",
        flavor: "history"
      },
      {
        id: "vt-pst-s-19",
        stem: "The porter ___ the bags to our room, handed us the key, and wished us a pleasant stay.",
        options: ["carried", "was carrying", "has carried"],
        answer: "carried",
        explanation: "A sequence of completed service actions in the past uses Past Simple.",
        fullExplanation: "Past Simple describes a series of completed actions in sequence (carried → handed → wished). 'Was carrying' is Past Continuous, implying the action was still in progress rather than completed. 'Has carried' is Present Perfect and does not fit a narrative sequence set in the past.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "carry",
        flavor: "social"
      },
      {
        id: "vt-pst-s-20",
        stem: "James Watson and Francis Crick ___ the double-helix structure of DNA at Cambridge in 1953.",
        options: ["described", "have described", "were describing"],
        answer: "described",
        explanation: "A completed scientific breakthrough at a specific date uses Past Simple.",
        fullExplanation: "Past Simple records a completed achievement at a specific past date ('1953'). 'Have described' is Present Perfect and cannot be anchored to a closed past time reference. 'Were describing' is Past Continuous, implying the work was still in progress rather than a completed discovery.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "describe",
        flavor: "science"
      },
      {
        id: "vt-pst-s-21",
        stem: "Ada Lovelace ___ the first algorithm intended to be processed by a machine in the 1840s.",
        options: ["wrote", "has written", "was writing"],
        answer: "wrote",
        explanation: "A completed intellectual achievement in a specific past decade uses Past Simple.",
        fullExplanation: "Past Simple expresses a completed action at a definite past time ('the 1840s'). 'Has written' is Present Perfect, which cannot combine with a closed past time marker. 'Was writing' is Past Continuous, implying the algorithm was still being composed rather than finished.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "write",
        flavor: "personalities"
      },
      {
        id: "vt-pst-s-22",
        stem: "The Industrial Revolution ___ in Britain during the late eighteenth century, transforming manufacturing forever.",
        options: ["began", "has begun", "was beginning"],
        answer: "began",
        explanation: "A completed historical event with a period marker uses Past Simple.",
        fullExplanation: "Past Simple records a completed event at a definite historical period ('late eighteenth century'). 'Has begun' is Present Perfect, incompatible with a closed past time reference. 'Was beginning' is Past Continuous, suggesting an ongoing process rather than the definitive start of an era.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "begin",
        flavor: "history"
      },
      {
        id: "vt-pst-s-23",
        stem: "My colleague ___ her presentation, answered the questions confidently, and then sat down.",
        options: ["finished", "was finishing", "has finished"],
        answer: "finished",
        explanation: "A narrative sequence of completed actions uses Past Simple.",
        fullExplanation: "Past Simple expresses a sequence of completed actions in a past narrative (finished → answered → sat down). 'Was finishing' is Past Continuous and would suggest the action was still in progress. 'Has finished' is Present Perfect and does not fit a specific past narrative sequence.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "finish",
        flavor: "social"
      },
      {
        id: "vt-pst-s-24",
        stem: "Edwin Hubble ___ that the universe is expanding after analysing the redshift of distant galaxies in 1929.",
        options: ["demonstrated", "was demonstrating", "has demonstrated"],
        answer: "demonstrated",
        explanation: "A completed scientific demonstration at a specific past date uses Past Simple.",
        fullExplanation: "Past Simple records a completed past achievement at a known date ('1929'). 'Was demonstrating' is Past Continuous, implying the work was still in progress rather than a concluded discovery. 'Has demonstrated' is Present Perfect and cannot be anchored to a closed past date.",
        source: "Murphy, EGU (4e), Unit 5",
        hint: "demonstrate",
        flavor: "science"
      }
  ...
  "vt-pst-c": {
    ...
    tasks: [
      ...
      {
        id: "vt-pst-c-13",
        stem: "Charles Dickens ___ Oliver Twist when his publisher demanded he increase the weekly chapter output.",
        options: ["was serialising", "serialised", "had serialised"],
        answer: "was serialising",
        explanation: "An action in progress at a past moment of interruption uses Past Continuous.",
        fullExplanation: "Past Continuous describes the ongoing background action (serialising) that was still under way when another event (the publisher's demand) occurred. 'Serialised' is Past Simple and would treat both events as equally completed and sequential. 'Had serialised' is Past Perfect, implying the serialisation was already over before the demand.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "serialise",
        flavor: "personalities"
      },
      {
        id: "vt-pst-c-14",
        stem: "Roman legionaries ___ a river crossing when a sudden flood swept away their supply boats.",
        options: ["were constructing", "constructed", "had constructed"],
        answer: "were constructing",
        explanation: "An activity in progress when a shorter interrupting event occurred uses Past Continuous.",
        fullExplanation: "Past Continuous describes the background activity (constructing a crossing) that was in progress when the flood (a sudden event) struck. 'Constructed' is Past Simple, making both events seem sequential and completed. 'Had constructed' is Past Perfect, implying the bridge was already complete before the flood.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "construct",
        flavor: "history"
      },
      {
        id: "vt-pst-c-15",
        stem: "The nurse ___ the patient's blood pressure when the alarm on the heart monitor suddenly sounded.",
        options: ["was measuring", "measured", "has measured"],
        answer: "was measuring",
        explanation: "An action in progress when an interrupting event occurred uses Past Continuous.",
        fullExplanation: "Past Continuous describes the activity in progress (measuring blood pressure) at the moment of interruption (alarm sounding). 'Measured' is Past Simple and would suggest the two events were sequential rather than overlapping. 'Has measured' is Present Perfect and does not fit a specific past narrative context.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "measure",
        flavor: "social"
      },
      {
        id: "vt-pst-c-16",
        stem: "The tectonic plates ___ slowly in opposite directions when a major earthquake suddenly ruptured the fault line.",
        options: ["were moving", "moved", "had moved"],
        answer: "were moving",
        explanation: "A prolonged background process at the moment of interruption uses Past Continuous.",
        fullExplanation: "Past Continuous expresses an ongoing process (plate movement) that was already under way when the sudden event (earthquake) occurred. 'Moved' in Past Simple would treat both as completed sequential events. 'Had moved' is Past Perfect, implying the movement was entirely finished before the earthquake.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "move",
        flavor: "science"
      },
      {
        id: "vt-pst-c-17",
        stem: "Leonardo da Vinci ___ a series of anatomical drawings when a Florentine patron commissioned a new portrait.",
        options: ["was completing", "completed", "has completed"],
        answer: "was completing",
        explanation: "An activity in progress when another event occurred uses Past Continuous.",
        fullExplanation: "Past Continuous describes Leonardo's ongoing work (completing drawings) at the moment the commission arrived. 'Completed' is Past Simple, which would present the completion and the commission as two sequential finished events. 'Has completed' is Present Perfect and cannot anchor the event in a past narrative.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "complete",
        flavor: "personalities"
      },
      {
        id: "vt-pst-c-18",
        stem: "Viking traders ___ goods along the Baltic coast when Norwegian longships raided a major trading post.",
        options: ["were transporting", "transported", "had transported"],
        answer: "were transporting",
        explanation: "An ongoing background activity interrupted by a sudden event uses Past Continuous.",
        fullExplanation: "Past Continuous describes the activity in progress (transporting goods) at the moment the raid (the interrupting event) happened. 'Transported' in Past Simple would make both events equally completed and sequential. 'Had transported' is Past Perfect, implying the goods were already delivered before the raid.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "transport",
        flavor: "history"
      },
      {
        id: "vt-pst-c-19",
        stem: "My father ___ a speech at my graduation when his phone rang and disrupted the whole ceremony.",
        options: ["was giving", "gave", "had given"],
        answer: "was giving",
        explanation: "The background action in progress at the moment of interruption uses Past Continuous.",
        fullExplanation: "Past Continuous describes the action (speech) in progress when the shorter interrupting event (phone ringing) occurred. 'Gave' in Past Simple would treat both events as a simple sequence. 'Had given' is Past Perfect, implying the speech was entirely over before the phone rang.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "give",
        flavor: "social"
      },
      {
        id: "vt-pst-c-20",
        stem: "The probe ___ atmospheric data from Saturn's upper cloud layer when its antenna lost contact with Earth.",
        options: ["was transmitting", "transmitted", "had transmitted"],
        answer: "was transmitting",
        explanation: "An ongoing operation at the moment a fault occurred uses Past Continuous.",
        fullExplanation: "Past Continuous expresses the activity in progress (transmitting data) at the moment the fault (loss of contact) occurred. 'Transmitted' in Past Simple would treat both events as sequential and complete. 'Had transmitted' is Past Perfect, implying all transmission was finished before the fault.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "transmit",
        flavor: "science"
      },
      {
        id: "vt-pst-c-21",
        stem: "Mark Twain ___ a lecture tour across Europe when his publisher went bankrupt and he lost his savings.",
        options: ["was conducting", "conducted", "had conducted"],
        answer: "was conducting",
        explanation: "An activity in progress when another past event struck uses Past Continuous.",
        fullExplanation: "Past Continuous describes Twain's ongoing activity (lecture tour) at the moment the shorter event (publisher going bankrupt) occurred. 'Conducted' in Past Simple would list both events as completed and sequential. 'Had conducted' is Past Perfect, suggesting the tour was over before the bankruptcy.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "conduct",
        flavor: "personalities"
      },
      {
        id: "vt-pst-c-22",
        stem: "Gladiators ___ in the arena when a violent thunderstorm forced the spectators to abandon the Colosseum.",
        options: ["were fighting", "fought", "had fought"],
        answer: "were fighting",
        explanation: "The ongoing background event at the moment of interruption uses Past Continuous.",
        fullExplanation: "Past Continuous describes the action in progress (fighting) at the moment the storm (the interrupting event) forced a stop. 'Fought' in Past Simple would place both events as equally completed and sequential. 'Had fought' is Past Perfect, implying the fight was completely over before the storm.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "fight",
        flavor: "history"
      },
      {
        id: "vt-pst-c-23",
        stem: "The technician ___ the server when a colleague accidentally unplugged the entire power supply.",
        options: ["was restarting", "restarted", "has restarted"],
        answer: "was restarting",
        explanation: "An action in progress at the moment of the accidental interruption uses Past Continuous.",
        fullExplanation: "Past Continuous describes the background action (restarting the server) at the moment the shorter, sudden event (unplugging) occurred. 'Restarted' in Past Simple would suggest both happened one after the other. 'Has restarted' is Present Perfect and does not fit a specific past narrative.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "restart",
        flavor: "social"
      },
      {
        id: "vt-pst-c-24",
        stem: "The satellite ___ images of the wildfire when a solar storm disrupted its onboard instruments.",
        options: ["was capturing", "captured", "had captured"],
        answer: "was capturing",
        explanation: "An ongoing operation interrupted by an external event uses Past Continuous.",
        fullExplanation: "Past Continuous expresses the activity in progress (capturing images) at the moment of the interrupting event (solar storm). 'Captured' in Past Simple would treat both as sequential completed events. 'Had captured' is Past Perfect, implying all image capture was finished before the storm.",
        source: "Murphy, EGU (4e), Unit 6",
        hint: "capture",
        flavor: "science"
      }
  ...
  "vt-pp-s": {
    ...
    tasks: [
      ...
      {
        id: "vt-pp-s-13",
        stem: "Nikola Tesla ___ over seven hundred patents during his lifetime, changing electrical engineering permanently.",
        options: ["has registered", "registered", "was registering"],
        answer: "has registered",
        explanation: "A life-achievement fact with present relevance uses Present Perfect.",
        fullExplanation: "Present Perfect describes a past achievement whose significance remains relevant today. 'Registered' in Past Simple would require a specific closed time marker. 'Was registering' is Past Continuous and implies an ongoing process rather than a completed lifetime total.",
        source: "Murphy, EGU (4e), Unit 7",
        hint: "register",
        flavor: "personalities"
      },
      {
        id: "vt-pp-s-14",
        stem: "Archaeologists ___ more than two thousand ancient artefacts at the site of the Agora in Athens.",
        options: ["have uncovered", "uncovered", "were uncovering"],
        answer: "have uncovered",
        explanation: "A cumulative discovery with present relevance uses Present Perfect.",
        fullExplanation: "Present Perfect expresses a cumulative achievement without a specific closed past date. 'Uncovered' in Past Simple would require a definite time expression such as 'last year'. 'Were uncovering' is Past Continuous and implies the process was in progress at a past moment rather than completed.",
        source: "Murphy, EGU (4e), Unit 7",
        hint: "uncover",
        flavor: "history"
      },
      {
        id: "vt-pp-s-15",
        stem: "My boss ___ just ___ the project deadline by two weeks, so we can all breathe again.",
        options: ["has / extended", "had / extended", "was / extending"],
        answer: "has / extended",
        explanation: "'Just' with Present Perfect describes a very recent completed decision with present relief.",
        fullExplanation: "Present Perfect with 'just' expresses a very recently completed action whose result is felt now (relief). 'Had extended' is Past Perfect, relating to a point before another past event. 'Was extending' is Past Continuous and describes an action in progress rather than a completed decision.",
        source: "Murphy, EGU (4e), Unit 8",
        hint: "extend",
        flavor: "social"
      },
      {
        id: "vt-pp-s-16",
        stem: "Scientists ___ a new species of deep-sea fish that uses bioluminescence to attract prey in total darkness.",
        options: ["have identified", "identified", "were identifying"],
        answer: "have identified",
        explanation: "A recent scientific discovery with present relevance uses Present Perfect.",
        fullExplanation: "Present Perfect describes a discovery relevant to current scientific knowledge, with no closed date. 'Identified' in Past Simple would need a specific past time marker. 'Were identifying' is Past Continuous, implying the work was still in progress.",
        source: "Murphy, EGU (4e), Unit 7",
        hint: "identify",
        flavor: "science"
      },
      {
        id: "vt-pp-s-17",
        stem: "Mozart ___ never ___ a complete opera longer than three hours, yet his works fill concert halls worldwide.",
        options: ["has / written", "had / written", "was / writing"],
        answer: "has / written",
        explanation: "'Never' + Present Perfect states a life-experience fact up to the present.",
        fullExplanation: "Present Perfect with 'never' expresses something that has not occurred in a person's lifetime up to now. 'Had written' is Past Perfect, relating to a point before another past event. 'Was writing' is Past Continuous and does not combine with 'never' in this structure.",
        source: "Murphy, EGU (4e), Unit 8",
        hint: "write",
        flavor: "personalities"
      },
      {
        id: "vt-pp-s-18",
        stem: "Historians ___ already ___ three previously unknown letters written by Cleopatra this decade.",
        options: ["have / authenticated", "had / authenticated", "were / authenticating"],
        answer: "have / authenticated",
        explanation: "'Already' + Present Perfect in an open current period shows completion before expected.",
        fullExplanation: "Present Perfect with 'already' signals completion sooner than expected, and 'this decade' (an open period) confirms it. 'Had authenticated' is Past Perfect, used before another past event. 'Were authenticating' is Past Continuous, not compatible with 'already' in this structure.",
        source: "Murphy, EGU (4e), Unit 8",
        hint: "authenticate",
        flavor: "history"
      },
      {
        id: "vt-pp-s-19",
        stem: "The electrician ___ not ___ yet, so please do not switch on the main circuit breaker.",
        options: ["has / arrived", "had / arrived", "was / arriving"],
        answer: "has / arrived",
        explanation: "'Yet' + negative Present Perfect describes something expected but not yet done.",
        fullExplanation: "Negative Present Perfect with 'yet' expresses that something expected has not happened up to now. 'Had arrived' is Past Perfect, relating to a point before another past event. 'Was arriving' is Past Continuous and does not work with 'yet' in this structure.",
        source: "Murphy, EGU (4e), Unit 8",
        hint: "arrive",
        flavor: "social"
      },
      {
        id: "vt-pp-s-20",
        stem: "The concentration of microplastics in ocean water ___ dramatically since the 1980s.",
        options: ["has increased", "increased", "was increasing"],
        answer: "has increased",
        explanation: "'Since the 1980s' with an ongoing change up to now uses Present Perfect.",
        fullExplanation: "Present Perfect with 'since' expresses a change from a past point that continues to be relevant now. 'Increased' in Past Simple would require a closed past time frame. 'Was increasing' is Past Continuous and would describe a process at a specific past moment rather than the cumulative change to the present.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "increase",
        flavor: "science"
      },
      {
        id: "vt-pp-s-21",
        stem: "Chopin ___ some of the most technically demanding piano études ever composed, inspiring generations of pianists.",
        options: ["has left", "left", "was leaving"],
        answer: "has left",
        explanation: "A creative legacy still relevant today uses Present Perfect to link past to present.",
        fullExplanation: "Present Perfect links Chopin's past compositional output to its continuing relevance today. 'Left' in Past Simple would treat the legacy as a closed past fact. 'Was leaving' is Past Continuous and implies an ongoing process rather than the completed body of work.",
        source: "Murphy, EGU (4e), Unit 7",
        hint: "leave",
        flavor: "personalities"
      },
      {
        id: "vt-pp-s-22",
        stem: "The number of UNESCO World Heritage Sites ___ to over a thousand since the programme was founded in 1972.",
        options: ["has grown", "grew", "was growing"],
        answer: "has grown",
        explanation: "'Since 1972' connecting a past start to the present uses Present Perfect.",
        fullExplanation: "Present Perfect with 'since' expresses a change that began in the past and continues to be relevant now. 'Grew' in Past Simple would require a closed time reference. 'Was growing' is Past Continuous, describing the process at a past moment rather than the cumulative result to the present.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "grow",
        flavor: "history"
      },
      {
        id: "vt-pp-s-23",
        stem: "I ___ for this train for over forty minutes and it still has not been announced on the board.",
        options: ["have been waiting", "waited", "am waiting"],
        answer: "have been waiting",
        explanation: "'For over forty minutes' extending to now uses Present Perfect for an ongoing state.",
        fullExplanation: "Present Perfect expresses an action that started in the past and continues to the present ('for over forty minutes'). 'Waited' in Past Simple would imply the wait is over. 'Am waiting' is Present Continuous and expresses only the current moment without the duration from a past starting point.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "wait",
        flavor: "social"
      },
      {
        id: "vt-pp-s-24",
        stem: "Astronomers ___ for years to confirm the existence of a black hole at the centre of the Milky Way.",
        options: ["have been gathering", "gathered", "are gathering"],
        answer: "have been gathering",
        explanation: "'For years' reaching the present uses Present Perfect for an ongoing scientific effort.",
        fullExplanation: "Present Perfect expresses effort that started in the past and continues now ('for years'). 'Gathered' in Past Simple would close the time frame and imply data collection has stopped. 'Are gathering' is Present Continuous and describes only the current moment, missing the duration from the past.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "gather",
        flavor: "science"
      }
  ...
  "vt-pp-c": {
    ...
    tasks: [
      ...
      {
        id: "vt-pp-c-13",
        stem: "Isaac Newton ___ the principles of classical mechanics since his early work at Cambridge in the 1660s.",
        options: ["has been refining", "refined", "has refined"],
        answer: "has been refining",
        explanation: "'Since his early work' with ongoing intellectual development uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous emphasises the unbroken continuity of an activity from a past starting point to the present. 'Refined' (Past Simple) would suggest he has stopped. 'Has refined' (Present Perfect Simple) focuses on the completed body of refinements rather than the ongoing process of intellectual development.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "refine",
        flavor: "personalities"
      },
      {
        id: "vt-pp-c-14",
        stem: "Scholars ___ the philosophical manuscripts of ancient Alexandria for centuries to understand classical thought.",
        options: ["have been analysing", "analysed", "have analysed"],
        answer: "have been analysing",
        explanation: "An unbroken scholarly activity from the past to the present uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous expresses a process that has been in progress over a long period and continues to the present. 'For centuries' gives the extended duration. 'Analysed' (Past Simple) would imply the research has stopped. 'Have analysed' (Present Perfect Simple) would emphasise the conclusions reached rather than the continuing act of analysis.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "analyse",
        flavor: "history"
      },
      {
        id: "vt-pp-c-15",
        stem: "My colleague ___ for a transfer to the overseas office ever since she came back from a conference there.",
        options: ["has been requesting", "requested", "is requesting"],
        answer: "has been requesting",
        explanation: "'Ever since she came back' with ongoing effort requires Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous links a past starting point ('ever since she came back') to the present, showing the activity is still ongoing. 'Requested' (Past Simple) would suggest the requests have stopped. 'Is requesting' (Present Continuous) describes only the present moment and does not convey how long the effort has lasted.",
        source: "Murphy, EGU (4e), Unit 10",
        hint: "request",
        flavor: "social"
      },
      {
        id: "vt-pp-c-16",
        stem: "Meteorologists ___ the frequency of extreme weather events for decades, observing a clear upward trend.",
        options: ["have been tracking", "tracked", "have tracked"],
        answer: "have been tracking",
        explanation: "An ongoing scientific observation over 'decades' to the present uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous highlights that a process has been going on continuously from the past to now. 'For decades' signals the duration. 'Tracked' (Past Simple) would wrongly imply the monitoring has ceased. 'Have tracked' (Present Perfect Simple) would focus on the data collected rather than the continuing act of observation.",
        source: "Swan, PEU (4e), §421.2",
        hint: "track",
        flavor: "science"
      },
      {
        id: "vt-pp-c-17",
        stem: "Roger Federer ___ the art of serve-and-volley since he was a junior player, perfecting it over decades.",
        options: ["has been practising", "practised", "has practised"],
        answer: "has been practising",
        explanation: "'Since he was a junior player' with ongoing mastery uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous expresses duration of an activity from a specific past point to the present. 'Since he was a junior player' marks the start. 'Practised' (Past Simple) would suggest the training stopped. 'Has practised' (Present Perfect Simple) focuses on the skill achieved rather than the ongoing act of practising.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "practise",
        flavor: "personalities"
      },
      {
        id: "vt-pp-c-18",
        stem: "Archaeologists ___ the mosaics beneath St Peter's Square ever since the first excavation permits were granted.",
        options: ["have been cataloguing", "catalogued", "are cataloguing"],
        answer: "have been cataloguing",
        explanation: "'Ever since the permits were granted' with ongoing activity requires Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous uses 'ever since' to mark the beginning of an unbroken activity that continues to the present. 'Catalogued' (Past Simple) would suggest the cataloguing has ended. 'Are cataloguing' (Present Continuous) describes only the current moment and does not capture the historical duration of the work.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "catalogue",
        flavor: "history"
      },
      {
        id: "vt-pp-c-19",
        stem: "The students ___ all morning and the classroom whiteboard is covered in equations and diagrams.",
        options: ["have been studying", "studied", "were studying"],
        answer: "have been studying",
        explanation: "'All morning' explaining a present result uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous explains a present visible state (covered whiteboard) through an activity that has been happening over a recent period. 'All morning' is the duration marker. 'Studied' (Past Simple) would imply the study session is over and not link it to the current state. 'Were studying' (Past Continuous) refers to a past moment and cannot explain the current mess.",
        source: "Murphy, EGU (4e), Unit 10",
        hint: "study",
        flavor: "social"
      },
      {
        id: "vt-pp-c-20",
        stem: "Biologists ___ on stem cell regeneration for years, recently producing tissue samples in laboratory conditions.",
        options: ["have been experimenting", "experimented", "are experimenting"],
        answer: "have been experimenting",
        explanation: "'For years' with a recent achievement signals Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous shows that research has been ongoing from the past leading to a recent result. 'For years' marks the duration. 'Experimented' (Past Simple) would imply the research has ended. 'Are experimenting' (Present Continuous) only describes the current moment and misses the historical duration of effort.",
        source: "Swan, PEU (4e), §421.3",
        hint: "experiment",
        flavor: "science"
      },
      {
        id: "vt-pp-c-21",
        stem: "Mark Twain ___ American social norms since his earliest short stories, challenging hypocrisy at every turn.",
        options: ["has been satirising", "satirised", "has satirised"],
        answer: "has been satirising",
        explanation: "'Since his earliest short stories' with ongoing critical writing uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous expresses an activity that started in the past and continues to the present. 'Satirised' (Past Simple) would imply he stopped. 'Has satirised' (Present Perfect Simple) would focus on the targets he has already criticised rather than the ongoing act of satire.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "satirise",
        flavor: "personalities"
      },
      {
        id: "vt-pp-c-22",
        stem: "The Thames ___ through central London for thousands of years, shaping the city's development continuously.",
        options: ["has been running", "ran", "has run"],
        answer: "has been running",
        explanation: "A natural ongoing process over 'thousands of years' to now uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous expresses a process that has been going on continuously from a distant past point to the present. 'Ran' (Past Simple) would wrongly imply the river stopped flowing. 'Has run' (Present Perfect Simple) would emphasise the total distance covered rather than the continuous nature of the flow.",
        source: "Murphy, EGU (4e), Unit 9",
        hint: "run",
        flavor: "history"
      },
      {
        id: "vt-pp-c-23",
        stem: "Our design team ___ on the new logo since the client briefing last week and we submit tomorrow.",
        options: ["has been working", "worked", "is working"],
        answer: "has been working",
        explanation: "'Since the client briefing last week' with work still in progress uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous links the past starting point ('since last week') to the present, showing the activity is still ongoing. 'Worked' (Past Simple) would imply the logo work is finished. 'Is working' (Present Continuous) only describes what is happening right now without expressing the duration from the past starting point.",
        source: "Murphy, EGU (4e), Unit 10",
        hint: "work",
        flavor: "social"
      },
      {
        id: "vt-pp-c-24",
        stem: "Satellite data shows that sea ice in the Arctic ___ at an accelerating pace since the late 1970s.",
        options: ["has been diminishing", "diminished", "has diminished"],
        answer: "has been diminishing",
        explanation: "'Since the late 1970s' with an ongoing process uses Present Perfect Continuous.",
        fullExplanation: "Present Perfect Continuous highlights an ongoing natural process from a specific past point to the present. 'Since the late 1970s' marks the start. 'Diminished' (Past Simple) would wrongly suggest the shrinkage has stopped. 'Has diminished' (Present Perfect Simple) would focus on the measured loss rather than the continuing process of reduction.",
        source: "Swan, PEU (4e), §421.2",
        hint: "diminish",
        flavor: "science"
      }
  ...
  "vt-pastperf": {
    ...
    tasks: [
      ...
      {
        id: "vt-pastperf-13",
        stem: "By the time Beethoven ___ his Ninth Symphony, he had already lost his hearing completely.",
        options: ["composed", "had composed", "was composing"],
        answer: "composed",
        explanation: "'By the time' + Past Simple marks the later reference point; the earlier fact uses Past Perfect.",
        fullExplanation: "The 'by the time' clause takes Past Simple ('composed') to mark the later reference point. The action completed before that — losing his hearing — uses Past Perfect ('had already lost'). 'Had composed' would make both clauses Past Perfect, blurring the time sequence. 'Was composing' (Past Continuous) does not express the completed point-in-time event required here.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "compose",
        flavor: "personalities"
      },
      {
        id: "vt-pastperf-14",
        stem: "By the time the Norman army ___ England in 1066, the Anglo-Saxon king had already mobilised his forces.",
        options: ["reached", "had reached", "was reaching"],
        answer: "reached",
        explanation: "'By the time' + Past Simple marks the later event; the earlier action uses Past Perfect.",
        fullExplanation: "The 'by the time' clause takes Past Simple ('reached') to mark the later reference point. The action completed before that — mobilising forces — uses Past Perfect ('had already mobilised'). 'Had reached' would create a double Past Perfect, removing the time distinction. 'Was reaching' (Past Continuous) cannot mark a completed boundary event.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "reach",
        flavor: "history"
      },
      {
        id: "vt-pastperf-15",
        stem: "When the guests arrived for the dinner party, we ___ the table and opened the first bottle of wine.",
        options: ["had set", "set", "were setting"],
        answer: "had set",
        explanation: "The completed preparation before the guests arrived uses Past Perfect Simple.",
        fullExplanation: "Past Perfect Simple ('had set') shows that the table was ready before the guests arrived. The sequence is clear: first setting, then arrival. 'Set' (Past Simple) would suggest both happened at the same time. 'Were setting' (Past Continuous) would imply the table was still being laid when the guests walked in.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "set",
        flavor: "social"
      },
      {
        id: "vt-pastperf-16",
        stem: "Before the Hubble Space Telescope ___ in 1990, astronomers had relied on ground-based observatories.",
        options: ["was launched", "had been launched", "launched"],
        answer: "was launched",
        explanation: "'Before' + Past Simple marks the later event; the earlier situation uses Past Perfect.",
        fullExplanation: "The 'before' clause takes Past Simple ('was launched') to mark the event that ended a prior situation. The earlier ongoing reliance ('had relied') uses Past Perfect. 'Had been launched' in the 'before' clause would create a non-standard double Past Perfect. 'Launched' is incorrect here because the telescope cannot launch itself — the passive is required.",
        source: "Swan, PEU (4e), §421.4",
        hint: "launch",
        flavor: "science"
      },
      {
        id: "vt-pastperf-17",
        stem: "Mark Twain ___ five novels before he turned forty, securing his reputation across the English-speaking world.",
        options: ["had written", "wrote", "had been writing"],
        answer: "had written",
        explanation: "Completed novels before turning forty uses Past Perfect Simple.",
        fullExplanation: "Past Perfect Simple ('had written') expresses an achievement completed before a past reference point (turning forty). 'Wrote' (Past Simple) would list two past events without marking which came first. 'Had been writing' (Past Perfect Continuous) emphasises the ongoing writing process rather than the completed set of five finished books.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "write",
        flavor: "personalities"
      },
      {
        id: "vt-pastperf-18",
        stem: "After the last Byzantine emperor ___, the Ottoman forces raised their flag over the Hagia Sophia.",
        options: ["had fallen", "fell", "was falling"],
        answer: "had fallen",
        explanation: "The earlier completed event before the flag-raising uses Past Perfect Simple.",
        fullExplanation: "Past Perfect Simple ('had fallen') shows that the emperor's defeat was completed before the flag was raised. 'After' signals sequence: first the emperor's fall, then the flag. 'Fell' (Past Simple) in an 'after' clause is also possible in informal usage but 'had fallen' most precisely marks the sequence. 'Was falling' (Past Continuous) implies the emperor was still fighting when the flag went up.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "fall",
        flavor: "history"
      },
      {
        id: "vt-pastperf-19",
        stem: "By the time the plumber arrived, the whole bathroom floor ___ and the water was still rising.",
        options: ["had already flooded", "already flooded", "was already flooding"],
        answer: "had already flooded",
        explanation: "'By the time the plumber arrived' signals the later event; flooding came earlier — Past Perfect.",
        fullExplanation: "Past Perfect Simple with 'already' ('had already flooded') stresses that the flood was complete before the plumber arrived. 'By the time' introduces the later reference point. 'Already flooded' (Past Simple without had) is grammatically incomplete for this sequence marker. 'Was already flooding' (Past Continuous) would mean flooding was still in progress when the plumber arrived, not that it was finished.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "flood",
        flavor: "social"
      },
      {
        id: "vt-pastperf-20",
        stem: "Before the polio vaccine ___ in 1955, epidemics had paralysed thousands of children every year.",
        options: ["was approved", "had been approved", "approved"],
        answer: "was approved",
        explanation: "'Before' + Past Simple marks the boundary event; the earlier state takes Past Perfect.",
        fullExplanation: "The 'before' clause uses Past Simple ('was approved') to mark the event that changed a prior situation. The preceding situation ('had paralysed') is expressed in Past Perfect. 'Had been approved' in the 'before' clause would be redundant double Past Perfect. 'Approved' would be incorrect because the vaccine cannot approve itself — the passive is required.",
        source: "Swan, PEU (4e), §421.4",
        hint: "approve",
        flavor: "science"
      },
      {
        id: "vt-pastperf-21",
        stem: "By the time Chopin gave his final public concert, he ___ the complete set of preludes for several years.",
        options: ["had performed", "had been performing", "performed"],
        answer: "had performed",
        explanation: "Completed performances before the reference point of the final concert use Past Perfect Simple.",
        fullExplanation: "Past Perfect Simple ('had performed') shows that performing the preludes was a completed achievement before the final concert. 'Had been performing' (Past Perfect Continuous) would emphasise the ongoing process of rehearsal rather than the completed record of performances. 'Performed' (Past Simple) would simply list two events without marking which came first.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "perform",
        flavor: "personalities"
      },
      {
        id: "vt-pastperf-22",
        stem: "By the time the Treaty of Versailles ___ in 1919, the Great War had claimed over fifteen million lives.",
        options: ["was signed", "had been signed", "was being signed"],
        answer: "was signed",
        explanation: "'By the time' + Past Simple marks the later event; the earlier situation uses Past Perfect.",
        fullExplanation: "Past Simple ('was signed') in the 'by the time' clause marks the later reference point. The earlier ongoing situation — lives being claimed — uses Past Perfect ('had claimed'). 'Had been signed' would create an unusual double Past Perfect in the reference clause. 'Was being signed' (Past Continuous passive) does not express a completed boundary event.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "sign",
        flavor: "history"
      },
      {
        id: "vt-pastperf-23",
        stem: "The technician realised she ___ the wrong configuration file only after the whole system crashed.",
        options: ["had uploaded", "uploaded", "was uploading"],
        answer: "had uploaded",
        explanation: "Uploading the wrong file happened before the realisation — Past Perfect Simple.",
        fullExplanation: "Past Perfect Simple ('had uploaded') shows that the wrong file was uploaded before the realisation. 'Uploaded' (Past Simple) would place both events at the same time, making the sequence less clear. 'Was uploading' (Past Continuous) would suggest she was in the middle of the upload when the crash happened, which contradicts the meaning.",
        source: "Murphy, EGU (4e), Unit 16",
        hint: "upload",
        flavor: "social"
      },
      {
        id: "vt-pastperf-24",
        stem: "Before fracking technology ___ widespread use in the 2000s, natural gas extraction had followed traditional drilling methods.",
        options: ["entered", "had entered", "was entering"],
        answer: "entered",
        explanation: "'Before' + Past Simple marks the boundary event; the earlier practice uses Past Perfect.",
        fullExplanation: "The 'before' clause uses Past Simple ('entered') to mark the event that changed a prior situation. The preceding practice ('had followed') is in Past Perfect. 'Had entered' in the 'before' clause would create a non-standard double Past Perfect. 'Was entering' (Past Continuous) implies a gradual process rather than the definitive point of adoption.",
        source: "Swan, PEU (4e), §421.4",
        hint: "enter",
        flavor: "science"
      }
  ...
  "vt-fut-will": {
    ...
    tasks: [
      ...
      {
        id: "vt-fut-will-13",
        stem: "I believe Nelson Mandela ___ remembered as the twentieth century's most inspiring moral leader.",
        options: ["will be", "is going to be", "is being"],
        answer: "will be",
        explanation: "'I believe' signals a personal prediction, which uses 'will', not 'going to'.",
        fullExplanation: "'Will' is used for predictions based on personal opinion or belief, especially after phrases like 'I believe', 'I think', or 'I expect'. 'Is going to be' is used for predictions based on visible present evidence, which is absent here. 'Is being' (Present Continuous) cannot express a future prediction.",
        source: "Murphy, EGU (4e), Unit 19",
        hint: "be",
        flavor: "personalities"
      },
      {
        id: "vt-fut-will-14",
        stem: "Historians expect that future scholars ___ the French Revolution as the birth of modern European democracy.",
        options: ["will interpret", "are going to interpret", "interpret"],
        answer: "will interpret",
        explanation: "'Expect' signals an opinion-based future prediction requiring 'will'.",
        fullExplanation: "'Will' follows verbs of belief and expectation such as 'expect', 'think', and 'believe'. 'Are going to interpret' would imply there is immediate present evidence pointing to this outcome. 'Interpret' (Present Simple) cannot express a future prediction in this context.",
        source: "Murphy, EGU (4e), Unit 19",
        hint: "interpret",
        flavor: "history"
      },
      {
        id: "vt-fut-will-15",
        stem: "A: The meeting room is double-booked. B: Don't worry — I ___ another room for the afternoon.",
        options: ["will find", "am going to find", "am finding"],
        answer: "will find",
        explanation: "A spontaneous decision made upon hearing a problem uses 'will', not 'going to'.",
        fullExplanation: "'Will' expresses a spontaneous decision made at the moment of speaking in response to new information. The speaker decides to find a room only after hearing about the double-booking. 'Am going to find' would imply the speaker had already planned this. 'Am finding' (Present Continuous for future) suggests a prior arrangement.",
        source: "Murphy, EGU (4e), Unit 20",
        hint: "find",
        flavor: "social"
      },
      {
        id: "vt-fut-will-16",
        stem: "Climatologists forecast that ocean temperatures ___ by at least one degree Celsius by 2100.",
        options: ["will rise", "are going to rise", "rise"],
        answer: "will rise",
        explanation: "A scientific forecast based on modelling and analysis uses 'will'.",
        fullExplanation: "'Will' expresses predictions based on expert analysis and knowledge. 'Are going to rise' would require present visible evidence that the rise is already starting right now. 'Rise' (Present Simple) expresses a general fact or schedule, not a future prediction.",
        source: "Murphy, EGU (4e), Unit 19",
        hint: "rise",
        flavor: "science"
      },
      {
        id: "vt-fut-will-17",
        stem: "I promise I ___ you a complete translation of the document by Friday without fail.",
        options: ["will send", "am going to send", "am sending"],
        answer: "will send",
        explanation: "'I promise I will' is the standard form for making a promise — a key use of 'will'.",
        fullExplanation: "'Will' is the standard form for promises and personal commitments made at the moment of speaking. 'Am going to send' would suggest a prior plan rather than a promise made now. 'Am sending' (Present Continuous for future) implies a prior arrangement, not a spontaneous promise.",
        source: "Murphy, EGU (4e), Unit 20",
        hint: "send",
        flavor: "personalities"
      },
      {
        id: "vt-fut-will-18",
        stem: "Many scholars believe the construction of the Panama Canal ___ shape global shipping routes for centuries.",
        options: ["will continue to", "is going to continue to", "continues to"],
        answer: "will continue to",
        explanation: "A belief-based future prediction after 'believe' uses 'will', not 'going to'.",
        fullExplanation: "'Will' follows verbs of opinion such as 'believe' to express a prediction about the future. 'Is going to continue to' would require visible present evidence that this continuation is imminent in a new way. 'Continues to' (Present Simple) states a current fact rather than a future prediction.",
        source: "Murphy, EGU (4e), Unit 19",
        hint: "continue",
        flavor: "history"
      },
      {
        id: "vt-fut-will-19",
        stem: "A: The photocopier is jammed again. B: Leave it — I ___ the repair company straight away.",
        options: ["will call", "am going to call", "am calling"],
        answer: "will call",
        explanation: "A spontaneous offer in response to a problem uses 'will', not 'going to'.",
        fullExplanation: "'Will' is used for spontaneous offers and decisions made at the moment of hearing a problem. The speaker decides to call the company only upon learning about the jam. 'Am going to call' would suggest the call was already planned. 'Am calling' (Present Continuous for future) implies a prior arrangement.",
        source: "Murphy, EGU (4e), Unit 20",
        hint: "call",
        flavor: "social"
      },
      {
        id: "vt-fut-will-20",
        stem: "Researchers predict that gene-editing technology ___ the treatment of hereditary diseases within two decades.",
        options: ["will transform", "is going to transform", "transforms"],
        answer: "will transform",
        explanation: "'Predict' signals an expert opinion requiring 'will', not 'going to'.",
        fullExplanation: "'Will' follows prediction verbs such as 'predict', 'expect', 'think', and 'believe'. 'Is going to transform' would require immediate present evidence that the transformation is already under way. 'Transforms' (Present Simple) cannot express a future prediction without an appropriate time context.",
        source: "Murphy, EGU (4e), Unit 19",
        hint: "transform",
        flavor: "science"
      },
      {
        id: "vt-fut-will-21",
        stem: "I am convinced that Maya Angelou's poetry ___ inspire readers for many generations to come.",
        options: ["will", "is going to", "is"],
        answer: "will",
        explanation: "'I am convinced' signals a belief-based prediction — 'will', not 'going to'.",
        fullExplanation: "'Will' expresses strong predictions based on personal conviction. 'I am convinced' confirms this is an opinion about the future, not an observation of present evidence. 'Is going to' would imply visible current signs of this outcome. 'Is' (Present Simple) states a current fact, not a future prediction.",
        source: "Murphy, EGU (4e), Unit 19",
        hint: "inspire",
        flavor: "personalities"
      },
      {
        id: "vt-fut-will-22",
        stem: "Archaeologists believe new digs along Hadrian's Wall ___ uncover further evidence of Roman military life.",
        options: ["will", "are going to", "are"],
        answer: "will",
        explanation: "'Believe' followed by a future prediction requires 'will', not 'going to'.",
        fullExplanation: "'Will' is used after 'believe', 'think', 'expect', and 'predict' to express a prediction about the future. 'Are going to' would require visible present evidence that an uncovering is imminent. 'Are' (Present Simple) does not express a future meaning in this sentence.",
        source: "Murphy, EGU (4e), Unit 19",
        hint: "uncover",
        flavor: "history"
      },
      {
        id: "vt-fut-will-23",
        stem: "A: There is no milk left in the fridge. B: No problem, I ___ pop to the shop on the corner.",
        options: ["will", "am going to", "am"],
        answer: "will",
        explanation: "A spontaneous decision made on learning about a problem uses 'will'.",
        fullExplanation: "'Will' expresses a spontaneous decision made in response to new information. The speaker decides to go to the shop only upon hearing the milk is finished. 'Am going to' would suggest the trip was already planned before this conversation. 'Am' (Present Continuous) would need a following verb form to express a future arrangement.",
        source: "Murphy, EGU (4e), Unit 20",
        hint: "pop",
        flavor: "social"
      },
      {
        id: "vt-fut-will-24",
        stem: "Astrophysicists predict that the James Webb Space Telescope ___ revolutionise understanding of the early universe.",
        options: ["will", "is going to", "is"],
        answer: "will",
        explanation: "'Predict' signals a future expert forecast requiring 'will', not 'going to'.",
        fullExplanation: "'Will' follows verbs such as 'predict', 'expect', and 'believe' to express a future forecast. 'Is going to' would require observable present evidence that the revolution is already visibly under way. 'Is' (Present Simple) states a current fact and does not express a future prediction.",
        source: "Murphy, EGU (4e), Unit 19",
        hint: "revolutionise",
        flavor: "science"
      }
  ...
  "vt-fut-going": {
    ...
    tasks: [
      ...
      {
        id: "vt-fut-going-13",
        stem: "Serena Williams confirmed last month that she ___ a tennis academy for girls in Los Angeles.",
        options: ["is going to establish", "will establish", "establishes"],
        answer: "is going to establish",
        explanation: "A pre-announced personal plan or intention uses 'going to', not 'will'.",
        fullExplanation: "'Going to' expresses a pre-decided intention that was formed before the moment of speaking. Williams confirmed the plan last month, so the intention already exists. 'Will establish' would be a spontaneous decision or an opinion-based prediction. 'Establishes' (Present Simple) would only work for a fixed timetable, not a personal plan.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "establish",
        flavor: "personalities"
      },
      {
        id: "vt-fut-going-14",
        stem: "Look at that crumbling archway — the stones ___ collapse onto the path if no one acts now.",
        options: ["are going to", "will", "are"],
        answer: "are going to",
        explanation: "Visible structural damage provides present evidence of imminent collapse — 'going to'.",
        fullExplanation: "'Going to' is used when the speaker can see present evidence that makes a future event seem inevitable. The crumbling stones are concrete visible proof that collapse is imminent. 'Will' would express a conditional opinion-based prediction rather than a response to visible evidence. 'Are' (Present Simple) cannot express a future event in this context.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "collapse",
        flavor: "history"
      },
      {
        id: "vt-fut-going-15",
        stem: "We have already reserved a table — we ___ celebrate our anniversary at the new riverside restaurant tonight.",
        options: ["are going to", "will", "are"],
        answer: "are going to",
        explanation: "A celebration already planned and booked in advance is a prior intention — 'going to'.",
        fullExplanation: "'Going to' expresses a plan or intention decided before the moment of speaking. 'Already reserved' confirms the decision was made earlier. 'Will' would suggest a spontaneous decision made right now, which contradicts 'already reserved'. 'Are' (Present Simple) would require a fixed-schedule timetable context to work as a future form.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "celebrate",
        flavor: "social"
      },
      {
        id: "vt-fut-going-16",
        stem: "The pressure readings in the pipeline are dangerously high — the joint ___ burst at any moment.",
        options: ["is going to", "will", "is"],
        answer: "is going to",
        explanation: "Dangerously high pressure readings provide present evidence of imminent failure — 'going to'.",
        fullExplanation: "'Going to' is used when present observable data (pressure readings) makes a future event almost certain. The readings are concrete present evidence. 'Will' would express a general opinion about what might happen without reference to visible data. 'Is' (Present Simple) cannot express a future prediction here.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "burst",
        flavor: "science"
      },
      {
        id: "vt-fut-going-17",
        stem: "The foundation has announced that it ___ fund a new wing of the national history museum next year.",
        options: ["is going to", "will", "funds"],
        answer: "is going to",
        explanation: "An officially announced institutional plan uses 'going to', not 'will'.",
        fullExplanation: "'Going to' expresses a plan or decision already made and officially announced before the moment of speaking. The foundation has already committed to the funding — it is a prior decision. 'Will' would be used for a spontaneous or opinion-based statement about the future. 'Funds' (Present Simple for future) would only work for a fixed schedule.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "fund",
        flavor: "personalities"
      },
      {
        id: "vt-fut-going-18",
        stem: "The city council has voted to approve the plans, and engineers ___ restore the medieval bridge over three years.",
        options: ["are going to", "will", "restore"],
        answer: "are going to",
        explanation: "An approved and confirmed plan with a voted decision uses 'going to', not 'will'.",
        fullExplanation: "'Going to' expresses an intention backed by a prior decision (the council vote). The commitment was made before speaking. 'Will' would be used for a prediction or spontaneous statement, but here the decision is confirmed. 'Restore' (Present Simple) would require a strict timetable context to express a future event.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "restore",
        flavor: "history"
      },
      {
        id: "vt-fut-going-19",
        stem: "I have made up my mind — I ___ resign from this position and start my own business next spring.",
        options: ["am going to", "will", "am"],
        answer: "am going to",
        explanation: "'I have made up my mind' signals a prior intention — 'going to', not 'will'.",
        fullExplanation: "'Going to' follows expressions of prior decision such as 'I have made up my mind', 'I have decided', or 'I intend'. The decision was made before speaking. 'Will' would suggest the speaker decides at this very moment — contradicting 'have made up my mind'. 'Am' without an infinitive cannot form a future meaning on its own here.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "resign",
        flavor: "social"
      },
      {
        id: "vt-fut-going-20",
        stem: "The battery charge is at two percent — the laptop ___ shut down before I finish the document.",
        options: ["is going to", "will", "is"],
        answer: "is going to",
        explanation: "Visible battery data provides present evidence of imminent shutdown — 'going to'.",
        fullExplanation: "'Going to' is used when present observable evidence (two percent battery) makes a future outcome almost certain. The visual indicator is the concrete proof. 'Will' would express a general opinion without reference to the specific visible evidence. 'Is' (Present Simple) cannot express a future prediction in this structure.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "shut",
        flavor: "science"
      },
      {
        id: "vt-fut-going-21",
        stem: "Chopin told his friends he ___ dedicate his next nocturne to the Countess he had met in Paris.",
        options: ["was going to", "would", "was"],
        answer: "was going to",
        explanation: "A reported prior intention in a past context uses 'was going to', not 'would'.",
        fullExplanation: "'Was going to' is the past form of 'going to' used for a pre-existing intention reported in the past. Chopin had already decided before telling his friends. 'Would' could express a future-in-the-past prediction but does not capture the sense of a prior personal intention. 'Was' without an infinitive cannot form a future meaning here.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "dedicate",
        flavor: "personalities"
      },
      {
        id: "vt-fut-going-22",
        stem: "The heritage committee has confirmed that they ___ demolish the Victorian railway station next spring.",
        options: ["are not going to", "will not", "do not"],
        answer: "are not going to",
        explanation: "A confirmed decision not to proceed uses 'not going to', not 'will not'.",
        fullExplanation: "'Are not going to' expresses that a prior decision has been made not to carry out the demolition. The committee has already settled the matter. 'Will not' would be used for a spontaneous refusal or a prediction. 'Do not' (Present Simple negative) does not express a future meaning in this context.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "demolish",
        flavor: "history"
      },
      {
        id: "vt-fut-going-23",
        stem: "Careful — the floor there is very slippery with ice and you ___ fall if you walk any faster.",
        options: ["are going to", "will", "fall"],
        answer: "are going to",
        explanation: "Visible icy conditions as present evidence of imminent danger require 'going to'.",
        fullExplanation: "'Going to' is used when the speaker can see present evidence that makes a future event seem inevitable. The visible ice is concrete proof the fall is about to happen. 'Will' would be used for a conditional prediction ('you will fall if...') based on opinion rather than visible evidence. 'Fall' (Present Simple) would describe a habitual event, which does not fit this warning.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "fall",
        flavor: "social"
      },
      {
        id: "vt-fut-going-24",
        stem: "The latest air quality sensors show critical pollution levels downtown — officials warn the situation ___ worsen overnight.",
        options: ["is going to", "will", "is"],
        answer: "is going to",
        explanation: "Current sensor data provides present evidence of predicted deterioration — 'going to'.",
        fullExplanation: "'Going to' is used when present observable data (sensor readings) serves as concrete evidence that a future outcome is almost certain. 'Will' would express a general opinion-based warning not tied to the specific present data. 'Is' (Present Simple) cannot function as a future prediction without a time marker and further context.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "worsen",
        flavor: "science"
      }
  ...
  "vt-pass-prs": {
    id: "vt-pass-prs",
    name: "Passive — present",
    canonicalSubId: "cs-pass-prs",
    canonicalTopicId: "passive",
    tasks: [
      {
        id: "vt-pass-prs-01",
      ...
      {
        id: "vt-pass-prs-13",
        stem: "Leonardo da Vinci's notebooks ___ in museums and private collections around the world.",
        options: ["are kept", "keep", "were kept"],
        answer: "are kept",
        explanation: "Passive Present: the notebooks are the recipient of the action of being kept.",
        fullExplanation: "'Are kept' (are + past participle) correctly expresses the present passive for a permanent ongoing state. 'Keep' is an active form and would need a human agent as subject. 'Were kept' is Passive Past and would wrongly imply they are no longer stored this way.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "keep",
        flavor: "personalities"
      },
      {
        id: "vt-pass-prs-14",
        stem: "Ancient Roman coins ___ by archaeologists on excavation sites across Europe every year.",
        options: ["are found", "find", "were found"],
        answer: "are found",
        explanation: "Passive Present for a recurring scientific discovery: coins receive the action.",
        fullExplanation: "'Are found' (are + past participle) expresses a recurring present passive action. 'Find' is active and would require archaeologists as the grammatical subject. 'Were found' is Passive Past and implies the discoveries no longer happen.",
        source: "Swan, PEU (4e), §417",
        hint: "find",
        flavor: "history"
      },
      {
        id: "vt-pass-prs-15",
        stem: "The monthly rent ___ from my bank account on the first day of every month.",
        options: ["is deducted", "deducts", "was deducted"],
        answer: "is deducted",
        explanation: "Passive Present: the rent is the recipient of a regular automated action.",
        fullExplanation: "'Is deducted' (is + past participle) correctly expresses that the rent undergoes the action of deduction regularly. 'Deducts' is an active form needing an agent subject. 'Was deducted' is Passive Past and implies this arrangement has ended.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "deduct",
        flavor: "social"
      },
      {
        id: "vt-pass-prs-16",
        stem: "Blood ___ by the heart through a network of arteries to every organ in the body.",
        options: ["is pumped", "pumps", "was pumped"],
        answer: "is pumped",
        explanation: "Passive Present for a universal biological process: blood receives the pumping action.",
        fullExplanation: "'Is pumped' (is + past participle) correctly states the passive for an ongoing physiological fact. 'Pumps' is active and would mean blood itself pumps something. 'Was pumped' is Passive Past and would wrongly imply this process has stopped.",
        source: "Swan, PEU (4e), §417",
        hint: "pump",
        flavor: "science"
      },
      {
        id: "vt-pass-prs-17",
        stem: "Mark Twain's novels ___ on secondary school reading lists in the United States to this day.",
        options: ["are included", "include", "were included"],
        answer: "are included",
        explanation: "Passive Present: the novels are the recipient of the action of being included.",
        fullExplanation: "'Are included' (are + past participle) correctly expresses the present passive for a current recurring practice. 'Include' is active and would need an institutional subject. 'Were included' is Passive Past and implies the novels no longer appear on lists.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "include",
        flavor: "personalities"
      },
      {
        id: "vt-pass-prs-18",
        stem: "The minutes of each city council meeting ___ on the official municipal website within 48 hours.",
        options: ["are published", "publish", "were published"],
        answer: "are published",
        explanation: "Passive Present with plural subject: are + past participle for a regular procedure.",
        fullExplanation: "'Are published' (are + past participle) is the correct Passive Present for the plural subject 'minutes'. 'Publish' is active and needs the council or a clerk as subject. 'Were published' is Past Passive and would suggest this practice has ceased.",
        source: "Swan, PEU (4e), §417",
        hint: "publish",
        flavor: "history"
      },
      {
        id: "vt-pass-prs-19",
        stem: "Passengers ___ to show a valid ticket before boarding any intercity train.",
        options: ["are required", "require", "were required"],
        answer: "are required",
        explanation: "Passive Present: passengers receive the requirement imposed by the operator.",
        fullExplanation: "'Are required' (are + past participle) correctly expresses the current passive state of obligation. 'Require' is active and implies passengers impose a requirement on something else. 'Were required' is Past Passive and implies this rule no longer applies.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "require",
        flavor: "social"
      },
      {
        id: "vt-pass-prs-20",
        stem: "Rainwater ___ by vegetation and soil before eventually reaching rivers and groundwater reserves.",
        options: ["is filtered", "filters", "was filtered"],
        answer: "is filtered",
        explanation: "Passive Present for a continuous natural process: rainwater receives the filtering action.",
        fullExplanation: "'Is filtered' (is + past participle) correctly expresses an ongoing natural passive process. 'Filters' is active and would mean rainwater filters something else. 'Was filtered' is Passive Past and would wrongly imply this hydrological cycle has stopped.",
        source: "Swan, PEU (4e), §417",
        hint: "filter",
        flavor: "science"
      },
      {
        id: "vt-pass-prs-21",
        stem: "Serena Williams ___ as one of the greatest tennis players in the history of the sport.",
        options: ["is regarded", "regards", "was regarded"],
        answer: "is regarded",
        explanation: "Passive Present: she is the recipient of the action of being regarded.",
        fullExplanation: "'Is regarded' (is + past participle) correctly expresses her current standing in the passive voice. 'Regards' is active and would require her to be the one doing the regarding. 'Was regarded' is Past Passive and implies this view is no longer held.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "regard",
        flavor: "personalities"
      },
      {
        id: "vt-pass-prs-22",
        stem: "The Magna Carta ___ as one of the founding documents of constitutional democracy.",
        options: ["is seen", "sees", "was seen"],
        answer: "is seen",
        explanation: "Passive Present: the Magna Carta receives the action of being seen or described.",
        fullExplanation: "'Is seen' (is + past participle) correctly expresses a present passive for an enduring assessment. 'Sees' is active and would mean the Magna Carta perceives something. 'Was seen' is Past Passive and would imply this view existed only in the past.",
        source: "Swan, PEU (4e), §417",
        hint: "see",
        flavor: "history"
      },
      {
        id: "vt-pass-prs-23",
        stem: "The company canteen ___ and restocked with fresh food every morning before staff arrive.",
        options: ["is cleaned", "cleans", "was cleaned"],
        answer: "is cleaned",
        explanation: "Passive Present: the canteen receives the cleaning action in a daily routine.",
        fullExplanation: "'Is cleaned' (is + past participle) correctly expresses the daily passive routine. 'Cleans' is active and would need the canteen as an active agent. 'Was cleaned' is Past Passive and would imply this routine no longer takes place.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "clean",
        flavor: "social"
      },
      {
        id: "vt-pass-prs-24",
        stem: "Solar energy ___ by photovoltaic cells and converted into electrical current for household use.",
        options: ["is captured", "captures", "was captured"],
        answer: "is captured",
        explanation: "Passive Present: solar energy is the recipient of the capturing process.",
        fullExplanation: "'Is captured' (is + past participle) correctly expresses the present passive for a current ongoing technological process. 'Captures' is active and would require solar energy to be the agent. 'Was captured' is Past Passive and implies this technology is no longer in use.",
        source: "Swan, PEU (4e), §417",
        hint: "capture",
        flavor: "science"
      }
  ...
  "vt-pass-pst": {
    ...
    tasks: [
      ...
      {
        id: "vt-pass-pst-13",
        stem: "The Eiffel Tower ___ in Paris between 1887 and 1889 as the entrance arch to the World's Fair.",
        options: ["was constructed", "constructed", "is constructed"],
        answer: "was constructed",
        explanation: "Passive Past: the tower received the action of construction in a completed historical event.",
        fullExplanation: "'Was constructed' (was + past participle) correctly places the completed action in the past. 'Constructed' is active and needs an explicit agent subject. 'Is constructed' is Passive Present and is inconsistent with the historical dates 1887–1889.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "construct",
        flavor: "history"
      },
      {
        id: "vt-pass-pst-14",
        stem: "My passport ___ at the border crossing, and I had to wait two hours for a replacement.",
        options: ["was confiscated", "confiscated", "is confiscated"],
        answer: "was confiscated",
        explanation: "Passive Past: the passport received the action in a completed past event.",
        fullExplanation: "'Was confiscated' (was + past participle) correctly expresses the completed past passive. 'Confiscated' is active and would mean the passport seized something itself. 'Is confiscated' is Passive Present and contradicts the clearly completed past context.",
        source: "Swan, PEU (4e), §417",
        hint: "confiscate",
        flavor: "social"
      },
      {
        id: "vt-pass-pst-15",
        stem: "The polio vaccine ___ by Jonas Salk and announced to the world in 1955.",
        options: ["was developed", "developed", "is developed"],
        answer: "was developed",
        explanation: "Passive Past: the vaccine received the action in a completed historical event.",
        fullExplanation: "'Was developed' (was + past participle) correctly expresses the completed past passive. 'Developed' is active and would need Salk as the explicit grammatical subject. 'Is developed' is Passive Present and is factually inconsistent with the historical date 1955.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "develop",
        flavor: "science"
      },
      {
        id: "vt-pass-pst-16",
        stem: "Vincent van Gogh ___ to a mental health facility in Saint-Rémy in 1889 by his own request.",
        options: ["was admitted", "admitted", "is admitted"],
        answer: "was admitted",
        explanation: "Passive Past: Van Gogh received the action of admission in a completed biographical event.",
        fullExplanation: "'Was admitted' (was + past participle) correctly expresses the completed past passive. 'Admitted' is active and would mean van Gogh admitted someone else. 'Is admitted' is Passive Present and contradicts the historical year 1889.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "admit",
        flavor: "personalities"
      },
      {
        id: "vt-pass-pst-17",
        stem: "The ancient city of Constantinople ___ by Ottoman forces led by Sultan Mehmed II in 1453.",
        options: ["was captured", "captured", "is captured"],
        answer: "was captured",
        explanation: "Passive Past: Constantinople received the action in a completed historical conquest.",
        fullExplanation: "'Was captured' (was + past participle) correctly expresses the completed past passive event. 'Captured' is active and needs the Ottoman forces as the explicit subject. 'Is captured' is Passive Present and is wrong for a finished historical event.",
        source: "Swan, PEU (4e), §417",
        hint: "capture",
        flavor: "history"
      },
      {
        id: "vt-pass-pst-18",
        stem: "My colleague ___ to the head office in Berlin for a six-month placement last spring.",
        options: ["was transferred", "transferred", "is transferred"],
        answer: "was transferred",
        explanation: "Passive Past: the colleague received the action of being transferred in the past.",
        fullExplanation: "'Was transferred' (was + past participle) correctly expresses the completed past passive. 'Transferred' is active and would mean the colleague moved someone else. 'Is transferred' is Passive Present and conflicts with the past time marker 'last spring'.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "transfer",
        flavor: "social"
      },
      {
        id: "vt-pass-pst-19",
        stem: "The structure of the atom ___ more precisely by Ernest Rutherford through his gold-foil experiment in 1911.",
        options: ["was mapped", "mapped", "is mapped"],
        answer: "was mapped",
        explanation: "Passive Past: the structure of the atom received the action in a completed scientific discovery.",
        fullExplanation: "'Was mapped' (was + past participle) correctly expresses the completed past passive. 'Mapped' is active and needs Rutherford as the explicit subject. 'Is mapped' is Passive Present and contradicts the historical date 1911.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "map",
        flavor: "science"
      },
      {
        id: "vt-pass-pst-20",
        stem: "Mahatma Gandhi ___ for his non-violent resistance campaign and awarded the title Mahatma by the people.",
        options: ["was revered", "revered", "is revered"],
        answer: "was revered",
        explanation: "Passive Past: Gandhi received the reverence during his lifetime — a completed biographical fact.",
        fullExplanation: "'Was revered' (was + past participle) correctly uses the past passive to describe how Gandhi was regarded during his life. 'Revered' is active and would need a different subject. 'Is revered' is Passive Present and shifts focus to the present, changing the intended historical context.",
        source: "Swan, PEU (4e), §417",
        hint: "revere",
        flavor: "personalities"
      },
      {
        id: "vt-pass-pst-21",
        stem: "The first transatlantic telegraph cable ___ in 1858, linking Britain and North America.",
        options: ["was laid", "laid", "is laid"],
        answer: "was laid",
        explanation: "Passive Past: the cable received the action of being laid in a completed historical event.",
        fullExplanation: "'Was laid' (was + past participle) correctly places the completed action in the past. 'Laid' is active and requires an explicit agent subject. 'Is laid' is Passive Present and is inconsistent with the specific historical year 1858.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "lay",
        flavor: "history"
      },
      {
        id: "vt-pass-pst-22",
        stem: "Our neighbour's car ___ from the street outside our building late on Saturday night.",
        options: ["was stolen", "stole", "is stolen"],
        answer: "was stolen",
        explanation: "Passive Past: the car received the action in a completed past event.",
        fullExplanation: "'Was stolen' (was + past participle) correctly expresses the completed past passive. 'Stole' is active and would mean the car itself did the stealing. 'Is stolen' is Passive Present and is wrong for a single completed past event.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "steal",
        flavor: "social"
      },
      {
        id: "vt-pass-pst-23",
        stem: "The electron ___ by J.J. Thomson in 1897 during experiments with cathode ray tubes.",
        options: ["was identified", "identified", "is identified"],
        answer: "was identified",
        explanation: "Passive Past: the electron received the action of identification in a completed discovery.",
        fullExplanation: "'Was identified' (was + past participle) correctly expresses the completed past passive. 'Identified' is active and needs Thomson as the explicit grammatical subject. 'Is identified' is Passive Present and conflicts with the historical date 1897.",
        source: "Swan, PEU (4e), §417",
        hint: "identify",
        flavor: "science"
      },
      {
        id: "vt-pass-pst-24",
        stem: "Isaac Newton ___ with a knighthood by Queen Anne in 1705 for his scientific achievements.",
        options: ["was honoured", "honoured", "is honoured"],
        answer: "was honoured",
        explanation: "Passive Past: Newton received the honour in a completed biographical event.",
        fullExplanation: "'Was honoured' (was + past participle) correctly expresses the completed past passive. 'Honoured' is active and would mean Newton honoured someone else. 'Is honoured' is Passive Present and contradicts the historical year 1705.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "honour",
        flavor: "personalities"
      }
  ...
  "vt-pass-mix": {
    id: "vt-pass-mix",
    name: "Passive — mixed tenses",
    canonicalSubId: "cs-pass-mix",
    canonicalTopicId: "passive",
    tasks: [
      {
        id: "vt-pass-mix-01",
      ...
      {
        id: "vt-pass-mix-13",
        stem: "Charles Darwin ___ with the prestigious Copley Medal in 1864 for his theory of evolution.",
        options: ["was presented", "is presented", "has been presented"],
        answer: "was presented",
        explanation: "Passive Past for a completed biographical fact in a closed historical period.",
        fullExplanation: "'Was presented' (was + past participle) is correct because Darwin's life is a finished historical period. 'Is presented' (Passive Present) would imply he is still alive. 'Has been presented' (Present Perfect Passive) suggests present relevance, but the fixed date 1864 closes the action.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "present",
        flavor: "personalities"
      },
      {
        id: "vt-pass-mix-14",
        stem: "The Parthenon ___ in Athens between 447 and 432 BC as a temple to Athena.",
        options: ["was erected", "is erected", "has been erected"],
        answer: "was erected",
        explanation: "Passive Past: a completed historical construction with a specific closed time period.",
        fullExplanation: "'Was erected' (was + past participle) is correct for a finished event anchored in a specific past period. 'Is erected' (Passive Present) implies construction is ongoing today. 'Has been erected' (Present Perfect Passive) is inappropriate because the specific dates 447–432 BC close the action.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "erect",
        flavor: "history"
      },
      {
        id: "vt-pass-mix-15",
        stem: "The office heating system ___ already ___ twice this winter and it keeps breaking down.",
        options: ["has been repaired", "was repaired", "is repaired"],
        answer: "has been repaired",
        explanation: "Present Perfect Passive: recent repeated action with present relevance.",
        fullExplanation: "'Has been repaired' (has + been + past participle) expresses a recent completed action that is still relevant to the present situation. 'Was repaired' (Passive Past) focuses on the past without the current frustration implied. 'Is repaired' (Passive Present) would describe a routine, not a count of recent events.",
        source: "Swan, PEU (4e), §419",
        hint: "repair",
        flavor: "social"
      },
      {
        id: "vt-pass-mix-16",
        stem: "Hundreds of exoplanets ___ in habitable zones of distant star systems in recent years.",
        options: ["have been detected", "were detected", "are detected"],
        answer: "have been detected",
        explanation: "Present Perfect Passive: accumulating discoveries up to the present.",
        fullExplanation: "'Have been detected' (have + been + past participle) correctly expresses discoveries that have accumulated up to now. 'Were detected' (Passive Past) would close the process at a past point. 'Are detected' (Passive Present) describes a current routine rather than a growing total.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "detect",
        flavor: "science"
      },
      {
        id: "vt-pass-mix-17",
        stem: "Ada Lovelace ___ as the world's first computer programmer by historians of science.",
        options: ["is regarded", "was regarded", "has been regarded"],
        answer: "is regarded",
        explanation: "Passive Present: an enduring contemporary view about a historical figure.",
        fullExplanation: "'Is regarded' (is + past participle) correctly expresses a timeless present assessment still held today. 'Was regarded' (Passive Past) would imply this view is no longer current. 'Has been regarded' (Present Perfect Passive) is grammatically possible but 'is regarded' is the more natural choice for a stable, ongoing consensus.",
        source: "Swan, PEU (4e), §417",
        hint: "regard",
        flavor: "personalities"
      },
      {
        id: "vt-pass-mix-18",
        stem: "The Declaration of Independence ___ by delegates of the thirteen colonies on 4 July 1776.",
        options: ["was signed", "is signed", "has been signed"],
        answer: "was signed",
        explanation: "Passive Past: a completed historical act with a specific closed date.",
        fullExplanation: "'Was signed' (was + past participle) is correct for a finished historical event anchored at a specific date. 'Is signed' (Passive Present) implies the signing is happening now. 'Has been signed' (Present Perfect Passive) is inappropriate because the specific date 1776 closes the action.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "sign",
        flavor: "history"
      },
      {
        id: "vt-pass-mix-19",
        stem: "My rental flat ___ recently and it looks much brighter with the new colour scheme.",
        options: ["has been repainted", "was repainted", "is repainted"],
        answer: "has been repainted",
        explanation: "Present Perfect Passive: a recent action with clear present relevance and effect.",
        fullExplanation: "'Has been repainted' (has + been + past participle) expresses a recently completed action whose result is visible now. 'Was repainted' (Passive Past) focuses only on the past without the current visible connection. 'Is repainted' (Passive Present) describes a recurring routine, not a single recent event.",
        source: "Swan, PEU (4e), §419",
        hint: "repaint",
        flavor: "social"
      },
      {
        id: "vt-pass-mix-20",
        stem: "Global average temperatures ___ by approximately 1.2°C since pre-industrial times.",
        options: ["have risen", "rose", "are rising"],
        answer: "have risen",
        explanation: "Present Perfect: cumulative change from the past up to the present.",
        fullExplanation: "'Have risen' (have + past participle) correctly expresses the cumulative increase extending from the past to now. 'Rose' (Simple Past) would close the change at a specific past point. 'Are rising' (Present Continuous) describes an ongoing process but does not convey the cumulative total referenced by 'since pre-industrial times'.",
        source: "Murphy, EGU (4e), Unit 7",
        hint: "rise",
        flavor: "science"
      },
      {
        id: "vt-pass-mix-21",
        stem: "Jane Austen's novels ___ by generations of readers who admire her sharp social observation.",
        options: ["are cherished", "were cherished", "have been cherished"],
        answer: "are cherished",
        explanation: "Passive Present: an ongoing timeless truth about Austen's enduring popularity.",
        fullExplanation: "'Are cherished' (are + past participle) correctly expresses a timeless ongoing state. 'Were cherished' (Passive Past) implies readers no longer appreciate her novels. 'Have been cherished' (Present Perfect Passive) is grammatically possible but 'are cherished' is the natural choice for a permanent, stable truth.",
        source: "Murphy, EGU (4e), Unit 21",
        hint: "cherish",
        flavor: "personalities"
      },
      {
        id: "vt-pass-mix-22",
        stem: "The first modern Olympic Games ___ in Athens, Greece, in April 1896.",
        options: ["were held", "are held", "have been held"],
        answer: "were held",
        explanation: "Passive Past: a completed historical event with a specific closed date.",
        fullExplanation: "'Were held' (were + past participle) correctly describes a completed historical event at a specific past date. 'Are held' (Passive Present) implies the 1896 games are currently in progress. 'Have been held' (Present Perfect Passive) suggests continuity to the present, which is incorrect for a single event in a closed year.",
        source: "Swan, PEU (4e), §417",
        hint: "hold",
        flavor: "history"
      },
      {
        id: "vt-pass-mix-23",
        stem: "Our street ___ with traffic cameras this month after several accidents at the junction.",
        options: ["has been fitted", "was fitted", "is fitted"],
        answer: "has been fitted",
        explanation: "Present Perfect Passive: a recent installation with present relevance and ongoing effect.",
        fullExplanation: "'Has been fitted' (has + been + past participle) expresses a recent completed action that affects the present situation. 'Was fitted' (Passive Past) focuses on the past without the current implication. 'Is fitted' (Passive Present) describes a routine state, not a specific recent installation event.",
        source: "Swan, PEU (4e), §419",
        hint: "fit",
        flavor: "social"
      },
      {
        id: "vt-pass-mix-24",
        stem: "The DNA sequences of many crop plants ___ to improve their resistance to drought and disease.",
        options: ["have been modified", "were modified", "are modified"],
        answer: "have been modified",
        explanation: "Present Perfect Passive: ongoing cumulative scientific work extending to the present.",
        fullExplanation: "'Have been modified' (have + been + past participle) correctly expresses cumulative scientific effort up to the present. 'Were modified' (Passive Past) would close the work at a specific past time. 'Are modified' (Passive Present) describes a current routine practice rather than a growing body of work.",
        source: "Murphy, EGU (4e), Unit 22",
        hint: "modify",
        flavor: "science"
      }
  ...
  "mg-mod-obl": {
    id: "mg-mod-obl",
    name: "Modals — obligation",
    canonicalSubId: "cs-mod-obl",
    canonicalTopicId: "modals",
    tasks: [
      {
        id: "mg-mod-obl-01",
      ...
      {
        id: "mg-mod-obl-13",
        stem: "Florence Nightingale believed that nurses ___ maintain strict hygiene standards in all patient wards.",
        options: ["should", "mustn't", "don't have to"],
        answer: "should",
        explanation: "'Should' conveys a strong professional recommendation or belief.",
        fullExplanation: "'Should' correctly captures Nightingale's personal conviction — a strong moral and professional stance. 'Mustn't' expresses prohibition, meaning nurses are forbidden from maintaining hygiene, which is the opposite of her belief. 'Don't have to' signals absence of obligation, undermining her core nursing principle.",
        source: "Murphy, EGU (4e), Unit 33",
        hint: "maintain",
        flavor: "personalities"
      },
      {
        id: "mg-mod-obl-14",
        stem: "Ambassadors ___ follow the diplomatic protocols of the country they are posted to.",
        options: ["have to", "must", "mustn't"],
        answer: "have to",
        explanation: "'Have to' expresses an external obligation imposed by diplomatic rules.",
        fullExplanation: "'Have to' signals an obligation imposed from outside — in this case by international diplomatic conventions. 'Must' also expresses obligation but typically from an internal sense of duty. 'Mustn't' expresses prohibition, meaning ambassadors are forbidden from following protocols, which is the opposite of the required meaning.",
        source: "Murphy, EGU (4e), Unit 32",
        hint: "follow",
        flavor: "history"
      },
      {
        id: "mg-mod-obl-15",
        stem: "You ___ return the library books by the due date, or you will be charged a fine.",
        options: ["must", "should", "don't have to"],
        answer: "must",
        explanation: "'Must' expresses a strong internal obligation with clear consequences.",
        fullExplanation: "'Must' correctly conveys the strong obligation to return books by the deadline, emphasising the speaker's direct instruction. 'Should' would soften this to advice, removing the sense of necessity. 'Don't have to' implies the return is optional, which contradicts the stated rule and fine.",
        source: "Murphy, EGU (4e), Unit 31",
        hint: "return",
        flavor: "social"
      },
      {
        id: "mg-mod-obl-16",
        stem: "Spacecraft re-entering the atmosphere ___ withstand extreme heat generated by friction with air molecules.",
        options: ["must", "should", "don't have to"],
        answer: "must",
        explanation: "'Must' expresses an absolute physical necessity — there is no alternative.",
        fullExplanation: "'Must' is correct for a non-negotiable engineering requirement: heat resistance is essential for survival. 'Should' would make it merely advisable, which understates the danger. 'Don't have to' implies heat resistance is optional, which would be catastrophic and is scientifically false.",
        source: "Swan, PEU (4e), §348",
        hint: "withstand",
        flavor: "science"
      },
      {
        id: "mg-mod-obl-17",
        stem: "Mahatma Gandhi argued that people ___ resist injustice through peaceful, non-violent means.",
        options: ["should", "mustn't", "don't have to"],
        answer: "should",
        explanation: "'Should' conveys Gandhi's personal moral recommendation.",
        fullExplanation: "'Should' correctly represents Gandhi's advocacy — a deeply held moral conviction framed as strong advice. 'Mustn't' would mean people are prohibited from using peaceful resistance, the opposite of his philosophy. 'Don't have to' implies peaceful resistance is entirely optional and unimportant.",
        source: "Murphy, EGU (4e), Unit 33",
        hint: "resist",
        flavor: "personalities"
      },
      {
        id: "mg-mod-obl-18",
        stem: "Tourists ___ photograph the interior of the Sistine Chapel — signs clearly prohibit it.",
        options: ["mustn't", "must", "don't have to"],
        answer: "mustn't",
        explanation: "'Mustn't' expresses a strict prohibition in the chapel.",
        fullExplanation: "'Mustn't' correctly expresses the prohibition against photographing inside. 'Must' would mean tourists are obliged to take photos, the opposite of the rule. 'Don't have to' would mean photography is simply not required, implying it is still allowed — which contradicts the posted signs.",
        source: "Murphy, EGU (4e), Unit 31",
        hint: "photograph",
        flavor: "history"
      },
      {
        id: "mg-mod-obl-19",
        stem: "You ___ bring anything to the housewarming party — your presence is more than enough.",
        options: ["don't have to", "must", "mustn't"],
        answer: "don't have to",
        explanation: "'Don't have to' means there is no obligation — bringing a gift is entirely optional.",
        fullExplanation: "'Don't have to' correctly conveys that bringing something is not required. 'Must' would mean it is compulsory to bring a gift, which contradicts the welcoming message. 'Mustn't' would mean it is forbidden, turning the sentence into a prohibition.",
        source: "Murphy, EGU (4e), Unit 31",
        hint: "bring",
        flavor: "social"
      },
      {
        id: "mg-mod-obl-20",
        stem: "Computer systems storing personal data ___ comply with data protection regulations in most countries.",
        options: ["must", "should", "don't have to"],
        answer: "must",
        explanation: "'Must' expresses a strong legal obligation imposed by data protection law.",
        fullExplanation: "'Must' conveys a non-negotiable legal requirement. 'Should' would downgrade this to advice or recommendation, understating the legal force. 'Don't have to' would mean compliance is optional, which is factually wrong given legal penalties for non-compliance.",
        source: "Swan, PEU (4e), §348",
        hint: "comply",
        flavor: "science"
      },
      {
        id: "mg-mod-obl-21",
        stem: "Roger Federer has always insisted that young tennis players ___ master their footwork first.",
        options: ["should", "have to", "don't have to"],
        answer: "should",
        explanation: "'Should' conveys Federer's personal coaching recommendation.",
        fullExplanation: "'Should' correctly captures his personal belief framed as strong advice. 'Have to' would imply an external rule or obligation forcing players to do this. 'Don't have to' implies footwork mastery is optional and unimportant, the opposite of his view.",
        source: "Murphy, EGU (4e), Unit 33",
        hint: "master",
        flavor: "personalities"
      },
      {
        id: "mg-mod-obl-22",
        stem: "Aircraft pilots ___ consume alcohol within eight hours of being on duty — it is prohibited by aviation law.",
        options: ["mustn't", "don't have to", "should"],
        answer: "mustn't",
        explanation: "'Mustn't' expresses a strict prohibition imposed by aviation law.",
        fullExplanation: "'Mustn't' correctly expresses the legal prohibition on drinking before duty. 'Don't have to' would mean drinking is simply not required, implying it remains permitted — which is factually wrong. 'Should' merely offers advice and fails to convey the legal force of the prohibition.",
        source: "Murphy, EGU (4e), Unit 31",
        hint: "consume",
        flavor: "history"
      },
      {
        id: "mg-mod-obl-23",
        stem: "Members of the public ___ wear a uniform to visit the national art gallery — entry is free to all.",
        options: ["don't have to", "must", "mustn't"],
        answer: "don't have to",
        explanation: "'Don't have to' expresses the absence of obligation — no dress requirement exists.",
        fullExplanation: "'Don't have to' correctly signals that wearing a uniform is not required for entry. 'Must' would incorrectly imply visitors are obliged to wear one. 'Mustn't' would mean it is forbidden, turning a neutral situation into a prohibition.",
        source: "Murphy, EGU (4e), Unit 31",
        hint: "wear",
        flavor: "social"
      },
      {
        id: "mg-mod-obl-24",
        stem: "Migratory birds ___ fly thousands of kilometres each year to reach warmer climates — it is instinctive.",
        options: ["must", "should", "don't have to"],
        answer: "must",
        explanation: "'Must' expresses an absolute biological necessity with no alternative.",
        fullExplanation: "'Must' is correct for a biological imperative driven by instinct — the birds have no choice. 'Should' would frame migration as merely advisable. 'Don't have to' implies migration is optional, which contradicts the instinctive and survival-driven nature of the behaviour.",
        source: "Swan, PEU (4e), §348",
        hint: "fly",
        flavor: "science"
      }
  ...
  "mg-mod-pos": {
    id: "mg-mod-pos",
    name: "Modals — possibility / deduction",
    canonicalSubId: "cs-mod-pos",
    canonicalTopicId: "modals",
    tasks: [
      {
        id: "mg-mod-pos-01",
      ...
      {
        id: "mg-mod-pos-13",
        stem: "Ada Lovelace collaborated with Babbage for years on the Analytical Engine, so she ___ have understood its logic deeply.",
        options: ["must", "might", "can't"],
        answer: "must",
        explanation: "'Must' expresses logical certainty based on the evidence of years of close collaboration.",
        fullExplanation: "'Must' is correct because years of detailed collaboration make deep understanding a logical certainty. 'Might' would weaken this to mere possibility, which understates the evidence. 'Can't' expresses logical impossibility — the opposite of what the facts support.",
        source: "Murphy, EGU (4e), Unit 29",
        hint: "have",
        flavor: "personalities"
      },
      {
        id: "mg-mod-pos-14",
        stem: "The construction of the Colosseum required thousands of workers — it ___ have taken enormous resources.",
        options: ["must", "can't", "might"],
        answer: "must",
        explanation: "'Must' expresses logical certainty deduced from the scale of the construction.",
        fullExplanation: "'Must' is correct because a project of that scale makes enormous resource expenditure a logical certainty. 'Can't' would mean it is logically impossible to have required resources, contradicting the historical evidence. 'Might' weakens the conclusion to a mere guess.",
        source: "Murphy, EGU (4e), Unit 29",
        hint: "have",
        flavor: "history"
      },
      {
        id: "mg-mod-pos-15",
        stem: "The kitchen door is locked and there is no smell of cooking — they ___ be preparing dinner yet.",
        options: ["can't", "must", "might"],
        answer: "can't",
        explanation: "'Can't' expresses logical impossibility based on clear physical evidence.",
        fullExplanation: "'Can't' is correct because two pieces of evidence (locked door, no smell) make dinner preparation logically impossible at this moment. 'Must' would mean we are certain they are cooking, contradicting the evidence. 'Might' implies it is possible they are cooking, which ignores the clear evidence against it.",
        source: "Murphy, EGU (4e), Unit 30",
        hint: "be",
        flavor: "social"
      },
      {
        id: "mg-mod-pos-16",
        stem: "The sky has turned completely orange — there ___ be a dust storm approaching from the desert.",
        options: ["might", "must", "can't"],
        answer: "might",
        explanation: "'Might' expresses a plausible but unconfirmed possibility.",
        fullExplanation: "'Might' correctly expresses that an approaching storm is possible but not confirmed — the colour is evidence but not proof. 'Must' would mean a storm is logically certain, overstating the conclusion from sky colour alone. 'Can't' would mean a storm is impossible, ignoring the warning signs.",
        source: "Swan, PEU (4e), §344",
        hint: "be",
        flavor: "science"
      },
      {
        id: "mg-mod-pos-17",
        stem: "Tchaikovsky composed some of the world's most beloved ballets, so he ___ have had an exceptional talent for melody.",
        options: ["must", "might", "can't"],
        answer: "must",
        explanation: "'Must' expresses logical certainty based on the enduring quality of the compositions.",
        fullExplanation: "'Must' is correct because the universally acclaimed compositions provide strong evidence for exceptional melodic talent. 'Might' weakens the conclusion to a guess, inconsistent with the factual evidence. 'Can't' expresses logical impossibility, contradicting the acknowledged quality of his work.",
        source: "Murphy, EGU (4e), Unit 29",
        hint: "have",
        flavor: "personalities"
      },
      {
        id: "mg-mod-pos-18",
        stem: "The inscription was carved in an unknown script — historians ___ be sure of its meaning yet.",
        options: ["can't", "must", "might"],
        answer: "can't",
        explanation: "'Can't' expresses logical impossibility given the undeciphered script.",
        fullExplanation: "'Can't' is correct because an unknown, undeciphered script makes certainty about meaning logically impossible. 'Must' would mean historians are certain of the meaning, which contradicts the premise. 'Might' implies they may be sure, which is weaker but still inconsistent with the unknown script.",
        source: "Murphy, EGU (4e), Unit 30",
        hint: "be",
        flavor: "history"
      },
      {
        id: "mg-mod-pos-19",
        stem: "He hasn't eaten anything since early morning and it is almost midnight now — he ___ be very hungry.",
        options: ["must", "might", "can't"],
        answer: "must",
        explanation: "'Must' expresses logical certainty deduced from a long period without food.",
        fullExplanation: "'Must' is correct because not eating for nearly twenty hours makes extreme hunger a logical certainty. 'Might' would suggest hunger is only a possibility, which understates the overwhelming evidence. 'Can't' would mean hunger is impossible, which contradicts basic biology.",
        source: "Murphy, EGU (4e), Unit 29",
        hint: "be",
        flavor: "social"
      },
      {
        id: "mg-mod-pos-20",
        stem: "Neptune has never been visited by a crewed spacecraft, so its surface conditions ___ be fully confirmed yet.",
        options: ["can't", "must", "might"],
        answer: "can't",
        explanation: "'Can't' expresses logical impossibility — direct observation has not occurred.",
        fullExplanation: "'Can't' is correct because without a crewed visit, direct confirmation of surface conditions is logically impossible. 'Must' would mean conditions are definitely confirmed, which contradicts the fact of no visit. 'Might' implies partial confirmation is possible, but 'can't' more accurately captures the impossibility.",
        source: "Murphy, EGU (4e), Unit 30",
        hint: "be",
        flavor: "science"
      },
      {
        id: "mg-mod-pos-21",
        stem: "Mark Twain wrote dozens of books and hundreds of short stories, so he ___ have been an extraordinarily productive writer.",
        options: ["must", "can't", "might"],
        answer: "must",
        explanation: "'Must' expresses logical certainty based on the documented output of his career.",
        fullExplanation: "'Must' is correct because dozens of books and hundreds of stories make extraordinary productivity a logical certainty. 'Can't' would mean productivity is logically impossible, contradicting the factual record. 'Might' weakens the conclusion to a guess, understating the clear evidence.",
        source: "Murphy, EGU (4e), Unit 29",
        hint: "have",
        flavor: "personalities"
      },
      {
        id: "mg-mod-pos-22",
        stem: "Columbus set sail in 1492, long before modern navigation tools existed — he ___ have used the stars to navigate.",
        options: ["must", "might", "can't"],
        answer: "must",
        explanation: "'Must' expresses logical certainty — no modern tools means celestial navigation was required.",
        fullExplanation: "'Must' is correct because the absence of modern navigation tools in 1492 makes celestial navigation a logical certainty for crossing the Atlantic. 'Might' weakens this to a mere possibility, understating the logical force. 'Can't' expresses impossibility, contradicting what we know about historical navigation methods.",
        source: "Murphy, EGU (4e), Unit 29",
        hint: "have",
        flavor: "history"
      },
      {
        id: "mg-mod-pos-23",
        stem: "I left my umbrella at home today, but the weather forecast says it ___ rain this afternoon.",
        options: ["could", "can't", "must"],
        answer: "could",
        explanation: "'Could' expresses a tentative possibility based on the forecast.",
        fullExplanation: "'Could' correctly expresses a tentative possibility — the forecast suggests rain but does not guarantee it. 'Can't' means rain is logically impossible, which is not supported by the forecast. 'Must' would indicate logical certainty, which overstates a weather prediction.",
        source: "Swan, PEU (4e), §344",
        hint: "rain",
        flavor: "social"
      },
      {
        id: "mg-mod-pos-24",
        stem: "A neutron star is so dense that a teaspoon of its material ___ weigh about a billion tonnes.",
        options: ["might", "can't", "must"],
        answer: "might",
        explanation: "'Might' expresses a scientific estimate — a remarkable but plausible figure.",
        fullExplanation: "'Might' correctly expresses that such extreme density is plausible but still a scientific estimate rather than an absolute certainty in casual speech. 'Can't' would mean extreme weight is impossible, contradicting astrophysics. 'Must' would make it a logical deduction, which is also defensible, but 'might' is more precise as a scientific estimate here.",
        source: "Murphy, EGU (4e), Unit 29",
        hint: "weigh",
        flavor: "science"
      }
  ...
  "mg-cond-0": {
    ...
    canonicalSubId: "cs-cond-0",
    canonicalTopicId: "conditionals",
    tasks: [
      {
        id: "mg-cond-0-01",
      ...
      {
        id: "mg-cond-0-13",
        stem: "If Isaac Newton ___ his prism experiments, he always recorded the results in meticulous notebooks.",
        options: ["conducted", "conducts", "had conducted"],
        answer: "conducted",
        explanation: "Historical habitual zero conditional: past simple in both clauses for a repeated past routine.",
        fullExplanation: "Repeated past routines use past simple in both clauses of the zero conditional. 'Conducts' is present simple and describes a current general truth. 'Had conducted' is past perfect and belongs to the third conditional.",
        source: "Swan, PEU (4e), §247.3",
        hint: "conduct",
        flavor: "personalities"
      },
      {
        id: "mg-cond-0-14",
        stem: "If a Roman legion ___ its supply line, it withdrew to the nearest fortified camp.",
        options: ["lost", "loses", "had lost"],
        answer: "lost",
        explanation: "Historical habitual zero conditional: past simple in both clauses for a repeated military procedure.",
        fullExplanation: "A condition that was repeatedly true in the past uses past simple in both clauses. 'Loses' is present simple and describes a current general truth. 'Had lost' is past perfect and signals third conditional.",
        source: "Swan, PEU (4e), §247.3",
        hint: "lose",
        flavor: "history"
      },
      {
        id: "mg-cond-0-15",
        stem: "If the photocopier jams, the maintenance team ___ it before anyone starts printing again.",
        options: ["fixes", "will fix", "would fix"],
        answer: "fixes",
        explanation: "Zero conditional: a standard office procedure uses present simple in both clauses.",
        fullExplanation: "Zero conditional covers habitual procedures that always apply: If + present simple, present simple. 'Will fix' makes it a first conditional (specific future prediction). 'Would fix' signals a hypothetical second conditional.",
        source: "Murphy, EGU (4e), Unit 38",
        hint: "fix",
        flavor: "social"
      },
      {
        id: "mg-cond-0-16",
        stem: "If you heat copper wire, its electrical resistance ___, which affects the efficiency of the circuit.",
        options: ["increases", "will increase", "would increase"],
        answer: "increases",
        explanation: "Zero conditional: a universal scientific fact about copper uses present simple in the main clause.",
        fullExplanation: "Zero conditional states facts that are always and universally true. Both clauses use present simple. 'Will increase' makes it a first conditional (specific future event). 'Would increase' signals a second conditional (hypothetical).",
        source: "Hewings, AGU (3e), Unit 37",
        hint: "increase",
        flavor: "science"
      },
      {
        id: "mg-cond-0-17",
        stem: "If Charles Dickens ___ a new chapter, his readers gathered at the docks to collect the latest instalment.",
        options: ["published", "publishes", "had published"],
        answer: "published",
        explanation: "Historical habitual zero conditional: past simple in both clauses for a repeatedly true Victorian event.",
        fullExplanation: "Repeated past conditions and results use past simple in both clauses. 'Publishes' is present simple and refers to a current general truth. 'Had published' is past perfect and belongs to the third conditional.",
        source: "Swan, PEU (4e), §247.3",
        hint: "publish",
        flavor: "personalities"
      },
      {
        id: "mg-cond-0-18",
        stem: "If plague ___ a medieval town, the local authorities sealed the gates immediately.",
        options: ["struck", "strikes", "had struck"],
        answer: "struck",
        explanation: "Historical habitual zero conditional: past simple in both clauses for a repeated past emergency procedure.",
        fullExplanation: "Conditions repeatedly true in a past historical context use past simple in both clauses. 'Strikes' is present simple. 'Had struck' is past perfect and belongs to third conditional.",
        source: "Hewings, AGU (3e), Unit 37",
        hint: "strike",
        flavor: "history"
      },
      {
        id: "mg-cond-0-19",
        stem: "If a guest books a table for more than six people, the restaurant ___ a fixed menu instead of à la carte.",
        options: ["offers", "will offer", "would offer"],
        answer: "offers",
        explanation: "Zero conditional: a standing restaurant policy uses present simple in both clauses.",
        fullExplanation: "Zero conditional describes a fixed rule that always holds: If + present simple, present simple. 'Will offer' turns the sentence into a first conditional (a specific future prediction). 'Would offer' creates a hypothetical second conditional.",
        source: "Murphy, EGU (4e), Unit 38",
        hint: "offer",
        flavor: "social"
      },
      {
        id: "mg-cond-0-20",
        stem: "If a star ___ enough mass, nuclear fusion begins and it starts emitting light.",
        options: ["accumulates", "will accumulate", "would accumulate"],
        answer: "accumulates",
        explanation: "Zero conditional: a universal astrophysical process uses present simple in both clauses.",
        fullExplanation: "Zero conditional expresses a scientific law that is always true: If + present simple, present simple. 'Will accumulate' implies a specific future event (first conditional). 'Would accumulate' makes the situation hypothetical (second conditional).",
        source: "Hewings, AGU (3e), Unit 37",
        hint: "accumulate",
        flavor: "science"
      },
      {
        id: "mg-cond-0-21",
        stem: "If Mozart ___ a new composition, the Emperor's court immediately requested a performance.",
        options: ["completed", "completes", "had completed"],
        answer: "completed",
        explanation: "Historical habitual zero conditional: past simple in both clauses for a repeatedly true court practice.",
        fullExplanation: "Repeated past events use past simple in both clauses of the zero conditional. 'Completes' is present simple and would describe a current recurring truth. 'Had completed' is past perfect and belongs to the third conditional.",
        source: "Swan, PEU (4e), §247.3",
        hint: "complete",
        flavor: "personalities"
      },
      {
        id: "mg-cond-0-22",
        stem: "If grain supplies ___ in a Roman province, the governor had to appeal to Rome for emergency shipments.",
        options: ["ran low", "run low", "had run low"],
        answer: "ran low",
        explanation: "Historical habitual zero conditional: past simple in both clauses for a standard administrative procedure.",
        fullExplanation: "Repeated past conditions and results use past simple in both clauses. 'Run low' is present simple. 'Had run low' is past perfect and signals third conditional.",
        source: "Hewings, AGU (3e), Unit 37",
        hint: "run",
        flavor: "history"
      },
      {
        id: "mg-cond-0-23",
        stem: "If the school bus ___ late, the head teacher always informs parents by a group text message.",
        options: ["is", "was", "will be"],
        answer: "is",
        explanation: "Zero conditional: a standing school procedure uses present simple in the if-clause.",
        fullExplanation: "Zero conditional uses present simple in both clauses to describe a fixed current procedure. 'Was' shifts the sentence to second conditional (hypothetical). 'Will be' is incorrect — 'will' cannot be used after 'if' in conditional sentences.",
        source: "Murphy, EGU (4e), Unit 38",
        hint: "be",
        flavor: "social"
      },
      {
        id: "mg-cond-0-24",
        stem: "If you freeze water rapidly, the ice crystals ___ smaller and the texture becomes smoother.",
        options: ["form", "will form", "would form"],
        answer: "form",
        explanation: "Zero conditional: a universal fact about rapid freezing uses present simple in the main clause.",
        fullExplanation: "Zero conditional expresses a fact that is always true: If + present simple, present simple. 'Will form' implies a specific future event (first conditional). 'Would form' makes the situation hypothetical (second conditional).",
        source: "Hewings, AGU (3e), Unit 37",
        hint: "form",
        flavor: "science"
      }
  ...
  "mg-cond-1": {
    ...
    tasks: [
      ...
      {
        id: "mg-cond-1-13",
        stem: "If Serena Williams ___ in the final, the crowd will cheer her throughout the match.",
        options: ["competes", "competed", "will compete"],
        answer: "competes",
        explanation: "First conditional if-clause: present simple (not will) for a real future possibility.",
        fullExplanation: "In first conditional, the if-clause uses present simple even though the meaning is future. 'Competed' is past simple and belongs to second conditional (hypothetical). 'Will compete' is a common learner error — 'will' cannot follow 'if' in a conditional clause.",
        source: "Murphy, EGU (4e), Unit 39",
        hint: "compete",
        flavor: "personalities"
      },
      {
        id: "mg-cond-1-14",
        stem: "If the restoration project ___ extra funding, historians will be able to preserve the medieval frescoes.",
        options: ["receives", "received", "will receive"],
        answer: "receives",
        explanation: "First conditional if-clause: present simple for a realistic future scenario.",
        fullExplanation: "First conditional if-clause takes present simple to express a real future condition. 'Received' is past simple (second conditional — hypothetical). 'Will receive' is incorrect — 'will' is not used after 'if' in conditional sentences.",
        source: "Swan, PEU (4e), §248.1",
        hint: "receive",
        flavor: "history"
      },
      {
        id: "mg-cond-1-15",
        stem: "If the supermarket is closed when we arrive, we ___ to the corner shop instead.",
        options: ["will go", "would go", "go"],
        answer: "will go",
        explanation: "First conditional main clause: will + base verb for a real future plan.",
        fullExplanation: "First conditional main clause uses will + infinitive for a realistic future outcome. 'Would go' is second conditional (hypothetical). 'Go' in the main clause without 'will' creates a zero conditional (general truth) rather than a future plan.",
        source: "Murphy, EGU (4e), Unit 39",
        hint: "go",
        flavor: "social"
      },
      {
        id: "mg-cond-1-16",
        stem: "If the probe ___ Jupiter's magnetic field next month, the data will transform our understanding.",
        options: ["enters", "entered", "will enter"],
        answer: "enters",
        explanation: "First conditional if-clause: present simple for a real upcoming scientific event.",
        fullExplanation: "First conditional if-clause uses present simple for a realistic future event. 'Entered' (past simple) belongs to second conditional (hypothetical). 'Will enter' is incorrect — 'will' is not used in the if-clause of conditional sentences.",
        source: "Hewings, AGU (3e), Unit 38",
        hint: "enter",
        flavor: "science"
      },
      {
        id: "mg-cond-1-17",
        stem: "If Jane Austen ___ the publisher's offer, her novel will finally appear in print this year.",
        options: ["accepts", "accepted", "will accept"],
        answer: "accepts",
        explanation: "First conditional if-clause: present simple for a real future possibility.",
        fullExplanation: "First conditional always has present simple in the if-clause. 'Accepted' (past simple) belongs to second conditional (unreal/hypothetical). 'Will accept' is incorrect after 'if' in conditional constructions.",
        source: "Swan, PEU (4e), §248.1",
        hint: "accept",
        flavor: "personalities"
      },
      {
        id: "mg-cond-1-18",
        stem: "If the peace talks ___ successful next month, trade sanctions will be lifted immediately.",
        options: ["are", "were", "will be"],
        answer: "are",
        explanation: "First conditional if-clause: present simple for a realistic near-future diplomatic outcome.",
        fullExplanation: "First conditional uses present simple in the if-clause to describe a real future possibility. 'Were' signals second conditional (hypothetical present). 'Will be' is not used after 'if' in conditional clauses.",
        source: "Murphy, EGU (4e), Unit 39",
        hint: "be",
        flavor: "history"
      ...
      {
        id: "mg-cond-1-19",
        stem: "If our landlord agrees to the new lease terms, we ___ in this flat for another two years.",
        options: ["will stay", "would stay", "stay"],
        answer: "will stay",
        explanation: "First conditional main clause: will + base verb for a real future decision.",
        fullExplanation: "First conditional main clause uses will + infinitive to express a real achievable outcome. 'Would stay' is second conditional (unlikely or hypothetical). 'Stay' in the main clause creates a zero conditional (always true) rather than a future plan.",
        source: "Murphy, EGU (4e), Unit 39",
        hint: "stay",
        flavor: "social"
      },
      {
        id: "mg-cond-1-20",
        stem: "If the deep-sea submersible ___ the hydrothermal vent, scientists will film the surrounding ecosystem.",
        options: ["reaches", "reached", "will reach"],
        answer: "reaches",
        explanation: "First conditional if-clause: present simple for a genuinely possible future scientific event.",
        fullExplanation: "First conditional treats the event as genuinely possible; the if-clause takes present simple. 'Reached' (past simple) is second conditional (hypothetical). 'Will reach' is a common error — 'will' is not used in the if-clause.",
        source: "Hewings, AGU (3e), Unit 38",
        hint: "reach",
        flavor: "science"
      },
      {
        id: "mg-cond-1-21",
        stem: "If Pelé ___ the award ceremony, the organisers will present him with a lifetime achievement trophy.",
        options: ["attends", "attended", "will attend"],
        answer: "attends",
        explanation: "First conditional if-clause: present simple for a real future possibility.",
        fullExplanation: "First conditional always has present simple in the if-clause. 'Attended' (past simple) belongs to second conditional (unreal/hypothetical). 'Will attend' is incorrect after 'if' in standard conditional constructions.",
        source: "Swan, PEU (4e), §248.1",
        hint: "attend",
        flavor: "personalities"
      },
      {
        id: "mg-cond-1-22",
        stem: "If the railway bridge ___ repaired in time, the morning commuter service will resume as normal.",
        options: ["is", "was", "will be"],
        answer: "is",
        explanation: "First conditional if-clause: present simple passive for a realistic near-future event.",
        fullExplanation: "First conditional requires present simple (including present simple passive) in the if-clause. 'Was' shifts the sentence to second conditional (unreal present). 'Will be' is incorrect — 'will' cannot be used after 'if' in conditional sentences.",
        source: "Murphy, EGU (4e), Unit 39",
        hint: "be",
        flavor: "history"
      },
      {
        id: "mg-cond-1-23",
        stem: "If the children help with the cooking tonight, we ___ together in the garden after dinner.",
        options: ["will eat", "would eat", "ate"],
        answer: "will eat",
        explanation: "First conditional main clause: will + base verb for a real achievable family plan.",
        fullExplanation: "First conditional states a real achievable result; main clause uses will + infinitive. 'Would eat' is second conditional (hypothetical). 'Ate' is past simple and does not express a future result.",
        source: "Murphy, EGU (4e), Unit 39",
        hint: "eat",
        flavor: "social"
      },
      {
        id: "mg-cond-1-24",
        stem: "If the ice caps ___ melting at the current rate, sea levels will rise by several metres by 2100.",
        options: ["continue", "continued", "will continue"],
        answer: "continue",
        explanation: "First conditional if-clause: present simple for a realistic ongoing scientific scenario.",
        fullExplanation: "First conditional expresses a realistic possibility; if-clause uses present simple. 'Continued' (past simple) is second conditional (hypothetical). 'Will continue' is incorrect — 'will' is not used in the if-clause of conditional sentences.",
        source: "Hewings, AGU (3e), Unit 38",
        hint: "continue",
        flavor: "science"
      }
  ...
  "mg-cond-2": {
    ...
    tasks: [
      ...
      {
        id: "mg-cond-2-13",
        stem: "If Ada Lovelace ___ alive today, she would be considered a pioneering software engineer.",
        options: ["were", "was", "had been"],
        answer: "were",
        explanation: "Second conditional if-clause: subjunctive 'were' for an unreal present situation.",
        fullExplanation: "Second conditional uses 'were' for all persons in the if-clause when expressing an unreal present. 'Was' is grammatically common informally but 'were' is the standard written form for CT/CE. 'Had been' is third conditional (unreal past).",
        source: "Murphy, EGU (4e), Unit 40",
        hint: "be",
        flavor: "personalities"
      },
      {
        id: "mg-cond-2-14",
        stem: "If the Library of Alexandria had never been destroyed, we ___ far more ancient knowledge today.",
        options: ["would possess", "will possess", "possessed"],
        answer: "would possess",
        explanation: "Second conditional main clause: would + base verb for an unreal present outcome.",
        fullExplanation: "Second conditional main clause uses would + base verb to express an unreal present result. 'Will possess' is first conditional (real future). 'Possessed' is past simple and would create a zero conditional meaning or be ungrammatical in this position.",
        source: "Swan, PEU (4e), §249.1",
        hint: "possess",
        flavor: "history"
      },
      {
        id: "mg-cond-2-15",
        stem: "If I ___ you, I would speak to the manager directly rather than sending an email.",
        options: ["were", "am", "had been"],
        answer: "were",
        explanation: "Second conditional: 'If I were you' is the standard form for advice about an unreal situation.",
        fullExplanation: "'If I were you' is the fixed second conditional expression used to give advice. 'Am' would create a first conditional or zero conditional (always true). 'Had been' is third conditional (unreal past event).",
        source: "Murphy, EGU (4e), Unit 40",
        hint: "be",
        flavor: "social"
      },
      {
        id: "mg-cond-2-16",
        stem: "If the Earth's axis ___ not tilted, there would be no seasons anywhere on the planet.",
        options: ["were", "is", "had been"],
        answer: "were",
        explanation: "Second conditional if-clause: 'were' for an unreal or contrary-to-fact scientific hypothesis.",
        fullExplanation: "Second conditional uses 'were' (subjunctive for all persons) in the if-clause to describe an unreal or impossible present state. 'Is' would create a zero conditional (an actual fact). 'Had been' is third conditional (unreal past event).",
        source: "Hewings, AGU (3e), Unit 38",
        hint: "be",
        flavor: "science"
      },
      {
        id: "mg-cond-2-17",
        stem: "If Leonardo da Vinci ___ today, he would use digital tools to design his inventions.",
        options: ["lived", "had lived", "lives"],
        answer: "lived",
        explanation: "Second conditional if-clause: past simple for an unreal present situation.",
        fullExplanation: "Second conditional if-clause uses past simple ('lived') to signal an unreal present condition. 'Had lived' is third conditional (unreal past). 'Lives' with 'would use' creates a tense mismatch.",
        source: "Murphy, EGU (4e), Unit 40",
        hint: "live",
        flavor: "personalities"
      },
      {
        id: "mg-cond-2-18",
        stem: "If the Channel Tunnel ___ never built, the journey from London to Paris would still rely entirely on ferries.",
        options: ["were", "was", "had been"],
        answer: "were",
        explanation: "Second conditional if-clause: 'were' for a counterfactual present hypothesis.",
        fullExplanation: "Second conditional can use 'were' (subjunctive) for all persons when speculating about an unreal present. 'Was' is sometimes heard informally but 'were' is the standard written form here. 'Had been' is third conditional (unreal past).",
        source: "Swan, PEU (4e), §249.1",
        hint: "be",
        flavor: "history"
      },
      {
        id: "mg-cond-2-19",
        stem: "If our office ___ closer to the train station, we would save at least thirty minutes a day.",
        options: ["were", "is", "had been"],
        answer: "were",
        explanation: "Second conditional if-clause: 'were' for all persons in an unreal present wish.",
        fullExplanation: "Second conditional uses 'were' (subjunctive) for all grammatical persons in the if-clause when expressing an unreal wish about the present. 'Is' creates a zero conditional (a fact). 'Had been' shifts the sentence to third conditional (unreal past).",
        source: "Murphy, EGU (4e), Unit 40",
        hint: "be",
        flavor: "social"
      },
      {
        id: "mg-cond-2-20",
        stem: "If the ozone layer ___ to disappear, radiation levels on Earth's surface would rise dramatically.",
        options: ["were", "is", "had been"],
        answer: "were",
        explanation: "Second conditional: 'were to' in the if-clause signals a hypothetical future scenario.",
        fullExplanation: "'Were to + infinitive' in the if-clause marks a hypothetical or unlikely future event in second conditional. 'Is' creates a first conditional (realistic possibility). 'Had been' is third conditional (unreal past).",
      ...
      {
        id: "mg-cond-2-21",
        stem: "If Chopin ___ better health throughout his life, he might have composed even more piano works.",
        options: ["had", "has", "had had"],
        answer: "had",
        explanation: "Second conditional if-clause: past simple for an unreal present or general condition.",
        fullExplanation: "Second conditional uses past simple in the if-clause. Here 'had' describes a hypothetical present state. 'Has' is present simple (zero/first conditional). 'Had had' is past perfect and belongs to the third conditional (unreal past).",
        source: "Swan, PEU (4e), §249.1",
        hint: "have",
        flavor: "personalities"
      ...
      {
        id: "mg-cond-2-22",
        stem: "If the Roman Empire ___ into an eastern and western half, its history would have been very different.",
        options: ["did not split", "does not split", "had not split"],
        answer: "did not split",
        explanation: "Second conditional if-clause: past simple negative for a counterfactual present/general hypothesis.",
        fullExplanation: "Second conditional uses past simple in the if-clause to speculate about how the present would be different. 'Does not split' is present simple (zero conditional). 'Had not split' is past perfect and would require 'would have been' — third conditional.",
        source: "Murphy, EGU (4e), Unit 40",
        hint: "split",
        flavor: "history"
      },
      {
        id: "mg-cond-2-23",
        stem: "If my salary ___ higher, I would definitely consider moving to a bigger apartment.",
        options: ["were", "is", "had been"],
        answer: "were",
        explanation: "Second conditional if-clause: 'were' for an unreal present wish about income.",
        fullExplanation: "Second conditional uses 'were' (subjunctive, all persons) in the if-clause for an unreal present wish. 'Is' creates a zero conditional (a statement of fact). 'Had been' is third conditional (unreal past event).",
        source: "Murphy, EGU (4e), Unit 40",
        hint: "be",
        flavor: "social"
      },
      {
        id: "mg-cond-2-24",
        stem: "If the Sun ___ twice as bright, the Earth's average temperature would increase by many degrees.",
        options: ["were", "is", "had been"],
        answer: "were",
        explanation: "Second conditional: scientific hypothesis about an unreal present uses 'were' in the if-clause.",
        fullExplanation: "Second conditional if-clause uses 'were' (all persons) to describe an unreal or impossible present state. 'Is' would create a zero conditional (an actual fact). 'Had been' is third conditional (unreal past event).",
  ...
  "mg-cond-3": {
    ...
    tasks: [
      ...
      {
        id: "mg-cond-3-13",
        stem: "If Vincent van Gogh ___ a better patron, he might have sold more paintings in his lifetime.",
        options: ["had found", "found", "would have found"],
        answer: "had found",
        explanation: "Third conditional if-clause: past perfect for an unreal past condition.",
        fullExplanation: "Third conditional expresses an unreal past situation: If + past perfect, would have + past participle. 'Found' is simple past (second conditional). 'Would have found' cannot be used in the if-clause.",
        source: "Murphy, EGU (4e), Unit 41",
        hint: "find",
        flavor: "personalities"
      },
      {
        id: "mg-cond-3-14",
        stem: "If the printing press ___ invented in the fifteenth century, the Reformation might have spread less quickly.",
        options: ["had not been", "was not", "were not"],
        answer: "had not been",
        explanation: "Third conditional if-clause: past perfect passive negative for a hypothetical historical event.",
        fullExplanation: "Third conditional if-clause uses past perfect passive ('had not been invented') to describe a past event that did not happen in the way specified. 'Was not' is simple past (second conditional). 'Were not' is second conditional subjunctive.",
        source: "Swan, PEU (4e), §250.1",
        hint: "be",
        flavor: "history"
      },
      {
        id: "mg-cond-3-15",
        stem: "If I had checked the weather forecast, I ___ a coat this morning.",
        options: ["would have worn", "would wear", "had worn"],
        answer: "would have worn",
        explanation: "Third conditional main clause: would have + past participle for an unrealised past result.",
        fullExplanation: "Third conditional main clause uses would + have + past participle. 'Would wear' is second conditional (unreal present). 'Had worn' is past perfect and cannot function as a main clause in this position.",
        source: "Murphy, EGU (4e), Unit 41",
        hint: "wear",
        flavor: "social"
      },
      {
        id: "mg-cond-3-16",
        stem: "If nuclear fission ___ discovered earlier, the Second World War might have ended sooner.",
        options: ["had been", "was", "were"],
        answer: "had been",
        explanation: "Third conditional if-clause: past perfect passive for a hypothetical historical scenario.",
        fullExplanation: "Third conditional uses past perfect passive ('had been discovered') in the if-clause to describe an event that did not happen as specified. 'Was' (simple past) belongs to second conditional. 'Were' is the second conditional subjunctive form.",
        source: "Hewings, AGU (3e), Unit 39",
        hint: "be",
        flavor: "science"
      },
      {
        id: "mg-cond-3-17",
        stem: "Muhammad Ali ___ his boxing titles if he had not refused to serve in the Vietnam War.",
        options: ["would not have lost", "would not lose", "had not lost"],
        answer: "would not have lost",
        explanation: "Third conditional main clause: would have + past participle for an unrealised past result.",
        fullExplanation: "Third conditional main clause uses would + have + past participle. 'Would not lose' is second conditional (unreal present). 'Had not lost' is past perfect and cannot function as a main clause here.",
        source: "Swan, PEU (4e), §250.1",
        hint: "lose",
        flavor: "personalities"
      },
      {
        id: "mg-cond-3-18",
        stem: "If the Spanish Armada ___ the English fleet in 1588, history might have been very different.",
        options: ["had defeated", "defeated", "would have defeated"],
        answer: "had defeated",
        explanation: "Third conditional if-clause: past perfect for a hypothetical past historical event.",
        fullExplanation: "Third conditional requires past perfect in the if-clause to indicate a past event that did not happen. 'Defeated' (simple past) belongs to second conditional. 'Would have defeated' cannot appear in the if-clause in standard conditional grammar.",
        source: "Murphy, EGU (4e), Unit 41",
        hint: "defeat",
        flavor: "history"
      },
      {
        id: "mg-cond-3-19",
        stem: "My brother ___ the deadline if the power cut had not erased all his work.",
        options: ["would have met", "would meet", "had met"],
        answer: "would have met",
        explanation: "Third conditional main clause: would + have + past participle for an unrealised past outcome.",
        fullExplanation: "Third conditional main clause takes would + have + past participle. 'Would meet' is second conditional (unreal present). 'Had met' is past perfect and functions as an if-clause, not a main clause.",
        source: "Murphy, EGU (4e), Unit 41",
        hint: "meet",
        flavor: "social"
      },
      {
        id: "mg-cond-3-20",
        stem: "If researchers ___ the bacteria's antibiotic resistance earlier, many patients could have been saved.",
        options: ["had identified", "identified", "would have identified"],
        answer: "had identified",
        explanation: "Third conditional if-clause: past perfect for a hypothetical earlier scientific discovery.",
        fullExplanation: "Third conditional requires past perfect in the if-clause. 'Identified' (simple past) belongs to second conditional. 'Would have identified' cannot appear in the if-clause in standard conditional grammar.",
        source: "Hewings, AGU (3e), Unit 39",
        hint: "identify",
        flavor: "science"
      },
      {
        id: "mg-cond-3-21",
        stem: "If Rosalind Franklin ___ proper credit during her lifetime, her contribution to biology would have been recognised sooner.",
        options: ["had received", "received", "would have received"],
        answer: "had received",
        explanation: "Third conditional if-clause: past perfect for an unreal past condition.",
        fullExplanation: "Third conditional if-clause uses past perfect ('had received') for a past event that did not happen. 'Received' (simple past) belongs to second conditional. 'Would have received' cannot be placed in the if-clause.",
        source: "Swan, PEU (4e), §250.1",
        hint: "receive",
        flavor: "personalities"
      },
      {
        id: "mg-cond-3-22",
        stem: "The French Revolution ___ if Louis XVI had addressed the economic crisis more effectively.",
        options: ["might not have occurred", "might not occur", "had not occurred"],
        answer: "might not have occurred",
        explanation: "Third conditional main clause: might have + past participle for an unrealised past result.",
        fullExplanation: "Third conditional main clause uses might/would + have + past participle to describe what could have been the outcome. 'Might not occur' is second conditional (unreal present). 'Had not occurred' is past perfect and cannot stand alone as a main clause.",
        source: "Murphy, EGU (4e), Unit 41",
        hint: "occur",
        flavor: "history"
      },
      {
        id: "mg-cond-3-23",
        stem: "We ___ the last bus if the film had not run over by thirty minutes.",
        options: ["would have caught", "would catch", "had caught"],
        answer: "would have caught",
        explanation: "Third conditional main clause: would + have + past participle for an unrealised past result.",
        fullExplanation: "Third conditional main clause uses would + have + past participle. 'Would catch' is second conditional (unreal present). 'Had caught' is past perfect and functions as an if-clause element, not a main clause.",
        source: "Murphy, EGU (4e), Unit 41",
        hint: "catch",
        flavor: "social"
      },
      {
        id: "mg-cond-3-24",
        stem: "If the meteor ___ at a steeper angle 66 million years ago, the impact could have been far less severe.",
        options: ["had entered", "entered", "would have entered"],
        answer: "had entered",
        explanation: "Third conditional if-clause: past perfect for a hypothetical past event with different outcome.",
        fullExplanation: "Third conditional if-clause uses past perfect ('had entered') for an unreal past event. 'Entered' (simple past) belongs to second conditional counterfactual speculation. 'Would have entered' cannot be placed in the if-clause.",
        source: "Hewings, AGU (3e), Unit 39",
        hint: "enter",
        flavor: "science"
      }
  ...
  "mg-ger-inf": {
    ...
    canonicalSubId: "cs-ger-inf-choice",
    canonicalTopicId: "gerund-infinitive",
    tasks: [
      {
        id: "mg-ger-inf-01",
      ...
      {
        id: "mg-ger-inf-13",
        stem: "Maya Angelou disliked ___ her early drafts to others before the work was fully complete.",
        options: ["showing", "to show", "to showing"],
        answer: "showing",
        explanation: "'Dislike' always takes a gerund (-ing), never an infinitive.",
        fullExplanation: "'Dislike' is a verb that only takes a gerund as its complement. 'To show' (infinitive) is grammatically impossible after 'dislike'. 'To showing' is never a valid English form.",
        source: "Murphy, EGU (4e), Unit 53",
        hint: "show",
        flavor: "personalities"
      },
      {
        id: "mg-ger-inf-14",
        stem: "The armistice negotiators refused ___ until all prisoner exchange terms had been agreed.",
        options: ["to sign", "signing", "to signing"],
        answer: "to sign",
        explanation: "'Refuse' takes an infinitive, not a gerund.",
        fullExplanation: "'Refuse' is always followed by to + infinitive ('refuse to do something'). 'Signing' is a gerund and cannot follow 'refuse'. 'To signing' is not a valid construction in English.",
        source: "Murphy, EGU (4e), Unit 54",
        hint: "sign",
        flavor: "history"
      },
      {
        id: "mg-ger-inf-15",
        stem: "My colleague keeps ___ the same mistake in the monthly reports, despite repeated reminders.",
        options: ["making", "to make", "make"],
        answer: "making",
        explanation: "'Keep' takes a gerund, not an infinitive or bare infinitive.",
        fullExplanation: "'Keep' (meaning to do something repeatedly) always takes a gerund. 'To make' (infinitive) cannot follow 'keep' in this sense. The bare infinitive 'make' is also incorrect after 'keep'.",
        source: "Murphy, EGU (4e), Unit 53",
        hint: "make",
        flavor: "social"
      },
      {
        id: "mg-ger-inf-16",
        stem: "Astronomers expect ___ more detailed images of distant galaxies when the new telescope launches.",
        options: ["to receive", "receiving", "to receiving"],
        answer: "to receive",
        explanation: "'Expect' takes an infinitive, not a gerund.",
        fullExplanation: "'Expect' is followed by to + infinitive ('expect to do something'). A gerund ('receiving') is not used after 'expect'. 'To receiving' is never a valid form.",
        source: "Murphy, EGU (4e), Unit 54",
        hint: "receive",
        flavor: "science"
      },
      {
        id: "mg-ger-inf-17",
        stem: "Nikola Tesla admitted ___ obsessively on a single project for weeks without rest.",
        options: ["working", "to work", "work"],
        answer: "working",
        explanation: "'Admit' takes a gerund, not an infinitive or bare infinitive.",
        fullExplanation: "'Admit' (to confess to doing something) always takes a gerund. 'To work' (infinitive) cannot follow 'admit'. The bare infinitive 'work' is also incorrect after 'admit'.",
        source: "Murphy, EGU (4e), Unit 53",
        hint: "work",
        flavor: "personalities"
      },
      {
        id: "mg-ger-inf-18",
        stem: "The Roman Senate voted ___ Julius Caesar as dictator in perpetuity in 44 BC.",
        options: ["to appoint", "appointing", "to appointing"],
        answer: "to appoint",
        explanation: "'Vote' (in a legislative sense) takes an infinitive, not a gerund.",
        fullExplanation: "'Vote to do something' uses to + infinitive to express a decision made by vote. 'Appointing' (gerund) is not used after 'vote' in this construction. 'To appointing' is not a grammatical English form.",
        source: "Swan, PEU (4e), §275.2",
        hint: "appoint",
        flavor: "history"
      },
      {
        id: "mg-ger-inf-19",
        stem: "The patient stopped ___ the prescribed medication without consulting her doctor first.",
        options: ["taking", "to take", "take"],
        answer: "taking",
        explanation: "'Stop + gerund' means to cease an action — the patient ceased taking the medication.",
        fullExplanation: "'Stop + gerund' means to finish or cease doing something. 'Stop to take' (stop + infinitive) means to pause in order to take medication, changing the meaning entirely. The bare infinitive 'take' is not used after 'stop'.",
        source: "Murphy, EGU (4e), Unit 55",
        hint: "take",
        flavor: "social"
      },
      {
        id: "mg-ger-inf-20",
        stem: "Geologists plan ___ the rock samples from the deep borehole next month.",
        options: ["to analyse", "analysing", "to analysing"],
        answer: "to analyse",
        explanation: "'Plan' takes an infinitive, not a gerund.",
        fullExplanation: "'Plan' is followed by to + infinitive ('plan to do something'). 'Analysing' (gerund) is not used after 'plan'. 'To analysing' is not a valid construction in English.",
        source: "Murphy, EGU (4e), Unit 54",
        hint: "analyse",
        flavor: "science"
      },
      {
        id: "mg-ger-inf-21",
        stem: "Frida Kahlo did not mind ___ long recovery periods in hospital when she used the time to paint.",
        options: ["spending", "to spend", "spend"],
        answer: "spending",
        explanation: "'Mind' takes a gerund, not an infinitive.",
        fullExplanation: "'Mind' (in negative sentences and questions) takes a gerund ('don't mind doing something'). 'To spend' (infinitive) is not used after 'mind'. The bare infinitive 'spend' is also incorrect after 'mind'.",
        source: "Murphy, EGU (4e), Unit 53",
        hint: "spend",
        flavor: "personalities"
      },
      {
        id: "mg-ger-inf-22",
        stem: "Allied commanders decided ___ a second front in Normandy rather than the Balkans in 1944.",
        options: ["to open", "opening", "to opening"],
        answer: "to open",
        explanation: "'Decide' takes an infinitive, not a gerund.",
        fullExplanation: "'Decide' is always followed by to + infinitive ('decide to do something'). 'Opening' (gerund) is not used after 'decide'. 'To opening' is not a grammatical English form.",
        source: "Murphy, EGU (4e), Unit 54",
        hint: "open",
        flavor: "history"
      },
      {
        id: "mg-ger-inf-23",
        stem: "I remember ___ the lights off before leaving the house, but somehow the bill is still enormous.",
        options: ["turning", "to turn", "turn"],
        answer: "turning",
        explanation: "'Remember + gerund' refers to a memory of a past completed action.",
        fullExplanation: "'Remember + gerund' means to recall a past action ('I remember turning off' = I have a memory of having done it). 'Remember + infinitive' ('remember to turn off') means not to forget to do it in the future. The bare infinitive 'turn' is not used after 'remember'.",
        source: "Murphy, EGU (4e), Unit 55",
        hint: "turn",
        flavor: "social"
      },
      {
        id: "mg-ger-inf-24",
        stem: "Scientists tried ___ the faulty spacecraft module by transmitting a remote software patch.",
        options: ["to reboot", "rebooting", "reboot"],
        answer: "to reboot",
        explanation: "'Try + infinitive' means to make an attempt to do something — the intended meaning here.",
        fullExplanation: "'Try + infinitive' means to attempt to do something ('scientists try to reboot'). 'Try + gerund' means to experiment with a different approach. Here scientists are making an attempt, so the infinitive is correct. The bare infinitive 'reboot' is not used after 'try'.",
        source: "Murphy, EGU (4e), Unit 55",
        hint: "reboot",
        flavor: "science"
      }
  ...
  "mg-rel": {
    ...
    tasks: [
      ...
      {
        id: "mg-rel-13",
        stem: "Nikola Tesla, ___ held over 300 patents in his lifetime, struggled financially in later years.",
        options: ["who", "which", "whose"],
        answer: "who",
        explanation: "Use 'who' in a non-defining relative clause referring to a named person.",
        fullExplanation: "'Who' is the correct relative pronoun for a person in a non-defining clause (set off by commas). 'Which' refers to things, not people. 'Whose' is possessive and cannot act as the subject of the clause.",
        source: "Murphy, EGU (4e), Unit 92",
        flavor: "personalities"
      },
      {
        id: "mg-rel-14",
        stem: "The Battle of Hastings, ___ took place in 1066, marked the beginning of Norman rule in England.",
        options: ["which", "who", "where"],
        answer: "which",
        explanation: "Use 'which' in a non-defining relative clause referring to an event.",
        fullExplanation: "'Which' is correct for events and things in non-defining relative clauses (set off by commas). 'Who' is for people, not historical events. 'Where' refers to places and cannot function as the subject of the verb 'took place' here.",
        source: "Murphy, EGU (4e), Unit 92",
        flavor: "history"
      },
      {
        id: "mg-rel-15",
        stem: "The colleague ___ sits next to me always offers to help when I have too much work.",
        options: ["who", "which", "whose"],
        answer: "who",
        explanation: "Use 'who' as the subject of a defining relative clause about a person.",
        fullExplanation: "'Who' refers to a person and acts as the subject of the defining clause. 'Which' is for things and animals. 'Whose' is possessive and would require a following noun (e.g., 'whose desk').",
        source: "Murphy, EGU (4e), Unit 91",
        flavor: "social"
      },
      {
        id: "mg-rel-16",
        stem: "A neutron star ___ spins very rapidly is called a pulsar by astronomers.",
        options: ["that", "who", "where"],
        answer: "that",
        explanation: "Use 'that' in a defining relative clause about a thing.",
        fullExplanation: "'That' is used in defining relative clauses for things. 'Who' refers to people. 'Where' introduces a clause of place and cannot act as the subject of 'spins'.",
        source: "Murphy, EGU (4e), Unit 91",
        flavor: "science"
      },
      {
        id: "mg-rel-17",
        stem: "Isaac Newton, ___ laws of motion transformed physics, also made major contributions to optics.",
        options: ["whose", "who", "which"],
        answer: "whose",
        explanation: "Use 'whose' to show that the laws of motion belong to Newton.",
        fullExplanation: "'Whose' is the possessive relative pronoun for people, meaning 'belonging to whom'. 'Who' can only be the subject or object of the clause, not a possessive. 'Which' is for things and cannot be possessive in this way.",
        source: "Murphy, EGU (4e), Unit 93",
        flavor: "personalities"
      },
      {
        id: "mg-rel-18",
        stem: "The city ___ the French Revolution began is now one of the most visited capitals in the world.",
        options: ["where", "which", "that"],
        answer: "where",
        explanation: "Use 'where' to refer to a place in a relative clause.",
        fullExplanation: "'Where' (= in which) correctly refers to the city as a location. 'Which' could work only with a preposition ('in which'). 'That' requires a preposition in this structure and is awkward without one.",
        source: "Murphy, EGU (4e), Unit 93",
        flavor: "history"
      },
      {
        id: "mg-rel-19",
        stem: "The receptionist ___ checked us in yesterday remembered our room preferences from last time.",
        options: ["who", "which", "where"],
        answer: "who",
        explanation: "Use 'who' as the subject of a defining relative clause about a person.",
        fullExplanation: "'Who' refers to a person and acts as the subject of the defining relative clause. 'Which' is used for things. 'Where' introduces a clause of place and cannot be the subject of 'checked'.",
        source: "Murphy, EGU (4e), Unit 91",
        flavor: "social"
      },
      {
        id: "mg-rel-20",
        stem: "Coral polyps, ___ build calcium carbonate structures, are the main architects of coral reefs.",
        options: ["which", "who", "that"],
        answer: "which",
        explanation: "Use 'which' in a non-defining relative clause about small marine animals.",
        fullExplanation: "'Which' is correct for animals and things in non-defining relative clauses. 'Who' is reserved for people. 'That' cannot be used in non-defining relative clauses (those set off by commas).",
        source: "Murphy, EGU (4e), Unit 92",
        flavor: "science"
      },
      {
        id: "mg-rel-21",
        stem: "Beethoven, ___ continued composing after losing his hearing, left an extraordinary musical legacy.",
        options: ["who", "which", "whose"],
        answer: "who",
        explanation: "Use 'who' in a non-defining relative clause about a named person.",
        fullExplanation: "'Who' is the correct pronoun for a named person in a non-defining clause. 'Which' refers to things or animals. 'Whose' is possessive and cannot act as the subject of the clause.",
      ...
      {
        id: "mg-rel-22",
        stem: "The Forbidden City, ___ was home to Chinese emperors for nearly five centuries, is now a museum.",
        options: ["which", "who", "where"],
        answer: "which",
        explanation: "Use 'which' in a non-defining relative clause referring to a building complex.",
        fullExplanation: "'Which' is correct for things and places used as subjects in non-defining relative clauses. 'Who' is for people. 'Where' introduces a clause of place but cannot be the subject of the verb 'was home'.",
        source: "Murphy, EGU (4e), Unit 92",
        flavor: "history"
      },
      {
        id: "mg-rel-23",
        stem: "The café ___ I study every morning is closing down at the end of the month.",
        options: ["where", "which", "that"],
        answer: "where",
        explanation: "Use 'where' to refer to a place in a defining relative clause.",
        fullExplanation: "'Where' (= in which) correctly refers to the café as a location. 'Which' would work only with a preposition ('at which'). 'That' requires a preposition here and is awkward without one in a defining clause of place.",
        source: "Murphy, EGU (4e), Unit 93",
        flavor: "social"
      },
      {
        id: "mg-rel-24",
        stem: "Antibodies ___ recognise foreign proteins attach to them and signal the immune system to respond.",
        options: ["that", "who", "which"],
        answer: "that",
        explanation: "Use 'that' in a defining relative clause about biological molecules.",
  ...
  "mg-comp": {
    id: "mg-comp",
    name: "Comparatives",
    canonicalSubId: "cs-comp",
    canonicalTopicId: "comparatives",
    tasks: [
      {
        id: "mg-comp-01",
      ...
      {
        id: "mg-comp-13",
        stem: "Galileo's telescope was ___ any optical instrument that existed before his time.",
        options: ["more powerful than", "powerfuler than", "more powerful as"],
        answer: "more powerful than",
        explanation: "Multi-syllable adjectives form comparatives with 'more ... than'.",
        fullExplanation: "'More powerful than' is correct because 'powerful' (three syllables) takes 'more' for the comparative, followed by 'than'. 'Powerfuler' is not a standard form. 'More powerful as' incorrectly uses 'as' instead of 'than'.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "powerful",
        flavor: "personalities"
      },
      {
        id: "mg-comp-14",
        stem: "The Great Plague of 1665 was ___ previous outbreaks of disease in London's history.",
        options: ["more devastating than", "devastatingER than", "more devastating as"],
        answer: "more devastating than",
        explanation: "Multi-syllable adjectives form comparatives with 'more ... than'.",
        fullExplanation: "'More devastating than' is correct because 'devastating' (four syllables) always takes 'more'. 'Devastatinger' is not a valid comparative form. 'More devastating as' incorrectly uses 'as' instead of 'than'.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "devastating",
        flavor: "history"
      },
      {
        id: "mg-comp-15",
        stem: "The new open-plan office is ___ the previous layout, which had dozens of small cubicles.",
        options: ["noisier than", "more noisy than", "noisier as"],
        answer: "noisier than",
        explanation: "Two-syllable adjectives ending in '-y' change to '-ier than' in the comparative.",
        fullExplanation: "'Noisier than' is correct; 'noisy' (two syllables, ending in -y) changes the 'y' to 'i' and adds '-er', then 'than'. 'More noisy than' can be found informally but '-ier' is the standard written form. 'Noisier as' incorrectly substitutes 'as' for 'than'.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "noisy",
        flavor: "social"
      },
      {
        id: "mg-comp-16",
        stem: "The surface of Venus is ___ the surface of Mars, even though Mars is much further from the Sun.",
        options: ["hotter than", "more hot than", "hotter as"],
        answer: "hotter than",
        explanation: "One-syllable adjectives with CVC pattern double the consonant and add '-er than'.",
        fullExplanation: "'Hotter than' is correct; 'hot' (CVC pattern) doubles the 't' and adds '-er', then 'than'. 'More hot than' incorrectly uses 'more' with a one-syllable adjective. 'Hotter as' replaces 'than' with 'as', which is a learner error.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "hot",
        flavor: "science"
      },
      {
        id: "mg-comp-17",
        stem: "Stephen Hawking's later books were ___ his early academic papers, reaching a much wider audience.",
        options: ["more accessible than", "accessibler than", "more accessible as"],
        answer: "more accessible than",
        explanation: "Multi-syllable adjectives form comparatives with 'more ... than'.",
        fullExplanation: "'More accessible than' is correct because 'accessible' (four syllables) always takes 'more'. 'Accessibler' is not a valid form. 'More accessible as' incorrectly substitutes 'as' for 'than'.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "accessible",
        flavor: "personalities"
      },
      {
        id: "mg-comp-18",
        stem: "The trenches of World War I were ___ anything the soldiers had trained for.",
        options: ["worse than", "more bad than", "worse as"],
        answer: "worse than",
        explanation: "'Bad' has an irregular comparative: 'worse than'.",
        fullExplanation: "'Worse than' is the correct irregular comparative of 'bad'. 'More bad than' is non-standard because 'bad' does not form its comparative with 'more'. 'Worse as' incorrectly replaces 'than' with 'as'.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "bad",
        flavor: "history"
      },
      {
        id: "mg-comp-19",
        stem: "Working from home is ___ the office for some people, as there are fewer interruptions.",
        options: ["more productive than", "productiver than", "more productive as"],
        answer: "more productive than",
        explanation: "Multi-syllable adjectives form comparatives with 'more ... than'.",
        fullExplanation: "'More productive than' is correct because 'productive' (three syllables) takes 'more'. 'Productiver' is not a standard comparative form. 'More productive as' incorrectly uses 'as' in place of 'than'.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "productive",
        flavor: "social"
      },
      {
        id: "mg-comp-20",
        stem: "Polar ice melts ___ in recent decades than it did throughout the twentieth century.",
        options: ["faster than", "more fast than", "faster as"],
        answer: "faster than",
        explanation: "One-syllable adjectives/adverbs add '-er than' for the comparative.",
        fullExplanation: "'Faster than' is correct; 'fast' forms its comparative with '-er' followed by 'than'. 'More fast than' incorrectly adds 'more' to a one-syllable word. 'Faster as' incorrectly uses 'as' in place of 'than'.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "fast",
        flavor: "science"
      },
      {
        id: "mg-comp-21",
        stem: "Chopin's nocturnes are ___ his études, requiring more emotional sensitivity than technical speed.",
        options: ["more lyrical than", "lyricalier than", "more lyrical as"],
        answer: "more lyrical than",
        explanation: "Multi-syllable adjectives form comparatives with 'more ... than'.",
        fullExplanation: "'More lyrical than' is correct because 'lyrical' (three syllables) takes 'more'. 'Lyricalier' is not a valid form. 'More lyrical as' incorrectly uses 'as' instead of 'than'.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "lyrical",
        flavor: "personalities"
      },
      {
        id: "mg-comp-22",
        stem: "Medieval siege warfare was ___ open battlefield combat, as sieges often lasted months or years.",
        options: ["slower than", "more slow than", "slower as"],
        answer: "slower than",
        explanation: "One-syllable adjectives add '-er than' to form the comparative.",
        fullExplanation: "'Slower than' is correct; 'slow' (one syllable) adds '-er' and is followed by 'than'. 'More slow than' incorrectly uses 'more' with a short adjective. 'Slower as' replaces 'than' with 'as', a common learner error.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "slow",
        flavor: "history"
      },
      {
        id: "mg-comp-23",
        stem: "My journey to work is ___ it was six months ago, now that the new bus route has opened.",
        options: ["shorter than", "more short than", "shorter as"],
        answer: "shorter than",
        explanation: "One-syllable adjectives add '-er than' to form the comparative.",
        fullExplanation: "'Shorter than' is correct; 'short' (one syllable) adds '-er' and is followed by 'than'. 'More short than' incorrectly uses 'more' with a one-syllable adjective. 'Shorter as' replaces 'than' with 'as', which is incorrect in comparatives.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "short",
        flavor: "social"
      },
      {
        id: "mg-comp-24",
        stem: "The deep ocean is ___ most people imagine; pressures can exceed 600 times atmospheric pressure.",
        options: ["deeper than", "more deep than", "deeper as"],
        answer: "deeper than",
        explanation: "One-syllable adjectives add '-er than' to form the comparative.",
        fullExplanation: "'Deeper than' is correct; 'deep' (one syllable) adds '-er' and is followed by 'than'. 'More deep than' incorrectly uses 'more' with a short adjective. 'Deeper as' replaces 'than' with 'as', which is incorrect in English comparative structures.",
        source: "Murphy, EGU (4e), Unit 99",
        hint: "deep",
        flavor: "science"
      }
  ...
  "mg-sup": {
    ...
    tasks: [
      ...
      {
        id: "mg-sup-13",
        stem: "Muhammad Ali is often described as ___ boxer of the twentieth century.",
        options: ["the greatest", "the most great", "the greater"],
        answer: "the greatest",
        explanation: "One-syllable adjectives add '-est' with 'the' to form the superlative.",
        fullExplanation: "'The greatest' is correct; 'great' adds '-est'. 'The most great' wrongly uses 'most' with a one-syllable adjective. 'The greater' is the comparative and compares only two items, not all boxers.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "great",
        flavor: "personalities"
      },
      {
        id: "mg-sup-14",
        stem: "World War II was ___ conflict in human history, involving more than 30 countries.",
        options: ["the most destructive", "the destructivest", "the more destructive"],
        answer: "the most destructive",
        explanation: "Multi-syllable adjectives form superlatives with 'the most ...'.",
        fullExplanation: "'The most destructive' is correct because 'destructive' (three syllables) takes 'most'. 'The destructivest' is not a real word. 'The more destructive' is the comparative form and compares only two items.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "destructive",
        flavor: "history"
      },
      {
        id: "mg-sup-15",
        stem: "That was ___ experience I have ever had at a hotel — from check-in to breakfast.",
        options: ["the most pleasant", "the pleasantest", "the more pleasant"],
        answer: "the most pleasant",
        explanation: "Two-syllable adjectives usually form superlatives with 'the most ...'.",
        fullExplanation: "'The most pleasant' is correct because 'pleasant' (two syllables) takes 'most'. 'The pleasantest' is occasionally heard but non-standard in formal writing. 'The more pleasant' is the comparative and not the superlative.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "pleasant",
        flavor: "social"
      },
      {
        id: "mg-sup-16",
        stem: "The Mariana Trench is ___ part of the world's oceans, reaching nearly 11,000 metres.",
        options: ["the deepest", "the most deep", "the deeper"],
        answer: "the deepest",
        explanation: "One-syllable adjectives add '-est' with 'the' to form the superlative.",
        fullExplanation: "'The deepest' is correct; 'deep' (one syllable) adds '-est'. 'The most deep' incorrectly adds 'most' to a one-syllable adjective. 'The deeper' is the comparative, not the superlative.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "deep",
        flavor: "science"
      },
      {
        id: "mg-sup-17",
        stem: "Many critics consider Tolstoy ___ novelist who ever lived, pointing to the depth of War and Peace.",
        options: ["the most gifted", "the giftedest", "the more gifted"],
        answer: "the most gifted",
        explanation: "Two-syllable adjectives ending in '-ed' take 'the most ...' for the superlative.",
        fullExplanation: "'The most gifted' is correct; 'gifted' (two syllables) takes 'most'. 'The giftedest' is not a standard form. 'The more gifted' is the comparative and implies comparison with only one other person.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "gifted",
        flavor: "personalities"
      },
      {
        id: "mg-sup-18",
        stem: "The Great Fire of London in 1666 was ___ disaster the city had faced since the medieval plagues.",
        options: ["the worst", "the most bad", "the baddest"],
        answer: "the worst",
        explanation: "'Bad' has an irregular superlative: 'the worst'.",
        fullExplanation: "'The worst' is the irregular superlative of 'bad'. 'The most bad' is non-standard because 'bad' does not use 'most'. 'The baddest' is informal slang meaning 'the best' and is not a formal superlative.",
      ...
      {
        id: "mg-sup-19",
        stem: "The annual company retreat was ___ team-building event I have attended in years.",
        options: ["the most rewarding", "the rewardingest", "the more rewarding"],
        answer: "the most rewarding",
        explanation: "Multi-syllable adjectives form superlatives with 'the most ...'.",
        fullExplanation: "'The most rewarding' is correct because 'rewarding' (three syllables) takes 'most'. 'The rewardingest' is not a valid form. 'The more rewarding' is the comparative, not the superlative.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "rewarding",
        flavor: "social"
      },
      {
        id: "mg-sup-20",
        stem: "Sirius is ___ star visible to the naked eye in the night sky.",
        options: ["the brightest", "the most bright", "the brighter"],
        answer: "the brightest",
        explanation: "One-syllable adjectives add '-est' with 'the' to form the superlative.",
        fullExplanation: "'The brightest' is correct; 'bright' (one syllable) adds '-est'. 'The most bright' incorrectly adds 'most' to a one-syllable adjective. 'The brighter' is the comparative, not the superlative.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "bright",
        flavor: "science"
      },
      {
        id: "mg-sup-21",
        stem: "Many music historians regard Beethoven's Ninth Symphony as ___ piece of orchestral music ever composed.",
        options: ["the most ambitious", "the ambitiousest", "the more ambitious"],
        answer: "the most ambitious",
        explanation: "Multi-syllable adjectives form superlatives with 'the most ...'.",
        fullExplanation: "'The most ambitious' is correct because 'ambitious' (three syllables) takes 'most'. 'The ambitiousest' is not a real word. 'The more ambitious' is the comparative form and compares only two items.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "ambitious",
        flavor: "personalities"
      },
      {
        id: "mg-sup-22",
        stem: "The signing of the Magna Carta in 1215 was one of ___ events in the development of English law.",
        options: ["the most significant", "the significantest", "the more significant"],
        answer: "the most significant",
        explanation: "Multi-syllable adjectives form superlatives with 'the most ...'.",
        fullExplanation: "'The most significant' is correct because 'significant' (four syllables) takes 'most'. 'The significantest' is not a recognised form. 'The more significant' is the comparative and cannot be used in a superlative context.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "significant",
        flavor: "history"
      },
      {
        id: "mg-sup-23",
        stem: "Saturday's party was ___ I have been to since I moved to this city two years ago.",
        options: ["the best", "the most good", "the better"],
        answer: "the best",
        explanation: "'Good' has an irregular superlative: 'the best'.",
        fullExplanation: "'The best' is the irregular superlative of 'good'. 'The most good' is incorrect because 'good' never uses 'most'. 'The better' is the comparative, not the superlative.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "good",
        flavor: "social"
      },
      {
        id: "mg-sup-24",
        stem: "The human brain is ___ organ in the known animal kingdom relative to body size.",
        options: ["the most complex", "the complexest", "the more complex"],
        answer: "the most complex",
        explanation: "Multi-syllable adjectives form superlatives with 'the most ...'.",
        fullExplanation: "'The most complex' is correct because 'complex' (two syllables) takes 'most' for the superlative. 'The complexest' is not a standard form. 'The more complex' is the comparative form and compares only two items.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "complex",
        flavor: "science"
      }
  ...
  "mg-quant": {
    id: "mg-quant",
    name: "Quantifiers — mixed",
    canonicalSubId: "cs-quant-mixed",
    ...
    tasks: [
      ...
      {
        id: "mg-quant-13",
        stem: "Thomas Edison conducted ___ experiments before perfecting a reliable light bulb filament.",
        options: ["many", "much", "little"],
        answer: "many",
        explanation: "Use 'many' with countable plural nouns like 'experiments'.",
        fullExplanation: "'Many' is correct with countable plural nouns such as 'experiments'. 'Much' is for uncountable nouns. 'Little' means 'not much' and collocates with uncountable nouns, contradicting the historical fact of thousands of trials.",
        source: "Murphy, EGU (4e), Unit 83",
        flavor: "personalities"
      },
      {
        id: "mg-quant-14",
        stem: "There was ___ evidence available to historians about daily life in the Bronze Age.",
        options: ["little", "few", "many"],
        answer: "little",
        explanation: "Use 'little' (= not much) with uncountable nouns like 'evidence'.",
        fullExplanation: "'Little' means 'not much' and goes with uncountable nouns such as 'evidence'. 'Few' means 'not many' and is for countable plural nouns. 'Many' is also for countable nouns and cannot modify an uncountable noun.",
      ...
      {
        id: "mg-quant-15",
        stem: "Would you like ___ more water, or shall I open the other bottle?",
        options: ["a little", "a few", "many"],
        answer: "a little",
        explanation: "Use 'a little' with uncountable nouns like 'water'.",
        fullExplanation: "'A little' means 'some (but not much)' and goes with uncountable nouns. 'A few' is for countable plural nouns. 'Many' is also for countable nouns and cannot be used with 'water'.",
        source: "Murphy, EGU (4e), Unit 84",
        flavor: "social"
      },
      {
        id: "mg-quant-16",
        stem: "Bacteria can exchange ___ genetic information directly through a process called conjugation.",
        options: ["a great deal of", "many", "a few"],
        answer: "a great deal of",
        explanation: "Use 'a great deal of' (= a lot of) with uncountable nouns like 'genetic information'.",
        fullExplanation: "'A great deal of' collocates with uncountable nouns such as 'genetic information'. 'Many' is for countable plural nouns. 'A few' means 'some' and is used with countable plural nouns, not uncountable ones.",
        source: "Murphy, EGU (4e), Unit 83",
        flavor: "science"
      },
      {
        id: "mg-quant-17",
        stem: "Frida Kahlo had ___ close friends in the international art world, as her illness kept her isolated.",
        options: ["few", "little", "much"],
        answer: "few",
        explanation: "Use 'few' (= not many) with countable plural nouns like 'friends'.",
        fullExplanation: "'Few' means 'not many' and is used with countable plural nouns. 'Little' means 'not much' and collocates with uncountable nouns. 'Much' is also for uncountable nouns and cannot be used with 'friends'.",
        source: "Murphy, EGU (4e), Unit 84",
        flavor: "personalities"
      },
      {
        id: "mg-quant-18",
        stem: "There was ___ recorded communication between the rival commanders in the weeks before the battle.",
        options: ["little", "few", "many"],
        answer: "little",
        explanation: "Use 'little' (= not much) with uncountable nouns like 'communication'.",
        fullExplanation: "'Little' means 'not much' and goes with uncountable nouns such as 'communication'. 'Few' means 'not many' and is for countable plural nouns. 'Many' is for countable nouns and cannot modify an uncountable noun.",
        source: "Murphy, EGU (4e), Unit 84",
        flavor: "history"
      },
      {
        id: "mg-quant-19",
        stem: "Is there ___ space left in the overhead luggage compartment, or should I check my bag in?",
        options: ["any", "some", "every"],
        answer: "any",
        explanation: "Use 'any' in questions with uncountable nouns.",
        fullExplanation: "'Any' is used in questions and negative sentences with uncountable nouns. 'Some' would suggest the speaker expects a positive answer or is making an offer. 'Every' is used with singular countable nouns and cannot precede 'space' here.",
        source: "Murphy, EGU (4e), Unit 85",
        flavor: "social"
      },
      {
        id: "mg-quant-20",
        stem: "___ cell in the human body contains a complete copy of an individual's DNA.",
        options: ["Every", "Much", "A few"],
        answer: "Every",
        explanation: "Use 'every' + singular noun to mean 'all members of a group without exception'.",
        fullExplanation: "'Every cell' means 'all cells without exception' and takes a singular countable noun. 'Much' is for uncountable nouns. 'A few' means 'some' and is for countable plural nouns, not the universal statement intended here.",
        source: "Murphy, EGU (4e), Unit 86",
        flavor: "science"
      },
      {
        id: "mg-quant-21",
        stem: "Roger Federer showed ___ admirable patience during his decades-long professional tennis career.",
        options: ["such", "many", "a few"],
        answer: "such",
        explanation: "Use 'such' before an uncountable noun phrase to intensify a quality.",
        fullExplanation: "'Such admirable patience' uses 'such' to intensify the quality of an uncountable noun. 'Many' is for countable plural nouns. 'A few' is for countable plural nouns and means 'some'.",
        source: "Murphy, EGU (4e), Unit 83",
        flavor: "personalities"
      },
      {
        id: "mg-quant-22",
        stem: "___ ship in the Spanish Armada carried specific orders about which English ports to target.",
        options: ["Each", "Many", "Little"],
        answer: "Each",
        explanation: "Use 'each' + singular countable noun to refer to individual members of a group.",
        fullExplanation: "'Each ship' refers to every ship individually and takes a singular countable noun. 'Many' is for countable plural nouns and cannot take a singular. 'Little' is for uncountable nouns.",
        source: "Murphy, EGU (4e), Unit 86",
        flavor: "history"
      },
      {
        id: "mg-quant-23",
        stem: "The new policy created ___ confusion among staff, who were unsure what was expected of them.",
        options: ["so much", "so many", "a few"],
        answer: "so much",
        explanation: "Use 'so much' with uncountable nouns like 'confusion'.",
        fullExplanation: "'So much confusion' is correct because 'confusion' is uncountable. 'So many' is for countable plural nouns. 'A few' is for countable plural nouns and means 'some', which is too weak for this context.",
        source: "Murphy, EGU (4e), Unit 83",
        flavor: "social"
      },
      {
        id: "mg-quant-24",
        stem: "The mantle contains ___ minerals that have never reached the surface of the Earth naturally.",
        options: ["some", "much", "little"],
        answer: "some",
        explanation: "Use 'some' with countable plural nouns in affirmative sentences.",
  ...
  "owg-quant": {
    id: "owg-quant",
    name: "Quantifier expressions",
    canonicalSubId: "cs-quant-expr",
    canonicalTopicId: "quantifiers",
    tasks: [
      {
        id: "owg-quant-01",
        stem: "Einstein produced ___ of groundbreaking work during his miraculous year of 1905.",
        options: ["a great deal", "a great number", "plenty", "a couple"],
        answer: "a great deal",
      ...
      },
      {
        ...
        options: ["number", "deal", "lot", "couple"],
        answer: "number",
      ...
      },
      {
        ...
        options: ["plenty", "a great deal", "a number", "a couple"],
        answer: "plenty",
      ...
      },
      {
        ...
        options: ["lots", "a number", "a couple", "a few"],
        answer: "lots",
      ...
      },
      {
        ...
        options: ["a number", "a great deal", "plenty", "a lot"],
        answer: "a number",
      ...
      },
      {
        ...
        options: ["great number", "great deal", "plenty", "couple"],
        answer: "great number",
      ...
      },
      {
        ...
        options: ["a couple", "a great deal", "plenty", "a number"],
        answer: "a couple",
      ...
      },
      {
        ...
        options: ["a great deal", "a great number", "a couple", "a few"],
        answer: "a great deal",
      ...
      },
      {
        ...
        options: ["a great deal", "a great number", "a couple", "plenty"],
        answer: "a great deal",
      ...
      },
      {
        ...
        options: ["great number", "great deal", "couple", "lot"],
        answer: "great number",
      ...
      },
      {
        ...
        options: ["plenty", "a number", "a couple", "a great number"],
        answer: "plenty",
      ...
      },
      {
        ...
        options: ["lots", "a number", "a couple", "a great number"],
        answer: "lots",
      ...
      {
        id: "owg-quant-13",
        stem: "Ada Lovelace dedicated a ___ of energy to translating and annotating Menabrea's paper on the Analytical Engine.",
        options: ["great deal", "great number", "couple", "plenty"],
        answer: "great deal",
        explanation: "'A great deal of' collocates with uncountable nouns like 'energy'.",
        fullExplanation: "'A great deal of energy' is correct because 'energy' is uncountable and 'a great deal of' collocates with uncountable nouns. 'A great number of' requires a countable plural noun. 'A couple of' implies roughly two. 'Plenty of' works but 'plenty' alone cannot precede 'of energy' here.",
        source: "Swan, PEU (4e), §467",
        flavor: "personalities"
      },
      {
        id: "owg-quant-14",
        stem: "A ___ of medieval manuscripts were destroyed when the monasteries were dissolved in the 1530s.",
        options: ["great number", "great deal", "couple", "plenty"],
        answer: "great number",
        explanation: "'A great number of' means 'very many' and is used with countable plural nouns like 'manuscripts'.",
        fullExplanation: "'A great number of manuscripts' means 'very many manuscripts' and is correct with a countable plural noun. 'A great deal of' is for uncountable quantities. 'A couple of' implies roughly two, which understates the historical loss. 'Plenty of' is possible but 'plenty' alone without 'of' after the blank does not fit.",
        source: "Swan, PEU (4e), §467",
        flavor: "history"
      },
      {
        id: "owg-quant-15",
        stem: "There are ___ of options on the menu tonight, so take your time choosing.",
        options: ["plenty", "a great deal", "a couple", "a number"],
        answer: "plenty",
        explanation: "'Plenty of' means 'more than enough' and works with countable plural nouns like 'options'.",
        fullExplanation: "'Plenty of options' means 'more than enough options' and correctly uses a countable plural noun. 'A great deal of' collocates with uncountable nouns. 'A couple of' implies only two. 'A number of' is possible but 'a number' alone before 'of' here does not match the blank structure.",
        source: "Swan, PEU (4e), §467",
        flavor: "social"
      },
      {
        id: "owg-quant-16",
        stem: "Deep-sea vents release ___ of thermal energy into the surrounding ocean every second.",
        options: ["lots", "a number", "a couple", "a great number"],
        answer: "lots",
        explanation: "'Lots of' means 'a large amount of' and works with uncountable nouns like 'thermal energy'.",
        fullExplanation: "'Lots of thermal energy' is correct; 'lots of' (informal for 'a lot of') collocates with uncountable quantities. 'A number of' is for countable plural nouns. 'A couple of' implies roughly two. 'A great number of' is for countable plural nouns.",
        source: "Swan, PEU (4e), §467",
        flavor: "science"
      },
      {
        id: "owg-quant-17",
        stem: "Agatha Christie produced a ___ of detective stories that are still read by millions worldwide.",
        options: ["great number", "great deal", "couple", "lot"],
        answer: "great number",
        explanation: "'A great number of' means 'very many' and precedes countable plural nouns like 'detective stories'.",
        fullExplanation: "'A great number of detective stories' means 'very many stories' and correctly uses a countable plural noun. 'A great deal of' is for uncountable quantities. 'A couple of' implies roughly two. 'A lot of' works but 'lot' alone before 'of' would need 'a lot' not 'a great'.",
        source: "Swan, PEU (4e), §467",
        flavor: "personalities"
      },
      {
        id: "owg-quant-18",
        stem: "A ___ of key diplomatic letters between the rival empires were intercepted before the war began.",
        options: ["number", "deal", "lot", "couple"],
        answer: "number",
        explanation: "'A number of' means 'several' and precedes countable plural nouns.",
        fullExplanation: "'A number of letters' means 'several letters' and is correct with a countable plural noun. 'A deal of' is not a standard fixed expression with this meaning. 'A lot of' is correct but 'lot' alone without 'of' immediately after does not work here. 'A couple of' would mean only about two.",
        source: "Swan, PEU (4e), §467",
        flavor: "history"
      },
      {
        id: "owg-quant-19",
        stem: "I only need ___ of hours to finish this report; I should be done by lunchtime.",
        options: ["a couple", "a great deal", "plenty", "a number"],
        answer: "a couple",
        explanation: "'A couple of' means 'approximately two' and fits a small countable quantity.",
        fullExplanation: "'A couple of hours' means 'about two hours' and fits the context of a short task. 'A great deal of' is for uncountable nouns and implies a large amount. 'Plenty of' means 'more than enough'. 'A number of' means 'several', which is more than two.",
        source: "Swan, PEU (4e), §467",
        flavor: "social"
      },
      {
        id: "owg-quant-20",
        stem: "Researchers have gathered a ___ of data showing that deep ocean currents influence global climate.",
        options: ["great deal", "great number", "couple", "few"],
        answer: "great deal",
        explanation: "'A great deal of' collocates with uncountable nouns like 'data'.",
        fullExplanation: "'A great deal of data' is correct because 'data' is treated as uncountable here. 'A great number of' requires a countable plural noun. 'A couple of' implies roughly two. 'A few of' means 'some but not many' and is for countable nouns.",
        source: "Swan, PEU (4e), §467",
        flavor: "science"
      },
      {
        id: "owg-quant-21",
        stem: "Serena Williams spent a ___ of effort developing her powerful serve in her early career.",
        options: ["great deal", "great number", "couple", "plenty"],
        answer: "great deal",
        explanation: "'A great deal of' collocates with uncountable nouns like 'effort'.",
        fullExplanation: "'A great deal of effort' is correct because 'effort' is uncountable. 'A great number of' is for countable plural nouns. 'A couple of' implies roughly two. 'Plenty of' works but 'plenty' alone is not idiomatic before 'of effort' in this structure.",
        source: "Swan, PEU (4e), §467",
        flavor: "personalities"
      },
      {
        id: "owg-quant-22",
        stem: "A ___ of important trade routes were established along the Silk Road in ancient times.",
        options: ["great number", "great deal", "couple", "lot"],
        answer: "great number",
        explanation: "'A great number of' means 'very many' and is used with countable plural nouns.",
        fullExplanation: "'A great number of trade routes' is correct; 'routes' is a countable plural noun. 'A great deal of' is for uncountable quantities. 'A couple of' means roughly two, which undersells the extent of the Silk Road network. 'A lot of' works but 'lot' alone after the article 'A' would need 'of' not 'great'.",
        source: "Swan, PEU (4e), §467",
        flavor: "history"
      },
      {
        id: "owg-quant-23",
        stem: "We have ___ of time before the conference starts, so we can go for a coffee first.",
        options: ["plenty", "a number", "a couple", "a great number"],
        answer: "plenty",
        explanation: "'Plenty of time' means 'more than enough time' and collocates with uncountable nouns.",
        fullExplanation: "'Plenty of time' correctly uses 'plenty of' with the uncountable noun 'time'. 'A number of' is for countable plural nouns. 'A couple of' means about two (e.g., minutes). 'A great number of' is for countable plural nouns.",
      ...
      {
        id: "owg-quant-24",
        stem: "Glaciers contain ___ of the world's freshwater, locked away in ice sheets and mountain snowfields.",
        options: ["lots", "a number", "a couple", "a great number"],
        answer: "lots",
        explanation: "'Lots of' means 'a large amount of' and works with uncountable nouns like 'freshwater'.",
  ...
  "art-indef": {
    ...
    tasks: [
      ...
      {
        id: "art-indef-13",
        stem: "Charles Darwin was ___ naturalist who spent five years on HMS Beagle studying wildlife across the globe.",
        options: ["a", "an", "the"],
        answer: "a",
        explanation: "'Naturalist' begins with the consonant sound /n/, so 'a' is correct.",
        fullExplanation: "'Naturalist' begins with the consonant sound /n/, so 'a naturalist' is required. 'An' is reserved for words beginning with a vowel sound. 'The' would imply Darwin is already identified as a specific naturalist, but here he is being introduced into a category.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "personalities"
      },
      {
        id: "art-indef-14",
        stem: "The Colosseum in Rome was ___ massive amphitheatre that could seat up to fifty thousand spectators.",
        options: ["a", "an", "the"],
        answer: "a",
        explanation: "'Massive' begins with the consonant sound /m/, so 'a' is correct.",
        fullExplanation: "'Massive' begins with the consonant sound /m/, so 'a massive amphitheatre' is required. 'An' is used before vowel sounds only. 'The' would refer to a specific amphitheatre already known to the listener, but here it is being classified.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "history"
      },
      {
        id: "art-indef-15",
        stem: "My colleague received ___ promotion last month and now manages the entire sales department.",
        options: ["a", "an", "the"],
        answer: "a",
        explanation: "'Promotion' begins with the consonant sound /p/, so 'a' is correct.",
        fullExplanation: "'Promotion' begins with the consonant sound /p/, so 'a promotion' is correct. 'An' would be needed if the word began with a vowel sound. 'The' would imply a specific promotion already known in context.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "social"
      },
      {
        id: "art-indef-16",
        stem: "Water boils at ___ lower temperature at high altitude because atmospheric pressure decreases.",
        options: ["a", "an", "the"],
        answer: "a",
        explanation: "'Lower' begins with the consonant sound /l/, so 'a' is correct.",
        fullExplanation: "'Lower' begins with the consonant sound /l/, so 'a lower temperature' is correct. The article modifies the adjective that follows it, and the sound of that adjective determines the article form. 'An' is incorrect. 'The' would make the temperature specific rather than comparative.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "science"
      },
      {
        id: "art-indef-17",
        stem: "Vincent van Gogh was ___ unconventional painter whose work sold for very little during his lifetime.",
        options: ["an", "a", "the"],
        answer: "an",
        explanation: "'Unconventional' begins with the vowel sound /ʌ/, so 'an' is correct.",
        fullExplanation: "'Unconventional' begins with the vowel sound /ʌ/, so 'an unconventional painter' is required. The article precedes the adjective, so the adjective's initial sound governs the form. 'A unconventional' is incorrect. 'The' would indicate a uniquely identified painter.",
        source: "Swan, PEU (4e), §68",
        flavor: "personalities"
      },
      {
        id: "art-indef-18",
        stem: "The moon landing in 1969 was ___ extraordinary achievement for human science and engineering.",
        options: ["an", "a", "the"],
        answer: "an",
        explanation: "'Extraordinary' begins with the vowel sound /ɪ/, so 'an' is correct.",
        fullExplanation: "'Extraordinary' begins with the vowel sound /ɪ/ (in 'ex-' the 'e' is the first sound). 'An extraordinary achievement' is therefore the correct form. 'A extraordinary' is incorrect. 'The' would introduce a specific, already-identified achievement.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "history"
      },
      {
        id: "art-indef-19",
        stem: "The receptionist gave each visitor ___ identification badge to wear throughout their visit.",
        options: ["an", "a", "the"],
        answer: "an",
        explanation: "'Identification' begins with the vowel sound /aɪ/, so 'an' is correct.",
        fullExplanation: "'Identification' begins with the vowel sound /aɪ/, so 'an identification badge' is required. The article choice always depends on the initial sound of the word directly following it. 'A identification' is grammatically incorrect. 'The' would imply a badge already known to the visitor.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "social"
      },
      {
        id: "art-indef-20",
        stem: "A neutron star has ___ incredibly strong gravitational field, compressing matter to enormous densities.",
        options: ["an", "a", "the"],
        answer: "an",
        explanation: "'Incredibly' begins with the vowel sound /ɪ/, so 'an' is correct.",
        fullExplanation: "'Incredibly' begins with the vowel sound /ɪ/, so 'an incredibly strong gravitational field' is correct. The article governs the word that immediately follows it. 'A incredibly' is incorrect. 'The' would refer to a previously identified specific field.",
        source: "Swan, PEU (4e), §68",
        flavor: "science"
      },
      {
        id: "art-indef-21",
        stem: "Roger Federer was considered ___ outstanding role model both on and off the tennis court.",
        options: ["an", "a", "the"],
        answer: "an",
        explanation: "'Outstanding' begins with the vowel sound /aʊ/, so 'an' is correct.",
        fullExplanation: "'Outstanding' begins with the vowel sound /aʊ/, so 'an outstanding role model' is required. The rule depends on sound, not spelling. 'A outstanding' is incorrect. 'The outstanding role model' would identify a uniquely specific person already discussed.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "personalities"
      },
      {
        id: "art-indef-22",
        stem: "The French Revolution began in 1789 as ___ uprising against the monarchy and the aristocracy.",
        options: ["an", "a", "the"],
        answer: "an",
        explanation: "'Uprising' begins with the vowel sound /ʌ/, so 'an' is correct.",
        fullExplanation: "'Uprising' begins with the vowel sound /ʌ/, making 'an uprising' the correct form. 'A uprising' is grammatically wrong. 'The uprising' would refer to a specific uprising already introduced in context, but here it is being classified for the first time.",
        source: "Swan, PEU (4e), §68",
        flavor: "history"
      },
      {
        id: "art-indef-23",
        stem: "Our teacher suggested we read at least ___ article about current events every day.",
        options: ["an", "a", "the"],
        answer: "an",
        explanation: "'Article' begins with the vowel sound /ɑː/, so 'an' is correct.",
        fullExplanation: "'Article' begins with the vowel sound /ɑː/, so 'an article' is required. The form of the indefinite article depends on the initial sound of the following word. 'A article' is incorrect. 'The article' would refer to a specific one already chosen.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "social"
      },
      {
        id: "art-indef-24",
        stem: "During photosynthesis, plants absorb ___ amount of carbon dioxide that helps regulate the atmosphere.",
        options: ["an", "a", "the"],
        answer: "an",
        explanation: "'Amount' begins with the vowel sound /ə/, so 'an' is correct.",
  ...
  "art-def": {
    ...
    tasks: [
      ...
      {
        id: "art-def-13",
        stem: "Nikola Tesla was widely regarded as ___ most inventive electrical engineer of his era.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "Superlative 'most inventive' requires 'the' to mark the unique top-ranked position.",
        fullExplanation: "Superlatives always require 'the' because they identify a single, unique position in a ranking. 'A most inventive' is ungrammatical as a superlative. 'An' is incorrect because 'most' begins with the consonant sound /m/.",
        source: "Murphy, EGU (4e), Unit 72",
        flavor: "personalities"
      },
      {
        id: "art-def-14",
        stem: "Julius Caesar crossed ___ Rubicon river in 49 BC, triggering a civil war in the Roman Republic.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "Rivers take 'the' as a grammatical convention for proper names.",
        fullExplanation: "'The' is required before the names of rivers as a grammatical convention (the Rubicon, the Nile, the Thames). 'A Rubicon' incorrectly treats it as one of many. 'An' is incorrect because 'Rubicon' begins with the consonant sound /r/.",
        source: "Swan, PEU (4e), §72",
        flavor: "history"
      },
      {
        id: "art-def-15",
        stem: "He left his bag on ___ train and had to call lost property to get it back.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "'The train' refers to a specific train the speaker had just used.",
        fullExplanation: "'The train' uses 'the' because both speaker and listener understand which specific train is meant — the one he had been travelling on. 'A train' would imply any train in general, losing the specific reference. 'An' is incorrect because 'train' begins with the consonant sound /t/.",
        source: "Murphy, EGU (4e), Unit 70",
        flavor: "social"
      },
      {
        id: "art-def-16",
        stem: "___ Moon orbits the Earth at an average distance of about 384,000 kilometres.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "'The Moon' is a unique celestial body, so it takes 'the'.",
        fullExplanation: "'The' is used with unique, one-of-a-kind nouns. Earth has exactly one moon, so it is inherently definite. 'A moon' would imply one of many possible moons. 'An' is incorrect because 'Moon' begins with the consonant sound /m/.",
        source: "Murphy, EGU (4e), Unit 72",
        flavor: "science"
      },
      {
        id: "art-def-17",
        stem: "Muhammad Ali is remembered as ___ greatest heavyweight boxer of the twentieth century.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "Superlative 'greatest' requires 'the' to indicate a unique top position.",
        fullExplanation: "Superlatives ('greatest', 'best', 'fastest') always require 'the' because they identify one entity above all others. 'A greatest' is grammatically incorrect. 'An' is incorrect because 'greatest' begins with the consonant sound /ɡ/.",
        source: "Murphy, EGU (4e), Unit 72",
        flavor: "personalities"
      },
      {
        id: "art-def-18",
        stem: "A stone fortress was built near ___ coast of Normandy and still stands today.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "'The coast of Normandy' is a specific, geographically identified area.",
        fullExplanation: "'The coast of Normandy' uses 'the' because it identifies a specific geographic area. 'The' is required here because the coast of Normandy is a known, uniquely identified location. 'A coast' would not specify which coastline. 'An' is incorrect because 'coast' begins with the consonant sound /k/.",
        source: "Murphy, EGU (4e), Unit 70",
        flavor: "history"
      },
      {
        id: "art-def-19",
        stem: "Please switch off ___ light before you leave; the electricity bill is already very high.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "'The light' refers to the specific, contextually identifiable light in the room.",
        fullExplanation: "'The' is used when both the speaker and listener share knowledge of which specific item is meant. In any given room, there is one understood light. 'A light' would introduce any unidentified light. 'An' is incorrect because 'light' begins with the consonant sound /l/.",
        source: "Murphy, EGU (4e), Unit 70",
        flavor: "social"
      },
      {
        id: "art-def-20",
        stem: "DNA stores genetic information as a sequence of four chemical bases; ___ sequence determines each organism's traits.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "'The sequence' uses 'the' on second mention — it was introduced in the first clause.",
        fullExplanation: "After 'a sequence' is introduced in the first clause, referring back to it as 'the sequence' is correct because it is now identified. 'A sequence' would wrongly re-introduce it as new information. 'An' is incorrect because 'sequence' begins with the consonant sound /s/.",
        source: "Murphy, EGU (4e), Unit 70",
        flavor: "science"
      },
      {
        id: "art-def-21",
        stem: "Rosalind Franklin's X-ray images provided ___ key evidence that led to the discovery of DNA's structure.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "'The key evidence' refers to a specific, uniquely identifiable body of evidence in context.",
        fullExplanation: "'The key evidence' uses 'the' because the evidence is specified as the particular evidence that was decisive in the discovery. 'A key evidence' is ungrammatical as 'evidence' is uncountable. 'An' is incorrect because 'key' begins with the consonant sound /k/.",
        source: "Swan, PEU (4e), §73",
        flavor: "personalities"
      },
      {
        id: "art-def-22",
        stem: "The Mongol Empire reached its greatest extent during ___ thirteenth century under Genghis Khan's successors.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "Ordinal-based century names require 'the'.",
        fullExplanation: "'The thirteenth century' requires 'the' because ordinal expressions used as unique time periods are treated as definite. 'A thirteenth century' is incorrect — there is only one thirteenth century. 'An' is incorrect because 'thirteenth' begins with the consonant sound /θ/.",
        source: "Murphy, EGU (4e), Unit 72",
        flavor: "history"
      },
      {
        id: "art-def-23",
        stem: "She found a wallet in the street and handed it in to ___ nearest police station.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "Superlative 'nearest' requires 'the', and the station is a contextually specific one.",
        fullExplanation: "The superlative 'nearest' always takes 'the' to identify the unique closest item. 'A nearest' is ungrammatical. 'An' is incorrect because 'nearest' begins with the consonant sound /n/.",
        source: "Swan, PEU (4e), §73",
        flavor: "social"
      },
      {
        id: "art-def-24",
        stem: "___ Pacific Ocean is the largest and deepest ocean on Earth, covering more than thirty percent of the surface.",
        options: ["the", "a", "an"],
        answer: "the",
        explanation: "Oceans take 'the' as a grammatical convention, and 'largest' is a superlative.",
  ...
  "art-zero": {
    ...
    tasks: [
      ...
      {
        id: "art-zero-13",
        stem: "Mahatma Gandhi believed that ___ nonviolent resistance was the most powerful tool for political change.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used with abstract nouns like 'nonviolent resistance' in a general sense.",
        fullExplanation: "Abstract concepts used to make general statements (nonviolent resistance, freedom, justice) take zero article. 'The nonviolent resistance' would imply a specific, identified instance. 'A nonviolent resistance' is ungrammatical because the noun phrase is uncountable in this usage.",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "personalities"
      },
      {
        id: "art-zero-14",
        stem: "___ Vikings were seafaring peoples from Scandinavia who raided and traded across Europe between the 8th and 11th centuries.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used with plural nouns referring to a general historical group.",
        fullExplanation: "Plural nouns making broad general statements about a group take zero article. 'The Vikings' would identify a specific subgroup already mentioned in context. 'A Vikings' is ungrammatical because 'a' cannot precede plural nouns.",
        source: "Swan, PEU (4e), §67",
        flavor: "history"
      },
      {
        id: "art-zero-15",
        stem: "He prefers to stay at ___ home and cook rather than go out to expensive restaurants.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used in the fixed expression 'at home'.",
        fullExplanation: "The fixed expression 'at home' (meaning in one's own residence) uses zero article. 'At the home' would refer to a specific named care home or institution. 'At a home' would imply one of several possible homes, breaking the fixed phrase.",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "social"
      },
      {
        id: "art-zero-16",
        stem: "___ electricity flows through a conductor when a potential difference is applied across its ends.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used with uncountable abstract nouns like 'electricity' in a general scientific statement.",
        fullExplanation: "Uncountable nouns referring to general physical phenomena (electricity, heat, light, magnetism) take zero article in general statements. 'The electricity' would imply a specific supply already discussed. 'An electricity' is ungrammatical because the noun is uncountable.",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "science"
      },
      {
        id: "art-zero-17",
        stem: "Pablo Picasso studied ___ art in Barcelona before moving to Paris to develop his unique style.",
        options: ["—", "the", "an"],
        answer: "—",
        explanation: "Zero article is used with academic subjects and disciplines used in a general sense.",
        fullExplanation: "Disciplines and fields of study (art, science, history, music) are used without an article when referred to generally. 'The art' would imply a specific body of art already identified. 'An art' would be used only in a countable sense (an art form), not when referring to the subject of study.",
        source: "Swan, PEU (4e), §67",
        flavor: "personalities"
      },
      {
        id: "art-zero-18",
        stem: "___ World War Two ended in 1945 with the surrender of Germany in May and Japan in September.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Numbered world wars used as proper names do not take an article.",
        fullExplanation: "Proper names like 'World War Two' or 'World War One' are used without 'the'. 'The World War Two' adds an unnecessary definite article. 'A World War Two' is incorrect because proper names do not take the indefinite article.",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "history"
      },
      {
        id: "art-zero-19",
        stem: "My parents always insisted that the family sit together for ___ dinner every evening.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used with meals (dinner, lunch, breakfast) in a routine sense.",
        fullExplanation: "Meals referred to in a habitual or general way (have dinner, eat breakfast, prepare lunch) take zero article. 'The dinner' would imply a specific meal already identified. 'A dinner' would be used only if modified (a dinner party, a formal dinner).",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "social"
      },
      {
        id: "art-zero-20",
        stem: "___ photosynthesis allows plants to convert sunlight into chemical energy stored as glucose.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used with scientific processes and phenomena used in a general sense.",
        fullExplanation: "Technical or scientific processes used as general concepts (photosynthesis, gravity, osmosis) take zero article. 'The photosynthesis' would imply a specific instance. 'A photosynthesis' is ungrammatical because the noun is uncountable in this context.",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "science"
      },
      {
        id: "art-zero-21",
        stem: "Winston Churchill showed great ___ courage during the darkest days of the Second World War.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used with abstract nouns like 'courage' in a general sense.",
        fullExplanation: "Abstract nouns expressing qualities or virtues (courage, patience, wisdom, loyalty) take zero article when used generally. 'The courage' would point to a specific act of courage already discussed. 'A courage' is ungrammatical because 'courage' is an uncountable noun.",
        source: "Swan, PEU (4e), §67",
        flavor: "personalities"
      },
      {
        id: "art-zero-22",
        stem: "___ ancient Egyptians developed a sophisticated system of writing using hieroglyphs.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used with plural nouns referring to a general historical civilisation.",
        fullExplanation: "General plural nouns used for broad statements about a historical group take zero article. 'The ancient Egyptians' would imply a specifically identified subgroup already mentioned. 'A ancient Egyptians' is ungrammatical because 'a' cannot precede plural nouns.",
        source: "Murphy, EGU (4e), Unit 74",
        flavor: "history"
      },
      {
        id: "art-zero-23",
        stem: "The flight attendant asked all passengers to remain in their seats until the aircraft came to ___ rest.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used in the fixed expression 'come to rest'.",
        fullExplanation: "The expression 'come to rest' (meaning to stop moving) is a fixed phrase using zero article. 'Come to the rest' is not the standard phrase. 'Come to a rest' is sometimes heard informally but 'come to rest' without any article is the conventional form.",
        source: "Swan, PEU (4e), §67",
        flavor: "social"
      },
      {
        id: "art-zero-24",
        stem: "___ penguins are found exclusively in the Southern Hemisphere and cannot fly.",
        options: ["—", "the", "a"],
        answer: "—",
        explanation: "Zero article is used with plural nouns representing an entire species.",
  ...
  "art-mixed": {
    id: "art-mixed",
    name: "Two-blank article choice",
    canonicalSubId: "cs-art-mixed",
    canonicalTopicId: "articles",
    tasks: [
      {
        id: "art-mixed-01",
      ...
      {
        id: "art-mixed-13",
        stem: "Isaac Newton was ___ exceptionally gifted scientist who laid ___ foundations of classical mechanics.",
        options: ["an / the", "a / a", "the / an"],
        answer: "an / the",
        explanation: "'An exceptionally' — 'exceptionally' begins with vowel sound /ɪ/; 'the foundations' — specific, unique body of work.",
        fullExplanation: "'An' precedes 'exceptionally' because the adverb begins with the vowel sound /ɪ/. 'The foundations' uses 'the' because the foundations of classical mechanics are a specific, uniquely identified set of principles. 'A / a' uses 'a' before a vowel sound incorrectly. 'The / an' wrongly identifies Newton before he is classified.",
        source: "Murphy, EGU (4e), Units 69–72",
        flavor: "personalities"
      },
      {
        id: "art-mixed-14",
        stem: "The Renaissance was ___ era of artistic rebirth that began in ___ Italian city of Florence.",
        options: ["an / the", "a / the", "the / an"],
        answer: "an / the",
        explanation: "'An era' — 'era' begins with vowel sound /ɪ/; 'the Italian city' — specific, unique geographic reference.",
        fullExplanation: "'An' is required before 'era' because it begins with the vowel sound /ɪ/. 'The Italian city of Florence' uses 'the' because it identifies one specific city. 'A / the' uses 'a' before a vowel sound. 'The / an' wrongly treats the Renaissance as already introduced and misapplies 'an' before 'Italian'.",
        source: "Swan, PEU (4e), §68–73",
        flavor: "history"
      },
      {
        id: "art-mixed-15",
        stem: "I ordered ___ pizza, but ___ pizza arrived completely cold, so I asked for a refund.",
        options: ["a / the", "the / a", "an / the"],
        answer: "a / the",
        explanation: "'A pizza' — first mention, unidentified; 'the pizza' — second mention, now identified.",
        fullExplanation: "On first mention, 'a pizza' introduces the item as unidentified. On second mention, 'the pizza' shows it is now identified. 'The / a' reverses the correct order. 'An / the' is incorrect because 'pizza' begins with the consonant sound /p/.",
        source: "Murphy, EGU (4e), Unit 70",
        flavor: "social"
      },
      {
        id: "art-mixed-16",
        stem: "Sound travels at ___ speed of about 343 metres per second, which is ___ much slower rate than light.",
        options: ["a / a", "the / the", "an / the"],
        answer: "a / a",
        explanation: "Both 'a speed' and 'a much slower rate' introduce approximate or comparative values for the first time.",
        fullExplanation: "'A speed of about 343 m/s' uses 'a' because the speed is being introduced as an approximate value. 'A much slower rate' uses 'a' because the rate is being introduced comparatively for the first time. 'The / the' wrongly treats both as already known. 'An / the' incorrectly uses 'an' before 'speed' which begins with /s/.",
        source: "Murphy, EGU (4e), Units 69–72",
        flavor: "science"
      },
      {
        id: "art-mixed-17",
        stem: "Serena Williams was ___ inspirational athlete who became ___ most decorated women's tennis player of her generation.",
        options: ["an / the", "a / the", "an / a"],
        answer: "an / the",
        explanation: "'An inspirational' — 'inspirational' begins with vowel sound /ɪ/; 'the most decorated' — superlative requires 'the'.",
        fullExplanation: "'An' is used before 'inspirational' because it begins with the vowel sound /ɪ/. 'The most decorated' requires 'the' because superlatives identify a unique position. 'A / the' uses 'a' before a vowel-initial adjective. 'An / a' omits 'the' from the superlative.",
        source: "Swan, PEU (4e), §68–73",
        flavor: "personalities"
      },
      {
        id: "art-mixed-18",
        stem: "The fall of ___ Roman Empire in 476 AD marked ___ end of the ancient world in Western history.",
        options: ["the / the", "a / the", "the / a"],
        answer: "the / the",
        explanation: "'The Roman Empire' — unique, named historical entity; 'the end' — specific, uniquely identifiable moment.",
        fullExplanation: "'The Roman Empire' takes 'the' as a unique named state. 'The end' uses 'the' because it refers to the specific, identifiable endpoint of an era. 'A / the' uses 'a' before a unique proper noun. 'The / a' incorrectly treats 'end' as an indefinite first mention.",
        source: "Murphy, EGU (4e), Units 70–72",
        flavor: "history"
      },
      {
        id: "art-mixed-19",
        stem: "Our office bought ___ new printer and ___ printer broke down on the very first day.",
        options: ["a / the", "the / a", "a / a"],
        answer: "a / the",
        explanation: "'A new printer' — first mention, unidentified; 'the printer' — second mention, now identified.",
        fullExplanation: "On first mention, 'a new printer' introduces the object as unidentified. On second mention, 'the printer' refers back to that same object. 'The / a' reverses the order. 'A / a' fails to use 'the' on second mention.",
        source: "Murphy, EGU (4e), Unit 70",
        flavor: "social"
      },
      {
        id: "art-mixed-20",
        stem: "The human brain is ___ organ of extraordinary complexity, containing ___ estimated 86 billion neurons.",
        options: ["an / an", "a / the", "the / an"],
        answer: "an / an",
        explanation: "'An organ' — 'organ' begins with vowel sound /ɔː/; 'an estimated' — 'estimated' begins with vowel sound /ɛ/.",
        fullExplanation: "'Organ' begins with the vowel sound /ɔː/, so 'an organ' is correct. 'Estimated' begins with the vowel sound /ɛ/, so 'an estimated 86 billion' is correct. 'A / the' incorrectly uses 'a' before vowel sounds. 'The / an' wrongly treats the brain as pre-identified in context.",
        source: "Swan, PEU (4e), §68–73",
        flavor: "science"
      },
      {
        id: "art-mixed-21",
        stem: "William Shakespeare was ___ actor as well as ___ playwright, which gave him deep insight into stagecraft.",
        options: ["an / a", "a / the", "the / an"],
        answer: "an / a",
        explanation: "'An actor' — 'actor' begins with vowel sound /æ/; 'a playwright' — 'playwright' begins with consonant sound /p/, first mention.",
        fullExplanation: "'Actor' begins with the vowel sound /æ/, so 'an actor' is correct. 'Playwright' begins with the consonant sound /p/, so 'a playwright' is correct. Both nouns are being introduced as categories, not as specific identified individuals. 'A / the' uses 'a' before a vowel sound. 'The / an' misidentifies Shakespeare before any category is established.",
        source: "Murphy, EGU (4e), Units 69–72",
        flavor: "personalities"
      },
      {
        id: "art-mixed-22",
        stem: "During ___ Cold War, both superpowers developed ___ enormous arsenal of nuclear weapons.",
        options: ["the / an", "a / the", "the / a"],
        answer: "the / an",
        explanation: "'The Cold War' — unique, named historical era; 'an enormous arsenal' — 'enormous' begins with vowel sound /ɪ/.",
        fullExplanation: "'The Cold War' uses 'the' because it is a unique, named historical period. 'An enormous arsenal' uses 'an' because 'enormous' begins with the vowel sound /ɪ/. 'A / the' uses 'a' before the unique proper noun. 'The / a' uses 'a' before the vowel-initial adjective.",
        source: "Swan, PEU (4e), §68–73",
        flavor: "history"
      },
      {
        id: "art-mixed-23",
        stem: "She is ___ only student in the class who passed ___ advanced certificate exam this year.",
        options: ["the / an", "a / an", "the / a"],
        answer: "the / an",
        explanation: "'The only student' — 'only' creates a unique reference; 'an advanced certificate' — 'advanced' begins with vowel sound /ə/.",
        fullExplanation: "'The' is required before 'only student' because 'only' defines a singular unique person. 'An advanced certificate' uses 'an' because 'advanced' begins with the vowel sound /ə/. 'A / an' wrongly uses 'a' before the uniquely identified student. 'The / a' incorrectly uses 'a' before the vowel-initial adjective.",
        source: "Murphy, EGU (4e), Units 69–72",
        flavor: "social"
      },
      {
        id: "art-mixed-24",
        stem: "Water is ___ essential compound for all known life; without it, ___ atmosphere cannot support living organisms.",
        options: ["an / the", "a / a", "the / a"],
        answer: "an / the",
        explanation: "'An essential compound' — 'essential' begins with vowel sound /ɪ/; 'the atmosphere' — Earth's atmosphere is a unique entity.",
  ...
  "prep-time": {
    ...
    tasks: [
      ...
      {
        id: "prep-time-13",
        stem: "Serena Williams was born ___ September 1981 in Saginaw, Michigan.",
        options: ["in", "on", "at"],
        answer: "in",
        explanation: "Use 'in' with months and years.",
        fullExplanation: "'In' is used with months and years. 'On' is used with specific dates and days. 'At' is used with clock times and fixed points such as noon or midnight.",
        source: "Murphy, EGU (4e), Unit 108",
        flavor: "personalities"
      },
      {
        id: "prep-time-14",
        stem: "The signing of the Treaty of Versailles took place ___ 28 June 1919.",
        options: ["on", "in", "at"],
        answer: "on",
        explanation: "Use 'on' with specific calendar dates.",
        fullExplanation: "'On' is required before a specific day-month date. 'In' would be used for a month or year alone. 'At' refers to clock times and fixed daily points, not calendar dates.",
        source: "Murphy, EGU (4e), Unit 108",
        flavor: "history"
      },
      {
        id: "prep-time-15",
        stem: "The pharmacy opens ___ eight o'clock and closes at six every weekday.",
        options: ["at", "in", "on"],
        answer: "at",
        explanation: "Use 'at' with clock times.",
        fullExplanation: "'At' is used with specific times on the clock (at eight o'clock, at noon). 'In' is used with longer periods such as months and seasons. 'On' is used with days and dates.",
        source: "Murphy, EGU (4e), Unit 108",
        flavor: "social"
      },
      {
        id: "prep-time-16",
        stem: "A hummingbird can beat its wings up to eighty times ___ a single second.",
        options: ["in", "for", "during"],
        answer: "in",
        explanation: "'In' expresses the time within which an action is completed.",
        fullExplanation: "'In' states how quickly or how many times something happens within a time span. 'For' indicates continuous duration. 'During' names a background period without expressing completion or rate.",
        source: "Swan, PEU (4e), §416",
        flavor: "science"
      },
      {
        id: "prep-time-17",
        stem: "Leonardo da Vinci began painting the Mona Lisa ___ the early sixteenth century.",
        options: ["in", "on", "at"],
        answer: "in",
        explanation: "Use 'in' with centuries.",
        fullExplanation: "Centuries and decades take 'in' (in the sixteenth century, in the 1500s). 'On' is for specific days and dates. 'At' is for clock times and specific fixed points.",
        source: "Murphy, EGU (4e), Unit 108",
        flavor: "personalities"
      },
      {
        id: "prep-time-18",
        stem: "Many significant battles were fought ___ the Hundred Years' War between England and France.",
        options: ["during", "for", "in"],
        answer: "during",
        explanation: "'During' means at some point within a named background period.",
        fullExplanation: "'During' indicates that something occurred within the span of a named period or event. 'For' would suggest a measured duration. Using 'in' before a named war is not standard when the intended meaning is 'throughout that period'.",
        source: "Murphy, EGU (4e), Unit 109",
        flavor: "history"
      },
      {
        id: "prep-time-19",
        stem: "The family had been living in their current house ___ over twenty years.",
        options: ["for", "since", "during"],
        answer: "for",
        explanation: "'For' is used with a measured span of time.",
        fullExplanation: "'For' + a period of time expresses duration (over twenty years is a measured span). 'Since' requires a starting point in time, not a duration. 'During' introduces a named background period, not a measured length.",
        source: "Murphy, EGU (4e), Unit 13",
        flavor: "social"
      },
      {
        id: "prep-time-20",
        stem: "Continental drift moves tectonic plates by a few centimetres ___ a year.",
        options: ["in", "for", "within"],
        answer: "in",
        explanation: "'In a year' expresses the rate of change within that time span.",
        fullExplanation: "'In a year' here means 'within the span of one year', expressing the rate at which movement occurs. 'For a year' would imply the movement happens continuously for that full year without specifying completion. 'Within' is possible but less natural in this scientific rate expression.",
        source: "Swan, PEU (4e), §416",
        flavor: "science"
      },
      {
        id: "prep-time-21",
        stem: "Mark Twain wrote The Adventures of Huckleberry Finn ___ the 1880s.",
        options: ["in", "on", "at"],
        answer: "in",
        explanation: "Use 'in' with decades.",
        fullExplanation: "Decades take 'in' (in the 1880s, in the 1960s). 'On' is reserved for days and specific dates. 'At' is used for clock times and fixed points such as midnight or noon.",
        source: "Murphy, EGU (4e), Unit 108",
        flavor: "personalities"
      },
      {
        id: "prep-time-22",
        stem: "The D-Day landings occurred ___ the morning of 6 June 1944.",
        options: ["on", "in", "at"],
        answer: "on",
        explanation: "Use 'on' with specific named days, dates, and mornings.",
        fullExplanation: "'On' is used with days and expressions like 'on the morning of'. 'In' would apply to a month or year alone. 'At' refers to clock times and short daily reference points but not a full date expression.",
        source: "Murphy, EGU (4e), Unit 108",
        flavor: "history"
      },
      {
        id: "prep-time-23",
        stem: "You must return the library books ___ Thursday; they are already overdue.",
        options: ["by", "until", "for"],
        answer: "by",
        explanation: "'By' sets a deadline — no later than that time.",
        fullExplanation: "'By' means at or before a specified deadline. 'Until' implies a process continuing up to that point, then stopping. 'For' indicates a duration, not a deadline.",
        source: "Murphy, EGU (4e), Unit 109",
        flavor: "social"
      },
      {
        id: "prep-time-24",
        stem: "The Sun has been burning hydrogen ___ approximately 4.6 billion years.",
        options: ["for", "since", "during"],
        answer: "for",
        explanation: "'For' expresses a measured span of continuous duration.",
  ...
  "prep-place": {
    ...
    tasks: [
      ...
      {
        id: "prep-place-13",
        stem: "Frida Kahlo was born ___ Coyoacán, a district on the outskirts of Mexico City.",
        options: ["in", "at", "on"],
        answer: "in",
        explanation: "Use 'in' with towns, districts, and cities.",
        fullExplanation: "'In' is used with towns, cities, districts, and any area treated as an enclosed space. 'At' marks a specific point or address. 'On' is used for surfaces, roads, and lines.",
        source: "Murphy, EGU (4e), Unit 110",
        flavor: "personalities"
      },
      {
        id: "prep-place-14",
        stem: "The Battle of Hastings was fought ___ Senlac Hill, several kilometres from the town of Hastings.",
        options: ["on", "in", "at"],
        answer: "on",
        explanation: "Use 'on' with hills and elevated terrain treated as a surface.",
        fullExplanation: "'On' describes position on an open elevated surface like a hill or plain. 'In' would imply an enclosed space. 'At' would mark a specific point rather than a broad surface feature.",
        source: "Murphy, EGU (4e), Unit 110",
        flavor: "history"
      },
      {
        id: "prep-place-15",
        stem: "The receptionist asked us to wait ___ the second floor until the meeting room was ready.",
        options: ["on", "in", "at"],
        answer: "on",
        explanation: "Use 'on' with floors of a building.",
        fullExplanation: "Floors of buildings take 'on' (on the second floor, on the ground floor). 'In' would be used for a room or office on that floor. 'At' marks a specific address or destination point.",
        source: "Murphy, EGU (4e), Unit 110",
        flavor: "social"
      },
      {
        id: "prep-place-16",
        stem: "The deepest point of the ocean, the Mariana Trench, lies ___ a depth of about 11 kilometres.",
        options: ["at", "in", "on"],
        answer: "at",
        explanation: "'At' is used with measurements of depth and specific positions.",
        fullExplanation: "'At' collocates with numerical measurements of depth, altitude, height, and speed. 'In' would imply being enclosed within a space. 'On' refers to surfaces, not precise depth measurements.",
        source: "Swan, PEU (4e), §418",
        flavor: "science"
      },
      {
        id: "prep-place-17",
        stem: "Cleopatra ruled Egypt from Alexandria, and much of her political life was spent ___ the royal palace.",
        options: ["in", "at", "on"],
        answer: "in",
        explanation: "Use 'in' for being inside a building or large structure.",
        fullExplanation: "The interior of buildings and large structures takes 'in'. 'At the royal palace' would suggest it as a destination or address. 'On' applies to surfaces such as a floor or roof.",
        source: "Murphy, EGU (4e), Unit 110",
        flavor: "personalities"
      },
      {
        id: "prep-place-18",
        stem: "The first Olympic Games of the modern era were held ___ Athens, Greece, in 1896.",
        options: ["in", "at", "on"],
        answer: "in",
        explanation: "Use 'in' with cities and countries.",
        fullExplanation: "'In' is used with cities and countries as enclosed geographical spaces. 'At' would refer to a specific venue or address. 'On' applies to surfaces, roads, or lines.",
        source: "Murphy, EGU (4e), Unit 110",
        flavor: "history"
      },
      {
        id: "prep-place-19",
        stem: "We arranged to meet ___ the entrance to the cinema at seven o'clock.",
        options: ["at", "in", "on"],
        answer: "at",
        explanation: "'At' is used for meeting points and specific locations.",
        fullExplanation: "'At' refers to a specific point used as a meeting place or destination. 'In the entrance' would suggest being inside an enclosed entrance hall. 'On the entrance' does not collocate naturally with this usage.",
        source: "Swan, PEU (4e), §418",
        flavor: "social"
      },
      {
        id: "prep-place-20",
        stem: "Migratory birds navigate using iron-based crystals found ___ their beaks and inner ears.",
        options: ["in", "on", "at"],
        answer: "in",
        explanation: "Use 'in' for locations inside body parts.",
        fullExplanation: "Locations inside body parts or enclosed structures take 'in'. 'On their beaks' would imply the surface of the beak. 'At their beaks' is not a standard location phrase for internal anatomy.",
        source: "Murphy, EGU (4e), Unit 110",
        flavor: "science"
      },
      {
        id: "prep-place-21",
        stem: "Nelson Mandela was imprisoned for 27 years ___ Robben Island, off the coast of Cape Town.",
        options: ["on", "in", "at"],
        answer: "on",
        explanation: "Use 'on' with islands.",
        fullExplanation: "Islands take 'on' as a grammatical convention (on Robben Island, on Madagascar). 'In' would treat it as an enclosed space. 'At' would mark it as a specific functional point rather than a geographic area.",
        source: "Swan, PEU (4e), §418",
        flavor: "personalities"
      },
      {
        id: "prep-place-22",
        stem: "The city of Troy, made famous by Homer's Iliad, was located ___ the northwest coast of modern Turkey.",
        options: ["on", "in", "at"],
        answer: "on",
        explanation: "Use 'on' with coasts and linear geographic features.",
        fullExplanation: "'On the coast' is the standard phrase for position along a coastline, treating it as a line or edge. 'In the coast' is not standard. 'At the coast' refers to visiting the seaside in a general sense, not a fixed geographic location.",
        source: "Murphy, EGU (4e), Unit 110",
        flavor: "history"
      },
      {
        id: "prep-place-23",
        stem: "The new coffee shop is ___ the post office and the bookshop on the high street.",
        options: ["between", "among", "opposite"],
        answer: "between",
        explanation: "'Between' is used with exactly two named reference points.",
        fullExplanation: "'Between' is used when two specific things are named. 'Among' is for groups of three or more. 'Opposite' means facing, not positioned in the middle of two things.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "social"
      },
      {
        id: "prep-place-24",
        stem: "The ozone layer is found ___ the stratosphere at an altitude of roughly 15 to 35 kilometres.",
        options: ["in", "on", "at"],
        answer: "in",
        explanation: "Use 'in' with atmospheric layers treated as three-dimensional zones.",
  ...
  "prep-dir": {
    id: "prep-dir",
    name: "Direction prepositions",
    canonicalSubId: "cs-prep-dir",
    canonicalTopicId: "prepositions",
    tasks: [
      {
        id: "prep-dir-01",
      ...
      {
        id: "prep-dir-13",
        stem: "Marie Curie moved ___ Poland to Paris in 1891 to continue her scientific studies.",
        options: ["from", "out of", "across"],
        answer: "from",
        explanation: "'From' indicates the starting point of a journey or movement.",
        fullExplanation: "'From' marks the origin or starting point of movement. 'Out of' also suggests departure but implies moving out of an enclosed space rather than simply noting the place of origin. 'Across' describes movement spanning a surface, not departure from a specific point.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "personalities"
      },
      {
        id: "prep-dir-14",
        stem: "The Spanish Armada sailed ___ the English Channel in 1588, attempting to invade England.",
        options: ["through", "across", "along"],
        answer: "through",
        explanation: "'Through' is used for movement within and across a sea passage.",
        fullExplanation: "'Through' describes movement inside a channel or passage from one end to the other. 'Across' would fit an open expanse but the English Channel is a narrow passage, making 'through' more natural. 'Along' would mean travelling parallel to the edge of the Channel.",
        source: "Swan, PEU (4e), §420",
        flavor: "history"
      },
      {
        id: "prep-dir-15",
        stem: "She ran ___ the library without borrowing anything because she had forgotten her card.",
        options: ["into", "past", "through"],
        answer: "into",
        explanation: "'Into' shows entry — moving from outside to inside.",
        fullExplanation: "'Into' expresses movement entering a building or enclosed space. 'Past' would mean going beside the library without entering. 'Through' would imply entering and exiting, not simply entering.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "social"
      },
      {
        id: "prep-dir-16",
        stem: "Electrical impulses travel ___ nerve fibres at speeds of up to 120 metres per second.",
        options: ["along", "through", "across"],
        answer: "along",
        explanation: "'Along' describes movement following the length of a linear structure.",
        fullExplanation: "'Along' is used for movement following the length or direction of a linear thing such as a fibre, road, or wire. 'Through' would suggest passing inside a three-dimensional medium. 'Across' implies crossing from one side to the other of an expanse.",
        source: "Swan, PEU (4e), §420",
        flavor: "science"
      },
      {
        id: "prep-dir-17",
        stem: "Agatha Christie often travelled ___ Europe by train when researching settings for her detective novels.",
        options: ["across", "through", "along"],
        answer: "across",
        explanation: "'Across' describes movement spanning a broad region from one side to another.",
        fullExplanation: "'Across Europe' expresses the idea of travelling over the breadth of a large area. 'Through Europe' is also possible but emphasises movement within the interior of the region. 'Along Europe' does not make natural geographic sense.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "personalities"
      },
      {
        id: "prep-dir-18",
        stem: "Thousands of pilgrims walked ___ the ancient route to Santiago de Compostela each year.",
        options: ["along", "across", "through"],
        answer: "along",
        explanation: "'Along' describes movement following an established route or path.",
        fullExplanation: "'Along' is the correct preposition for following the length of a path, road, or route. 'Across' would mean crossing from one side to the other of a region. 'Through' would imply passing inside and out of a territory rather than following a specific path.",
        source: "Swan, PEU (4e), §420",
        flavor: "history"
      },
      {
        id: "prep-dir-19",
        stem: "The protesters marched ___ the parliament building and held banners outside the main gate.",
        options: ["past", "through", "into"],
        answer: "past",
        explanation: "'Past' means moving beside a point without entering or stopping.",
        fullExplanation: "'Past' indicates movement alongside and beyond a reference point. 'Through' would imply entering and passing inside the building. 'Into' would mean entering the building, which contradicts the context of holding banners outside.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "social"
      },
      {
        id: "prep-dir-20",
        stem: "Seismic waves travel ___ the Earth's interior and allow scientists to map its layered structure.",
        options: ["through", "across", "along"],
        answer: "through",
        explanation: "'Through' describes movement within a three-dimensional medium.",
        fullExplanation: "'Through' is used when movement passes inside a solid or three-dimensional space. 'Across' would suggest movement over the surface. 'Along' would mean following the edge or a line, not passing inside.",
        source: "Swan, PEU (4e), §420",
        flavor: "science"
      },
      {
        id: "prep-dir-21",
        stem: "Muhammad Ali jabbed ___ the air during training routines to perfect his footwork and timing.",
        options: ["into", "across", "past"],
        answer: "into",
        explanation: "'Into' shows movement directed toward entering a space.",
        fullExplanation: "'Into' expresses directed movement entering a three-dimensional space (the air). 'Across' would mean spanning from side to side. 'Past' would mean going beside a specific reference point, which does not apply here.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "personalities"
      },
      {
        id: "prep-dir-22",
        stem: "Napoleon's army marched ___ the plains of Russia during the brutal winter of 1812.",
        options: ["across", "through", "along"],
        answer: "across",
        explanation: "'Across' describes movement spanning the width of a broad landscape.",
        fullExplanation: "'Across the plains' expresses movement over the open flat expanse from one side to another. 'Through' would be used for a more enclosed terrain such as a forest or mountain pass. 'Along the plains' would mean following their edge, not crossing them.",
        source: "Swan, PEU (4e), §420",
        flavor: "history"
      },
      {
        id: "prep-dir-23",
        stem: "The children ran ___ the house and out the back door when they heard the ice cream van.",
        options: ["through", "across", "past"],
        answer: "through",
        explanation: "'Through' means moving from one end of an enclosed space to the other.",
        fullExplanation: "'Through the house' means entering at one point and exiting at another, passing within the enclosed space. 'Across the house' would suggest movement over its surface from side to side, which is less natural. 'Past the house' means going beside it without entering.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "social"
      },
      {
        id: "prep-dir-24",
        stem: "Honey bees navigate ___ distances of several kilometres by using landmarks and the position of the sun.",
        options: ["across", "along", "into"],
        answer: "across",
        explanation: "'Across' describes spanning a wide area to reach a destination.",
  ...
  "prep-verb": {
    ...
    tasks: [
      ...
      {
        id: "prep-verb-13",
        stem: "Mahatma Gandhi dedicated his life to fighting ___ injustice and colonial oppression.",
        options: ["against", "with", "for"],
        answer: "against",
        explanation: "'Fight against' is the fixed collocation for opposing something.",
        fullExplanation: "'Fight against' means to struggle in opposition to something. 'Fight with' means either to quarrel with someone or to fight alongside them, which changes the meaning. 'Fight for' means to struggle on behalf of something, which also changes the meaning.",
        source: "Murphy, EGU (4e), Unit 128",
        flavor: "personalities"
      },
      {
        id: "prep-verb-14",
        stem: "The Allied powers insisted ___ unconditional surrender from Germany at the end of World War Two.",
        options: ["on", "for", "about"],
        answer: "on",
        explanation: "'Insist on' is the fixed collocation meaning to demand firmly.",
        fullExplanation: "'Insist on' + gerund or noun is the fixed pattern. 'Insist for' is not standard English. 'Insist about' is also non-standard; the correct form always uses 'on'.",
        source: "Swan, PEU (4e), §13",
        flavor: "history"
      },
      {
        id: "prep-verb-15",
        stem: "The children complained ___ the cold weather and refused to go out for their afternoon walk.",
        options: ["about", "of", "for"],
        answer: "about",
        explanation: "'Complain about' is the standard collocation for expressing dissatisfaction.",
        fullExplanation: "'Complain about' is fixed for expressing dissatisfaction with a situation. 'Complain of' exists in medical usage (complain of pain) but not for general grievances. 'Complain for' is not a recognised collocation.",
        source: "Murphy, EGU (4e), Unit 128",
        flavor: "social"
      },
      {
        id: "prep-verb-16",
        stem: "Researchers have been searching ___ a vaccine against malaria for several decades.",
        options: ["for", "at", "into"],
        answer: "for",
        explanation: "'Search for' means to try to find something.",
        fullExplanation: "'Search for' means to look for something actively. 'Search at' is not a standard collocation. 'Search into' is not used in standard English to mean looking for something — 'look into' means to investigate.",
        source: "Murphy, EGU (4e), Unit 128",
        flavor: "science"
      },
      {
        id: "prep-verb-17",
        stem: "Ada Lovelace corresponded ___ Charles Babbage for years, exchanging ideas on computing machines.",
        options: ["with", "to", "about"],
        answer: "with",
        explanation: "'Correspond with' is the fixed collocation meaning to exchange letters or messages.",
        fullExplanation: "'Correspond with' means to exchange written communication with someone. 'Correspond to' means to match or be equivalent to something. 'Correspond about' is not the standard form for this verb.",
        source: "Swan, PEU (4e), §13",
        flavor: "personalities"
      },
      {
        id: "prep-verb-18",
        stem: "The French citizens rose up ___ the monarchy in 1789, demanding liberty and equality.",
        options: ["against", "with", "on"],
        answer: "against",
        explanation: "'Rise up against' is the fixed collocation for revolt.",
        fullExplanation: "'Rise up against' means to rebel or revolt against authority. 'Rise up with' would suggest joining rather than opposing. 'Rise up on' is not a standard collocation in this context.",
        source: "Murphy, EGU (4e), Unit 128",
        flavor: "history"
      },
      {
        id: "prep-verb-19",
        stem: "The guest at the hotel complained that the room did not look ___ the brochure description at all.",
        options: ["like", "of", "to"],
        answer: "like",
        explanation: "'Look like' means to resemble or match the appearance of something.",
        fullExplanation: "'Look like' is a fixed phrase meaning to resemble. 'Look of' is not a standard collocation. 'Look to' means to turn to for help or guidance, which is different from resembling something.",
        source: "Murphy, EGU (4e), Unit 128",
        flavor: "social"
      },
      {
        id: "prep-verb-20",
        stem: "The scientists disagreed ___ which method to use for measuring atmospheric carbon levels.",
        options: ["about", "with", "on"],
        answer: "about",
        explanation: "'Disagree about' introduces the topic of disagreement.",
        fullExplanation: "'Disagree about' introduces the subject matter of the disagreement. 'Disagree with' introduces the person you disagree with, not the subject. 'Disagree on' is also possible but 'disagree about' is the more natural choice when the topic involves a procedure or decision.",
        source: "Swan, PEU (4e), §13",
        flavor: "science"
      },
      {
        id: "prep-verb-21",
        stem: "Chopin longed ___ his homeland of Poland throughout his years of exile in France.",
        options: ["for", "of", "about"],
        answer: "for",
        explanation: "'Long for' is the fixed collocation meaning to desire intensely.",
        fullExplanation: "'Long for' means to feel an intense desire for something absent. 'Long of' is not standard English. 'Long about' is also not a recognised collocation.",
        source: "Murphy, EGU (4e), Unit 128",
        flavor: "personalities"
      },
      {
        id: "prep-verb-22",
        stem: "The soldiers were ordered to retreat ___ the advancing enemy and regroup at the river.",
        options: ["from", "against", "of"],
        answer: "from",
        explanation: "'Retreat from' is the fixed collocation for withdrawing from a threat.",
        fullExplanation: "'Retreat from' means to withdraw away from a source of danger or an enemy force. 'Retreat against' does not make directional sense. 'Retreat of' is not a standard collocation.",
        source: "Swan, PEU (4e), §13",
        flavor: "history"
      },
      {
        id: "prep-verb-23",
        stem: "The neighbours warned us ___ the icy road outside the garage before we drove away.",
        options: ["about", "of", "against"],
        answer: "about",
        explanation: "'Warn about' is the standard collocation when alerting someone to a danger.",
        fullExplanation: "'Warn about' is used when alerting someone to a specific danger or situation. 'Warn of' is used in more formal or literary contexts. 'Warn against' means to advise against doing something, which would change the grammatical structure.",
        source: "Murphy, EGU (4e), Unit 128",
        flavor: "social"
      },
      {
        id: "prep-verb-24",
        stem: "Scientists are now experimenting ___ new materials that can generate electricity from body heat.",
        options: ["with", "on", "in"],
        answer: "with",
        explanation: "'Experiment with' is the fixed collocation for trying out materials or methods.",
  ...
  "prep-adj": {
    ...
    tasks: [
      ...
      {
        id: "prep-adj-13",
        stem: "Stephen Hawking was aware ___ his growing physical limitations but continued to research brilliantly.",
        options: ["of", "about", "for"],
        answer: "of",
        explanation: "'Aware of' is the fixed adjective + preposition collocation.",
        fullExplanation: "'Aware of' is the standard collocation meaning to have knowledge of something. 'Aware about' is non-standard; 'of' is always used here. 'Aware for' does not exist as a collocation.",
        source: "Murphy, EGU (4e), Unit 129",
        flavor: "personalities"
      },
      {
        id: "prep-adj-14",
        stem: "Many soldiers were exhausted ___ years of fighting and longed for the war to end.",
        options: ["from", "of", "by"],
        answer: "from",
        explanation: "'Exhausted from' introduces the cause of exhaustion.",
        fullExplanation: "'Exhausted from' is the natural collocation when stating the cause of tiredness. 'Exhausted of' is not standard for a cause. 'Exhausted by' is also possible but 'from' is more natural when the cause is a prolonged activity rather than a specific agent.",
        source: "Swan, PEU (4e), §13",
        flavor: "history"
      },
      {
        id: "prep-adj-15",
        stem: "My flatmate is not very good ___ cooking, so we usually order takeaway food at weekends.",
        options: ["at", "in", "with"],
        answer: "at",
        explanation: "'Good at' collocates with skills and activities.",
        fullExplanation: "'Good at' is the fixed collocation used with skills and activities. 'Good in' is non-standard in this context. 'Good with' collocates with people or tools (good with children) but not with activities like cooking.",
        source: "Murphy, EGU (4e), Unit 129",
        flavor: "social"
      },
      {
        id: "prep-adj-16",
        stem: "Cheetahs are well adapted ___ hunting on open plains due to their exceptional speed and eyesight.",
        options: ["to", "for", "in"],
        answer: "to",
        explanation: "'Adapted to' is the standard collocation for evolutionary or functional adjustment.",
        fullExplanation: "'Adapted to' is the fixed collocation for being adjusted or suited to an environment or conditions. 'Adapted for' is also possible but 'adapted to' is the more standard form in biological and scientific contexts. 'Adapted in' is not a recognised collocation.",
        source: "Swan, PEU (4e), §13",
        flavor: "science"
      },
      {
        id: "prep-adj-17",
        stem: "Florence Nightingale was deeply committed ___ improving conditions in military hospitals.",
        options: ["to", "for", "with"],
        answer: "to",
        explanation: "'Committed to' is the fixed collocation expressing dedication.",
        fullExplanation: "'Committed to' is the standard fixed collocation meaning deeply dedicated to a cause or goal. 'Committed for' is used in legal contexts (committed for trial) but not here. 'Committed with' is not a recognised collocation.",
        source: "Murphy, EGU (4e), Unit 129",
        flavor: "personalities"
      },
      {
        id: "prep-adj-18",
        stem: "Roman soldiers were accustomed ___ long marches and could cover up to thirty kilometres a day.",
        options: ["to", "with", "of"],
        answer: "to",
        explanation: "'Accustomed to' is the fixed adjective + preposition collocation.",
        fullExplanation: "'Accustomed to' means used to or familiar with something through habit. 'Accustomed with' is not standard. 'Accustomed of' is also not a recognised collocation in English.",
        source: "Swan, PEU (4e), §13",
        flavor: "history"
      },
      {
        id: "prep-adj-19",
        stem: "The new employee seemed nervous ___ making presentations to large groups of people.",
        options: ["about", "of", "for"],
        answer: "about",
        explanation: "'Nervous about' introduces the situation causing anxiety.",
        fullExplanation: "'Nervous about' collocates with situations or events that cause worry. 'Nervous of' is sometimes used but is less common in standard British English. 'Nervous for' is not a standard collocation.",
        source: "Murphy, EGU (4e), Unit 129",
        flavor: "social"
      },
      {
        id: "prep-adj-20",
        stem: "Many deep-sea creatures are immune ___ the enormous pressure that would crush surface animals.",
        options: ["to", "from", "against"],
        answer: "to",
        explanation: "'Immune to' is the fixed collocation meaning unaffected by.",
        fullExplanation: "'Immune to' is the standard collocation in both medical and general contexts meaning unaffected by something. 'Immune from' is used in legal contexts (immune from prosecution). 'Immune against' is not standard.",
        source: "Swan, PEU (4e), §13",
        flavor: "science"
      },
      {
        id: "prep-adj-21",
        stem: "Vincent van Gogh was often short ___ money and depended on financial support from his brother Theo.",
        options: ["of", "on", "in"],
        answer: "of",
        explanation: "'Short of' means lacking or having insufficient amounts of something.",
        fullExplanation: "'Short of' is the fixed collocation meaning lacking in supply or quantity. 'Short on' is also used informally (short on time, short on patience) but 'short of money' is the standard form for financial shortage. 'Short in' is not used.",
        source: "Murphy, EGU (4e), Unit 129",
        flavor: "personalities"
      },
      {
        id: "prep-adj-22",
        stem: "The soldiers were tired ___ fighting and many deserted before the battle ended.",
        options: ["of", "from", "with"],
        answer: "of",
        explanation: "'Tired of' means fed up with or no longer willing to tolerate something.",
        fullExplanation: "'Tired of' means fed up with or unwilling to continue doing something. 'Tired from' is also correct but means physically fatigued as a result of an activity, not the psychological exhaustion of repetition. The context implies they had had enough of fighting, so 'tired of' is correct.",
        source: "Swan, PEU (4e), §13",
        flavor: "history"
      },
      {
        id: "prep-adj-23",
        stem: "She was very satisfied ___ the outcome of the negotiation and shook hands with both parties.",
        options: ["with", "about", "of"],
        answer: "with",
        explanation: "'Satisfied with' collocates with a result, outcome, or performance.",
        fullExplanation: "'Satisfied with' is the fixed collocation used when evaluating a result or outcome. 'Satisfied about' focuses on the overall situation. 'Satisfied of' is used in legal language (satisfied of guilt) but not in general everyday contexts.",
        source: "Murphy, EGU (4e), Unit 129",
        flavor: "social"
      },
      {
        id: "prep-adj-24",
        stem: "Many species of deep-ocean fish are tolerant ___ complete darkness and near-freezing temperatures.",
        options: ["of", "to", "with"],
        answer: "of",
        explanation: "'Tolerant of' is the standard adjective + preposition collocation.",
  ...
  "wf-noun": {
    ...
    tasks: [
      ...
      {
        id: "wf-noun-13",
        stem: "Serena Williams showed remarkable ___ (DETERMINE) throughout her career, winning 23 Grand Slam titles.",
        options: ["determination", "determining", "determiner"],
        answer: "determination",
        explanation: "The suffix -ation converts the verb 'determine' into the noun 'determination'.",
        fullExplanation: "Adding -ation to 'determine' (dropping -e) forms the noun 'determination', meaning strong resolve. 'Determining' is a participle. 'Determiner' is a grammatical term for words like 'the', 'a', and 'some', not the noun needed here.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "determine",
        flavor: "personalities"
      },
      {
        id: "wf-noun-14",
        stem: "The ___ (ABOLISH) of slavery in the United States was formally enacted with the Thirteenth Amendment in 1865.",
        options: ["abolition", "abolishing", "abolisher"],
        answer: "abolition",
        explanation: "The suffix -ition converts the verb 'abolish' into the noun 'abolition'.",
        fullExplanation: "Adding -ition to 'abolish' (dropping -ish) forms the noun 'abolition', meaning the act of formally ending a practice. 'Abolishing' is a gerund/participle. 'Abolisher' refers to a person who abolishes, not the act itself.",
        source: "Swan, PEU (4e), §344",
        hint: "abolish",
        flavor: "history"
      },
      {
        id: "wf-noun-15",
        stem: "The ___ (GENEROUS) of the donors allowed the charity to build three new schools in the region.",
        options: ["generosity", "generousness", "generosify"],
        answer: "generosity",
        explanation: "The suffix -ity converts the adjective 'generous' into the noun 'generosity'.",
        fullExplanation: "Adding -ity (with spelling change) to 'generous' gives 'generosity', meaning the quality of giving freely. 'Generousness' is theoretically formed but is not the standard word. 'Generosify' is not a real English word.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "generous",
        flavor: "social"
      },
      {
        id: "wf-noun-16",
        stem: "The ___ (ELASTIC) of a material determines how well it returns to its original shape after stretching.",
        options: ["elasticity", "elasticness", "elastication"],
        answer: "elasticity",
        explanation: "The suffix -ity converts the adjective 'elastic' into the scientific noun 'elasticity'.",
        fullExplanation: "Adding -ity to 'elastic' gives the scientific noun 'elasticity', denoting the property of recovering shape. 'Elasticness' is not the standard technical term. 'Elastication' refers to the process of adding elastic to fabric, not the physical property.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "elastic",
        flavor: "science"
      },
      {
        id: "wf-noun-17",
        stem: "Mozart showed early signs of musical ___ (CREATIVE), composing minuets at the age of five.",
        options: ["creativity", "creativeness", "creation"],
        answer: "creativity",
        explanation: "The suffix -ity converts the adjective 'creative' into the noun 'creativity'.",
        fullExplanation: "Adding -ity to 'creative' (dropping -e) gives 'creativity', meaning the ability to produce original ideas. 'Creativeness' exists but 'creativity' is the standard form. 'Creation' refers to a specific created work or the act of creating, not the general capacity.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "creative",
        flavor: "personalities"
      },
      {
        id: "wf-noun-18",
        stem: "The ___ (DECLARE) of independence by the American colonies in 1776 began a new era in political history.",
        options: ["declaration", "declaring", "declarer"],
        answer: "declaration",
        explanation: "The suffix -ation converts the verb 'declare' into the noun 'declaration'.",
        fullExplanation: "Adding -ation to 'declare' (dropping -e) gives the noun 'declaration', the act of formally stating something. 'Declaring' is a present participle. 'Declarer' refers to a person who declares, not the act itself.",
        source: "Swan, PEU (4e), §344",
        hint: "declare",
        flavor: "history"
      },
      {
        id: "wf-noun-19",
        stem: "The ___ (ANXIOUS) in the waiting room grew as the announcement was delayed by over an hour.",
        options: ["anxiety", "anxiousness", "anxiosity"],
        answer: "anxiety",
        explanation: "The suffix -iety (via spelling change) converts 'anxious' into the noun 'anxiety'.",
        fullExplanation: "The standard noun derived from 'anxious' is 'anxiety', formed through a root change. 'Anxiousness' is grammatically possible but is not the standard form. 'Anxiosity' is not a real English word.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "anxious",
        flavor: "social"
      },
      {
        id: "wf-noun-20",
        stem: "The ___ (CONDUCT) of electricity through metals depends on the movement of free electrons.",
        options: ["conduction", "conducting", "conductor"],
        answer: "conduction",
        explanation: "The suffix -ion converts the verb 'conduct' into the scientific noun 'conduction'.",
        fullExplanation: "Adding -ion to 'conduct' gives 'conduction', the physical process of heat or electricity passing through a material. 'Conducting' is a participle. 'Conductor' refers to a material or person that conducts, not the process itself.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "conduct",
        flavor: "science"
      },
      {
        id: "wf-noun-21",
        stem: "Charles Darwin's ___ (RECOGNISE) as the founder of evolutionary theory came gradually during his lifetime.",
        options: ["recognition", "recognising", "recogniser"],
        answer: "recognition",
        explanation: "The suffix -ition converts the verb 'recognise' into the noun 'recognition'.",
        fullExplanation: "Adding -ition to 'recognise' (with spelling adjustment) forms the noun 'recognition', meaning acknowledgement or identification. 'Recognising' is a participle. 'Recogniser' is not the standard noun for the concept being tested.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "recognise",
        flavor: "personalities"
      },
      {
        id: "wf-noun-22",
        stem: "The ___ (CONSTRUCT) of the Suez Canal took over a decade and involved thousands of workers.",
        options: ["construction", "constructing", "constructor"],
        answer: "construction",
        explanation: "The suffix -ion converts the verb 'construct' into the noun 'construction'.",
        fullExplanation: "Adding -ion to 'construct' gives the noun 'construction', meaning the process of building. 'Constructing' is a gerund or participle. 'Constructor' refers to a person or company that builds, not the process itself.",
        source: "Swan, PEU (4e), §344",
        hint: "construct",
        flavor: "history"
      },
      {
        id: "wf-noun-23",
        stem: "The ___ (FRIEND) between the two colleagues grew stronger after they worked on the same project.",
        options: ["friendship", "friendness", "friending"],
        answer: "friendship",
        explanation: "The suffix -ship converts the noun 'friend' into the abstract noun 'friendship'.",
        fullExplanation: "Adding -ship to 'friend' forms 'friendship', meaning a close and trusting relationship. 'Friendness' is not a standard English word. 'Friending' is an informal internet term, not the abstract noun required here.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "friend",
        flavor: "social"
      },
      {
        id: "wf-noun-24",
        stem: "The ___ (SOLUBLE) of a substance in water is measured in grams per litre at a given temperature.",
        options: ["solubility", "solubleness", "solution"],
        answer: "solubility",
        explanation: "The suffix -ility converts the adjective 'soluble' into the scientific noun 'solubility'.",
        fullExplanation: "Adding -ility to 'soluble' (dropping -le) gives 'solubility', the technical noun for how easily a substance dissolves. 'Solubleness' is not the standard scientific term. 'Solution' refers to the resulting mixture, not the property of dissolving.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "soluble",
        flavor: "science"
      }
  ...
  "wf-adj": {
    ...
    tasks: [
      ...
      {
        id: "wf-adj-13",
        stem: "Roger Federer was known for his ___ (GRACE) playing style and precise footwork on the tennis court.",
        options: ["graceful", "graceless", "gracing"],
        answer: "graceful",
        explanation: "The suffix -ful converts the noun 'grace' into the adjective 'graceful', meaning elegant.",
        fullExplanation: "Adding -ful to 'grace' forms 'graceful', meaning moving with elegance and ease. 'Graceless' (grace + -less) means lacking grace — the opposite meaning. 'Gracing' is a present participle, not an adjective.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "grace",
        flavor: "personalities"
      },
      {
        id: "wf-adj-14",
        stem: "The discovery of gold in California in 1848 sparked a ___ (MASS) migration westward.",
        options: ["massive", "massing", "massless"],
        answer: "massive",
        explanation: "The suffix -ive converts the noun 'mass' into the adjective 'massive', meaning very large.",
        fullExplanation: "Adding -ive to 'mass' forms 'massive', meaning enormous in scale or quantity. 'Massing' is a present participle used as a verb. 'Massless' means having no mass, which is a physics term and not the intended meaning.",
        source: "Swan, PEU (4e), §344",
        hint: "mass",
        flavor: "history"
      },
      {
        id: "wf-adj-15",
        stem: "The instructions in the manual were very ___ (PRACTICE), with step-by-step diagrams for each stage.",
        options: ["practical", "practising", "practiceful"],
        answer: "practical",
        explanation: "The suffix -al converts the noun 'practice' into the adjective 'practical', meaning useful and effective.",
        fullExplanation: "Adding -al to 'practice' (with spelling change) gives 'practical', meaning useful and well-designed. 'Practising' is a present participle. 'Practiceful' is not a real English word.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "practice",
        flavor: "social"
      },
      {
        id: "wf-adj-16",
        stem: "The Sahara Desert has a very ___ (ARIDITY) climate with less than 25 mm of rainfall per year.",
        options: ["arid", "ariding", "aridity"],
        answer: "arid",
        explanation: "'Arid' is the correct adjective form from the base, meaning extremely dry.",
        fullExplanation: "'Arid' is the adjective meaning extremely dry with very little rainfall. 'Ariding' is not a real word. 'Aridity' is the noun form, not the adjective needed to modify 'climate'.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "arid",
        flavor: "science"
      },
      {
        id: "wf-adj-17",
        stem: "Ada Lovelace had a ___ (LOGIC) mind and was able to understand Babbage's complex mathematical concepts.",
        options: ["logical", "logicous", "logicful"],
        answer: "logical",
        explanation: "The suffix -al (via -ical) converts the noun 'logic' into the adjective 'logical'.",
        fullExplanation: "Adding -al to 'logic' forms 'logical', meaning based on clear reasoning. 'Logicous' is not a real word. 'Logicful' is also non-standard and does not exist in English.",
        source: "Swan, PEU (4e), §344",
        hint: "logic",
        flavor: "personalities"
      },
      {
        id: "wf-adj-18",
        stem: "The ___ (INDUSTRY) output of Britain during the Victorian era made it the world's leading economy.",
        options: ["industrial", "industrious", "industriful"],
        answer: "industrial",
        explanation: "The suffix -al converts the noun 'industry' into the adjective 'industrial', meaning relating to industry.",
        fullExplanation: "Adding -al to 'industry' (with spelling adjustment) gives 'industrial', meaning relating to manufacturing or industry. 'Industrious' means hardworking (a different sense of the root). 'Industriful' is not a real word.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "industry",
        flavor: "history"
      },
      {
        id: "wf-adj-19",
        stem: "The receptionist was very ___ (HELP) and printed out all the documents we needed for the meeting.",
        options: ["helpful", "helpless", "helping"],
        answer: "helpful",
        explanation: "The suffix -ful converts the noun 'help' into the adjective 'helpful', meaning willing to assist.",
        fullExplanation: "Adding -ful to 'help' forms 'helpful', meaning providing assistance. 'Helpless' (help + -less) means unable to help oneself — opposite meaning. 'Helping' is a participle, not the adjective form required here.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "help",
        flavor: "social"
      },
      {
        id: "wf-adj-20",
        stem: "The surface of Mars is ___ (VOLCANO) and shows signs of ancient lava flows and craters.",
        options: ["volcanic", "volcanoful", "volcaning"],
        answer: "volcanic",
        explanation: "The suffix -ic converts the noun 'volcano' into the adjective 'volcanic'.",
        fullExplanation: "Adding -ic to 'volcano' (with spelling change) forms 'volcanic', meaning relating to or produced by volcanoes. 'Volcanoful' is not a real word. 'Volcaning' is also non-standard.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "volcano",
        flavor: "science"
      },
      {
        id: "wf-adj-21",
        stem: "Winston Churchill was a ___ (TALENT) writer and orator who won the Nobel Prize in Literature in 1953.",
        options: ["talented", "talentful", "talenting"],
        answer: "talented",
        explanation: "The suffix -ed converts the noun 'talent' into the adjective 'talented', meaning having a natural ability.",
        fullExplanation: "Adding -ed to 'talent' forms 'talented', meaning possessing natural ability or skill. 'Talentful' is not a standard English word. 'Talenting' is not a recognised word form.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "talent",
        flavor: "personalities"
      },
      {
        id: "wf-adj-22",
        stem: "The construction of the Berlin Wall in 1961 became one of the most ___ (SYMBOL) acts of the Cold War.",
        options: ["symbolic", "symbolful", "symboling"],
        answer: "symbolic",
        explanation: "The suffix -ic converts the noun 'symbol' into the adjective 'symbolic'.",
        fullExplanation: "Adding -ic to 'symbol' forms 'symbolic', meaning representing or serving as a symbol. 'Symbolful' is not a real word. 'Symboling' is also non-standard.",
        source: "Swan, PEU (4e), §344",
        hint: "symbol",
        flavor: "history"
      },
      {
        id: "wf-adj-23",
        stem: "Her presentation was so ___ (BORE) that several people in the audience fell asleep.",
        options: ["boring", "boreful", "borish"],
        answer: "boring",
        explanation: "The suffix -ing converts the verb 'bore' into the adjective 'boring', meaning dull or uninteresting.",
        fullExplanation: "Adding -ing to 'bore' gives 'boring', meaning causing boredom. 'Boreful' is not a real word. 'Borish' is a misspelling of 'boorish', which means rude — a different word entirely.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "bore",
        flavor: "social"
      },
      {
        id: "wf-adj-24",
        stem: "Renewable energy sources such as wind and solar are becoming increasingly ___ (AFFORD).",
        options: ["affordable", "affording", "affordless"],
        answer: "affordable",
        explanation: "The suffix -able converts the verb 'afford' into the adjective 'affordable'.",
        fullExplanation: "Adding -able to 'afford' forms 'affordable', meaning priced within reach of most people. 'Affording' is a present participle. 'Affordless' is not a real English word.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "afford",
        flavor: "science"
      }
  ...
  "wf-adv": {
    ...
    tasks: [
      ...
      {
        id: "wf-adv-13",
        stem: "Nelson Mandela spoke ___ (CALM) and with great authority during his address to the nation.",
        options: ["calmly", "calm", "calmily"],
        answer: "calmly",
        explanation: "The suffix -ly converts the adjective 'calm' into the adverb 'calmly'.",
        fullExplanation: "Adding -ly to 'calm' (which ends in a consonant) gives 'calmly'. No spelling changes are needed. 'Calm' is the adjective. 'Calmily' is a misspelling — the -e is not inserted before -ly for this word.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "calm",
        flavor: "personalities"
      },
      {
        id: "wf-adv-14",
        stem: "The Roman army was ___ (REGULAR) supplied by a sophisticated logistics network across the empire.",
        options: ["regularly", "regular", "regularely"],
        answer: "regularly",
        explanation: "The suffix -ly converts the adjective 'regular' into the adverb 'regularly'.",
        fullExplanation: "Adding -ly to 'regular' (which ends in -ar) gives 'regularly'. The full adjective stem is kept before adding -ly. 'Regular' is the adjective. 'Regularely' is a misspelling — no -e is inserted.",
        source: "Swan, PEU (4e), §18",
        hint: "regular",
        flavor: "history"
      },
      {
        id: "wf-adv-15",
        stem: "The manager spoke ___ (DIRECT) to the customer and explained the refund process clearly.",
        options: ["directly", "direct", "directely"],
        answer: "directly",
        explanation: "The suffix -ly converts the adjective 'direct' into the adverb 'directly'.",
        fullExplanation: "Adding -ly to 'direct' gives 'directly'. The adjective ends in a consonant so no spelling change is needed. 'Direct' can be used as an adverb informally, but 'directly' is the standard form. 'Directely' is a misspelling.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "direct",
        flavor: "social"
      },
      {
        id: "wf-adv-16",
        stem: "Glaciers move ___ (EXTREME) slowly, typically advancing only a few centimetres per day.",
        options: ["extremely", "extreme", "extremeily"],
        answer: "extremely",
        explanation: "Adjectives ending in -e retain the -e and add -ly: extreme → extremely.",
        fullExplanation: "Adding -ly to 'extreme' (which ends in -e) gives 'extremely'. Unlike adjectives ending in -le, the -e here is kept before -ly. 'Extreme' is the adjective. 'Extremeily' is a misspelling.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "extreme",
        flavor: "science"
      },
      {
        id: "wf-adv-17",
        stem: "Nikola Tesla worked ___ (TIRELESS) on his experiments, often sleeping only two hours a night.",
        options: ["tirelessly", "tireless", "tirelessely"],
        answer: "tirelessly",
        explanation: "The suffix -ly converts the adjective 'tireless' into the adverb 'tirelessly'.",
        fullExplanation: "Adding -ly to 'tireless' gives 'tirelessly'. The full adjective is preserved before adding -ly. 'Tireless' is the adjective. 'Tirelessely' is a misspelling — there is no double -e.",
        source: "Swan, PEU (4e), §18",
        hint: "tireless",
        flavor: "personalities"
      },
      {
        id: "wf-adv-18",
        stem: "The Reformation spread ___ (RAPID) across Northern Europe after Luther published his Ninety-Five Theses.",
        options: ["rapidly", "rapid", "rapidily"],
        answer: "rapidly",
        explanation: "The suffix -ly converts the adjective 'rapid' into the adverb 'rapidly'.",
        fullExplanation: "Adding -ly to 'rapid' gives 'rapidly'. The adjective ends in a consonant so no spelling change is needed. 'Rapid' is the adjective. 'Rapidily' is a misspelling — no extra -i is inserted.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "rapid",
        flavor: "history"
      },
      {
        id: "wf-adv-19",
        stem: "She answered the interviewer's questions ___ (CONFIDENT) and was offered the job on the spot.",
        options: ["confidently", "confident", "confidentely"],
        answer: "confidently",
        explanation: "The suffix -ly converts the adjective 'confident' into the adverb 'confidently'.",
        fullExplanation: "Adding -ly to 'confident' gives 'confidently'. The -t is retained and -ly is appended directly. 'Confident' is the adjective. 'Confidentely' is a misspelling.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "confident",
        flavor: "social"
      },
      {
        id: "wf-adv-20",
        stem: "Electrons orbit the nucleus ___ (RELATIVE) far from the central protons and neutrons.",
        options: ["relatively", "relative", "relativeily"],
        answer: "relatively",
        explanation: "Adjectives ending in -e retain the -e and add -ly: relative → relatively.",
        fullExplanation: "Adding -ly to 'relative' (ending in -e) gives 'relatively'. The -e is kept before adding -ly. 'Relative' is the adjective. 'Relativeily' is a misspelling.",
        source: "Swan, PEU (4e), §18",
        hint: "relative",
        flavor: "science"
      },
      {
        id: "wf-adv-21",
        stem: "Pablo Picasso painted ___ (PROLIFIC) throughout his life, producing more than 20,000 works.",
        options: ["prolifically", "prolific", "prolificly"],
        answer: "prolifically",
        explanation: "Adjectives ending in -ic add -ally to form the adverb: prolific → prolifically.",
        fullExplanation: "Adjectives ending in -ic take the suffix -ally (not just -ly): prolific → prolifically. 'Prolific' is the adjective. 'Prolificly' is a common error — the rule for -ic adjectives requires -ally.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "prolific",
        flavor: "personalities"
      },
      {
        id: "wf-adv-22",
        stem: "The Pyramids of Giza were built ___ (PRECISE) using tools and techniques that still impress engineers today.",
        options: ["precisely", "precise", "precisedly"],
        answer: "precisely",
        explanation: "Adjectives ending in -e retain the -e and add -ly: precise → precisely.",
        fullExplanation: "Adding -ly to 'precise' gives 'precisely'. The -e is retained before -ly (unlike -ble adjectives which drop the -e). 'Precise' is the adjective. 'Precisedly' is a misspelling — only -ly is added, not -dly.",
        source: "Swan, PEU (4e), §18",
        hint: "precise",
        flavor: "history"
      },
      {
        id: "wf-adv-23",
        stem: "The children behaved ___ (PERFECT) during the ceremony and were praised by all the guests.",
        options: ["perfectly", "perfect", "perfectely"],
        answer: "perfectly",
        explanation: "The suffix -ly converts the adjective 'perfect' into the adverb 'perfectly'.",
        fullExplanation: "Adding -ly to 'perfect' gives 'perfectly'. The full adjective is preserved before adding -ly. 'Perfect' is the adjective. 'Perfectely' is a misspelling — there is no -e insertion.",
        source: "Murphy, EGU (4e), Unit 100",
        hint: "perfect",
        flavor: "social"
      },
      {
        id: "wf-adv-24",
        stem: "The temperature of the Sun's core reaches ___ (APPROXIMATE) 15 million degrees Celsius.",
        options: ["approximately", "approximate", "approximatly"],
        answer: "approximately",
        explanation: "Adjectives ending in -ate add -ly: approximate → approximately.",
        fullExplanation: "Adding -ly to 'approximate' (ending in -ate) gives 'approximately'. The -e is retained before -ly. 'Approximate' is the adjective. 'Approximatly' is a misspelling — the -e must be kept.",
        source: "Swan, PEU (4e), §18",
        hint: "approximate",
        flavor: "science"
      }
  ...
  "wf-neg": {
    ...
    tasks: [
      ...
      {
        id: "wf-neg-13",
        stem: "Rosalind Franklin's contribution to the discovery of DNA was largely ___ (ACKNOWLEDGE) during her lifetime.",
        options: ["unacknowledged", "disacknowledged", "inacknowledged"],
        answer: "unacknowledged",
        explanation: "The prefix un- negates the past participle 'acknowledged' to form 'unacknowledged'.",
        fullExplanation: "Un- attached to past participles expresses the state of not receiving something: unacknowledged. 'Disacknowledged' is not a standard English word. 'Inacknowledged' also does not exist; un- is the correct prefix for this form.",
        source: "Murphy, EGU (4e), Unit 74",
        hint: "acknowledge",
        flavor: "personalities"
      },
      {
        id: "wf-neg-14",
        stem: "Many of the promises made in the peace treaty proved ___ (ENFORCE) without international support.",
        options: ["unenforceable", "disenforceable", "inenforceable"],
        answer: "unenforceable",
        explanation: "The prefix un- negates the adjective 'enforceable' to form 'unenforceable'.",
        fullExplanation: "Un- is used with -able adjectives from native English roots: unenforceable means not capable of being enforced. 'Disenforceable' is not a recognised word. 'Inenforceable' is also non-standard; un- is required here.",
        source: "Swan, PEU (4e), §383",
        hint: "enforceable",
        flavor: "history"
      },
      {
        id: "wf-neg-15",
        stem: "It is considered ___ (MATURE) to send angry messages to colleagues instead of resolving conflicts in person.",
        options: ["immature", "unmature", "dismature"],
        answer: "immature",
        explanation: "The prefix im- is used before adjectives beginning with m: mature → immature.",
        fullExplanation: "Im- (a variant of in-) is used before roots beginning with m or p: immature. 'Unmature' is non-standard; im- is the correct prefix here. 'Dismature' is not a real English word.",
        source: "Murphy, EGU (4e), Unit 74",
        hint: "mature",
        flavor: "social"
      },
      {
        id: "wf-neg-16",
        stem: "Certain frequencies of electromagnetic radiation are ___ (VISIBLE) to the human eye.",
        options: ["invisible", "unvisible", "disvisible"],
        answer: "invisible",
        explanation: "The prefix in- negates the adjective 'visible' to form 'invisible'.",
        fullExplanation: "In- is the standard negative prefix for 'visible': invisible means not able to be seen. 'Unvisible' is non-standard; in- is the fixed prefix for this word. 'Disvisible' is not a real English word.",
        source: "Swan, PEU (4e), §383",
        hint: "visible",
        flavor: "science"
      },
      {
        id: "wf-neg-17",
        stem: "Many people considered Galileo's heliocentric theory ___ (ACCEPT) in his time because it challenged Church doctrine.",
        options: ["unacceptable", "disacceptable", "inacceptable"],
        answer: "unacceptable",
        explanation: "The prefix un- negates the adjective 'acceptable' to form 'unacceptable'.",
        fullExplanation: "Un- is the standard negative prefix for 'acceptable': unacceptable. 'Disacceptable' is not a real word. 'Inacceptable' is non-standard; English uses un- rather than in- for this adjective.",
        source: "Murphy, EGU (4e), Unit 74",
        hint: "acceptable",
        flavor: "personalities"
      },
      {
        id: "wf-neg-18",
        stem: "The siege of Leningrad lasted 872 days and caused ___ (DESCRIBE) suffering among the civilian population.",
        options: ["indescribable", "undescribable", "misdescribable"],
        answer: "indescribable",
        explanation: "The prefix in- negates the adjective 'describable' to form 'indescribable'.",
        fullExplanation: "In- is the standard negative prefix for 'describable' (a Latin-root -able adjective): indescribable. 'Undescribable' is non-standard; in- is required for this word. 'Misdescribable' is not a real English word.",
        source: "Swan, PEU (4e), §383",
        hint: "describable",
        flavor: "history"
      },
      {
        id: "wf-neg-19",
        stem: "It is ___ (RESPONSIBLE) to ignore safety warnings when operating heavy machinery at work.",
        options: ["irresponsible", "unresponsible", "disresponsible"],
        answer: "irresponsible",
        explanation: "The prefix ir- is used before adjectives beginning with r: responsible → irresponsible.",
        fullExplanation: "The prefix ir- (variant of in-) assimilates before r: irresponsible. 'Unresponsible' is non-standard; ir- is required here. 'Disresponsible' is not a real English word.",
        source: "Murphy, EGU (4e), Unit 74",
        hint: "responsible",
        flavor: "social"
      },
      {
        id: "wf-neg-20",
        stem: "The fossil record shows several evolutionary pathways that turned out to be ___ (VIABLE) in the long run.",
        options: ["non-viable", "unviable", "disviable"],
        answer: "non-viable",
        explanation: "The prefix non- is used to negate compound or technical adjectives like 'viable'.",
        fullExplanation: "Non- is used to negate technical and scientific adjectives, often hyphenated: non-viable. 'Unviable' is sometimes used but 'non-viable' is the more established scientific term. 'Disviable' is not a real word.",
        source: "Hewings, AGU (3e), Unit 70",
        hint: "viable",
        flavor: "science"
      },
      {
        id: "wf-neg-21",
        stem: "Leonardo da Vinci's extraordinary range of talents makes him almost ___ (COMPARE) to any other historical figure.",
        options: ["incomparable", "uncomparable", "discomparable"],
        answer: "incomparable",
        explanation: "The prefix in- negates 'comparable' to form 'incomparable', meaning without equal.",
        fullExplanation: "In- is the standard negative prefix for Latin-root -able adjectives: incomparable means without equal or beyond comparison. 'Uncomparable' is non-standard. 'Discomparable' is not a real English word.",
        source: "Swan, PEU (4e), §383",
        hint: "comparable",
        flavor: "personalities"
      },
      {
        id: "wf-neg-22",
        stem: "Many ancient ruins are in a state of ___ (REPAIR) and require urgent conservation work.",
        options: ["disrepair", "unrepair", "misrepair"],
        answer: "disrepair",
        explanation: "The prefix dis- negates 'repair' to form the noun 'disrepair', meaning a poor state of maintenance.",
        fullExplanation: "The fixed expression is 'in a state of disrepair', meaning not maintained. 'Unrepair' is non-standard; dis- is the correct prefix. 'Misrepair' is also not a recognised word.",
        source: "Murphy, EGU (4e), Unit 74",
        hint: "repair",
        flavor: "history"
      },
      {
        id: "wf-neg-23",
        stem: "The customer was ___ (SATISFY) with the service and asked to speak to the manager immediately.",
        options: ["dissatisfied", "unsatisfied", "nonsatisfied"],
        answer: "dissatisfied",
        explanation: "The prefix dis- negates the past participle 'satisfied' to form 'dissatisfied'.",
        fullExplanation: "The negative of 'satisfied' expressing a feeling of discontent is 'dissatisfied'. 'Unsatisfied' is also correct but typically refers to a need not being met (an unsatisfied demand). 'Nonsatisfied' is not standard English.",
        source: "Swan, PEU (4e), §383",
        hint: "satisfied",
        flavor: "social"
      },
      {
        id: "wf-neg-24",
        stem: "Some proteins are ___ (STABLE) and break down quickly when exposed to heat or acid.",
        options: ["unstable", "instable", "misstable"],
        answer: "unstable",
        explanation: "The prefix un- negates the adjective 'stable' to form 'unstable'.",
        fullExplanation: "Un- is the standard prefix for 'stable': unstable means likely to break down or change. 'Instable' is not standard English (the correct in- form is 'instability' as a noun, but the adjective is 'unstable'). 'Misstable' is not a real word.",
        source: "Murphy, EGU (4e), Unit 74",
        hint: "stable",
        flavor: "science"
      }
  ...
  "wf-mixed": {
    id: "wf-mixed",
    name: "Mixed word formation",
    canonicalSubId: "cs-wf-mixed",
    canonicalTopicId: "word-formation",
    tasks: [
      {
        id: "wf-mixed-01",
      ...
      {
        id: "wf-mixed-13",
        stem: "Marie Curie helped ___ (POPULAR) the idea that women could excel in the physical sciences.",
        options: ["popularise", "popular", "popularity"],
        answer: "popularise",
        explanation: "The suffix -ise forms a verb from the adjective 'popular': popularise.",
        fullExplanation: "Adding -ise to 'popular' forms the verb 'popularise', meaning to make something widely known or accepted. 'Popular' is the adjective. 'Popularity' is a noun, not a verb.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "popular",
        flavor: "personalities"
      },
      {
        id: "wf-mixed-14",
        stem: "Napoleon tried to ___ (CENTRAL) power in France by restructuring all government institutions.",
        options: ["centralise", "central", "centrality"],
        answer: "centralise",
        explanation: "The suffix -ise converts the adjective 'central' into the verb 'centralise'.",
        fullExplanation: "Adding -ise to 'central' forms the verb 'centralise', meaning to concentrate power in one place. 'Central' is the adjective. 'Centrality' is an abstract noun, not a verb.",
        source: "Swan, PEU (4e), §344",
        hint: "central",
        flavor: "history"
      },
      {
        id: "wf-mixed-15",
        stem: "The government decided to ___ (LEGAL) the activity, allowing companies to operate freely in the sector.",
        options: ["legalise", "legal", "legality"],
        answer: "legalise",
        explanation: "The suffix -ise converts the adjective 'legal' into the verb 'legalise'.",
        fullExplanation: "Adding -ise to 'legal' forms the verb 'legalise', meaning to make something lawful. 'Legal' is the adjective. 'Legality' is a noun, not a verb.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "legal",
        flavor: "social"
      },
      ...
      {
        id: "wf-mixed-18",
        stem: "The discovery of penicillin helped ___ (REVOLUTION) the treatment of bacterial infections in the twentieth century.",
        options: ["revolutionise", "revolution", "revolutionary"],
        answer: "revolutionise",
        explanation: "The suffix -ise forms the verb 'revolutionise' from the noun 'revolution'.",
        fullExplanation: "Adding -ise to 'revolution' (adjusting the spelling) gives the verb 'revolutionise', meaning to bring about radical change. 'Revolution' is the noun form. 'Revolutionary' is an adjective or noun.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "revolution",
        flavor: "history"
      },
      {
        id: "wf-mixed-19",
        stem: "The teacher asked the class to ___ (SUMMAR) the main events of the story in their own words.",
        options: ["summarise", "summary", "summarily"],
        answer: "summarise",
        explanation: "The suffix -ise forms the verb 'summarise' from the noun 'summary'.",
        fullExplanation: "Adding -ise to the base 'summar-' (from 'summary') forms 'summarise', meaning to give a brief account of something. 'Summary' is a noun. 'Summarily' is an adverb meaning in a summary way, not the verb needed here.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "summar",
        flavor: "social"
      },
      {
        id: "wf-mixed-20",
        stem: "Climate scientists aim to ___ (QUANTITY) the rate at which Arctic sea ice is decreasing each decade.",
        options: ["quantify", "quantity", "quantise"],
        answer: "quantify",
        explanation: "The suffix -ify converts the noun 'quantity' into the verb 'quantify'.",
        fullExplanation: "Adding -ify to the base 'quant-' (from 'quantity') gives the verb 'quantify', meaning to measure or express as a number. 'Quantity' is the noun. 'Quantise' means to apply quantum theory, which is a different technical term.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "quantity",
        flavor: "science"
      },
      {
        id: "wf-mixed-21",
        stem: "Maya Angelou worked to ___ (STRENGTH) the voices of marginalised communities through her writing.",
        options: ["strengthen", "strength", "strengthful"],
        answer: "strengthen",
        explanation: "The suffix -en converts the noun 'strength' into the verb 'strengthen'.",
        fullExplanation: "Adding -en to 'strength' forms the verb 'strengthen', meaning to make stronger. 'Strength' is the noun. 'Strengthful' is not a real English word.",
        source: "Murphy, EGU (4e), Unit 73",
        hint: "strength",
        flavor: "personalities"
      },
      {
        id: "wf-mixed-22",
        stem: "The introduction of printing helped ___ (STANDARD) spelling and grammar across European languages.",
        options: ["standardise", "standard", "standardness"],
        answer: "standardise",
        explanation: "The suffix -ise converts the adjective/noun 'standard' into the verb 'standardise'.",
        fullExplanation: "Adding -ise to 'standard' forms the verb 'standardise', meaning to make uniform. 'Standard' is the adjective or noun. 'Standardness' is not a real English word.",
        source: "Swan, PEU (4e), §344",
        hint: "standard",
        flavor: "history"
      },
      {
        id: "wf-mixed-23",
        stem: "The charity aims to ___ (WIDE) access to clean water in rural areas through new infrastructure projects.",
        options: ["widen", "wide", "wideness"],
        answer: "widen",
        explanation: "The suffix -en converts the adjective 'wide' into the verb 'widen'.",
        fullExplanation: "Adding -en to 'wide' forms the verb 'widen', meaning to make broader or more expansive. 'Wide' is the adjective. 'Wideness' is a noun, not the verb required after 'to'.",
        source: "Hewings, AGU (3e), Unit 68",
        hint: "wide",
        flavor: "social"
      },
  ...
  "err-aux": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["does", "works", "very", "support"],
        answer: "does",
      ...
      },
      {
        ...
        options: ["does", "boils", "at", "atmospheric"],
        answer: "does",
      ...
      },
      {
        ...
        options: ["could", "was", "able", "complete"],
        answer: "could",
      ...
      },
      {
        ...
        options: ["was", "been", "built", "separate"],
        answer: "was",
      ...
      },
      {
        ...
        options: ["did", "mentioned", "had", "been"],
        answer: "did",
      ...
      },
      {
        ...
        options: ["do", "travels", "through", "expanding"],
        answer: "do",
      ...
      },
      {
        ...
        options: ["would", "could", "write", "ahead"],
        answer: "would",
      ...
      },
      {
        ...
        options: ["must", "have", "finish", "before"],
        answer: "must",
      ...
      {
        id: "err-aux-13",
        stem: "Isaac Newton was being a fellow of the Royal Society when he published his laws of motion. Find the redundant word: ___",
        options: ["was", "being", "fellow", "published"],
        answer: "was",
        explanation: "'Was being' is ungrammatical for a permanent state; 'being' alone is also wrong — 'was' is the redundant auxiliary here.",
        fullExplanation: "Permanent membership in an institution uses simple past: 'Newton was a fellow'. 'Was being' implies temporary behaviour, which is ungrammatical for a role or status. 'Being' alone could also be removed, but the redundant auxiliary that creates the error is 'was' paired with 'being'. 'Fellow', 'published' are correctly used.",
        source: "Murphy, EGU (4e), Unit 3",
        flavor: "personalities"
      },
      {
        id: "err-aux-14",
        stem: "The pyramids of Giza was were built as tombs for the pharaohs of ancient Egypt. Find the redundant word: ___",
        options: ["was", "were", "built", "ancient"],
        answer: "was",
        explanation: "'Was were built' contains two auxiliaries; 'was' is the redundant one since the plural subject requires 'were'.",
        fullExplanation: "'The pyramids' is plural, so the passive auxiliary must be 'were built'. Having both 'was' and 'were' is a double-auxiliary error; 'was' is the redundant intrusion. 'Built' and 'ancient' are both correctly used.",
        source: "Murphy, EGU (4e), Unit 21",
        flavor: "history"
      },
      {
        id: "err-aux-15",
        stem: "Our landlord has did repaired the boiler twice already this winter. Find the redundant word: ___",
        options: ["did", "has", "repaired", "already"],
        answer: "did",
        explanation: "'Has did repaired' stacks present perfect and past auxiliary; 'did' is the redundant auxiliary.",
        fullExplanation: "'Has repaired' is the correct present perfect form. Inserting 'did' between 'has' and 'repaired' creates an ungrammatical auxiliary pile-up. Either 'has repaired' (present perfect) or 'did repair' (emphatic past) is correct alone. 'Already' is correctly placed.",
        source: "Murphy, EGU (4e), Unit 43",
        flavor: "social"
      },
      {
        id: "err-aux-16",
        stem: "Dolphins are can able to communicate using a complex system of clicks and whistles. Find the redundant word: ___",
        options: ["are", "can", "able", "communicate"],
        answer: "are",
        explanation: "'Are can able to' stacks three ability expressions; 'are' is the redundant auxiliary.",
        fullExplanation: "'Can' and 'are able to' both express ability. 'Are' is the auxiliary belonging to 'are able to', but when 'can' is also present, one structure is superfluous. 'Can communicate' or 'are able to communicate' is correct. The extra 'are' before 'can' is the redundant element here.",
        source: "Murphy, EGU (4e), Unit 29",
        flavor: "science"
      },
      {
        id: "err-aux-17",
        stem: "Jane Austen should must have struggled to find a publisher as a woman in the early nineteenth century. Find the redundant word: ___",
        options: ["should", "must", "have", "struggled"],
        answer: "should",
        explanation: "'Should must have' stacks two modal auxiliaries; 'should' is redundant before 'must have'.",
        fullExplanation: "English does not allow two modal auxiliaries in sequence. 'Must have struggled' expresses a logical deduction about the past, which is the intended meaning. 'Should have' expresses regret or obligation, which changes the meaning. 'Should' is therefore the redundant auxiliary here. 'Have' and 'struggled' are correctly part of the 'must have' structure.",
        source: "Murphy, EGU (4e), Unit 31",
        flavor: "personalities"
      },
      {
        id: "err-aux-18",
        stem: "The Cold War had was ended in 1991 when the Soviet Union officially dissolved. Find the redundant word: ___",
        options: ["had", "was", "ended", "officially"],
        answer: "had",
        explanation: "'Had was ended' wrongly combines past perfect and simple past; 'had' is the redundant auxiliary.",
        fullExplanation: "'Was ended' is a simple past passive, which is appropriate here with the specific date '1991'. 'Had was ended' incorrectly mixes past perfect ('had') with simple past passive ('was ended'). Remove 'had' to leave the grammatical 'was ended'. 'Officially' is correctly used.",
        source: "Murphy, EGU (4e), Unit 15",
        flavor: "history"
      },
      {
        id: "err-aux-19",
        stem: "The children should be able to have finished their homework before dinner tonight. Find the redundant word: ___",
        options: ["be", "able", "have", "finished"],
        answer: "be",
        explanation: "'Should be able to have' inserts a redundant 'be' between 'should' and 'able to have'.",
        fullExplanation: "'Should have finished' is the correct form (modal + perfect). 'Should be able to' expresses present/future ability. Combining them as 'should be able to have finished' creates an overloaded modal chain. 'Be' is the redundant auxiliary that breaks the correct 'should have finished' structure. 'Able', 'have', and 'finished' are part of different but coherent chains — 'be' is the intrusion.",
        source: "Murphy, EGU (4e), Unit 29",
        flavor: "social"
      },
      {
        id: "err-aux-20",
        stem: "Carbon dioxide does absorbs infrared radiation, contributing to the greenhouse effect on Earth. Find the redundant word: ___",
        options: ["does", "absorbs", "contributing", "greenhouse"],
        answer: "does",
        explanation: "'Does absorbs' is ungrammatical; 'does' requires the base form 'absorb', making 'does' redundant with the inflected 'absorbs'.",
        fullExplanation: "The emphatic auxiliary 'does' must be followed by the bare infinitive: 'carbon dioxide does absorb'. Since 'absorbs' is already correctly inflected for third-person singular, adding 'does' creates double-marking. Remove 'does' to keep 'absorbs', or use 'does absorb' for emphasis. 'Contributing' and 'greenhouse' are correctly used.",
        source: "Swan, PEU (4e), §147",
        flavor: "science"
      },
      {
        id: "err-aux-21",
        stem: "Agatha Christie was able could write mystery plots of remarkable intricacy and surprise. Find the redundant word: ___",
        options: ["could", "was", "able", "write"],
        answer: "could",
        explanation: "'Was able could write' stacks two ability expressions; 'could' is the redundant one.",
        fullExplanation: "'Was able to write' is a complete ability expression. Inserting 'could' between 'able' and 'write' creates an ungrammatical combination. Either 'was able to write' or 'could write' is correct alone; 'could' in this position is the redundant auxiliary. 'Write' correctly follows as the base-form verb.",
        source: "Murphy, EGU (4e), Unit 29",
        flavor: "personalities"
      },
      {
        id: "err-aux-22",
        stem: "The moon landing of 1969 had has been called the greatest technological achievement of the century. Find the redundant word: ___",
        options: ["had", "has", "been", "called"],
        answer: "had",
        explanation: "'Had has been called' stacks past perfect and present perfect auxiliaries; 'had' is the redundant auxiliary.",
        fullExplanation: "'Has been called' is a correct present perfect passive. Adding 'had' before 'has' creates an ungrammatical double-auxiliary structure. The context does not require past perfect here; 'has been called' covers the ongoing judgment of history. Remove 'had' to leave the grammatical form.",
        source: "Murphy, EGU (4e), Unit 21",
        flavor: "history"
      },
      {
        id: "err-aux-23",
        stem: "The new employee didn't used to arrive late, but it has become a habit recently. Find the redundant word: ___",
        options: ["didn't", "used", "become", "recently"],
        answer: "didn't",
        explanation: "'Didn't used to' is incorrect; 'used to' does not require 'didn't' before it — 'didn't' is the redundant auxiliary.",
        fullExplanation: "The negative of 'used to' is either 'didn't use to' (informal) or 'never used to'. Here 'used to' already carries the past habitual meaning; placing 'didn't' before 'used' while keeping the full 'used to' creates a double-negative error. The correct form is simply 'used not to' or 'didn't use to arrive'. 'Become' and 'recently' are correctly used.",
        source: "Murphy, EGU (4e), Unit 35",
        flavor: "social"
      },
      {
        id: "err-aux-24",
        stem: "Migratory birds can are able to navigate thousands of kilometres using the Earth's magnetic field. Find the redundant word: ___",
        options: ["are", "can", "able", "using"],
        answer: "are",
        explanation: "'Can are able to' stacks two ability structures; 'are' is the redundant auxiliary.",
    ...
    tasks: [
      {
        ...
        options: ["into", "every", "before", "continue"],
        answer: "into",
      ...
      },
      {
        ...
        options: ["about", "during", "harsh", "letters"],
        answer: "about",
      ...
      },
      {
        ...
        options: ["about", "to", "during", "morning"],
        answer: "about",
      ...
      {
        id: "err-prep-13",
        stem: "Leonardo da Vinci often contemplated about the nature of water and its movement in rivers. Find the redundant word: ___",
        options: ["about", "often", "nature", "movement"],
        answer: "about",
        explanation: "'Contemplate' is transitive and takes no preposition; 'about' after it is redundant.",
        fullExplanation: "The verb 'contemplate' takes a direct object without a preposition: 'contemplated the nature'. 'Contemplate about' adds a spurious preposition. 'Often', 'nature', and 'movement' are all correctly used in the sentence.",
        source: "Swan, PEU (4e), §185",
        flavor: "personalities"
      },
      {
        id: "err-prep-14",
        stem: "During the Crusades, knights from Western Europe travelled to reached the Holy Land on long campaigns. Find the redundant word: ___",
        options: ["to", "During", "from", "on"],
        answer: "to",
        explanation: "'Travelled to reached' is redundant; the motion verb 'travelled' already implies direction, making 'to' before 'reached' superfluous.",
        fullExplanation: "'Travelled … to the Holy Land' and 'reached the Holy Land' are two separate correct constructions. Combining them as 'travelled to reached' is a double-motion redundancy. The preposition 'to' is the intrusive element. 'During', 'from', and 'on' are all correctly used.",
        source: "Swan, PEU (4e), §185",
        flavor: "history"
      },
      {
        id: "err-prep-15",
        stem: "Could you please describe to me about the problem you experienced with your order? Find the redundant word: ___",
        options: ["about", "please", "to", "with"],
        answer: "about",
        explanation: "'Describe' takes a direct object; 'about' after 'describe' is a redundant preposition.",
        fullExplanation: "The verb 'describe' is transitive and takes a direct object: 'describe the problem to me'. Adding 'about' creates 'describe about', which is a common learner error. 'Please', 'to', and 'with' are all correctly used.",
        source: "Swan, PEU (4e), §185",
        flavor: "social"
      },
      {
        id: "err-prep-16",
        stem: "Water evaporates up into the atmosphere when heated by solar radiation at the surface. Find the redundant word: ___",
        options: ["up", "into", "by", "at"],
        answer: "up",
        explanation: "'Evaporates up' is redundant; 'evaporate' already implies upward movement into the atmosphere.",
        fullExplanation: "The verb 'evaporate' inherently describes the process of a liquid converting to gas and rising, so 'up' adds nothing. 'Evaporates into the atmosphere' is the correct form. 'Into', 'by', and 'at' are all correctly placed.",
        source: "Swan, PEU (4e), §185",
        flavor: "science"
      },
      {
        id: "err-prep-17",
        stem: "Roger Federer mentioned about his retirement plans only after winning his final match at the Laver Cup. Find the redundant word: ___",
        options: ["about", "his", "only", "after"],
        answer: "about",
        explanation: "'Mention' is transitive; 'about' after it is a redundant preposition.",
        fullExplanation: "'Mention' takes a direct object without 'about': 'mentioned his retirement plans'. 'Mention about' is a common learner error. 'His', 'only', and 'after' are all correctly used in the sentence.",
        source: "Swan, PEU (4e), §185",
        flavor: "personalities"
      },
      {
        id: "err-prep-18",
        stem: "Napoleon Bonaparte rose up to become Emperor of France after the turmoil of the Revolution. Find the redundant word: ___",
        options: ["up", "to", "after", "of"],
        answer: "up",
        explanation: "'Rose up to become' is redundant; 'rose to become' is the standard phrase meaning to advance to a rank.",
        fullExplanation: "'Rise to become' is the idiomatic English phrase meaning to advance through the ranks to a position. 'Rose up' means to rebel, which changes the meaning. 'Up' is therefore the redundant particle here. 'To', 'after', and 'of' are all correctly used.",
        source: "Swan, PEU (4e), §185",
        flavor: "history"
      },
      {
        id: "err-prep-19",
        stem: "My neighbour always phones up me whenever she needs help with her computer. Find the redundant word: ___",
        options: ["up", "always", "whenever", "with"],
        answer: "up",
        explanation: "'Phone up me' is ungrammatical; when the object is a pronoun, the particle cannot separate — 'phones me' is correct.",
        fullExplanation: "With separable phrasal verbs like 'phone up', when the object is a pronoun, the particle must follow the pronoun: 'phones me up', not 'phones up me'. In standard British English, 'phones me' is also perfectly correct, making 'up' the redundant element in this position. 'Always', 'whenever', and 'with' are correctly used.",
        source: "Murphy, EGU (4e), Unit 134",
        flavor: "social"
      },
      {
        id: "err-prep-20",
        stem: "Each winter, thousands of monarch butterflies migrate to southwards to warmer regions in Mexico. Find the redundant word: ___",
        options: ["to", "Each", "thousands", "in"],
        answer: "to",
        explanation: "'Migrate to southwards' repeats directional meaning; the first 'to' before 'southwards' is redundant.",
        fullExplanation: "'Southwards' is already a directional adverb indicating the direction of migration. Adding 'to' before it creates a redundant preposition. The correct form is either 'migrate southwards to Mexico' or 'migrate to warmer regions'. 'Each', 'thousands', and 'in' are all correctly used.",
        source: "Swan, PEU (4e), §185",
        flavor: "science"
      },
      {
        id: "err-prep-21",
        stem: "Rosalind Franklin contributed to greatly to our understanding of the structure of DNA. Find the redundant word: ___",
        options: ["to", "greatly", "understanding", "of"],
        answer: "to",
        explanation: "'Contributed to greatly to' repeats the preposition 'to'; the first 'to' is redundant.",
        fullExplanation: "The correct construction is 'contributed greatly to our understanding'. Having 'to' both before 'greatly' and before 'our' creates a doubled preposition error. The first 'to' (before 'greatly') is the redundant one. 'Greatly', 'understanding', and 'of' are all correctly used.",
        source: "Swan, PEU (4e), §185",
        flavor: "personalities"
      },
      {
        id: "err-prep-22",
        stem: "The Berlin Blockade of 1948 prevented supplies from reaching into West Berlin by road or rail. Find the redundant word: ___",
        options: ["into", "from", "by", "or"],
        answer: "into",
        explanation: "'Reaching into' is redundant; 'reach' already implies arriving at a destination without 'into'.",
        fullExplanation: "The verb 'reach' is transitive and takes a direct object without 'into': 'reaching West Berlin'. 'Reaching into' adds a superfluous preposition. 'From', 'by', and 'or' are all correctly placed.",
        source: "Swan, PEU (4e), §185",
        flavor: "history"
      },
      {
        id: "err-prep-23",
        stem: "My doctor advised me to reduce of the amount of salt in my daily diet. Find the redundant word: ___",
        options: ["of", "me", "the", "in"],
        answer: "of",
        explanation: "'Reduce of the amount' is wrong; 'reduce' is transitive and takes no preposition.",
        fullExplanation: "The verb 'reduce' takes a direct object directly: 'reduce the amount'. 'Reduce of' is a learner error adding a superfluous preposition. 'Me', 'the', and 'in' are all correctly used in the sentence.",
        source: "Swan, PEU (4e), §185",
        flavor: "social"
      },
      {
        id: "err-prep-24",
        stem: "Astronomers must carefully observe of the sky over many nights before reporting a new discovery. Find the redundant word: ___",
        options: ["of", "must", "over", "before"],
        answer: "of",
        explanation: "'Observe of the sky' is wrong; 'observe' is transitive and takes no preposition.",
  ...
  "err-art": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["the", "ancient", "carry", "long"],
        answer: "the",
      ...
      },
      {
        ...
        options: ["a", "The", "the", "approximately"],
        answer: "a",
      ...
      {
        id: "err-art-13",
        stem: "Mark Twain spent the most of his childhood near the Mississippi River, which inspired his greatest novels. Find the redundant word: ___",
        options: ["the", "most", "his", "greatest"],
        answer: "the",
        explanation: "The correct phrase is 'most of his childhood', not 'the most of'; 'the' before 'most' is redundant here.",
        fullExplanation: "'Most of' as a quantifier does not take a definite article. 'The most' is used only for superlatives (the most talented). 'The' before 'most' in this context is superfluous. 'Most', 'his', and 'greatest' are all correctly used.",
        source: "Murphy, EGU (4e), Unit 80",
        flavor: "personalities"
      },
      {
        id: "err-art-14",
        stem: "During a Medieval times, most people in Europe lived in small agricultural villages. Find the redundant word: ___",
        options: ["a", "the", "most", "small"],
        answer: "a",
        explanation: "'During a Medieval times' is wrong; the plural noun 'times' takes no indefinite article here.",
        fullExplanation: "The indefinite article 'a' cannot precede a plural noun. The correct form is 'During Medieval times' or 'During the Medieval period'. 'A Medieval times' is ungrammatical. 'The', 'most', and 'small' are all correctly used.",
        source: "Murphy, EGU (4e), Unit 67",
        flavor: "history"
      },
      {
        id: "err-art-15",
        stem: "She went to the hospital last night and came back the home very late in the morning. Find the redundant word: ___",
        options: ["the", "to", "back", "in"],
        answer: "the",
        explanation: "'Came back the home' is wrong; 'home' as a destination takes zero article: 'came back home'.",
        fullExplanation: "Fixed expressions of movement like 'go home', 'come home', and 'stay home' use zero article. Adding 'the' before 'home' turns it into a specific building rather than the idiomatic destination. 'To', 'back', and 'in' are all correctly used.",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "social"
      },
      {
      ...
      {
        id: "err-art-17",
        stem: "Charles Darwin is regarded as a most influential naturalist in the history of biology. Find the redundant word: ___",
        options: ["a", "as", "in", "the"],
        answer: "a",
        explanation: "Superlative 'most influential' requires the definite article 'the', not 'a'; 'a' is redundant.",
        fullExplanation: "Superlatives must be preceded by 'the': 'the most influential naturalist'. 'A' is the indefinite article and cannot precede a superlative. The sentence should read 'regarded as the most influential'. 'As', 'in', and the final 'the' are correctly used.",
        source: "Murphy, EGU (4e), Unit 67",
        flavor: "personalities"
      },
      {
        id: "err-art-18",
        stem: "The ancient Greek soldiers were the expected to train every day from a young age. Find the redundant word: ___",
        options: ["the", "ancient", "every", "young"],
        answer: "the",
        explanation: "'Were expected' is correct; 'the' between 'were' and 'expected' is a redundant article.",
        fullExplanation: "The passive construction 'were expected to train' requires no article between the auxiliary 'were' and the past participle 'expected'. Inserting 'the' breaks the passive structure. 'Ancient', 'every', and 'young' are all correctly used.",
        source: "Murphy, EGU (4e), Unit 67",
        flavor: "history"
      },
      {
        id: "err-art-19",
        stem: "My colleague goes to the church every Sunday morning with her whole family. Find the redundant word: ___",
        options: ["the", "every", "whole", "Sunday"],
        answer: "the",
        explanation: "'Go to church' is a fixed zero-article phrase meaning to attend a religious service; 'the' before 'church' is redundant.",
        fullExplanation: "Fixed institutional expressions like 'go to church', 'go to school', and 'go to hospital' use zero article when referring to the purpose rather than the building. 'Goes to the church' implies visiting a specific building, which is not the intended meaning here. Remove 'the' to leave the idiomatic 'goes to church'. 'Every', 'whole', and 'Sunday' are correctly used.",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "social"
      },
      {
      ...
      {
        id: "err-art-21",
        stem: "Isaac Newton wrote the over two hundred thousand words on alchemy during his lifetime. Find the redundant word: ___",
        options: ["the", "over", "on", "during"],
        answer: "the",
        explanation: "'Over two hundred thousand' is a quantifying phrase; 'the' before it is a redundant article.",
        fullExplanation: "When 'over' is used as a quantifier meaning 'more than', it does not take a preceding definite article: 'wrote over two hundred thousand words'. Inserting 'the' before 'over' is redundant. 'Over', 'on', and 'during' are all correctly used.",
        source: "Murphy, EGU (4e), Unit 67",
        flavor: "personalities"
      },
      {
      ...
      {
        id: "err-art-23",
        stem: "The manager told us to go to the bed early the night before the important interview. Find the redundant word: ___",
        options: ["the", "early", "before", "important"],
        answer: "the",
        explanation: "'Go to bed' is a fixed zero-article phrase; 'the' before 'bed' is redundant.",
        fullExplanation: "Fixed expressions like 'go to bed', 'go to school', and 'go to work' use zero article. Adding 'the' before 'bed' turns it into a specific piece of furniture rather than the idiomatic activity of sleeping. Remove 'the' (before 'bed') to leave the correct 'go to bed'. 'Early', 'before', and 'important' are correctly used.",
        source: "Murphy, EGU (4e), Unit 75",
        flavor: "social"
      },
      {
        id: "err-art-24",
        stem: "The sharks have survived for more than four hundred million years, outlasting many mass extinctions. Find the redundant word: ___",
        options: ["The", "for", "than", "many"],
        answer: "The",
        explanation: "Generic reference to a species uses zero article; 'The' before 'sharks' as a class is redundant.",
  ...
  "err-pron": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["she", "always", "without", "asking"],
        answer: "she",
      ...
      },
      {
        ...
        options: ["it", "The", "changed", "European"],
        answer: "it",
      ...
      },
      {
        ...
        options: ["they", "very", "typically", "each"],
        answer: "they",
      ...
      },
      {
        ...
        options: ["he", "five", "collecting", "around"],
        answer: "he",
      ...
      {
        id: "err-pron-13",
        stem: "Marie Curie she won the Nobel Prize in Chemistry in 1911, making her the first person to win it twice. Find the redundant word: ___",
        options: ["she", "the", "first", "twice"],
        answer: "she",
        explanation: "'Marie Curie she won' has the redundant pronoun 'she' after the proper noun subject.",
        fullExplanation: "In English, a subject noun and a co-referential subject pronoun cannot both occupy the subject slot in the same clause: 'Marie Curie won'. Using both 'Marie Curie' and 'she' creates a double-subject error. 'The', 'first', and 'twice' are all correctly used.",
        source: "Swan, PEU (4e), §423",
        flavor: "personalities"
      },
      {
        id: "err-pron-14",
        stem: "The Magna Carta it was signed at Runnymede in 1215 and limited the power of the king. Find the redundant word: ___",
        options: ["it", "The", "at", "limited"],
        answer: "it",
        explanation: "'The Magna Carta it was signed' has the redundant pronoun 'it' shadowing the subject.",
        fullExplanation: "The noun phrase 'The Magna Carta' already fills the subject position; the pronoun 'it' directly after it is redundant. English requires one subject per clause. The sentence should read 'The Magna Carta was signed'. 'The', 'at', and 'limited' are all correctly used.",
        source: "Swan, PEU (4e), §423",
        flavor: "history"
      },
      {
        id: "err-pron-15",
        stem: "Our head teacher she always encourages students to participate in after-school activities. Find the redundant word: ___",
        options: ["she", "always", "in", "after-school"],
        answer: "she",
        explanation: "'Our head teacher she' has a redundant pronoun; the noun phrase is the subject already.",
        fullExplanation: "English does not allow a resumptive pronoun to repeat the subject in the same clause. 'Our head teacher always encourages' is the correct structure. 'She' after the noun phrase is superfluous. 'Always', 'in', and 'after-school' are all correctly used.",
        source: "Swan, PEU (4e), §423",
        flavor: "social"
      },
      {
        id: "err-pron-16",
        stem: "The International Space Station it orbits the Earth at an altitude of approximately four hundred kilometres. Find the redundant word: ___",
        options: ["it", "The", "at", "approximately"],
        answer: "it",
        explanation: "'The International Space Station it orbits' has the redundant pronoun 'it' duplicating the subject.",
        fullExplanation: "The full noun phrase 'The International Space Station' is the subject; inserting 'it' before the verb creates a double-subject. The sentence should read 'The International Space Station orbits the Earth'. 'The', 'at', and 'approximately' are all correctly placed.",
        source: "Swan, PEU (4e), §423",
        flavor: "science"
      },
      {
        id: "err-pron-17",
        stem: "Nikola Tesla he filed more than three hundred patents during his extraordinary career as an inventor. Find the redundant word: ___",
        options: ["he", "more", "during", "extraordinary"],
        answer: "he",
        explanation: "'Nikola Tesla he filed' has the redundant pronoun 'he' duplicating the proper-noun subject.",
        fullExplanation: "A proper noun and a co-referential pronoun cannot both function as subject in the same clause. 'Nikola Tesla filed more than three hundred patents' is correct. 'He' is redundant. 'More', 'during', and 'extraordinary' are all correctly used.",
        source: "Swan, PEU (4e), §423",
        flavor: "personalities"
      },
      {
        id: "err-pron-18",
        stem: "The D-Day landings it turned the tide of the Second World War in favour of the Allied forces. Find the redundant word: ___",
        options: ["it", "The", "of", "favour"],
        answer: "it",
        explanation: "'The D-Day landings it turned' has the pronoun 'it' redundantly echoing the plural subject.",
        fullExplanation: "The noun phrase 'The D-Day landings' is the complete subject. Inserting the pronoun 'it' before 'turned' creates a double-subject error and also mismatches number (plural subject, singular pronoun). The sentence should read 'The D-Day landings turned the tide'. 'The', 'of', and 'favour' are all correctly used.",
        source: "Swan, PEU (4e), §423",
        flavor: "history"
      },
      {
        id: "err-pron-19",
        stem: "The new receptionist she greeted every visitor warmly and offered them a cup of tea. Find the redundant word: ___",
        options: ["she", "every", "warmly", "them"],
        answer: "she",
        explanation: "'The new receptionist she greeted' has the redundant pronoun 'she' echoing the noun subject.",
        fullExplanation: "The noun phrase 'The new receptionist' is the complete subject; the pronoun 'she' directly after it is redundant. English allows only one subject element per clause. 'Every', 'warmly', and 'them' are all correctly used in the sentence.",
        source: "Swan, PEU (4e), §423",
        flavor: "social"
      },
      {
        id: "err-pron-20",
        stem: "Photosynthesis it converts light energy into chemical energy stored in the bonds of glucose molecules. Find the redundant word: ___",
        options: ["it", "into", "stored", "bonds"],
        answer: "it",
        explanation: "'Photosynthesis it converts' has the redundant pronoun 'it' duplicating the noun subject.",
        fullExplanation: "The noun 'Photosynthesis' is the subject; adding 'it' immediately after creates an illegal double-subject. The sentence should read 'Photosynthesis converts light energy'. 'Into', 'stored', and 'bonds' are all correctly used.",
        source: "Swan, PEU (4e), §423",
        flavor: "science"
      },
      {
        id: "err-pron-21",
        stem: "Stephen Hawking he transformed our understanding of black holes and the origins of the universe. Find the redundant word: ___",
        options: ["he", "our", "origins", "universe"],
        answer: "he",
        explanation: "'Stephen Hawking he transformed' has the redundant pronoun 'he' after the proper noun subject.",
        fullExplanation: "A subject noun phrase and a co-referential pronoun cannot co-occur as subject in the same clause. 'Stephen Hawking transformed our understanding' is correct. 'He' is redundant. 'Our', 'origins', and 'universe' are all correctly used.",
        source: "Swan, PEU (4e), §423",
        flavor: "personalities"
      },
      {
        id: "err-pron-22",
        stem: "The Eiffel Tower it was designed by Gustave Eiffel and completed in time for the 1889 World's Fair. Find the redundant word: ___",
        options: ["it", "The", "by", "for"],
        answer: "it",
        explanation: "'The Eiffel Tower it was designed' has a redundant pronoun 'it' after the long noun phrase.",
        fullExplanation: "The noun phrase 'The Eiffel Tower' is the full subject. Inserting 'it' before the verb is a resumptive-pronoun error. The sentence should read 'The Eiffel Tower was designed by Gustave Eiffel'. 'The', 'by', and 'for' are all correctly used.",
        source: "Swan, PEU (4e), §423",
        flavor: "history"
      },
      {
        id: "err-pron-23",
        stem: "My manager he told everyone to submit their expense claims before the end of the month. Find the redundant word: ___",
        options: ["he", "everyone", "their", "end"],
        answer: "he",
        explanation: "'My manager he told' has the redundant pronoun 'he' immediately after the noun-phrase subject.",
        fullExplanation: "English does not allow a resumptive pronoun to duplicate the noun-phrase subject within the main clause. 'My manager told everyone' is correct. 'Everyone', 'their', and 'end' are all correctly placed in the sentence.",
        source: "Swan, PEU (4e), §423",
        flavor: "social"
      },
      {
        id: "err-pron-24",
        stem: "The human immune system it identifies and destroys foreign pathogens that enter the body. Find the redundant word: ___",
        options: ["it", "The", "destroys", "enter"],
        answer: "it",
        explanation: "'The human immune system it identifies' has the redundant pronoun 'it' shadowing the subject.",
  ...
  "err-int": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["completely", "totally", "unexpected", "discovery"],
        answer: "completely",
      ...
      },
      {
        ...
        options: ["really", "truly", "amazing", "standing"],
        answer: "really",
      ...
      },
      {
        ...
        options: ["extremely", "incredibly", "high", "millions"],
        answer: "extremely",
      ...
      },
      {
        ...
        options: ["very", "utterly", "dedicated", "fitness"],
        answer: "very",
      ...
      },
      {
        ...
        options: ["deeply", "profoundly", "significant", "history"],
        answer: "deeply",
      ...
      },
      {
        ...
        options: ["quite", "fairly", "surprised", "early"],
        answer: "quite",
      ...
      },
      {
        ...
        options: ["highly", "extremely", "dangerous", "around"],
        answer: "highly",
      ...
      },
      {
        ...
        options: ["most", "certainly", "undoubtedly", "greatest"],
        answer: "most",
      ...
      },
      {
        ...
        options: ["simply", "absolutely", "pivotal", "invention"],
        answer: "simply",
      ...
      },
      {
        ...
        options: ["very", "so", "extremely", "overtime"],
        answer: "very",
      ...
      },
      {
        ...
        options: ["totally", "completely", "below", "around"],
        answer: "totally",
      ...
      {
        id: "err-int-13",
        stem: "Ada Lovelace was very absolutely exceptional in her ability to grasp abstract mathematical concepts. Find the redundant word: ___",
        options: ["very", "absolutely", "exceptional", "abstract"],
        answer: "very",
        explanation: "'Absolutely' is a maximiser; 'very' before 'absolutely' is redundant.",
        fullExplanation: "'Absolutely' is an extreme intensifier used with strong adjectives like 'exceptional' instead of 'very'. Pairing 'very' with 'absolutely' is redundant because 'absolutely' already expresses the maximum degree. Use either 'very exceptional' or 'absolutely exceptional'. 'Abstract' is correctly used.",
        source: "Swan, PEU (4e), §18",
        flavor: "personalities"
      },
      {
        id: "err-int-14",
        stem: "The fall of Constantinople in 1453 was entirely completely decisive for the end of the Byzantine Empire. Find the redundant word: ___",
        options: ["entirely", "completely", "decisive", "Byzantine"],
        answer: "entirely",
        explanation: "'Entirely completely' stacks two synonymous maximisers; 'entirely' is redundant before 'completely'.",
        fullExplanation: "'Entirely' and 'completely' are both absolute degree adverbs with the same function. Placing both before 'decisive' is redundant. Either 'entirely decisive' or 'completely decisive' is sufficient. 'Decisive' and 'Byzantine' are correctly used.",
        source: "Swan, PEU (4e), §18",
        flavor: "history"
      },
      {
        id: "err-int-15",
        stem: "The hotel receptionist was really truly helpful and found us a room at very short notice. Find the redundant word: ___",
        options: ["really", "truly", "helpful", "short"],
        answer: "really",
        explanation: "'Really truly' pairs two equivalent boosters; 'really' is the redundant intensifier.",
        fullExplanation: "'Really' and 'truly' both intensify adjectives like 'helpful'. Using both together is a redundant stacking of degree adverbs. Either 'really helpful' or 'truly helpful' expresses the idea adequately. 'Helpful' and 'short' are both correctly used.",
        source: "Swan, PEU (4e), §18",
        flavor: "social"
      },
      {
        id: "err-int-16",
        stem: "The pressure at the bottom of the Mariana Trench is extremely incredibly intense, exceeding 1,000 atmospheres. Find the redundant word: ___",
        options: ["extremely", "incredibly", "intense", "exceeding"],
        answer: "extremely",
        explanation: "'Extremely incredibly' stacks two intensifiers; 'extremely' is redundant before 'incredibly'.",
        fullExplanation: "'Extremely' and 'incredibly' are both degree adverbs modifying 'intense'. Only one is needed. 'Incredibly intense' is the more natural collocation; 'extremely' adds nothing and creates redundancy. 'Intense' and 'exceeding' are correctly used.",
        source: "Swan, PEU (4e), §18",
        flavor: "science"
      },
      {
        id: "err-int-17",
        stem: "Maya Angelou was very utterly fearless in addressing the injustices she had experienced in her life. Find the redundant word: ___",
        options: ["very", "utterly", "fearless", "addressing"],
        answer: "very",
        explanation: "'Utterly' is a maximiser incompatible with 'very'; 'very' before 'utterly' is redundant.",
        fullExplanation: "'Utterly' functions as an absolute maximiser similar to 'absolutely' or 'completely', replacing the graded intensifier 'very'. Placing 'very' before 'utterly' is redundant. Use 'utterly fearless' or 'very fearless'. 'Fearless' and 'addressing' are correctly used.",
        source: "Swan, PEU (4e), §18",
        flavor: "personalities"
      },
      {
        id: "err-int-18",
        stem: "The signing of the Treaty of Versailles in 1919 was deeply profoundly controversial among historians and diplomats. Find the redundant word: ___",
        options: ["deeply", "profoundly", "controversial", "historians"],
        answer: "deeply",
        explanation: "'Deeply profoundly' stacks two synonymous intensifiers; 'deeply' is redundant before 'profoundly'.",
        fullExplanation: "'Deeply' and 'profoundly' both intensify 'controversial' with the same meaning. Using both is pleonastic. Either 'deeply controversial' or 'profoundly controversial' is appropriate. 'Controversial' and 'historians' are correctly used.",
        source: "Swan, PEU (4e), §18",
        flavor: "history"
      },
      {
        id: "err-int-19",
        stem: "I was quite fairly disappointed when the concert was cancelled due to heavy rain. Find the redundant word: ___",
        options: ["quite", "fairly", "disappointed", "heavy"],
        answer: "quite",
        explanation: "'Quite fairly' stacks two similar scalar adverbs; 'quite' is redundant before 'fairly'.",
        fullExplanation: "'Quite' and 'fairly' both signal a moderate degree of an adjective. Using them together is redundant. 'Fairly disappointed' or 'quite disappointed' is sufficient. 'Disappointed' and 'heavy' are correctly used in the sentence.",
        source: "Swan, PEU (4e), §18",
        flavor: "social"
      },
      {
        id: "err-int-20",
        stem: "Hurricane-force winds can be highly extremely destructive and must be forecast well in advance. Find the redundant word: ___",
        options: ["highly", "extremely", "destructive", "advance"],
        answer: "highly",
        explanation: "'Highly extremely' stacks two intensifiers; 'highly' is redundant before 'extremely'.",
        fullExplanation: "'Highly' and 'extremely' are both intensifying adverbs. Used together before 'destructive' they are redundant. 'Extremely destructive' is the standard collocation; 'highly destructive' is also acceptable, but combining both is unnecessary. 'Destructive' and 'advance' are correctly used.",
        source: "Swan, PEU (4e), §18",
        flavor: "science"
      },
      {
        id: "err-int-21",
        stem: "Galileo was most certainly undoubtedly one of the greatest astronomers in the history of science. Find the redundant word: ___",
        options: ["most", "certainly", "undoubtedly", "greatest"],
        answer: "most",
        explanation: "'Most certainly undoubtedly' contains three stacked adverbs; 'most' is the redundant intensifier.",
        fullExplanation: "'Certainly' and 'undoubtedly' already express the same high degree of confidence; adding 'most' before 'certainly' is an extra redundant layer. Either 'certainly one of' or 'undoubtedly one of' is sufficient. 'Greatest' is correctly used as a superlative.",
        source: "Swan, PEU (4e), §18",
        flavor: "personalities"
      },
      {
        id: "err-int-22",
        stem: "The discovery of penicillin was simply absolutely pivotal to the development of modern medicine. Find the redundant word: ___",
        options: ["simply", "absolutely", "pivotal", "development"],
        answer: "simply",
        explanation: "'Simply absolutely' pairs two incompatible boosters; 'simply' is redundant before 'absolutely'.",
        fullExplanation: "'Absolutely' is a maximising adverb for adjectives like 'pivotal'. 'Simply' as an intensifier belongs to a different register and overlaps in function. The combination 'simply absolutely' is redundant. 'Absolutely pivotal' stands alone. 'Pivotal' and 'development' are correctly used.",
        source: "Swan, PEU (4e), §18",
        flavor: "history"
      },
      {
        id: "err-int-23",
        stem: "The job market is so very extremely competitive that candidates need to stand out from the crowd. Find the redundant word: ___",
        options: ["very", "so", "extremely", "competitive"],
        answer: "very",
        explanation: "'So very extremely' stacks three degree adverbs; 'very' in the middle is the most redundant.",
        fullExplanation: "'So extremely competitive' already conveys high intensity; inserting 'very' between 'so' and 'extremely' adds nothing and over-stacks adverbs. 'So' is the head intensifier here, making 'very' redundant. 'So', 'extremely', and 'competitive' are all correctly retained.",
        source: "Swan, PEU (4e), §18",
        flavor: "social"
      },
      {
        id: "err-int-24",
        stem: "The surface of Venus is totally completely inhospitable, with temperatures exceeding four hundred degrees Celsius. Find the redundant word: ___",
        options: ["totally", "completely", "exceeding", "four"],
        answer: "totally",
        explanation: "'Totally completely' stacks two synonymous maximisers; 'totally' is redundant before 'completely'.",
  ...
  "owg-fixed": {
    id: "owg-fixed",
    name: "Fixed phrases & collocations",
    canonicalSubId: "cs-owg-fixed",
    canonicalTopicId: "one-word-gap",
    tasks: [
      {
        id: "owg-fixed-01",
      ...
      {
        id: "owg-fixed-13",
        stem: "Frida Kahlo often painted ___ person, producing more than fifty self-portraits during her career.",
        options: ["in", "on", "by", "at"],
        answer: "in",
        explanation: "'In person' is the fixed phrase meaning 'physically present, in face-to-face context'.",
        fullExplanation: "'In person' is a fixed collocation. 'On person' is not idiomatic. 'By person' is not a standard phrase. 'At person' does not exist as a set expression.",
        source: "Swan, PEU (4e), §282",
        flavor: "personalities"
      },
      {
        id: "owg-fixed-14",
        stem: "After centuries of foreign rule, the country was ___ last free to govern itself in the twentieth century.",
        options: ["at", "in", "on", "by"],
        answer: "at",
        explanation: "'At last' is the fixed phrase meaning 'finally, after a long time'.",
        fullExplanation: "'At last' is a fixed phrase meaning 'finally, after a long period of waiting'. 'In last' is not idiomatic. 'On last' does not exist as a set phrase. 'By last' is not used in this sense.",
        source: "Swan, PEU (4e), §282",
        flavor: "history"
      },
      {
        id: "owg-fixed-15",
        stem: "The delivery driver spilled the package ___ purpose just to film a funny video for social media.",
        options: ["on", "in", "by", "at"],
        answer: "on",
        explanation: "'On purpose' is the fixed phrase meaning 'deliberately'.",
        fullExplanation: "'On purpose' is the established collocation meaning 'intentionally'. 'In purpose' is not standard English. 'By purpose' is not a recognised fixed expression. 'At purpose' does not exist.",
        source: "Swan, PEU (4e), §282",
        flavor: "social"
      },
      {
        id: "owg-fixed-16",
        stem: "Two distant galaxies collided ___ chance, producing one of the largest observed mergers in the universe.",
        options: ["by", "at", "on", "in"],
        answer: "by",
        explanation: "'By chance' is the fixed phrase meaning 'accidentally, without planning'.",
        fullExplanation: "'By chance' is the fixed collocation meaning 'accidentally' or 'not by design'. 'At chance' is not standard. 'On chance' is used only in 'on the off chance' and not alone. 'In chance' does not exist as a fixed phrase.",
        source: "Swan, PEU (4e), §282",
        flavor: "science"
      },
      {
        id: "owg-fixed-17",
        stem: "Winston Churchill always insisted on meeting world leaders ___ person to ensure direct communication.",
        options: ["in", "by", "on", "at"],
        answer: "in",
        explanation: "'In person' is the fixed phrase meaning 'physically rather than via technology'.",
        fullExplanation: "'In person' means physically present for a face-to-face interaction. 'By person' is not a standard phrase. 'On person' is not idiomatic in this sense. 'At person' does not exist as a set expression.",
        source: "Swan, PEU (4e), §282",
        flavor: "personalities"
      },
      {
        id: "owg-fixed-18",
        stem: "The first transatlantic telegraph cable rarely transmitted messages ___ time due to signal interference.",
        options: ["on", "in", "at", "by"],
        answer: "on",
        explanation: "'On time' means 'at the scheduled moment, punctually'.",
        fullExplanation: "'On time' is the fixed phrase meaning 'punctually'. 'In time' means 'before it is too late', which changes the meaning. 'At time' is not standard. 'By time' is not idiomatic here.",
        source: "Swan, PEU (4e), §282",
        flavor: "history"
      },
      {
        id: "owg-fixed-19",
        stem: "We arrived at the airport just ___ time to check in before the gate closed for our flight.",
        options: ["in", "on", "at", "by"],
        answer: "in",
        explanation: "'In time' means 'before it is too late, with time to spare'.",
        fullExplanation: "'In time' means 'with enough time before something happens'. 'On time' means 'at the scheduled moment', not 'before it is too late'. 'At time' is not idiomatic. 'By time' is not a set phrase.",
        source: "Swan, PEU (4e), §282",
        flavor: "social"
      },
      {
        id: "owg-fixed-20",
        stem: "Experts recommend that emergency evacuation routes should be memorised ___ heart for quick response.",
        options: ["by", "in", "on", "at"],
        answer: "by",
        explanation: "'By heart' is the fixed phrase meaning 'from memory without notes'.",
        fullExplanation: "'By heart' is a fixed collocation meaning to know something entirely from memory. 'In heart' is not a standard phrase. 'On heart' does not exist. 'At heart' means 'fundamentally' or 'in one's character', which is unrelated.",
        source: "Swan, PEU (4e), §282",
        flavor: "science"
      },
      {
        id: "owg-fixed-21",
        stem: "Isaac Newton allegedly worked out his laws of gravity well ___ advance before publishing them in 1687.",
        options: ["in", "on", "at", "by"],
        answer: "in",
        explanation: "'In advance' is the fixed phrase meaning 'beforehand'.",
        fullExplanation: "'In advance' correctly means 'before the event or deadline'. 'On advance' is not a standard expression. 'At advance' is not used. 'By advance' does not exist as an idiom.",
        source: "Swan, PEU (4e), §282",
        flavor: "personalities"
      },
      {
        id: "owg-fixed-22",
        stem: "After years of setbacks, the archaeological team found the lost city ___ last in the dense jungle.",
        options: ["at", "in", "on", "by"],
        answer: "at",
        explanation: "'At last' is the fixed phrase meaning 'finally, after a long wait or effort'.",
        fullExplanation: "'At last' means 'finally, after a long period of effort or waiting'. 'In last' is not idiomatic. 'On last' does not exist as a set expression. 'By last' is not used with this meaning.",
        source: "Swan, PEU (4e), §282",
        flavor: "history"
      },
      {
        id: "owg-fixed-23",
        stem: "The children knocked over the plant ___ purpose to see how their parents would react.",
        options: ["on", "in", "at", "by"],
        answer: "on",
        explanation: "'On purpose' is the fixed phrase meaning 'deliberately, with intention'.",
        fullExplanation: "'On purpose' is the established collocation meaning 'intentionally'. 'In purpose' is not standard. 'At purpose' does not exist. 'By purpose' is not a recognised fixed phrase in English.",
        source: "Swan, PEU (4e), §282",
        flavor: "social"
      },
      {
        id: "owg-fixed-24",
        stem: "The two research teams met ___ chance at the same conference and decided to share their data.",
        options: ["by", "on", "in", "at"],
        answer: "by",
        explanation: "'By chance' is the fixed phrase meaning 'accidentally, not by design'.",
    ...
    tasks: [
      {
        ...
        options: ["nevertheless", "therefore", "moreover", "consequently"],
        answer: "nevertheless",
      ...
      },
      {
        ...
        options: ["consequently", "although", "however", "meanwhile"],
        answer: "consequently",
      ...
      },
      {
        ...
        options: ["consequently", "however", "although", "otherwise"],
        answer: "consequently",
      ...
      },
      {
        ...
        options: ["otherwise", "however", "moreover", "furthermore"],
        answer: "otherwise",
      ...
      },
      {
        ...
        options: ["moreover", "however", "otherwise", "nevertheless"],
        answer: "moreover",
      ...
      },
      {
        ...
        options: ["meanwhile", "therefore", "otherwise", "consequently"],
        answer: "meanwhile",
      ...
      },
      {
        ...
        options: ["therefore", "however", "although", "furthermore"],
        answer: "therefore",
      ...
      },
      {
        ...
        options: ["furthermore", "however", "otherwise", "nevertheless"],
        answer: "furthermore",
      ...
      {
        id: "owg-conn-13",
        stem: "Rosalind Franklin's crucial contribution to discovering DNA's structure was largely overlooked; ___, James Watson and Francis Crick received the Nobel Prize.",
        options: ["instead", "therefore", "moreover", "consequently"],
        answer: "instead",
        explanation: "'Instead' signals substitution — someone else received recognition in place of Franklin.",
        fullExplanation: "'Instead' signals that something happened in place of what might have been expected. Franklin was overlooked, and Watson and Crick took the prize instead of her being recognised. 'Therefore' implies a logical result; 'moreover' adds information; 'consequently' shows a direct consequence — none capture the substitution meaning.",
        source: "Swan, PEU (4e), §261",
        flavor: "personalities"
      },
      {
        id: "owg-conn-14",
        stem: "The Black Death killed approximately one third of Europe's population in the fourteenth century; ___, it dramatically altered the social and economic structure of the continent.",
        options: ["consequently", "although", "however", "meanwhile"],
        answer: "consequently",
        explanation: "'Consequently' links the social change as a direct result of the devastating death toll.",
        fullExplanation: "'Consequently' shows the logical outcome: because so many died, society was transformed. 'Although' introduces a concession. 'However' signals contrast, not cause-and-effect. 'Meanwhile' refers to parallel events, not results.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "history"
      },
      {
        id: "owg-conn-15",
        stem: "The supermarket was completely out of the product I needed; ___, I decided to order it online instead.",
        options: ["therefore", "however", "although", "furthermore"],
        answer: "therefore",
        explanation: "'Therefore' introduces the logical result of the product being unavailable.",
        fullExplanation: "'Therefore' introduces a conclusion that follows logically from the previous situation. 'However' would signal contrast, not consequence. 'Although' introduces a concessive clause. 'Furthermore' adds information rather than drawing a consequence.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "social"
      },
      {
        id: "owg-conn-16",
        stem: "The James Webb Space Telescope can detect galaxies from the early universe; ___, it can analyse the atmosphere of distant exoplanets.",
        options: ["moreover", "however", "otherwise", "nevertheless"],
        answer: "moreover",
        explanation: "'Moreover' adds a further impressive capability to the one already stated.",
        fullExplanation: "'Moreover' introduces an additional point that extends the previous one. 'However' would contrast the two capabilities, which is not intended. 'Otherwise' signals a conditional alternative. 'Nevertheless' signals contrast despite an obstacle.",
        source: "Swan, PEU (4e), §261",
        flavor: "science"
      },
      {
        id: "owg-conn-17",
        stem: "Vincent van Gogh sold almost nothing during his lifetime; ___, he is now considered one of the most influential painters in Western art.",
        options: ["nevertheless", "therefore", "moreover", "consequently"],
        answer: "nevertheless",
        explanation: "'Nevertheless' highlights his posthumous fame despite his obscurity in life.",
        fullExplanation: "'Nevertheless' introduces a concessive contrast: despite commercial failure in life, he became hugely famous. 'Therefore' would suggest failure caused fame, which is illogical. 'Moreover' adds without contrasting. 'Consequently' signals a direct logical result.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "personalities"
      },
      {
        id: "owg-conn-18",
        stem: "The Treaty of Versailles imposed severe reparations on Germany after World War I; ___, many historians argue it planted the seeds of World War II.",
        options: ["consequently", "however", "although", "otherwise"],
        answer: "consequently",
        explanation: "'Consequently' shows the punishing terms as a cause of future conflict.",
        fullExplanation: "'Consequently' shows that the harsh terms caused resentment that led to further conflict. 'However' would introduce a contrast where none is intended. 'Although' introduces a concession. 'Otherwise' signals an alternative condition.",
        source: "Swan, PEU (4e), §261",
        flavor: "history"
      },
      {
        id: "owg-conn-19",
        stem: "You must confirm your reservation at least 48 hours before arrival; ___, the hotel may give your room to another guest.",
        options: ["otherwise", "however", "moreover", "furthermore"],
        answer: "otherwise",
        explanation: "'Otherwise' signals the negative consequence if the condition is not met.",
        fullExplanation: "'Otherwise' introduces the alternative negative outcome if the condition is not satisfied. 'However' contrasts two facts but does not introduce a conditional threat. 'Moreover' and 'furthermore' add positive information, not a negative alternative.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "social"
      },
      {
        id: "owg-conn-20",
        stem: "The Amazon rainforest produces roughly twenty percent of the world's oxygen; ___, it is home to the greatest biodiversity of any ecosystem on Earth.",
        options: ["furthermore", "however", "otherwise", "nevertheless"],
        answer: "furthermore",
        explanation: "'Furthermore' adds another equally impressive fact about the rainforest.",
        fullExplanation: "'Furthermore' adds a second complementary point: not only does it produce oxygen, but it also harbours vast biodiversity. 'However' would introduce a contrast that is not intended. 'Otherwise' signals a negative alternative. 'Nevertheless' signals contrast despite an obstacle.",
        source: "Swan, PEU (4e), §261",
        flavor: "science"
      },
      {
        id: "owg-conn-21",
        stem: "Ada Lovelace worked in an era when women were excluded from scientific institutions; ___, she produced what many consider the world's first computer algorithm.",
        options: ["nevertheless", "therefore", "moreover", "consequently"],
        answer: "nevertheless",
        explanation: "'Nevertheless' signals her achievement despite severe social obstacles.",
        fullExplanation: "'Nevertheless' introduces a positive outcome despite a negative condition. 'Therefore' would wrongly suggest the exclusion caused her achievement. 'Moreover' adds without contrasting. 'Consequently' signals a direct result.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "personalities"
      },
      {
        id: "owg-conn-22",
        stem: "The ancient city of Pompeii was buried under volcanic ash in 79 AD; ___, archaeologists have been excavating it since the eighteenth century.",
        options: ["meanwhile", "therefore", "otherwise", "consequently"],
        answer: "meanwhile",
        explanation: "'Meanwhile' connects the ancient burial and the ongoing modern excavation across time.",
        fullExplanation: "'Meanwhile' connects two events occurring across different periods: the ancient burial and the ongoing modern excavation. 'Therefore' would wrongly suggest the burial caused the excavation as a logical conclusion. 'Otherwise' introduces a conditional alternative. 'Consequently' signals a direct result, which is too strong here.",
        source: "Swan, PEU (4e), §261",
        flavor: "history"
      },
      {
        id: "owg-conn-23",
        stem: "The train was running thirty minutes late; ___, my colleague and I decided to grab a coffee while we waited.",
        options: ["therefore", "however", "although", "furthermore"],
        answer: "therefore",
        explanation: "'Therefore' presents the coffee stop as the logical result of the long delay.",
        fullExplanation: "'Therefore' introduces a consequence: because the train was late, they had time to get coffee. 'However' signals contrast, not result. 'Although' introduces a concession. 'Furthermore' adds information rather than drawing a consequence.",
        source: "Murphy, EGU (4e), Unit 111",
        flavor: "social"
      },
      {
        id: "owg-conn-24",
        stem: "The human eye contains approximately one hundred and twenty million rod cells for low-light vision; ___, it has six to seven million cone cells for colour perception.",
        options: ["moreover", "however", "otherwise", "nevertheless"],
        answer: "moreover",
        explanation: "'Moreover' introduces a complementary additional fact about eye anatomy.",
  ...
  "w2s-poly": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["cut", "destroy", "block", "remove"],
        answer: "cut",
      ...
      },
      {
        ...
        options: ["result", "proof", "data", "score"],
        answer: "result",
      ...
      },
      {
        ...
        options: ["symphony", "concert", "opera", "recital"],
        answer: "symphony",
      ...
      },
      {
        ...
        options: ["empire", "state", "colony", "domain"],
        answer: "empire",
      ...
      },
      {
        ...
        options: ["reception", "welcome", "greeting", "entrance"],
        answer: "reception",
      ...
      },
      {
        ...
        options: ["layer", "sheet", "cover", "band"],
        answer: "layer",
      ...
      },
      {
        ...
        options: ["campaign", "attack", "strategy", "mission"],
        answer: "campaign",
      ...
      },
      {
        ...
        options: ["fix", "improve", "solve", "handle"],
        answer: "fix",
      ...
      {
        id: "w2s-poly-13",
        stem: "1) The artist mixed several colours on his ___ before applying them to the canvas.\n2) The palace is a fine ___ of baroque architecture from the eighteenth century.",
        options: ["palette", "canvas", "brush", "frame"],
        answer: "palette",
        explanation: "'Palette' means both an artist's colour-mixing board and a range or example of something.",
        fullExplanation: "'Palette' is polysemous: an artist's palette is the board on which paints are mixed, and a 'palette of architecture' means a fine example or display. 'Canvas' fits sentence 1 partially but not as the mixing surface; 'brush' and 'frame' fit neither sentence naturally as a single shared word.",
        source: "Swan, PEU (4e), §595",
        flavor: "personalities"
      },
      {
        id: "w2s-poly-14",
        stem: "1) The army decided to ___ the border crossing to prevent enemy reinforcements from arriving.\n2) The writer suffered a mental ___ and could not finish the final chapter of her novel.",
        options: ["block", "close", "seal", "stop"],
        answer: "block",
        explanation: "'Block' means to obstruct a physical passage and also to experience a mental creative barrier.",
        fullExplanation: "'Block' is polysemous: to block a border crossing means to obstruct it, and a mental block is an inability to think or create freely. 'Close' fits sentence 1 partly but not sentence 2. 'Seal' fits sentence 1 but not sentence 2. 'Stop' fits sentence 1 but not the noun form needed in sentence 2.",
        source: "Swan, PEU (4e), §595",
        flavor: "history"
      },
      {
        id: "w2s-poly-15",
        stem: "1) The ___ of the interview was set by the journalist, who started with the easiest questions.\n2) She set the ___ for the race and the other runners struggled to keep up.",
        options: ["pace", "tone", "speed", "order"],
        answer: "pace",
        explanation: "'Pace' means the tempo at which something proceeds and also the physical running speed.",
        fullExplanation: "'Pace' is polysemous: the pace of an interview is its speed and rhythm, and the pace of a race is the physical speed. 'Tone' fits sentence 1 loosely but not sentence 2. 'Speed' fits sentence 2 but not sentence 1 naturally. 'Order' fits neither sentence well.",
        source: "Swan, PEU (4e), §595",
        flavor: "social"
      },
      {
        id: "w2s-poly-16",
        stem: "1) Scientists discovered a new ___ of bacteria that thrives in extremely hot spring water.\n2) The professor published a new ___ of her influential textbook with three additional chapters.",
        options: ["strain", "type", "kind", "sort"],
        answer: "strain",
        explanation: "'Strain' means a biological variant and also a new version of a text.",
        fullExplanation: "'Strain' is polysemous: a strain of bacteria is a specific genetic variant, and a new strain (or edition) of a textbook is a new version. 'Type' and 'kind' fit sentence 1 partially but not sentence 2 in the same precise role. 'Sort' is too informal and fits neither sentence precisely.",
        source: "Swan, PEU (4e), §595",
        flavor: "science"
      },
      {
        id: "w2s-poly-17",
        stem: "1) Beethoven's Fifth Symphony opens with one of the most famous ___ in musical history.\n2) She received a short ___ from her editor asking her to revise the opening paragraph.",
        options: ["note", "phrase", "message", "signal"],
        answer: "note",
        explanation: "'Note' means both a single musical sound and a brief written message.",
        fullExplanation: "'Note' is polysemous: a musical note is a single pitch in a composition, and a note from an editor is a brief written message. 'Phrase' fits sentence 1 marginally but is not a single note; 'message' fits sentence 2 but not sentence 1; 'signal' fits neither sentence naturally as the shared word.",
        source: "Swan, PEU (4e), §595",
        flavor: "personalities"
      },
      {
        id: "w2s-poly-18",
        stem: "1) The Cold War created a deep ___ between the Eastern and Western blocs that lasted decades.\n2) There is a large ___ between what the government promised and what it actually delivered.",
        options: ["divide", "gap", "wall", "border"],
        answer: "divide",
        explanation: "'Divide' means both a geopolitical split and an abstract gap between two things.",
        fullExplanation: "'Divide' is polysemous: the Cold War divide was a geopolitical and ideological split, and a divide between promises and delivery is an abstract gap. 'Gap' fits sentence 2 more naturally but less naturally for the geopolitical Cold War sense. 'Wall' fits sentence 1 historically but not sentence 2. 'Border' does not fit sentence 2.",
        source: "Swan, PEU (4e), §595",
        flavor: "history"
      },
      {
        id: "w2s-poly-19",
        stem: "1) The hotel staff treated every guest with the utmost ___ and attention to detail.\n2) This old watch belonged to my grandfather and is a matter of great ___ to our family.",
        options: ["care", "respect", "kindness", "value"],
        answer: "care",
        explanation: "'Care' means both attentive service/treatment and deep emotional concern or attachment.",
        fullExplanation: "'Care' is polysemous: hotel care means attentive service, and 'a matter of great care' means something held with deep emotional value or concern. 'Respect' fits sentence 1 but not sentence 2 as naturally. 'Kindness' fits sentence 1 but not sentence 2. 'Value' fits sentence 2 loosely but not sentence 1 in the same role.",
        source: "Swan, PEU (4e), §595",
        flavor: "social"
      },
      {
        id: "w2s-poly-20",
        stem: "1) Astronomers study the ___ of distant stars to determine their chemical composition.\n2) The engineer analysed the full ___ of possible failure modes before approving the design.",
        options: ["spectrum", "light", "range", "colour"],
        answer: "spectrum",
        explanation: "'Spectrum' means both the light wavelengths emitted by stars and a complete range of possibilities.",
        fullExplanation: "'Spectrum' is polysemous: the light spectrum of a star reveals its elements, and a spectrum of failure modes means the complete range of possibilities. 'Light' fits sentence 1 but not sentence 2. 'Range' fits sentence 2 but is less precise for sentence 1. 'Colour' does not fit sentence 2.",
        source: "Swan, PEU (4e), §595",
        flavor: "science"
      },
      {
        id: "w2s-poly-21",
        stem: "1) Chopin composed his most celebrated ___ for solo piano in the last decade of his life.\n2) The chess master played an unexpected ___ that caught his opponent completely off guard.",
        options: ["piece", "work", "move", "song"],
        answer: "piece",
        explanation: "'Piece' means a musical composition and also a single move or action in a game.",
        fullExplanation: "'Piece' is polysemous: a musical piece is a composition, and a chess piece or 'a piece of play' can mean a specific move or action. 'Work' fits sentence 1 but not sentence 2 naturally. 'Move' fits sentence 2 but not sentence 1. 'Song' fits neither sentence precisely.",
        source: "Swan, PEU (4e), §595",
        flavor: "personalities"
      },
      {
        id: "w2s-poly-22",
        stem: "1) The two superpowers formed a military ___ in 1949 that would last for the entire Cold War.\n2) She and her business partner formed a ___ that proved highly successful in the export market.",
        options: ["alliance", "union", "pact", "team"],
        answer: "alliance",
        explanation: "'Alliance' denotes both a military-political union between states and a business partnership.",
        fullExplanation: "'Alliance' is polysemous: a military alliance is a formal defensive agreement between countries, and a business alliance is a cooperative partnership. 'Union' fits sentence 1 but less naturally for business partnerships. 'Pact' fits sentence 1 but not sentence 2 as naturally. 'Team' does not fit sentence 1.",
        source: "Swan, PEU (4e), §595",
        flavor: "history"
      },
      {
        id: "w2s-poly-23",
        stem: "1) The company ___ the contract with a new supplier after the previous one raised prices suddenly.\n2) She ___ down in tears when she heard the news about her friend's accident.",
        options: ["broke", "ended", "cut", "stopped"],
        answer: "broke",
        explanation: "'Broke' means to terminate a contract and also to burst into emotional crying.",
        fullExplanation: "'Break' is polysemous: to break a contract means to terminate it, and to break down means to lose emotional composure. 'Ended' fits sentence 1 but not sentence 2. 'Cut' fits sentence 1 partly but not sentence 2. 'Stopped' fits neither sentence naturally.",
        source: "Swan, PEU (4e), §595",
        flavor: "social"
      },
      {
        id: "w2s-poly-24",
        stem: "1) The ___ of the river carried enormous quantities of sediment towards the delta each year.\n2) She followed the ___ of the argument carefully and found a flaw in the conclusion.",
        options: ["flow", "current", "course", "movement"],
        answer: "flow",
        explanation: "'Flow' means the physical movement of water and also the progression or logic of an argument.",
  ...
  "w2s-particle": {
    ...
    canonicalSubId: "cs-w2s-particle",
    canonicalTopicId: "word-two-sentences",
    tasks: [
      {
        id: "w2s-particle-01",
      ...
      },
      {
        ...
        options: ["across", "up", "over", "through"],
        answer: "across",
      ...
      {
        id: "w2s-particle-13",
        stem: "1) Rosalind Franklin's work helped rule ___ several incorrect models of DNA before the correct one was found.\n2) The accountant spent weeks trying to rule ___ fraud as a possible cause of the discrepancy.",
        options: ["out", "off", "away", "over"],
        answer: "out",
        explanation: "'Rule out' means to eliminate something as a possibility, fitting both scientific and investigative contexts.",
        fullExplanation: "'Rule out' is polyfunctional: to rule out an incorrect model means to eliminate it from consideration, and to rule out fraud means to establish it was not the cause. 'Rule off' means to draw a line; 'rule away' and 'rule over' are not standard phrasal verbs in this sense.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "personalities"
      },
      {
        id: "w2s-particle-14",
        stem: "1) The revolutionary army held ___ against the superior enemy forces for three days.\n2) She asked her assistant to hold ___ all non-urgent calls until the meeting was over.",
        options: ["off", "on", "back", "up"],
        answer: "off",
        explanation: "'Hold off' means to resist or delay an attack and also to defer or postpone something.",
        fullExplanation: "'Hold off' is polyfunctional: an army holds off enemy forces meaning it resists them, and holding off calls means deferring them. 'Hold on' means to wait or grip; 'hold back' means to restrain; 'hold up' means to delay or rob — none fit both sentences with the same meaning.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "history"
      },
      {
        id: "w2s-particle-15",
        stem: "1) The manager decided to take ___ a second job to cover the rising cost of living.\n2) The airline took ___ a new route connecting two previously unlinked regional airports.",
        options: ["on", "up", "over", "off"],
        answer: "on",
        explanation: "'Take on' means to accept additional work or responsibility, fitting both personal and institutional contexts.",
        fullExplanation: "'Take on' is polyfunctional: to take on a job means to start doing it, and an airline takes on a route means it begins operating it. 'Take up' means to start a hobby or fill space; 'take over' means to assume control; 'take off' means to depart or become successful — none fit both sentences.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "social"
      },
      {
        id: "w2s-particle-16",
        stem: "1) The carbon dioxide in the atmosphere filters ___ certain wavelengths of infrared radiation.\n2) The university filtered ___ the weak applications before sending the shortlist to the committee.",
        options: ["out", "off", "away", "through"],
        answer: "out",
        explanation: "'Filter out' means to remove unwanted elements from a system or collection.",
        fullExplanation: "'Filter out' is polyfunctional: to filter out wavelengths means to remove them from passing through, and to filter out weak applications means to remove them from consideration. 'Filter off' is not standard; 'filter away' is not used; 'filter through' means to pass through gradually, not to remove.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "science"
      },
      {
        id: "w2s-particle-17",
        stem: "1) Mahatma Gandhi always stood ___ for equality and justice even when it cost him dearly.\n2) The two friends stood ___ for each other whenever either of them faced unfair criticism.",
        options: ["up", "out", "by", "back"],
        answer: "up",
        explanation: "'Stand up' means to publicly defend a principle and also to support another person.",
        fullExplanation: "'Stand up for' is polyfunctional: to stand up for equality means to defend it publicly, and to stand up for a friend means to support them when challenged. 'Stand out' means to be visually or qualitatively distinctive; 'stand by' also means to support but requires 'by' not 'up'; 'stand back' means to step away.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "personalities"
      },
      {
        id: "w2s-particle-18",
        stem: "1) The armistice brought ___ the fighting on the Western Front in November 1918.\n2) The mediator managed to bring ___ a compromise between the two disputing parties.",
        options: ["about", "off", "down", "in"],
        answer: "about",
        explanation: "'Bring about' means to cause or produce a result, fitting both ending a war and achieving a compromise.",
        fullExplanation: "'Bring about' is polyfunctional: to bring about the end of fighting means to cause it to happen, and to bring about a compromise means to produce that outcome. 'Bring off' means to succeed at something difficult; 'bring down' means to make fall or reduce; 'bring in' means to introduce — none fit both sentences with the same meaning.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "history"
      },
      {
        id: "w2s-particle-19",
        stem: "1) The customer asked the shop assistant to wrap ___ the birthday gift before she left the store.\n2) The conference finally wrapped ___ after three long days of presentations and discussions.",
        options: ["up", "off", "over", "away"],
        answer: "up",
        explanation: "'Wrap up' means to package a gift and also to conclude or finish an event.",
        fullExplanation: "'Wrap up' is polyfunctional: to wrap up a gift means to cover it in wrapping paper, and to wrap up a conference means to bring it to a close. 'Wrap off' is not standard; 'wrap over' is not used; 'wrap away' is not a standard phrasal verb.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "social"
      },
      {
        id: "w2s-particle-20",
        stem: "1) The radioactive material gives ___ dangerous radiation that can be detected from a distance.\n2) The factory near the river gives ___ chemical fumes that pollute the surrounding area.",
        options: ["off", "out", "up", "away"],
        answer: "off",
        explanation: "'Give off' means to emit radiation, fumes, or other substances, fitting both sentences.",
        fullExplanation: "'Give off' is polyfunctional: radioactive material gives off radiation (emits it), and a factory gives off fumes (emits them). 'Give out' also means to emit but more often means to distribute or run out; 'give up' means to abandon; 'give away' means to donate or reveal.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "science"
      },
      {
        id: "w2s-particle-21",
        stem: "1) Charles Dickens drew ___ his own childhood poverty to write vivid stories about London's poor.\n2) The new medical protocol draws ___ the latest clinical guidelines and research findings.",
        options: ["on", "up", "away", "over"],
        answer: "on",
        explanation: "'Draw on' means to use a resource or experience as a basis, fitting both personal and institutional contexts.",
        fullExplanation: "'Draw on' is polyfunctional: to draw on childhood experience means to use it as creative material, and a protocol that draws on guidelines uses them as its foundation. 'Draw up' means to prepare a document; 'draw away' means to move away; 'draw over' is not a standard phrasal verb.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "personalities"
      },
      {
        id: "w2s-particle-22",
        stem: "1) The peace talks fell ___ when the two sides could not agree on territorial boundaries.\n2) The wedding plans fell ___ because the venue was double-booked and unavailable.",
        options: ["through", "down", "off", "apart"],
        answer: "through",
        explanation: "'Fall through' means to fail to happen as planned, fitting both diplomatic negotiations and personal arrangements.",
        fullExplanation: "'Fall through' is polyfunctional: peace talks that fall through have collapsed without agreement, and wedding plans that fall through have failed to materialise. 'Fall down' means to collapse physically or have a flaw; 'fall off' means to decrease; 'fall apart' means to disintegrate — none fit both sentences as precisely.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "history"
      },
      {
        id: "w2s-particle-23",
        stem: "1) The pilot had to pull ___ the landing as the runway was still occupied by another aircraft.\n2) Could you pull ___ the chair a bit so that others can pass through the gap?",
        options: ["back", "off", "away", "out"],
        answer: "back",
        explanation: "'Pull back' means to abort an approach and also to move something away from a position.",
        fullExplanation: "'Pull back' is polyfunctional: a pilot pulls back from landing means to abort the approach, and pulling back a chair means moving it away from a position. 'Pull off' means to succeed at something difficult or stop briefly; 'pull away' means to move away but is less idiomatic for a chair; 'pull out' means to leave or withdraw.",
        source: "Murphy, EGU (4e), Unit 135",
        flavor: "social"
      },
      {
        id: "w2s-particle-24",
        stem: "1) The research team set ___ an experiment to test whether plants grow faster in red or blue light.\n2) The charity set ___ a fund to help families affected by the devastating floods.",
        options: ["up", "out", "off", "on"],
        answer: "up",
        explanation: "'Set up' means to organise and establish a procedure or institution, fitting both scientific and charitable contexts.",
  ...
  "ei-verb": {
    ...
    tasks: [
      ...
      {
        id: "ei-verb-13",
        stem: "Pablo Picasso (A) has co-founded the Cubist movement (B) with Georges Braque around (C) 1907, transforming (D) modern art.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Has co-founded' is wrong; a closed past event requires Past Simple 'co-founded'.",
        fullExplanation: "Present perfect cannot be used with a specific closed past time. 1907 is a definite past date, so Past Simple 'co-founded' is required. Parts (B) 'with Georges Braque', (C) 'around 1907', and (D) 'modern art' are all correct.",
        source: "Murphy, EGU (4e), Unit 7",
        flavor: "personalities"
      },
      {
        id: "ei-verb-14",
        stem: "The ancient Egyptians (A) had built the Great Pyramid of Giza as a tomb (B) for Pharaoh Khufu (C) around 2560 BC (D) according to archaeological records.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Had built' is wrong for a standalone historical fact; Past Simple 'built' is needed.",
        fullExplanation: "Past Perfect requires a prior reference point in the past. As a standalone historical statement, Past Simple 'built' is correct. Parts (B) 'for Pharaoh Khufu', (C) 'around 2560 BC', and (D) 'according to archaeological records' are all correct.",
        source: "Murphy, EGU (4e), Unit 15",
        flavor: "history"
      },
      {
        id: "ei-verb-15",
        stem: "My neighbour (A) has broken (B) her ankle last (C) Thursday and (D) went to hospital straight away.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Has broken' is wrong with 'last Thursday'; Past Simple 'broke' is required.",
        fullExplanation: "Present perfect cannot co-occur with definite past time adverbials like 'last Thursday'. The correct form is 'broke'. Parts (B) 'her ankle last', (C) 'Thursday and', and (D) 'went to hospital' are all correct.",
        source: "Murphy, EGU (4e), Unit 7",
        flavor: "social"
      },
      {
        id: "ei-verb-16",
        stem: "The moon (A) is orbiting the Earth once every (B) 27.3 days, completing (C) one full revolution around (D) our planet.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Is orbiting' is wrong; 'orbit' is a stative/habitual fact and uses Present Simple 'orbits'.",
        fullExplanation: "Permanent scientific facts describing regular cycles use Present Simple: 'orbits'. 'Is orbiting' implies a temporary ongoing action and is inappropriate for a constant astronomical fact. Parts (B) '27.3 days', (C) 'one full revolution', and (D) 'our planet' are all correct.",
        source: "Murphy, EGU (4e), Unit 1",
        flavor: "science"
      },
      {
        id: "ei-verb-17",
        stem: "Leonardo da Vinci (A) began painting the Mona Lisa around 1503, (B) but he never (C) has fully completed (D) it to his own satisfaction.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'Has fully completed' is wrong in a past-time context; Past Simple 'completed' is required.",
        fullExplanation: "The sentence refers to past events in Da Vinci's life. Present perfect 'has completed' cannot anchor to a closed past reference. Past Simple 'completed' is correct. Parts (A) 'began painting', (B) 'but he never', and (D) 'it to his own satisfaction' are all correct.",
        source: "Murphy, EGU (4e), Unit 7",
        flavor: "personalities"
      },
      {
        id: "ei-verb-18",
        stem: "When the armistice of World War I (A) was signed on 11 November 1918, thousands of soldiers (B) was still (C) waiting in (D) the trenches.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'Was still waiting' is wrong; plural 'thousands of soldiers' requires 'were still waiting'.",
        fullExplanation: "The subject 'thousands of soldiers' is plural, so the auxiliary must be plural: 'were still waiting'. 'Was' is only correct with singular subjects. Parts (A) 'was signed on 11 November 1918', (C) 'waiting in', and (D) 'the trenches' are all correct.",
        source: "Murphy, EGU (4e), Unit 11",
        flavor: "history"
      },
      {
        id: "ei-verb-19",
        stem: "The receptionist (A) was typing the report (B) when the fire alarm (C) suddenly (D) had rung.",
        options: ["A", "B", "C", "D"],
        answer: "D",
        explanation: "'Had rung' is wrong; a sudden interruption uses Past Simple 'rang'.",
        fullExplanation: "When a Past Continuous action is interrupted, the interrupting event uses Past Simple. 'Rang' is correct; 'had rung' (Past Perfect) implies the alarm rang before the typing began, which contradicts the meaning. Parts (A) 'was typing the report', (B) 'when the fire alarm', and (C) 'suddenly' are all correct.",
        source: "Murphy, EGU (4e), Unit 14",
        flavor: "social"
      },
      {
        id: "ei-verb-20",
        stem: "Electricity (A) flows through a conductor when (B) a voltage difference (C) was applied (D) across its two ends.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'Was applied' is wrong; a permanent scientific rule needs Present Simple Passive 'is applied'.",
        fullExplanation: "Universal scientific laws use Present Simple. 'Was applied' incorrectly implies a past or temporary condition. The correct form is 'is applied'. Parts (A) 'flows through a conductor', (B) 'a voltage difference', and (D) 'across its two ends' are all correct.",
        source: "Murphy, EGU (4e), Unit 1",
        flavor: "science"
      },
      {
        id: "ei-verb-21",
        stem: "Maya Angelou (A) wrote seven autobiographies during her career, but she never (B) had received (C) the Pulitzer Prize (D) she deserved.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'Had received' (Past Perfect) is wrong here; Past Simple 'received' is correct.",
        fullExplanation: "Past Perfect requires a prior reference point in the past. The sentence does not provide one, so Past Simple 'received' is the correct form. Parts (A) 'wrote seven autobiographies', (C) 'the Pulitzer Prize', and (D) 'she deserved' are all correct.",
        source: "Murphy, EGU (4e), Unit 15",
        flavor: "personalities"
      },
      {
        id: "ei-verb-22",
        stem: "By 1945, Allied forces (A) have liberated (B) most of Western Europe (C) from Nazi (D) occupation.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Have liberated' (Present Perfect) is wrong; 'by 1945' requires Past Perfect 'had liberated'.",
        fullExplanation: "'By [past date]' signals completion before a past point, requiring Past Perfect 'had'. Present perfect 'have liberated' refers to completion relative to now, not 1945. Parts (B) 'most of Western Europe', (C) 'from Nazi', and (D) 'occupation' are all correct.",
        source: "Murphy, EGU (4e), Unit 15",
        flavor: "history"
      },
      {
        id: "ei-verb-23",
        stem: "Our team always submits reports on Mondays, but last week (A) we are (B) completely (C) forgetting to (D) send the final draft.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'We are' introduces Present tense; 'last week' requires Past Simple 'we forgot'.",
        fullExplanation: "'Last week' anchors the event in the past, so Past Simple is required: 'we forgot'. 'We are forgetting' uses Present Continuous, which cannot describe a completed past event. Parts (B) 'completely', (C) 'forgetting to', and (D) 'send the final draft' are otherwise correct.",
        source: "Murphy, EGU (4e), Unit 5",
        flavor: "social"
      },
      {
        id: "ei-verb-24",
        stem: "Migratory birds navigate by sensing magnetic fields; each bird (A) knows instinctively where (B) its wintering ground (C) was located (D) in the southern hemisphere.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'Was located' (Past Passive) is wrong; a current biological fact uses Present Passive 'is located'.",
  ...
  "ei-prep": {
    ...
    tasks: [
      ...
      {
        id: "ei-prep-13",
        stem: "Frida Kahlo was deeply influenced (A) from Mexican folk art and the natural landscape (B) of her homeland, which (C) shaped her unique (D) visual style.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Influenced from' is wrong; the correct collocation is 'influenced by'.",
        fullExplanation: "The verb 'influence' takes the preposition 'by' in passive constructions: 'influenced by Mexican folk art'. 'Influenced from' is a common learner error. Parts (B) 'of her homeland', (C) 'shaped her unique', and (D) 'visual style' are all correct.",
        source: "Swan, PEU (4e), §460",
        flavor: "personalities"
      },
      {
        id: "ei-prep-14",
        stem: "The first Olympic Games of the modern era took place (A) in Athens (B) on 1896 and featured (C) athletes from fourteen (D) countries.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'On 1896' is wrong; years take the preposition 'in': 'in 1896'.",
        fullExplanation: "Prepositions of time: years require 'in', not 'on'. 'On' is used for specific dates and days. 'In 1896' is correct. Parts (A) 'in Athens', (C) 'athletes from fourteen', and (D) 'countries' are all correct.",
        source: "Murphy, EGU (4e), Unit 108",
        flavor: "history"
      },
      {
        id: "ei-prep-15",
        stem: "My flatmate is very fond (A) for cooking Italian dishes and often (B) prepares a large meal (C) for the whole (D) household on Sundays.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Fond for' is wrong; the correct collocation is 'fond of'.",
        fullExplanation: "The adjective 'fond' always collocates with 'of', not 'for'. 'Fond of cooking' is correct. Parts (B) 'prepares a large meal', (C) 'for the whole', and (D) 'household on Sundays' are all correct.",
        source: "Swan, PEU (4e), §16",
        flavor: "social"
      },
      {
        id: "ei-prep-16",
        stem: "Sound travels fastest (A) through solids, (B) at a speed that is roughly (C) twenty times faster as (D) its speed in air.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'Faster as' is wrong; comparatives use 'than', not 'as': 'faster than'.",
        fullExplanation: "In comparative constructions, 'than' is required after a comparative adjective: 'faster than'. 'As … as' is used for equatives, not comparatives. Parts (A) 'through solids', (B) 'at a speed that is roughly', and (D) 'its speed in air' are all correct.",
        source: "Murphy, EGU (4e), Unit 105",
        flavor: "science"
      },
      {
        id: "ei-prep-17",
        stem: "Nelson Mandela (A) dedicated his life to the struggle (B) against apartheid and consistently insisted (C) about the importance of peaceful (D) negotiation.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'Insisted about' is wrong; the correct collocation is 'insisted on'.",
        fullExplanation: "The verb 'insist' collocates with 'on': 'insisted on the importance'. 'Insist about' is a common learner error. Parts (A) 'dedicated his life to', (B) 'against apartheid', and (D) 'negotiation' are all correct.",
        source: "Swan, PEU (4e), §460",
        flavor: "personalities"
      },
      {
        id: "ei-prep-18",
        stem: "The construction of the Suez Canal (A) was completed in 1869 and resulted (B) to a dramatic reduction (C) in shipping times (D) between Europe and Asia.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'Resulted to' is wrong; the correct collocation is 'resulted in'.",
        fullExplanation: "The verb 'result' always collocates with 'in': 'resulted in a dramatic reduction'. 'Resulted to' is a common learner error. Parts (A) 'was completed in 1869', (C) 'in shipping times', and (D) 'between Europe and Asia' are all correct.",
        source: "Swan, PEU (4e), §460",
        flavor: "history"
      },
      {
        id: "ei-prep-19",
        stem: "The children have been arguing about the trip (A) since days and still (B) cannot agree (C) on where they (D) want to go.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Since days' is wrong; duration without a start point uses 'for': 'for days'.",
        fullExplanation: "'Since' is used with a specific point in time ('since Monday'). 'For' is used with a duration ('for days'). Parts (B) 'cannot agree', (C) 'on where they', and (D) 'want to go' are all correct.",
        source: "Murphy, EGU (4e), Unit 13",
        flavor: "social"
      },
      {
        id: "ei-prep-20",
        stem: "Rainforests absorb large amounts of carbon dioxide, which is harmful (A) for the atmosphere (B) and contributes (C) to climate change (D) when released.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Harmful for' is wrong; the correct collocation is 'harmful to'.",
        fullExplanation: "The adjective 'harmful' collocates with 'to', not 'for'. 'Harmful to the atmosphere' is correct. Parts (B) 'and contributes', (C) 'to climate change', and (D) 'when released' are all correct.",
        source: "Swan, PEU (4e), §16",
        flavor: "science"
      },
      {
        id: "ei-prep-21",
        stem: "Ada Lovelace is widely regarded (A) as a pioneer of computing who was passionate (B) on mathematics and (C) worked closely with (D) Charles Babbage.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'Passionate on' is wrong; the correct collocation is 'passionate about'.",
        fullExplanation: "The adjective 'passionate' collocates with 'about', not 'on'. 'Passionate about mathematics' is the correct form. Parts (A) 'as a pioneer of computing', (C) 'worked closely with', and (D) 'Charles Babbage' are all correct.",
        source: "Swan, PEU (4e), §16",
        flavor: "personalities"
      },
      {
        id: "ei-prep-22",
        stem: "The Normandy landings took place (A) on 6 June 1944 and represented (B) the largest (C) seaborne invasion (D) at history.",
        options: ["A", "B", "C", "D"],
        answer: "D",
        explanation: "'At history' is wrong; the correct expression is 'in history'.",
        fullExplanation: "When referring to something in the context of recorded history, 'in history' is the correct preposition phrase. 'At history' is not standard. Parts (A) 'on 6 June 1944', (B) 'the largest', and (C) 'seaborne invasion' are all correct.",
        source: "Swan, PEU (4e), §461",
        flavor: "history"
      },
      {
        id: "ei-prep-23",
        stem: "My cousin is very good (A) at chess and practises (B) for at least two hours (C) every day (D) in weekends.",
        options: ["A", "B", "C", "D"],
        answer: "D",
        explanation: "'In weekends' is wrong; the correct preposition for recurring days is 'on': 'on weekends'.",
        fullExplanation: "Days and recurring weekly periods take 'on': 'on weekends'. 'In' is used for months, years, and seasons. Parts (A) 'at chess', (B) 'for at least two hours', and (C) 'every day' are all correct.",
        source: "Murphy, EGU (4e), Unit 108",
        flavor: "social"
      },
      {
        id: "ei-prep-24",
        stem: "Magma rises (A) through the Earth's crust (B) and emerges at (C) the surface through of (D) volcanic vents.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'Through of' is wrong; 'through' alone is the correct preposition.",
  ...
  "ei-extra": {
    ...
    tasks: [
      ...
      {
        id: "ei-extra-13",
        stem: "Stephen Hawking (A) he (B) communicated through a speech synthesiser (C) after losing (D) the ability to speak.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "The pronoun 'he' after 'Stephen Hawking' is a redundant resumptive pronoun.",
        fullExplanation: "In English, a sentence cannot have both a noun subject and a resumptive pronoun: 'Stephen Hawking communicated…' is correct. The redundant 'he' falls in segment (A). Parts (B) 'communicated through a speech synthesiser', (C) 'after losing', and (D) 'the ability to speak' are all correct.",
        source: "Swan, PEU (4e), §423",
        flavor: "personalities"
      },
      {
        id: "ei-extra-14",
        stem: "The Colosseum in Rome (A) it (B) could hold an estimated fifty thousand (C) spectators during gladiatorial (D) contests.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "The pronoun 'it' after 'The Colosseum in Rome' is a redundant resumptive pronoun.",
        fullExplanation: "English does not permit a noun subject and a resumptive pronoun in the same clause. 'The Colosseum … could hold…' is correct; 'it' must be deleted. Parts (B) 'could hold an estimated fifty thousand', (C) 'spectators during gladiatorial', and (D) 'contests' are all correct.",
        source: "Swan, PEU (4e), §423",
        flavor: "history"
      },
      {
        id: "ei-extra-15",
        stem: "She (A) needn't (B) hardly worry about the presentation — (C) she has practised it (D) at least twenty times.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Needn't' is redundant; 'hardly' is already a negative adverb, creating a double negative.",
        fullExplanation: "'Hardly' is a negative adverb, so combining it with 'needn't' creates an ungrammatical double negative. The correct form is 'She hardly needs to worry'. The redundant negative auxiliary falls in segment (A). Parts (B) 'hardly worry', (C) 'she has practised it', and (D) 'at least twenty times' are correct without the extra negative.",
        source: "Swan, PEU (4e), §375",
        flavor: "social"
      },
      {
        id: "ei-extra-16",
        stem: "The reason why the sky appears (A) red at sunset is (B) because (C) dust particles they (D) scatter shorter wavelengths of light.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "The pronoun 'they' after 'dust particles' is redundant in the relative clause.",
        fullExplanation: "In the clause 'because dust particles scatter', 'dust particles' is the subject and 'they' repeats it needlessly. 'Because dust particles scatter shorter wavelengths' is correct. Parts (A) 'red at sunset is', (B) 'because', and (D) 'scatter shorter wavelengths of light' are all correct.",
        source: "Swan, PEU (4e), §423",
        flavor: "science"
      },
      {
        id: "ei-extra-17",
        stem: "Mark Twain returned (A) back (B) to the Mississippi River region (C) many times during his (D) writing career.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Back' after 'returned' is redundant; 'return' already means 'go back'.",
        fullExplanation: "'Return' inherently means going back to a place, so 'back' adds nothing. The correct form is 'returned to the Mississippi River region'. The redundant 'back' falls in segment (A). Parts (B) 'to the Mississippi River region', (C) 'many times during his', and (D) 'writing career' are all correct.",
        source: "Swan, PEU (4e), §131",
        flavor: "personalities"
      },
      {
        id: "ei-extra-18",
        stem: "The Berlin Wall is widely (A) regarded as one of (B) the most powerful ever (C) symbols of the (D) Cold War division of Europe.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'Ever' is redundant alongside 'most powerful'; superlatives already cover all time.",
        fullExplanation: "The phrase 'the most powerful ever symbols' is redundant because superlatives already encompass all instances. 'Ever' is a pleonastic addition that also disrupts adjective order. The correct form is 'the most powerful symbols'. Parts (A) 'regarded as one of', (C) 'symbols of the', and (D) 'Cold War division of Europe' are all correct.",
        source: "Swan, PEU (4e), §131",
        flavor: "history"
      },
      {
        id: "ei-extra-19",
        stem: "I would like you to (A) please reconfirm (B) again your booking by (C) email before (D) the end of the week.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'Again' after 'reconfirm' is redundant; the prefix 're-' already means 'again'.",
        fullExplanation: "The prefix 're-' in 'reconfirm' already means 'to do again'. Adding 'again' is therefore redundant pleonasm. The correct form is 'please reconfirm your booking'. Parts (A) 'please reconfirm', (C) 'email before', and (D) 'the end of the week' are all correct.",
        source: "Swan, PEU (4e), §131",
        flavor: "social"
      },
      {
        id: "ei-extra-20",
        stem: "Both (A) each hemisphere of the brain (B) controls different (C) functions, though the two (D) halves communicate constantly.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Each' after 'Both' is redundant; 'Both' and 'Each' cannot be combined in this way.",
        fullExplanation: "'Both' and 'each' are near-synonymous determiners in this context and cannot be stacked: 'Both hemispheres' or 'Each hemisphere' is correct. The redundant 'each' falls in segment (A). Parts (B) 'controls different', (C) 'functions, though the two', and (D) 'halves communicate constantly' are all correct.",
        source: "Swan, PEU (4e), §184",
        flavor: "science"
      },
      {
        id: "ei-extra-21",
        stem: "Wolfgang Amadeus Mozart (A) he (B) composed his first symphony (C) at the age of just (D) eight years old.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "The pronoun 'he' after 'Wolfgang Amadeus Mozart' is a redundant resumptive pronoun.",
        fullExplanation: "In English, a sentence cannot have both a full noun subject and a resumptive pronoun. 'Mozart composed…' is correct. The redundant 'he' falls in segment (A). Parts (B) 'composed his first symphony', (C) 'at the age of just', and (D) 'eight years old' are all correct.",
        source: "Swan, PEU (4e), §423",
        flavor: "personalities"
      },
      {
        id: "ei-extra-22",
        stem: "During the Roman Republic, senators often had (A) to to debate (B) for hours before (C) reaching a decision (D) on military matters.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'To to debate' contains a doubled infinitive marker 'to'; only one 'to' is needed.",
        fullExplanation: "'Had to debate' is the correct semi-modal form. The doubled 'to to' in segment (A) is a redundant repetition of the infinitive marker. Parts (B) 'for hours before', (C) 'reaching a decision', and (D) 'on military matters' are all correct.",
        source: "Swan, PEU (4e), §307",
        flavor: "history"
      },
      {
        id: "ei-extra-23",
        stem: "The customers decided to (A) pre-plan their visit to (B) the theme park well in advance (C) so that everyone (D) could get the most out of the day.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Pre-plan' is redundant because 'plan … in advance' already expresses the idea.",
        fullExplanation: "The phrase 'plan … well in advance' already conveys advance planning. The prefix 'pre-' in 'pre-plan' duplicates the meaning of 'in advance' in segment (C) and is redundant. The correct form is 'decided to plan their visit … well in advance'. Parts (B) 'the theme park', (C) 'well in advance', and (D) 'could get the most out of the day' are all correct.",
        source: "Swan, PEU (4e), §131",
        flavor: "social"
      },
      {
        id: "ei-extra-24",
        stem: "The planets orbit (A) around (B) the Sun in elliptical paths, (C) a pattern first described (D) mathematically by Johannes Kepler.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Around' is redundant after 'orbit'; 'orbit' already means 'move in a path around'.",
  ...
  "ei-art": {
    ...
    tasks: [
      ...
      {
        id: "ei-art-13",
        stem: "Nikola Tesla invented (A) the alternating current motor while working (B) at a engineering firm (C) in New York (D) in the 1880s.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'A engineering firm' is wrong; before a vowel sound, the indefinite article is 'an'.",
        fullExplanation: "The word 'engineering' begins with a vowel sound, so it requires the article 'an', not 'a'. 'An engineering firm' is correct. Parts (A) 'the alternating current motor', (C) 'in New York', and (D) 'in the 1880s' are all correct.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "personalities"
      },
      {
        id: "ei-art-14",
        stem: "The Great Fire of London broke out in (A) a 1666 and destroyed (B) the majority (C) of the medieval city (D) within three days.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'A 1666' is wrong; years do not take an indefinite article — the correct form is simply '1666'.",
        fullExplanation: "Years do not take articles: 'in 1666' is correct. 'A 1666' inserts an erroneous indefinite article before the year. Parts (B) 'the majority', (C) 'of the medieval city', and (D) 'within three days' are all correct.",
        source: "Murphy, EGU (4e), Unit 73",
        flavor: "history"
      },
      {
        id: "ei-art-15",
        stem: "My colleague wants to become (A) an manager one day (B) because she loves (C) organising people (D) and solving complex problems.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'An manager' is wrong; 'manager' begins with a consonant sound, so 'a manager' is correct.",
        fullExplanation: "The word 'manager' begins with the consonant /m/, so the indefinite article is 'a', not 'an'. Parts (B) 'because she loves', (C) 'organising people', and (D) 'and solving complex problems' are all correct.",
        source: "Murphy, EGU (4e), Unit 69",
        flavor: "social"
      },
      {
        id: "ei-art-16",
        stem: "The speed of (A) the sound in dry (B) air at twenty degrees Celsius (C) is approximately (D) 343 metres per second.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'The sound' is wrong; 'sound' as a physical phenomenon takes zero article: 'speed of sound'.",
        fullExplanation: "When 'sound' refers to the physical phenomenon in general, it is an uncountable noun and takes no article. 'The speed of sound' (zero article) is correct. Parts (B) 'air at twenty degrees Celsius', (C) 'is approximately', and (D) '343 metres per second' are all correct.",
        source: "Murphy, EGU (4e), Unit 73",
        flavor: "science"
      },
      {
        id: "ei-art-17",
        stem: "Charles Darwin is considered (A) the most influential scientist (B) in a history of (C) evolutionary (D) biology.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'In a history' is wrong; the unique concept 'history of evolutionary biology' requires 'the history'.",
        fullExplanation: "When referring to a specific, unique body of history, the definite article 'the' is required: 'in the history of'. The indefinite article 'a' is incorrect here. Parts (A) 'the most influential scientist', (C) 'evolutionary', and (D) 'biology' are all correct.",
        source: "Murphy, EGU (4e), Unit 70",
        flavor: "personalities"
      },
      {
        id: "ei-art-18",
        stem: "Ancient Greece was governed by (A) a Senate in Athens; its system of (B) democracy (C) inspired many (D) later political thinkers.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'A Senate' is wrong; the specific Athenian governing body requires 'the Senate'.",
        fullExplanation: "When referring to a specific, unique institution, the definite article 'the' is required: 'the Senate'. 'A Senate' implies an unspecified body. Parts (B) 'democracy', (C) 'inspired many', and (D) 'later political thinkers' are all correct.",
        source: "Murphy, EGU (4e), Unit 70",
        flavor: "history"
      },
      {
        id: "ei-art-19",
        stem: "My neighbour plays (A) the violin beautifully; (B) she practises every day (C) before going (D) to a bed.",
        options: ["A", "B", "C", "D"],
        answer: "D",
        explanation: "'To a bed' is wrong; 'go to bed' takes zero article.",
        fullExplanation: "In the phrase 'go to bed', 'bed' is used without an article because it refers to the activity of sleeping, not a specific piece of furniture. 'A bed' is incorrect here. Parts (A) 'the violin beautifully', (B) 'she practises every day', and (C) 'before going' are all correct.",
        source: "Murphy, EGU (4e), Unit 74",
        flavor: "social"
      },
      {
        id: "ei-art-20",
        stem: "Photosynthesis is (A) the process by which (B) plants convert the carbon dioxide (C) into (D) sugars using energy from sunlight.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'Convert the carbon dioxide' is wrong; 'carbon dioxide' as a general substance takes zero article.",
        fullExplanation: "Uncountable substances used in a general sense take zero article. 'Carbon dioxide' here refers to the gas in general, not a specific quantity. 'Convert carbon dioxide' is correct. Parts (A) 'the process by which', (C) 'into', and (D) 'sugars using energy from sunlight' are all correct.",
        source: "Murphy, EGU (4e), Unit 73",
        flavor: "science"
      },
      {
        id: "ei-art-21",
        stem: "Jane Austen is best known (A) for her novels, which often reflected (B) the social conventions (C) of a Regency England (D) she observed around her.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'A Regency England' is wrong; country names take zero article: 'of Regency England'.",
        fullExplanation: "Country names do not take an indefinite article. 'A Regency England' is incorrect; the correct form is simply 'of Regency England'. Parts (A) 'for her novels', (B) 'the social conventions', and (D) 'she observed around her' are all correct.",
        source: "Murphy, EGU (4e), Unit 73",
        flavor: "personalities"
      },
      {
        id: "ei-art-22",
        stem: "The Roman forum was (A) a centre of public (B) life, where citizens gathered (C) to debate politics and conduct (D) a commerce.",
        options: ["A", "B", "C", "D"],
        answer: "D",
        explanation: "'A commerce' is wrong; 'commerce' as an abstract concept takes zero article.",
        fullExplanation: "Abstract uncountable nouns such as 'commerce', 'trade', and 'industry' in general statements take zero article. 'Conduct commerce' is correct. Parts (A) 'a centre of public', (B) 'life, where citizens gathered', and (C) 'to debate politics and conduct' are all correct.",
        source: "Murphy, EGU (4e), Unit 73",
        flavor: "history"
      },
      {
        id: "ei-art-23",
        stem: "My brother bought (A) a new raincoat because (B) the forecast predicted (C) the heavy rain (D) all week.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'The heavy rain' is wrong; 'rain' as an uncountable noun in a general weather statement takes zero article.",
        fullExplanation: "In general weather statements, 'rain' is uncountable and takes zero article: 'heavy rain all week'. The definite article 'the' is incorrect here. Parts (A) 'a new raincoat', (B) 'the forecast predicted', and (D) 'all week' are all correct.",
        source: "Murphy, EGU (4e), Unit 73",
        flavor: "social"
      },
      {
        id: "ei-art-24",
        stem: "The Milky Way galaxy contains roughly two hundred billion stars and is home (A) to an extraordinary (B) the variety of (C) stellar types, from red dwarfs (D) to supergiants.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'An extraordinary the variety' is wrong; only one article is used — 'an extraordinary variety'.",
  ...
  "ei-sva": {
    ...
    tasks: [
      ...
      {
        id: "ei-sva-13",
        stem: "Frida Kahlo, along with several other female artists, (A) were instrumental (B) in establishing (C) a uniquely Mexican (D) artistic tradition.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Were instrumental' is wrong; the head subject 'Frida Kahlo' is singular, requiring 'was instrumental'.",
        fullExplanation: "A singular subject followed by 'along with + noun' remains singular. 'Frida Kahlo … was instrumental' is correct. Parts (B) 'in establishing', (C) 'a uniquely Mexican', and (D) 'artistic tradition' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "personalities"
      },
      {
        id: "ei-sva-14",
        stem: "The number of battles (A) fought during the (B) Napoleonic Wars (C) were far greater (D) than most people realise today.",
        options: ["A", "B", "C", "D"],
        answer: "C",
        explanation: "'Were far greater' is wrong; 'the number' is singular and requires 'was far greater'.",
        fullExplanation: "The expression 'the number of' takes a singular verb. 'The number … was far greater' is correct. 'A number of' (meaning 'many') takes plural. Parts (A) 'fought during the', (B) 'Napoleonic Wars', and (D) 'than most people realise today' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "history"
      },
      {
        id: "ei-sva-15",
        stem: "Neither my sister nor my parents (A) has ever (B) visited (C) the museum in (D) the city centre.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Has ever visited' is wrong; with 'neither … nor', the verb agrees with the nearest subject ('my parents' — plural): 'have ever visited'.",
        fullExplanation: "With 'neither … nor', the verb agrees with the closest subject. 'My parents' is plural, so 'have ever visited' is correct. Parts (B) 'ever visited', (C) 'the museum in', and (D) 'the city centre' are all correct.",
        source: "Swan, PEU (4e), §369",
        flavor: "social"
      },
      {
        id: "ei-sva-16",
        stem: "The evidence gathered by (A) the researchers (B) clearly shows (C) that rising sea levels (D) threatens coastal communities worldwide.",
        options: ["A", "B", "C", "D"],
        answer: "D",
        explanation: "'Threatens' is wrong; the subject 'rising sea levels' is plural and requires 'threaten'.",
        fullExplanation: "The subject 'rising sea levels' is plural, so the verb must be 'threaten', not 'threatens'. Parts (A) 'the researchers', (B) 'clearly shows', and (C) 'that rising sea levels' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "science"
      },
      {
        id: "ei-sva-17",
        stem: "Mark Twain, as well as other great American writers, (A) have contributed (B) enormously to (C) the literary (D) tradition of the United States.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Have contributed' is wrong; the head subject 'Mark Twain' is singular, requiring 'has contributed'.",
        fullExplanation: "A singular subject joined to additional nouns by 'as well as' remains singular. 'Twain … has contributed' is correct. 'Have contributed' wrongly treats the subject as plural. Parts (B) 'enormously to', (C) 'the literary', and (D) 'tradition of the United States' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "personalities"
      },
      {
        id: "ei-sva-18",
        stem: "The Netherlands (A) were officially (B) declared a constitutional monarchy (C) at the Congress (D) of Vienna in 1815.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Were officially declared' is wrong; country names ending in -s take a singular verb: 'was officially declared'.",
        fullExplanation: "Country names ending in -s such as 'the Netherlands', 'the United States', and 'the Philippines' take singular verbs when referring to the country as a unit. 'Was officially declared' is correct. Parts (B) 'declared a constitutional monarchy', (C) 'at the Congress', and (D) 'of Vienna in 1815' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "history"
      },
      {
        id: "ei-sva-19",
        stem: "Each of the employees (A) were sent (B) a personalised (C) message (D) from the managing director.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Were sent' is wrong; 'each of' takes a singular verb: 'was sent'.",
        fullExplanation: "'Each of + plural noun' takes a singular verb because 'each' refers to individuals one by one. 'Was sent' is correct. Parts (B) 'a personalised', (C) 'message', and (D) 'from the managing director' are all correct.",
        source: "Swan, PEU (4e), §182",
        flavor: "social"
      },
      {
        id: "ei-sva-20",
        stem: "Economics (A) are considered (B) one of the most challenging (C) disciplines to study (D) at degree level.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Economics are considered' is wrong; academic subjects ending in -ics take singular verbs: 'is considered'.",
        fullExplanation: "Subjects ending in -ics (economics, physics, mathematics) are treated as singular. 'Economics is considered' is correct. Parts (B) 'one of the most challenging', (C) 'disciplines to study', and (D) 'at degree level' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "science"
      },
      {
        id: "ei-sva-21",
        stem: "Charles Dickens's novels, especially Oliver Twist, (A) continues (B) to be read (C) by millions (D) of people worldwide.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Continues' is wrong; the head subject 'Charles Dickens's novels' is plural, requiring 'continue'.",
        fullExplanation: "The subject 'novels' is plural. Even though a singular title is mentioned, the grammatical subject remains 'novels', requiring 'continue'. Parts (B) 'to be read', (C) 'by millions', and (D) 'of people worldwide' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "personalities"
      },
      {
        id: "ei-sva-22",
        stem: "A large number of artefacts (A) from ancient Greece (B) has been moved (C) to museums (D) outside the country.",
        options: ["A", "B", "C", "D"],
        answer: "B",
        explanation: "'Has been moved' is wrong; 'a large number of artefacts' requires the plural 'have been moved'.",
        fullExplanation: "'A number of' means 'many' and takes a plural verb. 'A large number of artefacts have been moved' is correct. 'The number of' takes singular. Parts (A) 'from ancient Greece', (C) 'to museums', and (D) 'outside the country' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "history"
      },
      {
        id: "ei-sva-23",
        stem: "The news about the price increase (A) were unexpected (B) for everyone (C) in the accounts department (D) and caused immediate concern.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Were unexpected' is wrong; 'the news' is always singular: 'was unexpected'.",
        fullExplanation: "'News' is an uncountable noun that always takes a singular verb. 'The news … was unexpected' is correct. Parts (B) 'for everyone', (C) 'in the accounts department', and (D) 'and caused immediate concern' are all correct.",
        source: "Swan, PEU (4e), §502",
        flavor: "social"
      },
      {
        id: "ei-sva-24",
        stem: "There (A) is a vast number of microorganisms (B) in a single teaspoon of (C) soil, most of which (D) remain unidentified by science.",
        options: ["A", "B", "C", "D"],
        answer: "A",
        explanation: "'Is a vast number' is wrong; 'a number of' takes a plural verb: 'are a vast number'.",
  ...
  "voc-syn": {
    ...
    canonicalSubId: "cs-voc-syn",
    canonicalTopicId: "vocab-context",
    tasks: [
      {
        id: "voc-syn-01",
      ...
      },
      {
        ...
        options: ["pivotal", "central", "critical", "main"],
        answer: "pivotal",
      ...
      },
      {
        ...
        options: ["exhausted", "tired", "weary", "drained"],
        answer: "exhausted",
      ...
      },
      {
        ...
        options: ["effective", "efficient", "productive", "useful"],
        answer: "effective",
      ...
      },
      {
        ...
        options: ["celebrated", "famous", "renowned", "known"],
        answer: "celebrated",
      ...
      },
      {
        ...
        options: ["facilitated", "helped", "supported", "aided"],
        answer: "facilitated",
      ...
      },
      {
        ...
        options: ["postpone", "delay", "cancel", "reschedule"],
        answer: "postpone",
      ...
      },
      {
        ...
        options: ["distribute", "spread", "carry", "deliver"],
        answer: "distribute",
      ...
      },
      {
        ...
        options: ["convey", "show", "express", "reveal"],
        answer: "convey",
      ...
      },
      {
        ...
        options: ["disrupted", "changed", "affected", "disturbed"],
        answer: "disrupted",
      ...
      },
      {
        ...
        options: ["warm", "nice", "pleasant", "friendly"],
        answer: "warm",
      ...
      },
      {
        ...
        options: ["established", "found", "discovered", "proved"],
        answer: "established",
      ...
      {
        id: "voc-syn-13",
        stem: "Tesla's ideas about wireless energy transmission were so ___ that mainstream science initially dismissed them as impossible.",
        options: ["visionary", "advanced", "clever", "different"],
        answer: "visionary",
        explanation: "'Visionary' means showing original foresight beyond conventional thinking — the best fit for ideas ahead of their time.",
        fullExplanation: "'Visionary' precisely describes thinking that anticipates developments long before they happen. 'Advanced' is factual but lacks the connotation of inspired foresight; 'clever' is too casual; 'different' is vague and descriptively weak.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "personalities"
      },
      {
        id: "voc-syn-14",
        stem: "The Battle of Waterloo in 1815 was a ___ moment that ended Napoleon's dominance of Europe.",
        options: ["decisive", "important", "critical", "special"],
        answer: "decisive",
        explanation: "'Decisive' means conclusively determining an outcome — the strongest fit for a battle that ended an era.",
        fullExplanation: "'Decisive' specifically means that the outcome was clear and determined everything that followed. 'Important' is too neutral; 'critical' can mean either 'crucial' or 'negative'; 'special' is too colloquial and lacks the finality the context requires.",
        source: "Oxford Advanced Learner's Dictionary (10e)",
        flavor: "history"
      },
      {
        id: "voc-syn-15",
        stem: "After waiting for forty minutes in the rain, the commuters grew increasingly ___ with the lack of any announcement.",
        options: ["frustrated", "angry", "worried", "unhappy"],
        answer: "frustrated",
        explanation: "'Frustrated' means feeling impatient and helpless due to an obstacle — the most precise fit for the situation.",
        fullExplanation: "'Frustrated' captures the specific feeling of being blocked from progress, which is exactly what waiting without information creates. 'Angry' implies a stronger emotional reaction; 'worried' implies concern about an outcome; 'unhappy' is too vague for the specific emotion in context.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "social"
      },
      {
        id: "voc-syn-16",
        stem: "The discovery of the Higgs boson in 2012 was ___ to physicists who had spent decades searching for it.",
        options: ["momentous", "good", "notable", "pleasing"],
        answer: "momentous",
        explanation: "'Momentous' means of great importance and long-lasting significance — the precise fit for a landmark scientific breakthrough.",
        fullExplanation: "'Momentous' is used for events of the greatest historical or scientific significance. 'Good' is too neutral and colloquial; 'notable' implies worthy of attention but lacks the magnitude; 'pleasing' focuses on emotional reaction rather than historical weight.",
        source: "Oxford Advanced Learner's Dictionary (10e)",
        flavor: "science"
      },
      {
        id: "voc-syn-17",
        stem: "Mahatma Gandhi was ___ for his philosophy of non-violent resistance and his role in Indian independence.",
        options: ["revered", "famous", "known", "respected"],
        answer: "revered",
        explanation: "'Revered' means deeply honoured and respected with an almost reverential admiration.",
        fullExplanation: "'Revered' conveys deep, almost devotional admiration and respect, which fits Gandhi's global standing. 'Famous' is neutral; 'known' is the weakest and most neutral; 'respected' is close but lacks the depth of feeling that 'revered' expresses.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "personalities"
      },
      {
        id: "voc-syn-18",
        stem: "The Great Fire of London in 1666 ___ much of the medieval city, clearing the way for a modern rebuild.",
        options: ["devastated", "destroyed", "burned", "ruined"],
        answer: "devastated",
        explanation: "'Devastated' means caused widespread and severe destruction — the strongest word for catastrophic urban damage.",
        fullExplanation: "'Devastated' implies total, wide-scale damage with lasting consequences, which fits the scale of the 1666 fire. 'Destroyed' is factually accurate but less evocative of scale; 'burned' is descriptive but weaker than 'devastated'; 'ruined' implies partial damage rather than near-total destruction.",
        source: "Oxford Advanced Learner's Dictionary (10e)",
        flavor: "history"
      },
      {
        id: "voc-syn-19",
        stem: "The waiter was ___ about the restaurant's menu and answered every question with confidence and detail.",
        options: ["knowledgeable", "good", "helpful", "aware"],
        answer: "knowledgeable",
        explanation: "'Knowledgeable' means having extensive information about a subject — the precise word for an informed waiter.",
        fullExplanation: "'Knowledgeable' directly describes someone who possesses detailed knowledge of a subject, which fits the context precisely. 'Good' is too vague; 'helpful' describes willingness to assist rather than having information; 'aware' suggests simple consciousness rather than deep knowledge.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "social"
      },
      {
        id: "voc-syn-20",
        stem: "The ozone layer ___ harmful ultraviolet radiation, preventing it from reaching the Earth's surface.",
        options: ["absorbs", "blocks", "stops", "catches"],
        answer: "absorbs",
        explanation: "'Absorbs' means takes in energy or radiation by a physical process — the most precise scientific term.",
        fullExplanation: "'Absorbs' is the standard scientific term for the process by which the ozone layer takes in UV radiation through photochemical reactions. 'Blocks' implies physical obstruction; 'stops' is too informal and vague; 'catches' is colloquial and does not describe a physical absorption process.",
        source: "Oxford Advanced Learner's Dictionary (10e)",
        flavor: "science"
      },
      {
        id: "voc-syn-21",
        stem: "Agatha Christie's writing was ___ in its ability to mislead the reader while keeping all the clues in plain sight.",
        options: ["ingenious", "clever", "smart", "tricky"],
        answer: "ingenious",
        explanation: "'Ingenious' means showing originality and clever invention — the most precise word for brilliantly constructed plots.",
        fullExplanation: "'Ingenious' describes creative cleverness combined with elegant problem-solving, fitting the construction of mystery plots. 'Clever' is close but less formal and precise; 'smart' is too colloquial; 'tricky' focuses on difficulty rather than creativity.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "personalities"
      },
      {
        id: "voc-syn-22",
        stem: "The Treaty of Versailles ___ Germany to pay enormous reparations that crippled its postwar economy.",
        options: ["compelled", "forced", "told", "asked"],
        answer: "compelled",
        explanation: "'Compelled' means forced by authority or circumstances — the most formal and precise term in this political context.",
        fullExplanation: "'Compelled' is the standard formal-academic verb for being legally or authoritatively forced to do something. 'Forced' is correct but less formal; 'told' is too informal and implies a simple instruction; 'asked' implies a request, not an obligation.",
        source: "Oxford Advanced Learner's Dictionary (10e)",
        flavor: "history"
      },
      {
        id: "voc-syn-23",
        stem: "The hotel manager was very ___ about the guest's complaint and immediately offered a full refund.",
        options: ["apologetic", "sorry", "sad", "upset"],
        answer: "apologetic",
        explanation: "'Apologetic' means expressing regret formally on behalf of an institution — the most precise professional term.",
        fullExplanation: "'Apologetic' describes the act of formally acknowledging fault and expressing regret, which is appropriate for a professional context. 'Sorry' is correct but too informal for a hotel manager's response; 'sad' implies personal emotion rather than professional acknowledgement; 'upset' describes emotional distress rather than formal apology.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "social"
      },
      {
        id: "voc-syn-24",
        stem: "Scientists have ___ that global average temperatures have risen by approximately 1.1 degrees Celsius since the industrial era.",
        options: ["determined", "found", "noticed", "seen"],
        answer: "determined",
        explanation: "'Determined' means established conclusively through systematic measurement — the most precise scientific term.",
  ...
  "voc-coll": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["develop", "make", "find", "create"],
        answer: "develop",
      ...
      },
      {
        ...
        options: ["delivered", "gave", "made", "said"],
        answer: "delivered",
      ...
      },
      {
        ...
        options: ["founded", "created", "started", "begun"],
        answer: "founded",
      ...
      },
      {
        ...
        options: ["sparked", "started", "caused", "began"],
        answer: "sparked",
      ...
      },
      {
        ...
        options: ["achieved", "made", "reached", "got"],
        answer: "achieved",
      ...
      {
        id: "voc-coll-13",
        stem: "The biographer urges readers to ___ attention to Curie's early struggles, which shaped her relentless work ethic.",
        options: ["pay", "give", "take", "put"],
        answer: "pay",
        explanation: "'Pay attention' is the fixed English collocation for directing focus.",
        fullExplanation: "'Pay attention' is the standard fixed collocation in English. 'Give attention' is occasionally used but less idiomatic; 'take attention' is not a valid collocation; 'put attention' is a common learner error influenced by other languages.",
        source: "Longman Collocations Dictionary (2e)",
        flavor: "personalities"
      },
      {
        id: "voc-coll-14",
        stem: "Historians are reluctant to ___ conclusions about the causes of the First World War without considering all available evidence.",
        options: ["draw", "make", "take", "reach"],
        answer: "draw",
        explanation: "'Draw conclusions' is the standard academic collocation for forming a judgement from evidence.",
        fullExplanation: "'Draw conclusions' is the established collocation in academic and analytical writing for forming a reasoned judgement from evidence. 'Make conclusions' is a common learner error; 'take conclusions' is not a valid collocation; 'reach conclusions' is possible but less standard than 'reach a conclusion' (singular).",
        source: "Oxford Collocations Dictionary (3e)",
        flavor: "history"
      },
      {
        id: "voc-coll-15",
        stem: "The charity campaign aims to ___ awareness of the rising rates of loneliness among elderly people in urban areas.",
        options: ["raise", "grow", "build", "spread"],
        answer: "raise",
        explanation: "'Raise awareness' is the established collocation for increasing public knowledge of an issue.",
        fullExplanation: "'Raise awareness' is the standard collocation for bringing an issue to public attention. 'Grow awareness' is not idiomatic in English; 'build awareness' is used in marketing contexts but is less universal; 'spread awareness' is informal and not the conventional phrase.",
        source: "Longman Collocations Dictionary (2e)",
        flavor: "social"
      },
      {
        id: "voc-coll-16",
        stem: "The clinical trial was designed to ___ evidence that the new drug reduces tumour growth more effectively than existing treatments.",
        options: ["provide", "give", "make", "do"],
        answer: "provide",
        explanation: "'Provide evidence' is the standard collocation in scientific and legal discourse.",
        fullExplanation: "'Provide evidence' is the established formal collocation in scientific reporting and legal language. 'Give evidence' is used in legal contexts specifically for witness testimony; 'make evidence' is not a valid collocation; 'do evidence' is entirely non-standard.",
        source: "Oxford Collocations Dictionary (3e)",
        flavor: "science"
      },
      {
        id: "voc-coll-17",
        stem: "By refusing to compromise on his artistic vision, Van Gogh ___ the risk of total poverty and professional rejection.",
        options: ["ran", "took", "made", "had"],
        answer: "ran",
        explanation: "'Run a risk' is the standard collocation meaning to knowingly expose oneself to danger or failure.",
        fullExplanation: "'Run a risk' (or 'run the risk of') is the established collocation for deliberately accepting a chance of harm or failure. 'Take a risk' is also correct and common; however, 'ran' is the precise expected answer for this collocation item. 'Made a risk' and 'had a risk' are not valid collocations.",
        source: "Longman Collocations Dictionary (2e)",
        flavor: "personalities"
      },
      {
        id: "voc-coll-18",
        stem: "Archaeologists ___ extensive research at the site before concluding that the ruins dated back to the Roman period.",
        options: ["conducted", "did", "made", "ran"],
        answer: "conducted",
        explanation: "'Conduct research' is the standard formal collocation in academic and scientific writing.",
        fullExplanation: "'Conduct research' is the established formal-academic collocation for carrying out systematic investigation. 'Do research' is common in informal or spoken English; 'make research' is a frequent learner error; 'ran research' is not a valid collocation in this sense.",
        source: "Oxford Collocations Dictionary (3e)",
        flavor: "history"
      },
      {
        id: "voc-coll-19",
        stem: "It is not our place to ___ judgement on another culture's traditions without first seeking to understand them.",
        options: ["pass", "make", "give", "do"],
        answer: "pass",
        explanation: "'Pass judgement' is the fixed collocation for making a moral or critical evaluation of someone or something.",
        fullExplanation: "'Pass judgement' is the standard collocation for delivering a moral or critical verdict, often with the implication of presumption. 'Make judgement' is used but requires the article ('make a judgement'); 'give judgement' is used in legal contexts; 'do judgement' is not a valid collocation.",
        source: "Longman Collocations Dictionary (2e)",
        flavor: "social"
      },
      {
        id: "voc-coll-20",
        stem: "The ethics board ___ permission for the team to proceed with the gene-editing experiments on human embryos.",
        options: ["granted", "gave", "allowed", "provided"],
        answer: "granted",
        explanation: "'Grant permission' is the formal collocation for officially authorising something.",
        fullExplanation: "'Grant permission' is the established formal collocation for officially authorising an activity, especially in institutional or legal contexts. 'Gave permission' is correct but less formal; 'allowed permission' is redundant and non-standard; 'provided permission' is not idiomatic.",
        source: "Oxford Collocations Dictionary (3e)",
        flavor: "science"
      },
      {
        id: "voc-coll-21",
        stem: "Usain Bolt ___ the world record for the 100 metres sprint at the 2009 World Athletics Championships in Berlin.",
        options: ["broke", "set", "beat", "achieved"],
        answer: "broke",
        explanation: "'Break a record' is the standard collocation for surpassing a previously established best performance.",
        fullExplanation: "'Break a record' is the fixed collocation for surpassing an existing performance record. 'Set a record' means to establish a new best for the first time; 'beat a record' is informal; 'achieved a record' is not a standard collocation.",
        source: "Longman Collocations Dictionary (2e)",
        flavor: "personalities"
      },
      {
        id: "voc-coll-22",
        stem: "Diplomats at the 1919 Paris Peace Conference struggled to ___ a balance between punishing Germany and preserving European stability.",
        options: ["strike", "find", "make", "reach"],
        answer: "strike",
        explanation: "'Strike a balance' is the fixed collocation for achieving an equilibrium between competing demands.",
        fullExplanation: "'Strike a balance' is the established idiom for achieving an appropriate middle point between two competing demands. 'Find a balance' is less formal and less idiomatic; 'make a balance' is not standard; 'reach a balance' is used but less conventional.",
        source: "Oxford Collocations Dictionary (3e)",
        flavor: "history"
      },
      {
        id: "voc-coll-23",
        stem: "Local residents ___ a campaign to save the community library from being closed due to council budget cuts.",
        options: ["launched", "started", "began", "opened"],
        answer: "launched",
        explanation: "'Launch a campaign' is the standard collocation for formally beginning an organised effort.",
        fullExplanation: "'Launch a campaign' is the established collocation for formally initiating an organised public effort or initiative. 'Started a campaign' is correct but more informal; 'began a campaign' is grammatically correct but less idiomatic; 'opened a campaign' is non-standard in this context.",
        source: "Longman Collocations Dictionary (2e)",
        flavor: "social"
      },
      {
        id: "voc-coll-24",
        stem: "Scientists ___ a responsibility to communicate the risks and benefits of new technologies honestly to the public.",
        options: ["bear", "have", "carry", "hold"],
        answer: "bear",
        explanation: "'Bear responsibility' is the formal collocation for holding a duty or obligation.",
  ...
  "voc-reg": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["generated", "caused", "brought about", "made"],
        answer: "generated",
      ...
      },
      {
        ...
        options: ["pop", "arrive", "attend", "proceed"],
        answer: "pop",
      ...
      },
      {
        ...
        options: ["indicate", "show", "prove", "tell"],
        answer: "indicate",
      ...
      },
      {
        ...
        options: ["acknowledged", "mentioned", "talked about", "noted down"],
        answer: "acknowledged",
      ...
      },
      {
        ...
        options: ["characterise", "see", "reckon", "call"],
        answer: "characterise",
      ...
      },
      {
        ...
        options: ["drop", "arrive", "attend", "appear"],
        answer: "drop",
      ...
      },
      {
        ...
        options: ["demonstrates", "proves", "shows that", "points out"],
        answer: "demonstrates",
      ...
      },
      {
        ...
        options: ["documents", "talks about", "discusses", "goes into"],
        answer: "documents",
      ...
      },
      {
        ...
        options: ["raises", "brings up", "asks", "poses"],
        answer: "raises",
      ...
      },
      {
        ...
        options: ["loved", "found gratifying", "savoured", "appreciated"],
        answer: "loved",
      ...
      },
      {
        ...
        options: ["consume", "eat", "devour", "swallow"],
        answer: "consume",
      ...
      {
        id: "voc-reg-13",
        stem: "The documentary ___ how Nikola Tesla's rivalry with Edison shaped the development of electrical power systems worldwide.",
        options: ["explored", "checked out", "went into", "looked at"],
        answer: "explored",
        explanation: "'Explored' is the formal-register verb appropriate for a documentary's narrative analysis.",
        fullExplanation: "'Explored' is the standard formal verb for systematic investigation or narration of a subject in a documentary or written account. 'Checked out' is informal and colloquial; 'went into' is informal and phrasal; 'looked at' is neutral but too casual for formal documentary narration.",
        source: "Oxford Writing Guide",
        flavor: "personalities"
      },
      {
        id: "voc-reg-14",
        stem: "The conference paper argues that the collapse of the Byzantine Empire ___ a prolonged period of political fragmentation in the eastern Mediterranean.",
        options: ["initiated", "started off", "kicked off", "set off"],
        answer: "initiated",
        explanation: "'Initiated' is the formal academic verb for the commencement of a process or period.",
        fullExplanation: "'Initiated' is the standard formal-academic verb for beginning a process with deliberate or significant consequence. 'Started off' and 'kicked off' are informal phrasal verbs; 'set off' implies a triggering event but is informal and more associated with alarms or journeys.",
        source: "Academic Word List; Swales & Feak, Academic Writing for Graduate Students",
        flavor: "history"
      },
      {
        id: "voc-reg-15",
        stem: "Text message: 'I'm just going to ___ to the corner shop — back in five minutes!'",
        options: ["nip out", "depart", "proceed", "exit"],
        answer: "nip out",
        explanation: "'Nip out' is informal/conversational — the natural British English expression for a quick, brief errand.",
        fullExplanation: "'Nip out' is an informal British English phrasal verb for a quick, brief departure, perfectly suited to a casual text message. 'Depart' is formal and official; 'proceed' is bureaucratic and incongruous in casual speech; 'exit' is formal and used for official or directional contexts.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "social"
      },
      {
        id: "voc-reg-16",
        stem: "The peer-reviewed study ___ that prolonged exposure to blue light from screens may disrupt the body's natural sleep cycle.",
        options: ["suggests", "proves", "tells us", "reckons"],
        answer: "suggests",
        explanation: "'Suggests' is the standard hedged verb in scientific writing for presenting evidence-based but uncertain conclusions.",
        fullExplanation: "'Suggests' is the preferred hedged verb in scientific writing for presenting findings that support a conclusion without claiming absolute certainty. 'Proves' overclaims certainty inappropriate to empirical science; 'tells us' is too conversational; 'reckons' is informal and dialectal.",
        source: "APA Publication Manual (7e); Academic Word List",
        flavor: "science"
      },
      {
        id: "voc-reg-17",
        stem: "The museum catalogue ___ Frida Kahlo as an artist whose work fundamentally redefined self-portraiture as a political act.",
        options: ["positions", "puts", "sees", "reckons"],
        answer: "positions",
        explanation: "'Positions' is the formal academic verb for placing someone within a critical or theoretical framework.",
        fullExplanation: "In formal academic and curatorial writing, 'position' is used to place a figure within a theoretical or critical framework. 'Puts' is too informal and vague; 'sees' is neutral but lacks the theoretical weight of 'positions'; 'reckons' is informal and dialectal.",
        source: "Academic Word List; Oxford Writing Guide",
        flavor: "personalities"
      },
      {
        id: "voc-reg-18",
        stem: "Scholars have long ___ the causes of the Hundred Years' War, examining the interplay of dynastic claims, economic rivalry, and feudal obligation.",
        options: ["scrutinised", "looked into", "gone over", "checked"],
        answer: "scrutinised",
        explanation: "'Scrutinised' is the formal academic verb for rigorous, critical examination of a subject.",
        fullExplanation: "In academic writing, 'scrutinise' means to examine carefully and critically, which fits the rigorous study of historical causes. 'Looked into' is informal and phrasal; 'gone over' is informal and suggests simple review rather than critical analysis; 'checked' is too casual for scholarly discourse.",
        source: "Academic Word List; Swales & Feak, Academic Writing for Graduate Students",
        flavor: "history"
      },
      {
        id: "voc-reg-19",
        stem: "A: 'Did you enjoy the concert last night?' B: 'It was incredible — I was absolutely ___ about it to everyone on the way home!'",
        options: ["raving", "enthusiastic", "positive", "vocal"],
        answer: "raving",
        explanation: "'Raving about' is informal/conversational — the natural idiom for talking about something with intense excitement.",
        fullExplanation: "'Raving about something' is an informal idiom meaning to talk about it with great enthusiasm and excitement, fitting a casual post-concert conversation. 'Enthusiastic' is an adjective, not a verb form; 'positive' is too neutral and formal; 'vocal' implies speaking up publicly rather than expressing personal excitement.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "social"
      },
      {
        id: "voc-reg-20",
        stem: "The data ___ that neurons in the prefrontal cortex exhibit heightened activity during tasks requiring abstract reasoning.",
        options: ["reveal", "show off", "prove", "tell"],
        answer: "reveal",
        explanation: "'Reveal' is the precise formal verb for data presenting previously unknown patterns or findings.",
        fullExplanation: "In scientific writing, 'reveal' is used when data discloses something not previously known or observed, making it more precise than 'prove'. 'Show off' is an informal phrasal verb with a completely different meaning; 'prove' overclaims certainty; 'tell' is too colloquial for scientific reporting.",
        source: "APA Publication Manual (7e); Academic Word List",
        flavor: "science"
      },
      {
        id: "voc-reg-21",
        stem: "The obituary ___ Churchill's legacy as one of the defining forces of twentieth-century democracy.",
        options: ["articulated", "talked about", "said things about", "went on about"],
        answer: "articulated",
        explanation: "'Articulated' is the formal verb for expressing ideas with precision and clarity in formal writing.",
        fullExplanation: "In formal biographical or journalistic writing, 'articulated' means to express ideas clearly and precisely. 'Talked about' is conversational; 'said things about' is too informal and vague; 'went on about' is informal and implies tedious repetition.",
        source: "Oxford Writing Guide",
        flavor: "personalities"
      },
      {
        id: "voc-reg-22",
        stem: "The historical thesis ___ the key economic factors that contributed to the decline of the Hanseatic League in the sixteenth century.",
        options: ["outlined", "went over", "laid out", "ran through"],
        answer: "outlined",
        explanation: "'Outlined' is the standard formal academic verb for presenting the main points of an argument or analysis.",
        fullExplanation: "In academic writing, 'outlined' is the conventional verb for setting out the main structure or key points of an argument. 'Went over' is informal and phrasal; 'laid out' is possible but more informal and journalistic; 'ran through' is conversational and implies speed rather than rigorous presentation.",
        source: "Academic Word List; Swales & Feak, Academic Writing for Graduate Students",
        flavor: "history"
      },
      {
        id: "voc-reg-23",
        stem: "A: 'What did you do after the meeting?' B: 'Oh, we just decided to ___ for a bit and grab a coffee.'",
        options: ["hang out", "remain", "socialise", "linger"],
        answer: "hang out",
        explanation: "'Hang out' is informal/conversational — the natural everyday phrase for spending casual time together.",
        fullExplanation: "'Hang out' is an informal phrasal verb for spending relaxed, unstructured time with others, appropriate for casual conversation. 'Remain' is formal and suggests physical presence rather than social interaction; 'socialise' is neutral-formal; 'linger' implies staying longer than expected, often with a negative connotation.",
        source: "Longman Dictionary of Contemporary English (6e)",
        flavor: "social"
      },
      {
        id: "voc-reg-24",
        stem: "Recent observations ___ that the ice caps of Mars undergo significant seasonal variation in response to temperature changes.",
        options: ["indicate", "prove", "tell", "confirm"],
        answer: "indicate",
        explanation: "'Indicate' is the standard hedged verb in scientific reporting for presenting observational evidence.",
  ...
  "dia-agree": {
    ...
    canonicalSubId: "cs-dia-agree",
    canonicalTopicId: "dialogue-skills",
    tasks: [
      {
        id: "dia-agree-01",
        stem: "A: 'I really admire Marie Curie — she was an extraordinary scientist.' B: '___, she was truly one of a kind.'",
        options: ["So do I", "Neither do I", "I don't either", "Me neither"],
        answer: "So do I",
      ...
      },
      {
        ...
        options: ["Neither did I", "So did I", "I did too", "Me too"],
      ...
      },
      {
        ...
        options: ["So do I", "Neither do I", "I don't either", "Nor I"],
        answer: "So do I",
      ...
      },
      {
        ...
        options: ["Neither have I", "So have I", "I have too", "Me too"],
      ...
      },
      {
        ...
        options: ["So do I", "Neither do I", "I don't", "Nor do I"],
        answer: "So do I",
      ...
      },
      {
        ...
        options: ["Neither can I", "So can I", "I can too", "So do I"],
      ...
      },
      {
        ...
        options: ["Neither do I", "So do I", "I do too", "Me too"],
        answer: "Neither do I",
      ...
      },
      {
        ...
        options: ["Neither had I", "So had I", "I had too", "Me too"],
      ...
      },
      {
        ...
        options: ["So was I", "Neither was I", "I wasn't either", "Nor was I"],
        answer: "So was I",
      ...
      {
        id: "dia-agree-13",
        stem: "A: 'I am really interested in the life of Leonardo da Vinci — he was so ahead of his time.' B: '___ — the breadth of his knowledge is staggering.'",
        options: ["So am I", "Neither am I", "I'm not either", "Me neither"],
        answer: "So am I",
        explanation: "'So am I' agrees with a positive present simple statement using 'be'.",
        fullExplanation: "A uses a positive present simple form ('I am interested'), so B agrees with 'So am I' (inverted structure: So + am + I). 'Neither am I' and 'I'm not either' respond to negative statements; 'Me neither' is positive but responds to negatives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "personalities"
      },
      {
        id: "dia-agree-14",
        stem: "A: 'I found the lecture on the causes of World War II surprisingly engaging.' B: '___ — the part about economic instability was especially well explained.'",
        options: ["So did I", "Neither did I", "I didn't either", "Me neither"],
        answer: "So did I",
        explanation: "'So did I' agrees with a positive past simple statement.",
        fullExplanation: "A uses a positive past tense verb ('I found'), so B agrees with 'So did I' (inverted positive agreement). 'Neither did I' and 'I didn't either' respond to negative past statements; 'Me neither' responds to negatives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "history"
      },
      {
        id: "dia-agree-15",
        stem: "A: 'I would love to take a long break and travel somewhere completely new.' B: '___ — I've been feeling burnt out for months.'",
        options: ["So would I", "Neither would I", "I wouldn't either", "Me neither"],
        answer: "So would I",
        explanation: "'So would I' agrees with a positive conditional statement using 'would'.",
        fullExplanation: "A uses a positive conditional ('I would love to…'), so B agrees with 'So would I'. 'Neither would I' and 'I wouldn't either' respond to negative conditional statements; 'Me neither' responds to negatives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "social"
      },
      {
        id: "dia-agree-16",
        stem: "A: 'I have always been fascinated by the way black holes bend the fabric of space-time.' B: '___ — it's one of the most counterintuitive ideas in physics.'",
        options: ["So have I", "Neither have I", "I haven't either", "Me neither"],
        answer: "So have I",
        explanation: "'So have I' agrees with a positive present perfect statement.",
        fullExplanation: "A uses a positive present perfect ('I have always been fascinated'), so B agrees with 'So have I'. 'Neither have I' and 'I haven't either' respond to negative present perfect statements; 'Me neither' responds to negatives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "science"
      },
      {
        id: "dia-agree-17",
        stem: "A: 'I wouldn't describe Shakespeare as easy to read without some guidance.' B: '___ — the language requires a lot of unpacking.'",
        options: ["Neither would I", "So would I", "I would too", "Me too"],
        answer: "Neither would I",
        explanation: "'Neither would I' agrees with a negative conditional statement using 'wouldn't'.",
        fullExplanation: "A uses a negative conditional ('I wouldn't describe…'), so B agrees with 'Neither would I'. 'So would I' and 'I would too' agree with positive conditionals; 'Me too' agrees with positives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "personalities"
      },
      {
        id: "dia-agree-18",
        stem: "A: 'I had always assumed the Vikings were purely raiders, but they were also skilled traders.' B: '___ until I read more about their history.'",
        options: ["So had I", "Neither had I", "I hadn't either", "Me neither"],
        answer: "So had I",
        explanation: "'So had I' agrees with a positive past perfect statement.",
        fullExplanation: "A uses a positive past perfect ('I had always assumed'), so B agrees with 'So had I'. 'Neither had I' and 'I hadn't either' respond to negative past perfect statements; 'Me neither' responds to negatives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "history"
      },
      {
        id: "dia-agree-19",
        stem: "A: 'I don't think social media platforms do enough to protect teenagers from harmful content.' B: '___ — there needs to be much stricter regulation.'",
        options: ["Neither do I", "So do I", "I do too", "Me too"],
        answer: "Neither do I",
        explanation: "'Neither do I' agrees with a negative present simple statement.",
        fullExplanation: "A uses a negative present simple ('I don't think'), so B agrees with 'Neither do I'. 'So do I' and 'I do too' agree with positive present simple statements; 'Me too' agrees with positives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "social"
      },
      {
        id: "dia-agree-20",
        stem: "A: 'I will never fully understand how quantum entanglement allows particles to be correlated across vast distances.' B: '___ — it defies every intuitive model of physics.'",
        options: ["Neither will I", "So will I", "I will too", "Me too"],
        answer: "Neither will I",
        explanation: "'Neither will I' agrees with a negative future statement using 'will never'.",
        fullExplanation: "A uses a negative future ('I will never understand'), so B agrees with 'Neither will I'. 'So will I' and 'I will too' agree with positive future statements; 'Me too' agrees with positives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "science"
      },
      {
        id: "dia-agree-21",
        stem: "A: 'I could listen to Callas sing all day — her voice is absolutely spellbinding.' B: '___ — there's nobody quite like her.'",
        options: ["So could I", "Neither could I", "I couldn't either", "Me neither"],
        answer: "So could I",
        explanation: "'So could I' agrees with a positive modal statement using 'could'.",
        fullExplanation: "A uses a positive modal ('I could listen'), so B agrees with 'So could I'. 'Neither could I' and 'I couldn't either' respond to negative modal statements; 'Me neither' responds to negatives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "personalities"
      },
      {
        id: "dia-agree-22",
        stem: "A: 'I was surprised by how quickly the Weimar Republic collapsed under economic and political pressure.' B: '___ — the speed of it was remarkable.'",
        options: ["So was I", "Neither was I", "I wasn't either", "Me neither"],
        answer: "So was I",
        explanation: "'So was I' agrees with a positive past state using the verb 'be'.",
        fullExplanation: "A uses a positive past state ('I was surprised'), so B agrees with 'So was I'. 'Neither was I' and 'I wasn't either' respond to negative past states; 'Me neither' responds to negatives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "history"
      },
      {
        id: "dia-agree-23",
        stem: "A: 'I am not really comfortable with the idea of strangers reading my personal messages.' B: '___ — it feels like a serious invasion of privacy.'",
        options: ["Neither am I", "So am I", "I am too", "Me too"],
        answer: "Neither am I",
        explanation: "'Neither am I' agrees with a negative present state using the verb 'be'.",
        fullExplanation: "A uses a negative present state ('I am not comfortable'), so B agrees with 'Neither am I'. 'So am I' and 'I am too' agree with positive present states; 'Me too' agrees with positives.",
        source: "Murphy, EGU (4e), Unit 47",
        flavor: "social"
      },
      {
        id: "dia-agree-24",
        stem: "A: 'I think researchers should be more transparent about the limitations of their data.' B: '___ — overconfident claims do a lot of damage to public trust in science.'",
        options: ["So do I", "Neither do I", "I don't either", "Nor I"],
        answer: "So do I",
        explanation: "'So do I' agrees with a positive present simple opinion statement.",
  ...
  "dia-sugg": {
    ...
    tasks: [
      ...
      },
      {
        ...
        options: ["Why don't we", "How about", "What about", "Let's"],
        answer: "Why don't we",
      ...
      },
      {
        ...
        options: ["Shall we", "Why not", "How about", "What about"],
        answer: "Shall we",
      ...
      },
      {
        ...
        options: ["What about", "Why don't we", "Shall we", "Let's"],
        answer: "What about",
      ...
      },
      {
        ...
        options: ["Let's", "Shall we", "How about", "Why don't"],
        answer: "Let's",
      ...
      },
      {
        ...
        options: ["Why not", "How about", "Shall we", "Let's"],
        answer: "Why not",
      ...
      },
      {
        ...
        options: ["Why don't we", "How about", "What about", "Why not"],
        answer: "Why don't we",
      ...
      },
      {
        ...
        options: ["Shall we", "Let's", "How about", "What about"],
        answer: "Shall we",
      ...
      },
      {
        ...
        options: ["What about", "Why don't we", "Let's", "Shall we"],
        answer: "What about",
      ...
      },
      {
        ...
        options: ["Why not", "How about", "What about", "Shall we"],
        answer: "Why not",
      ...
      },
      {
        ...
        options: ["Let's", "What about", "How about", "Why not"],
        answer: "Let's",
      ...
      {
        id: "dia-sugg-13",
        stem: "A: 'We need to choose a topic for our art history essay.' B: '___ writing about the influence of Japanese woodblock prints on Impressionism?'",
        options: ["How about", "Why don't we", "Let's", "Shall we"],
        answer: "How about",
        explanation: "'How about' is followed directly by a gerund (-ing form) to make a suggestion.",
        fullExplanation: "'How about + gerund' ('writing about…') is the standard suggestion pattern. 'Why don't we' requires a bare infinitive ('Why don't we write…'); 'Let's' also requires a bare infinitive; 'Shall we' requires a bare infinitive. Only 'How about' is naturally followed by a gerund.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "personalities"
      },
      {
        id: "dia-sugg-14",
        stem: "A: 'Our presentation on the Second World War doesn't have a clear conclusion.' B: '___ end with a quote from Churchill? It would give it real impact.'",
        options: ["Why don't we", "How about", "What about", "Shall we"],
        answer: "Why don't we",
        explanation: "'Why don't we' is followed by a bare infinitive to make a joint suggestion.",
        fullExplanation: "'Why don't we + bare infinitive' ('end with a quote') is a standard joint suggestion. 'How about' and 'What about' require a gerund; 'Shall we' also takes a bare infinitive but 'Why don't we' is more natural here as an informal proposal.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "history"
      },
      {
        id: "dia-sugg-15",
        stem: "A: 'The office is getting a bit noisy for this call.' B: '___ move to the meeting room down the hall?'",
        options: ["Shall we", "How about", "What about", "Why not"],
        answer: "Shall we",
        explanation: "'Shall we' before a bare infinitive politely invites agreement to a joint suggestion.",
        fullExplanation: "'Shall we + bare infinitive' ('move to the meeting room') is a polite suggestion seeking the listener's agreement. 'How about' and 'What about' require gerunds; 'Why not' works but would omit the subject 'we' ('Why not move?').",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "social"
      },
      {
        id: "dia-sugg-16",
        stem: "A: 'We need a control group for the experiment.' B: '___ the participants from last term's study? They already know the protocol.'",
        options: ["What about", "Why don't we", "Let's", "Shall we"],
        answer: "What about",
        explanation: "'What about' can be followed by a noun phrase to suggest it as an option.",
        fullExplanation: "'What about + noun phrase' ('the participants from last term's study') is a standard suggestion pattern. 'Why don't we', 'Let's', and 'Shall we' all require a verb (bare infinitive) after them, not a noun phrase.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "science"
      },
      {
        id: "dia-sugg-17",
        stem: "A: 'I really want to see that new exhibition on Renaissance sculpture.' B: '___ go this Saturday morning — it'll be less crowded.'",
        options: ["Let's", "How about", "What about", "Why not"],
        answer: "Let's",
        explanation: "'Let's' (= let us) is followed by a bare infinitive and directly proposes a joint action.",
        fullExplanation: "'Let's + bare infinitive' ('go this Saturday') is a direct, enthusiastic joint proposal. 'How about' and 'What about' require gerunds ('going'); 'Why not' also works with a bare infinitive but 'Let's' is more assertive and natural for a direct plan.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "personalities"
      },
      {
        id: "dia-sugg-18",
        stem: "A: 'This chapter on the Silk Road is far too long for one session.' B: '___ split it into two parts and cover the second half next week?'",
        options: ["Why not", "How about", "What about", "Let's"],
        answer: "Why not",
        explanation: "'Why not + bare infinitive' is an informal suggestion offered without requiring a subject pronoun.",
        fullExplanation: "'Why not + bare infinitive' ('split it') is a concise informal suggestion. 'How about' and 'What about' would require a gerund ('splitting'); 'Let's' also takes a bare infinitive but 'Why not' is more natural here as a quick, casual recommendation.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "history"
      },
      {
        id: "dia-sugg-19",
        stem: "A: 'We have an hour to kill before the show starts.' B: '___ grabbing a coffee at that place on the corner?'",
        options: ["How about", "Why don't we", "Let's", "Shall we"],
        answer: "How about",
        explanation: "'How about + -ing' is the correct structure before a gerund.",
        fullExplanation: "'How about + gerund' ('grabbing a coffee') is the standard pattern. 'Why don't we', 'Let's', and 'Shall we' all require bare infinitives ('grab').",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "social"
      },
      {
        id: "dia-sugg-20",
        stem: "A: 'The students keep confusing correlation with causation in their lab reports.' B: '___ dedicate a full lesson to the distinction before the next assignment?'",
        options: ["Why don't we", "How about", "What about", "Why not"],
        answer: "Why don't we",
        explanation: "'Why don't we + bare infinitive' makes a practical joint suggestion for a course of action.",
        fullExplanation: "'Why don't we + bare infinitive' ('dedicate a full lesson') is a standard joint suggestion. 'How about' and 'What about' require gerunds ('dedicating'); 'Why not' also takes a bare infinitive but 'Why don't we' is more idiomatic for a collaborative teaching proposal.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "science"
      },
      {
        id: "dia-sugg-21",
        stem: "A: 'I can't decide how to open my talk about Coco Chanel.' B: '___ start with a striking quote from her? It'll immediately grab the audience.'",
        options: ["Shall we", "How about", "What about", "Let's"],
        answer: "Shall we",
        explanation: "'Shall we + bare infinitive' invites agreement to a suggestion politely.",
        fullExplanation: "'Shall we + bare infinitive' ('start with a quote') seeks the listener's approval and agreement. 'How about' and 'What about' require gerunds ('starting'); 'Let's' is also possible but 'Shall we' adds a questioning, consultative tone appropriate here.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "personalities"
      },
      {
        id: "dia-sugg-22",
        stem: "A: 'We need a primary source for the section on the Industrial Revolution.' B: '___ one of Engels's letters from Manchester? They give a vivid first-hand account.'",
        options: ["What about", "Why don't we", "Let's", "Shall we"],
        answer: "What about",
        explanation: "'What about' followed by a noun phrase suggests it as a concrete option.",
        fullExplanation: "'What about + noun phrase' ('one of Engels's letters') naturally introduces a specific item as a suggestion. 'Why don't we', 'Let's', and 'Shall we' require a verb in bare infinitive form, not a noun phrase directly.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "history"
      },
      {
        id: "dia-sugg-23",
        stem: "A: 'The flat is a mess before the guests arrive.' B: '___ divide the rooms between us and get it done in twenty minutes.'",
        options: ["Let's", "How about", "What about", "Why not"],
        answer: "Let's",
        explanation: "'Let's + bare infinitive' proposes an immediate, decisive joint action.",
        fullExplanation: "'Let's + bare infinitive' ('divide the rooms') is the most direct and action-oriented joint suggestion. 'How about' and 'What about' require gerunds ('dividing'); 'Why not' also takes a bare infinitive but 'Let's' is stronger and more urgent for an immediate plan.",
        source: "Murphy, EGU (4e), Unit 36",
        flavor: "social"
      },
      {
        id: "dia-sugg-24",
        stem: "A: 'The research proposal needs a stronger justification section.' B: '___ include a brief literature review to show the gap in existing studies?'",
        options: ["Why not", "How about", "What about", "Shall we"],
        answer: "Why not",
        explanation: "'Why not + bare infinitive' is a concise, practical suggestion for improving a document.",
  ...
  "dia-infer": {
    id: "dia-infer",
    name: "Speaker intent inference",
    canonicalSubId: "cs-dia-infer",
    canonicalTopicId: "dialogue-skills",
    tasks: [
      {
        id: "dia-infer-01",
        stem: "A: 'Do you think Einstein fully understood the implications of his own theory?' B: '___' What does B mean?",
        options: ["The question remains unresolved among experts.", "B does not want to answer the question.", "Scientists agree that Einstein did not understand his theory.", "The theory of relativity is no longer relevant."],
      ...
      },
      {
        ...
        options: ["B confirms that the Romans were indeed highly advanced.", "B thinks people overestimate Roman achievements.", "B is unsure whether the Romans were advanced.", "B believes Roman engineering was inferior to modern standards."],
      ...
      },
      {
        ...
        options: ["B is saying A does not need to bring anything.", "B is asking A to bring only one small item.", "B thinks A would not enjoy the party.", "B is disappointed that A asked the question."],
      ...
      },
      {
        ...
        options: ["B believes the scientific consensus is clear and long-established.", "B thinks scientists have been wrong for decades.", "B is unsure about the current scientific evidence.", "B suggests the evidence needs to be re-examined."],
      ...
      },
      {
        ...
        options: ["B believes Kahlo's suffering was inseparable from her artistic identity.", "B thinks Kahlo's health struggles harmed the quality of her work.", "B is suggesting Kahlo exaggerated her suffering for fame.", "B means Kahlo's fame was based entirely on public sympathy."],
      ...
      },
      {
        ...
        options: ["B thinks the Revolution's ideals were real but took generations to fulfil.", "B believes the Revolution was a complete failure.", "B thinks the Revolution achieved all its goals immediately.", "B means the Revolution was irrelevant to later history."],
      ...
      },
      {
        ...
        options: ["B regrets that they did not book tickets online in advance.", "B is blaming A for not booking the tickets.", "B is happy they chose not to book online.", "B thinks the queue will move quickly."],
      ...
      },
      {
        ...
        options: ["B is saying the claim is false according to scientific evidence.", "B believes humans actually use even less than 10% of their brains.", "B agrees that the 10% figure is accurate.", "B thinks neuroscience has not yet studied this question."],
      ...
      },
      {
        ...
        options: ["B implies deafness did not prevent and may have deepened Beethoven's creativity.", "B believes Beethoven's best work was written before he went deaf.", "B thinks deafness was the sole reason for Beethoven's success.", "B means Beethoven's late works are not highly regarded."],
      ...
      },
      {
        ...
        options: ["B is saying the question is morally and historically complex.", "B thinks the Wall was clearly not worth the human cost.", "B believes the question has an obvious straightforward answer.", "B is refusing to engage with the topic at all."],
      ...
      },
      {
        ...
        options: ["B is encouraging A to be patient and stay optimistic.", "B is telling A to stop applying for jobs.", "B thinks A is not qualified for the positions.", "B believes A should apply for different types of jobs."],
      ...
      },
      {
        ...
        options: ["B thinks the existence of extraterrestrial life is statistically likely.", "B is certain that life has already been found on another planet.", "B believes the search for extraterrestrial life is pointless.", "B thinks the number of planets in the universe is very small."],
      ...
      {
        id: "dia-infer-13",
        stem: "A: 'Would you say Agatha Christie was overrated?' B: '___' What does B mean?",
        options: ["B thinks Christie's influence on literature was foundational and irreplaceable.", "B believes Christie wrote too many novels to be taken seriously.", "B is saying Christie's work is only popular because of film adaptations.", "B means Christie invented a genre that has now become outdated."],
        answer: "B thinks Christie's influence on literature was foundational and irreplaceable.",
        explanation: "B replies that Christie 'basically invented a genre', implying her contribution was essential, not overrated.",
        fullExplanation: "B's response — 'She basically invented a genre — mystery fiction as we know it wouldn't exist without her' — disputes 'overrated' by attributing the creation of an entire genre to Christie. Option 2 misreads the tone as critical; option 3 introduces film adaptations not mentioned by B; option 4 contradicts B's implied admiration.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "personalities"
      },
      {
        id: "dia-infer-14",
        stem: "A: 'Was the invention of the printing press really such a big deal?' B: '___' What does B mean?",
        options: ["B is saying the printing press caused a dramatic acceleration in the spread of knowledge.", "B thinks the printing press was only significant because books were already popular.", "B believes the printing press was invented too late to make a real difference.", "B means that hand-copying was nearly as effective as printing."],
        answer: "B is saying the printing press caused a dramatic acceleration in the spread of knowledge.",
        explanation: "B's comparison of fifty years of printing to centuries of hand-copying implies a revolutionary leap in efficiency.",
        fullExplanation: "B replies 'The printing press did in fifty years what centuries of hand-copying couldn't', contrasting the speed of print distribution with the slowness of manuscript culture. Options 2 and 3 contradict B's admiring tone; option 4 is the opposite of what the comparison implies.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "history"
      },
      {
        id: "dia-infer-15",
        stem: "A: 'I'm thinking of spending a week in the countryside instead of my usual city holiday.' B: '___' What does B mean?",
        options: ["B is encouraging A to try something different, suggesting it will be refreshing.", "B is warning A that the countryside will be exhausting.", "B thinks A should take a proper holiday rather than just a change of scenery.", "B means A is making a mistake by changing their usual plans."],
        answer: "B is encouraging A to try something different, suggesting it will be refreshing.",
        explanation: "The idiom 'a change is as good as a rest' means that doing something different is as beneficial as taking a break.",
        fullExplanation: "B says 'You know what they say — a change is as good as a rest!', using a well-known idiom to express support for A's plan and imply that a new experience will be just as restorative as resting. Options 2, 3, and 4 all misread B's encouraging tone as cautionary or critical.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "social"
      },
      {
        id: "dia-infer-16",
        stem: "A: 'Is the anti-vaccine movement a serious threat to public health?' B: '___' What does B mean?",
        options: ["B is implying that opposing vaccines puts an enormously valuable tool at risk.", "B believes the anti-vaccine movement is a minor inconvenience, not a real threat.", "B is saying vaccines are no longer effective against modern diseases.", "B means life expectancy would be the same without vaccines."],
        answer: "B is implying that opposing vaccines puts an enormously valuable tool at risk.",
        explanation: "B's statement about vaccines' unparalleled impact on life expectancy frames opposition as deeply dangerous.",
        fullExplanation: "B replies 'Vaccines have done more to extend human life expectancy than any other medical intervention', implying that anything undermining vaccination is a serious threat. Option 2 contradicts the gravity of B's statement; option 3 contradicts B's positive framing; option 4 is the opposite of B's assertion.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "science"
      },
      {
        id: "dia-infer-17",
        stem: "A: 'Do you think Michelangelo was really as passionate about art as people claim?' B: '___' What does B mean?",
        options: ["B implies that Michelangelo was far more complex and conflicted than his artwork suggests.", "B thinks Michelangelo's letters prove he had no real passion for painting.", "B believes the Sistine Chapel was painted by someone other than Michelangelo.", "B means Michelangelo's letters confirm that he was entirely devoted to his art."],
        answer: "B implies that Michelangelo was far more complex and conflicted than his artwork suggests.",
        explanation: "B's surprise at the contrast between the letters and the Sistine Chapel signals a striking gap between private man and public masterwork.",
        fullExplanation: "B replies 'When you read his letters, it's hard to believe the same man painted the Sistine Chapel', implying a contradiction between Michelangelo's private inner world and the transcendent beauty he produced. Option 2 overstates the letters as proof of no passion; option 3 is a factual misreading; option 4 is the opposite of what B's surprise implies.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "personalities"
      },
      {
        id: "dia-infer-18",
        stem: "A: 'Was the trans-Atlantic slave trade good or bad for the economies involved?' B: '___' What does B mean?",
        options: ["B is pointing out that the trade was economically beneficial for some and catastrophic for others.", "B believes the slave trade had no overall economic effect.", "B is refusing to make any judgement about the slave trade.", "B thinks the trade was equally harmful for all parties involved."],
        answer: "B is pointing out that the trade was economically beneficial for some and catastrophic for others.",
        explanation: "B's phrase 'which side of the trade you were on' draws a stark contrast between those who profited and those who suffered.",
        fullExplanation: "B replies 'It depended entirely on which side of the trade you were on', acknowledging profound economic asymmetry. Option 2 contradicts the implication of differential impact; option 3 misreads B as evasive when B is making an implicit moral point; option 4 contradicts the idea of different 'sides'.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "history"
      },
      {
        id: "dia-infer-19",
        stem: "A: 'Should I stay up late to finish this report or go to bed now?' B: '___' What does B mean?",
        options: ["B is recommending that A get a good night's sleep rather than work late.", "B thinks A should stay up and finish the report at all costs.", "B is saying that sleep is never as important as completing work.", "B means A should go to bed only if the report is already finished."],
        answer: "B is recommending that A get a good night's sleep rather than work late.",
        explanation: "The idiom 'nothing beats an early night' advocates rest over late-night work before an important day.",
        fullExplanation: "B says 'Nothing beats an early night when you've got a big day ahead', using an idiomatic expression to prioritise sleep before an important event. Options 2 and 4 contradict B's recommendation; option 3 is the opposite of B's implied view.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "social"
      },
      {
        id: "dia-infer-20",
        stem: "A: 'So the Bohr model of the atom — is that actually what atoms look like?' B: '___' What does B mean?",
        options: ["B is saying the Bohr model is a useful approximation, not a literal picture of reality.", "B believes the Bohr model has been completely abandoned by modern science.", "B is saying no one knows what an atom looks like.", "B means the Bohr model is accurate enough to be accepted as literally true."],
        answer: "B is saying the Bohr model is a useful approximation, not a literal picture of reality.",
        explanation: "B distinguishes between a predictive scientific model and a literal visual representation of physical reality.",
        fullExplanation: "B replies 'It's not what the atom looks like — it's a model that helps us predict behaviour', clarifying that scientific models are tools for prediction, not photographs of nature. Option 2 overstates B's point as full abandonment; option 3 misreads B as expressing ignorance; option 4 contradicts B's explicit statement that it is not literally what the atom looks like.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "science"
      },
      {
        id: "dia-infer-21",
        stem: "A: 'Why do you think Bartók dedicated so much of his life to collecting folk music?' B: '___' What does B mean?",
        options: ["B believes Bartók was driven by urgency to preserve a vanishing cultural heritage.", "B thinks Bartók collected folk music mainly to use it in his own compositions.", "B means Bartók was too busy collecting to compose original music himself.", "B believes Bartók's folk recordings were of poor quality due to limited time."],
        answer: "B believes Bartók was driven by urgency to preserve a vanishing cultural heritage.",
        explanation: "B's phrase 'every recording was a race against time' signals that Bartók was motivated by the imminent loss of oral musical traditions.",
        fullExplanation: "B replies 'He spent his whole life trying to save music that was disappearing — every recording was a race against time', framing Bartók as a cultural rescuer working against the clock. Option 2 introduces a different motive not stated by B; option 3 contradicts Bartók's prolific compositional output; option 4 misreads 'race against time' as a comment on recording quality.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "personalities"
      },
      {
        id: "dia-infer-22",
        stem: "A: 'Why did the Roman Empire eventually collapse despite being so powerful?' B: '___' What does B mean?",
        options: ["B is saying that the loss of infrastructure and political loyalty were key factors in Rome's fall.", "B believes Rome fell solely because its road network became too expensive to maintain.", "B thinks the Romans should have built more roads to prevent the collapse.", "B means trust between citizens was the only reason Rome survived as long as it did."],
        answer: "B is saying that the loss of infrastructure and political loyalty were key factors in Rome's fall.",
        explanation: "B uses 'roads' and 'trust' as paired metaphors for the physical and political foundations of the empire.",
        fullExplanation: "B replies 'You can't hold an empire together without roads and trust — and eventually both fell apart', identifying logistical infrastructure and political cohesion as twin pillars of imperial stability. Option 2 focuses only on roads; option 3 misreads B as prescriptive; option 4 isolates trust as the sole factor, ignoring B's pairing.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "history"
      },
      {
        id: "dia-infer-23",
        stem: "A: 'I need to renew my driving licence — is the post office busy at the moment?' B: '___' What does B mean?",
        options: ["B is advising A to go to the post office later to avoid the current crowds.", "B thinks A should not bother renewing the licence at the post office at all.", "B is warning A that the post office will be closed at the weekend.", "B means A should go immediately before the weekend rush begins."],
        answer: "B is advising A to go to the post office later to avoid the current crowds.",
        explanation: "'Wait until the weekend rush dies down' advises timing the visit to avoid peak congestion.",
        fullExplanation: "B replies 'I'd wait until the weekend rush dies down if I were you', using 'if I were you' as a polite advisory phrase to suggest a less busy time. Option 2 misreads B as discouraging the errand; option 3 contradicts B's implied advice to go after the rush; option 4 reverses B's meaning — 'wait until it dies down' means go later, not immediately.",
        source: "CT/CE Trainer Practice, dialogue inference",
        flavor: "social"
      },
      {
        id: "dia-infer-24",
        stem: "A: 'Is there a limit to how small subatomic particles can get?' B: '___' What does B mean?",
        options: ["B is implying that the search for the smallest particle may be endless.", "B believes scientists have already identified the smallest possible particle.", "B is saying physics has failed to find any subatomic particles at all.", "B thinks the question of particle size is not worth investigating."],
        answer: "B is implying that the search for the smallest particle may be endless.",
